...
# <a name="configure-a-manual-decision-in-a-workflow"></a>作業の現在の手動決定を設定します。
...
2.  通知を送信するイベントの横にあるチェック ボックスをオンにします。
    -   **\[に1\]**割り当てられたユーザーが選択した– **\[に1\]**。
    -   **\[に2\]**割り当てられたユーザーが選択した– **\[に2\]**。
...
2.  [**割り当てタイプ**] タブで、次の表のいずれかのオプションを選択し、オプションの追加手順を実行してから、手順 3 に進みます。
    ...
    <td><ol>
    <li>[<strong>ユーザー</strong>] を選択したのち、[<strong>ユーザー</strong>] タブをクリックします。</li>
    <li><strong>使用できるユーザー</strong> リストは、工程のユーザーのすべてのDynamics 365が含まれます。 決定を割り当てるユーザーを選択し、そのユーザーを [<strong>選択されたユーザー</strong>] リストに移動します。</li>
    </ol></td>
    </tr>
    <tr class="odd">
    <td>キュー</td>
...
2.  [**エスカレーション パスを使用**] チェック ボックスをオンにし、エスカレーション パスを作成します。 決定は、エスカレーション パスにリストされるユーザーに自動的に割り当てられます。 たとえば、次の表に、エスカレーション パスを示します。
    ...
    この例では、奈緒美に、期限超過の決定が割り当てられます。 割り当てられた時間内に奈緒美が決定を行わない場合は、悦子に決定が割り当てられます。 悦子が割り当てられた時間の請求しない場合、**\[に1\]選択**決定として表示します。
3.  エスカレーション パスにユーザーを追加するには、[**エスカレーションの追加**] をクリックします。 次の表のいずれかのオプションを選択し、そのオプションの追加ステップを実行してから、ステップ 4 に進みます。
    ...
    <td><ol>
    <li>[<strong>ユーザー</strong>] を選択したのち、[<strong>ユーザー</strong>] タブをクリックします。</li>
    <li><strong>使用できるユーザー</strong> リストは、工程のユーザーのすべてのDynamics 365が含まれます。 決定をエスカレートするユーザーを選択し、そのユーザーを [<strong>選択されたユーザー</strong>] リストに移動します。</li>
    </ol></td>
    </tr>
    </tbody>
    </table>
