---
title: "キーボード ショートカット"
description: "以下のキーボード ショートカットは、Microsoft Dynamics 365 for Operations 全体に適用されます。"
author: jasongre
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
以下のキーボード ショートカットは、Microsoft Dynamics 365 for Operations 全体に適用されます。 
...
| Dynamics 365 for Operations コンテキスト メニューを開く | Ctrl + F10                         |
...
| フォームをお気に入りに登録する / お気に入りから外す (ナビゲーション ペインのフォームにフォーカスがある場合) | Shift+F         |
