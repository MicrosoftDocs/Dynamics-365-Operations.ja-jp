...
マーケティング キャンペーンや活動を使用して、潜在的な顧客との関係を模索して構築し、初期の相互作用を販売関係へと発展させることができます。 次のプロセス フローは、マーケティングの業務プロセスを表しています。 [販売![業務プロセス] (。/media/marketing01.jpg) ] (。/media/marketing01.jpg) 
...
キャンペーンは、見込顧客、潜在顧客、営業案件、およびキャンペーンに参加するように選択されているお客様の連絡先をターゲットとします。 、Microsoft Dynamics 365では、顧客の可能性が最大限にキャンペーンの複数のタイプを、テレマーケティング、メールと電子メールのキャンペーンなど) を作成できます。 キャンペーンが進行して積極的な反応を受け取ると、キャンペーンに積極的に反応したこれらの受信者への営業プロセスを開始できます。

## <a name="sales"></a>販売注文
販売機能を使用して、見積、新規および既存のお客様のアップセル/クロスセルを作成し、販売注文の作成および顧客の売上請求書を作成します。 次のプロセス フローは、販売の業務プロセスを表しています。 [販売![業務プロセス] (。/media/sales01.jpg) ] (。/media/sales01.jpg) 
...
アップセル/クロスセルは、顧客の注文を入力するときに製品を販売するための手法です。 アップセルでは、現在の製品ではなく別の製品を推奨します。 クロスセルでは、現在の製品に加えて別の製品を推奨します。 製品リストを設定すると、製品が関連品目の販売または販売の製品としていつ提示方法を示す特定のルールを作成できます。
