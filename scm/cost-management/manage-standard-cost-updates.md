---
title: "標準原価の更新を管理します。"
description: "標準原価データの更新は二つの異なるアプローチ- 1バージョン アプローチと2バージョン アプローチ) を使用して管理できます。"
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
この例では、管理の更新2016に一つ追加の原価バージョンを一度中使用します。 複数の追加の原価バージョンには、更新のバッチごとに別のバージョンなど、使用できます。 複数の追加の原価を使用する場合は、有効原価が複数の原価バージョンに拡散されるため、予備を有効原価として表現する必要があります。
