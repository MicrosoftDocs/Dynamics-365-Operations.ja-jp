...
システム定義のテーブル制約は、属性タイプと Dynamics 365 for Operations テーブルのフィールドとの間のマッピングを表します。 システム定義のテーブル制約は、属性タイプとフィールドを動的にリンクさせます。 このリンクを使用すると、製品コンフィギュレーション モデルの属性が、フィールドのデータを Dynamics 365 for Operations テーブルに反映させることができます。</td>
</tr>
<tr class="odd">
<td>計算</td>
