...
# <a name="product-related-translations-faq"></a>製品関連の変換FAQ
...
## <a name="how-do-i-create-translations-for-productrelated-information"></a>どのように製品関連する情報の変換を作成しますか。
製品の翻訳を作成するには、次の手順に従います。
1.  [**製品情報管理** &gt; **普通** &gt; **リリース済製品**。
2.  アクション ウィンドウの製品を、**言語**グループで[**変換**選択します。
3.  [**テキストの翻訳**] ページの [**言語**] フィールドで、言語を選択します。 詳細の言語を追加するには、**言語**フィールドにつき、サイド リンク展開して**良い**。
...
4.  [**テキストの翻訳**] ページの [**言語**] フィールドで、言語を選択します。 詳細の言語を追加するには、**言語**フィールドにつき、サイド リンク展開して**良い**。
...
5.  [**テキストの翻訳**] ページの [**言語**] フィールドで、言語を選択します。 詳細の言語を追加するには、**言語**フィールドにつき、サイド リンク展開して**良い**。
6.  **変換されたテキスト**グループでは、** ** ** **名前および説明]フィールドに変換を入力します。
...
同じ分析コード値に基づいて、ある製品の名前**\#: 3同じ: 赤い**。  

ある顧客は S で赤い T シャツを購入したいと思い、T シャツの名前は請求書にフランス語で表示する必要があります。 分析コード値を、同じ変換および製品のフランス語および名前に赤い**\#は3です: 同じ: 弁柄**。
<table>
<colgroup>
<col width="100%" />
</colgroup>
...
<ol>  
<li>[ <strong>販売およびマーケティング</strong> &gt; <strong>共通</strong> &gt; <strong>顧客</strong> &gt; <strong>すべて</strong><strong>顧客</strong>。</li>
...
1.  [**製品情報管理** &gt; **設定** &gt; **バリアント グループ**。
2.  [**サイズ** **グループ**]、[**色グループ**] または [**スタイル グループ**] を選択します。
3.  [**新しい**サイズ** **グループで**、グループの名前を入力し、** **色のグループ**、または**フォームのグループ**フィールド。 [**サイズ**]、[**色**] または [**スタイル**] をクリックして、グループの明細行を作成します。
4.  **サイズ** **グループ**行、**色** **グループ** ** **行、または**グループの行のスタイルを作成します**ページ、新しい** **クリックし、グループのサイズ、色、およびスタイルを作成します。

分析コード値グループの値の翻訳を管理するには、次の手順を実行します。
1.  分析コード値グループを作成するための以前の手順に従い、[**サイズ グループ明細行**]、[**色グループ明細行**] または [**スタイル グループ明細行**] ページを開くます。
2.  [**テキストの翻訳**] をクリックします。 では**テキストに変換**、**変換されたテキスト**グループで入力し** ** ** **名前および説明]フィールドに変換を]ページでします。

## <a name="when-can-translations-of-productrelated-information-be-managed"></a>製品に関連する情報の変換を管理することができますか。
