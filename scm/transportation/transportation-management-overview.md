...
![負荷のグラフィック](./media/Load-drawing1-1024x477.jpg)

## <a name="inbound-transportation"></a>入庫輸送
[仕入先の注文品目、品目が倉庫に提供すると、ユーザー品目の配送を構成するかもしがあります。 工程が受信した負荷の配送および入庫を計画するために、Dynamics 365 for Operationsを使用できます。 次の図は、入庫積荷用の輸送を計画するための業務プロセス フローを示します。 
...
![発信の負荷を計画および処理します。](./media/Planningandprocessingoutboundloads.jpg)
