---
title: "製造オーダーから出荷ドックへのクロスドッキング | Microsoft Docs"
...
-   完了レポートされている数量は、それより少ない移動オーダー需要に分割することはできません。 たとえば、20 個が完了レポートされていて移動オーダーが 5 個に対して存在している場合、その移動オーダーはクロスドッキングに適用可能とは見なされません。
