---
title: "部品表およびフォーミュラ"
description: "この記事では、製品、および製品の定義の一部であるフォーミュラで提供されますが、および部品表(BOMs)に関する情報を。 BOMと式は、特定の製品に必要な材料または材料を指定します。 フォーミュラは、特定の生産のコンテキストで入庫する連産品や副産物を指定します。"
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
この記事では、製品、および製品の定義の一部であるフォーミュラで提供されますが、および部品表(BOMs)に関する情報を。 BOMと式は、特定の製品に必要な材料または材料を指定します。 フォーミュラは、特定の生産のコンテキストで入庫する連産品や副産物を指定します。 
...
フォーミュラは、通常プロセス製造に使用される BOM のサブタイプです。 コンポーネント、材料、フォーミュラに加えて、連産品と副産物について説明します。 実際のバージョンでは、連産品の定義およびフォーミュラの副産物、フォーミュラ バージョンが必要です。 フォーミュラ、フォーミュラ バージョンで定義されている一つの特定の製品に、定義されます (フォーミュラまたは計画品目)。
...
実装に実際に使用されたBOMタイプは、システムでなく、取引シナリオや要件によって異なります。 簡単な実装では、計画 BOM、生産 BOM、原価計算 BOM は、1 つの BOM としてモデル化できます。 頻繁な技術変更、複数の代替工順がある環境では、大規模な一連の BOM タイプが要求される可能性があります。
...
マスタ プランで使用する、または製造オーダーの作成に使用する既定の BOM バージョンまたはフォーミュラ バージョンとして、特定の BOM またはフォーミュラを設定するには、そのバージョンを有効化する必要があります。 バージョンが有効な場合、特定の制約のバージョンの固有性 (たとえば、期間、サイト、または数量) 確認されます。 まだ有効なバージョンの競合を有効化しようとするとエラー メッセージのバージョン表示されます。 競合するバージョンを無効にするか、バージョンの制約 (通常は期間) を変更して、あいまいな有効化を禁止する必要があります。
