...
この作業ポリシーは、製造の倉庫プロセスのために倉庫作業が作成されるかどうかをコントロールします。 **作業オーダー タイプ**、**在庫場所**、および**製品**の組み合わせを使用して作業ポリシーを設定できます。 たとえば、製品L0101は、出力場所001に完了報告されます。 完成品の出力場所001の別の製造オーダーで消費されます。 この場合、出力場所001に完了済とL0101製品の報告時に、作成からコピーします完成品の作業を回避するための作業ポリシーを設定できます。 作業ポリシーは次の情報を表すことができる個々のエンティティです:
