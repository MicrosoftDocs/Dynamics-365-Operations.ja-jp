...
[不適合 (タスク ガイド) を作成して処理する](https://ax.help.dynamics.com/en/wiki/create-and-process-a-nonconformance/)

[品質管理プロセス](quality-management-processes.md)

[不適合管理の前提条件の確認 (タスク ガイド)](https://ax.help.dynamics.com/en/wiki/set-up-prequisites-for-nonconformance-management/)
