...
# <a name="set-up-consignment"></a>設定委託
...
[![在庫![所有者] (。/media/inventory-owners.png) ] (。/media/inventory-owners.png) 
...
[![追跡分析コード グループ] (。/media/tracking分析コードgroup.png) ] (。/media/tracking分析コードgroup.png) 
...
[![在庫所有権の変更] (。/media/inventory所有権の変更Journal.png) ] (。/media/inventory所有権の変更journal.png) 
