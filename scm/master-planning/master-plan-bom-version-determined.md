---
title: "BOMバージョンを決定します。"
description: "展開時に、品目の生産の既定の注文タイプが場合、計画エンジンは、有効なBOMバージョンのサイトに基づいて参照してください。"
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="determine-the-bom-version"></a>BOMバージョンを決定します。

展開時に、品目の生産の既定の注文タイプが場合、計画エンジンは、有効なBOMバージョンのサイトに基づいて参照してください。 
