---
title: "サイトと倉庫の補充のマスタ プランが必要、倉庫は必須ではない"
...
# <a name="master-planning-for-site-and-warehouse-coverage-warehouse-not-mandatory"></a>サイトと倉庫の補充のマスタ プランが必要、倉庫は必須ではない
...
-   倉庫は [手動] に設定されています。 [**在庫管理設定の &gt;&gt; 詳細の &gt; 在庫倉庫**。 [**マスター計画**] クイック タブに、[**手動**] フィールドが表示されます。
