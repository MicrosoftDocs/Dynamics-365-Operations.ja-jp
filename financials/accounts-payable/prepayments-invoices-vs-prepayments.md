...
4.  支払を前払としてフラグを設定できます。 支払が前払としてフラグを付けられれば、支払は、手順1と2.で設定する転記プロファイルで定義された勘定科目に転記されます。 また、支払が前払としてフラグを付けられれば、税額が計算されます。 一部の政府は、請求書がなくても前払が記録されると、税の支払いを必要とします。
5.  前払を転記します。
6.  オプション: 請求書を作成する前に、発注書または販売注文に対して前払を決済できます。 販売注文または発注書]ページで、アクション ウィンドウで使用します。**決済のトランザクション**。
