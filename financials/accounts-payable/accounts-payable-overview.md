...
description: "この記事は、Microsoft Dynamics AX の買掛金勘定の基本機能およびオプション機能の設定に使用するページについて説明します。 また、買掛金勘定の設定を開始する前に実行しなければならない設定手順について説明します。"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
この記事は、Microsoft Dynamics AX の買掛金勘定の基本機能およびオプション機能の設定に使用するページについて説明します。 また、買掛金勘定の設定を開始する前に実行しなければならない設定手順について説明します。
...
## <a name="setup-pages-for-accounts-payable"></a>買掛金勘定のページ設定
...
## <a name="optional-setup-pages-for-accounts-payable"></a>買掛金勘定のページ設定オプション
...
-   仕入先の雑費グループ]ページで、仕入先の雑費グループを作成および管理します。
...
-   ** 1099のフィールド**ページで、Internal Revenue Service (IRS)に報告する必要のある最新のIRS要件に基づいて最小額の検証および更新します。

## <a name="optional-setup-for-other-modules"></a>**他のモジュールの設定オプション**
