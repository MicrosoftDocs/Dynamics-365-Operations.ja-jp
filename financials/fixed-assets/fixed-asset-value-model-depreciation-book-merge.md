...
description: "以前のリリースでは、固定資産からの二つの評価の概念が-価値モデルおよび減価償却簿に。 工程1611のMicrosoft Dynamics 365では、価値モデル機能をリリースすると減価償却簿機能は、帳簿と呼ばれる一つの概念にマージされます。"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
以前のリリースでは、固定資産からの二つの評価の概念が-価値モデルおよび減価償却簿に。 工程1611のMicrosoft Dynamics 365では、価値モデル機能をリリースすると減価償却簿機能は、帳簿と呼ばれる一つの概念にマージされます。

新しい帳簿機能は、以前の価値モデル機能に基づいていますが、前に減価償却簿でのみ提供されたすべての機能も含まれます。 [価値モデルおよび減価償却簿機能の結合として![帳簿] (。/media/fixed-assets.png) ] (。/media/fixed-assets.pngは、すべての固定資産プロセスの場合) このために、現在ページ、照会やレポートの一つの設定を使用してマージします。 このトピックの表は、帳簿の新しい機能とともに、減価償却簿および価値モデルの以前の機能について説明しています。
