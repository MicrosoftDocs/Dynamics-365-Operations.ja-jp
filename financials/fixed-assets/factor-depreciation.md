...
> [!NOTE] 
> **係数**では選択すると、**方法** ** **係数]フィールドに有効な期間** **フィールドが表示されます。
...
取得価格は100,000ですが、係数は70ですが、耐用年数は10年であり、1.月1日に開始されます。 減価償却金額、正味簿価額の耐用年数の最初の6年間の間のみが表示されます。
...
取得価格は100,000ですが、係数は20ですが、耐用年数は10年であり、1.月1日に開始されます。 減価償却金額、正味簿価額の耐用年数の最初の6年間の間のみが表示されます。
