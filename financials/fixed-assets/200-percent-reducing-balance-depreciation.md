...
[**暦年**] 選択すると、毎年 1 月 1 日に償却基礎額が更新されます。 通常、仕損価格を正味簿価額があります。 このトピックの後の例では、計算列の最初の式の分子が減価償却基準です。 
...
> [!NOTE] 
> 通常は200%年の逓減残高による減価償却法を使用して計算された金額が定額法を使用して計算された金額よりより未満にすると、残余耐用期間の定額法への換算があります。
