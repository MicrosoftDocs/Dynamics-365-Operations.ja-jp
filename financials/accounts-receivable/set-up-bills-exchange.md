...
[**売掛金勘定パラメーター**] ページでは、既定の受取手形の転記プロファイルを [**元帳と売上税**] タブに入力します。 番号順序コードは [**番号順序**] タブで定義します。
為替手形の仕訳帳名の設定
------------------------------------------
...
各受取手形の仕訳伝票ページでは、[**受取手形**] タブに受取手形に関する情報を入力します。 転記済みの受取手形仕訳帳明細行は、[**受取手形仕訳帳照会**] ページと [**受取手形統計**] ページで表示できます。
為替手形の支払方法の設定
-----------------------------------------------
