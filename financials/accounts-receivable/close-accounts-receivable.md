...
> [!NOTE] 
> テーブルの一部を開くには、情報を入力するか、またはパラメータ設定を指定する必要があります。
...
| 仕訳伝票                      | -   **Payment journal** – Generate, process, and post payments.
...
~ 梱包明細の転記                 ~ 販売注文の梱包明細を更新します。                                                     ~ ~ 自由書式の請求書を転記します。~ 自由書式の請求書を転記します。                                                                   ~ ~ 請求書の転記                      ~ 販売注文の請求書を転記します。                                                            ~ ~ ピッキング リストの転記                 ~販売注文のピッキング リストを更新します。                                                      |
