---
title: "売掛金勘定の貸方転記と取立"
description: "売掛金勘定の収集された情報は、工程のコレクション]ページでは、Microsoft Dynamics 365を使用して一つの中央ビューで管理されます。 貸方および取立マネージャが回収を管理するには、この中央ビューを使用できます。 回収代行業者は、定義済の回収基準または [顧客] ページを使用して生成された、顧客リストから回収プロセスを開始することができます。"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
売掛金勘定の収集された情報は、工程のコレクション]ページでは、Microsoft Dynamics 365を使用して一つの中央ビューで管理されます。 貸方および取立マネージャが回収を管理するには、この中央ビューを使用できます。 回収代行業者は、定義済の回収基準または [顧客] ページを使用して生成された、顧客リストから回収プロセスを開始することができます。
...
既定では、工程のユーザーのMicrosoft Dynamics 365には、督促のリスト ページのすべての顧客情報を表示できます。 回収代行業者のレコードを使用して、回収リスト ページと [回収] ページの情報をフィルタ処理して使用できる顧客プールを決定できます。 

回収代行業者とは、回収が時間通りに行われるように顧客ために動く担当者です。 、Microsoft Dynamics 365では、債権取立業者がユーザー設定のユーザーに割り当てられているためです。
...
<li>既定では、工程のユーザーのMicrosoft Dynamics 365に老化のスナップショットのすべての顧客にアクセスできます。</li>
...
選択した顧客の上部ウィンドウで陳列場合。 中央ウィンドウは、顧客のトランザクションを表示します。 下部ウィンドウには、顧客活動を表示します。 一つ以上のトランザクションと活動の回収情報を追跡するには、回収ケースを作成できます。 上下ウィンドウの情報はケースでフィルター処理できます。 
...
## <a name="create-writeoff-transactions"></a>控除トランザクションを作成します。
