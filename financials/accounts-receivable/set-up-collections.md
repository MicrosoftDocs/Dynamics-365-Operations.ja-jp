...
## <a name="set-up-journal-names-settlement-writeoff-and-nsf"></a>仕訳帳名の設定 (決済、控除、およびNSF) 
...
## <a name="set-up-a-reason-code-for-writeoff-transactions"></a>控除トランザクションの理由コードを設定します。
...
## <a name="set-up-a-writeoff-account"></a>控除の勘定を設定します。
...
> [!NOTE] 
> コレクションの連絡先が顧客に対して指定されている顧客の基本連絡先が使用されます。 基本連絡先が指定されていない場合は、電子メール メッセージは、[**連絡先**] ページに記載されている最初のアドレスに送信されます。
