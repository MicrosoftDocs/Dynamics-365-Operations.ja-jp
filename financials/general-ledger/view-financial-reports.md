...
-   分析コード フィルターの[レポートに適用する**分析コード フィルターの追加。**。 分析コードを選択し、[分析コードIDを入力するか、または一覧に分析コードを選択します。 分析コード フィルターを削除するには、[**クリア**] をクリックします。
...
現在の月のレポート、またはそのレポートを生成する前の月のレポートを表示できます。 前月間レポートを開くには、**に**クリックし、[]をクリックします。**前のレポート**。 レポートが生成される前月の一覧が表示されます。 月を展開してレポートを表示し、データを選択して、[**OK**] をクリックします。 前月のレポートが表示されます。 現在の月のレポートに戻るには、[**キャンセル**] をクリックします。
