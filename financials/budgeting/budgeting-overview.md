---
title: "予算作成用のホーム ページ"
description: "このトピックでは、Microsoft Dynamics 365 for Operations の予算作成機能コンポーネント、予算作成ツール、およびレポート機能の概要を示します。"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: index-page
...
このトピックでは、Microsoft Dynamics 365 for Operations の予算作成機能コンポーネント、予算作成ツール、およびレポート機能の概要を示します。 
