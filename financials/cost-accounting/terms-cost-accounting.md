...
# <a name="cost-accounting-terminology"></a>原価計算の用語
...
原価要素は、原価がどこに流れるかを追跡および分類する機能として使用されます。 原価要素には、主要原価と副次原価要素という 2 つのタイプがあります。 **基本原価**基本原価要素は、財務会計の原価計算に対する原価の流れを表します。 原価要素構造は、原価要素が主勘定に対応できる総勘定元帳で損益勘定構造に対応します。 業務上の要件に応じて、すべての主勘定が原価要素として表される必要があります。 次の主要原価要素の例があります:
...
- **固定費は、活動レベルの変更に関係なく** -固定費短期的に変化しない費用です。 たとえば、固定費は、家賃などの業務の基本的な作業経費であり、活動の増加および減少の影響を受けません。

- **変動費は、活動レベルの変更に従って- **変動費変更します。 たとえば、特定の直接材料の原価は、販売された各製品に関連付けられます。 販売された製品が多くなれば、直接的な材料の原価は多くなります。

- **半変動原価は- **半変動原価部分的に固定および部分的な変動費です。 たとえば、インターネット アクセス料金には、標準的な月額のアクセス料金とブロードバンド使用料金が含まれます。 標準的な月額アクセス料金は固定費で、ブロードバンド使用料金は変動費です。
