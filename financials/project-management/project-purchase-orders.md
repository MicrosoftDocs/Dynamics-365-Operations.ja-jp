...
、Microsoft Dynamics 365では、プロジェクトの発注書を作成する場合でも、複数の方法を使用できます。 発注書を作成する方法は、発注書の目的、購入する品目の消費時期、プロジェクトに請求される時期で決まります。
...
> [!NOTE] 
> 仕入先請求書または梱包明細を更新すると、在庫品目要求の梱包明細を更新するように要求されます。
