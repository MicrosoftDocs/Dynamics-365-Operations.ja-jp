...
ms.locfileid: "2002576"
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-september-17-2019"></a>Dynamics 365 for Talent (2019 年 9 月 17 日) の新機能および変更された機能
...
このセクションに記載された変更は、ビルド番号 8.1.2492 に適用されます。 ヘッダーにあるかっこ内の数字は、Microsoft Dynamics Lifecycle Services (LCS) のサポート番号を参照していることがあります。
...
### <a name="human-resources-staff-cant-see-performance-review-details-once-assigned-to-them-by-workflow-370308"></a>人事管理スタッフは、ワークフローにより一度割り当てられた業績確認の詳細を表示できません (370308)

今週の更新により、人事担当者は、ワークフロー処理によって割り当てられた業績評価の詳細を表示できるようになります。 評価を表示するには、**従業員セルフサービス > 自分自身に割り当てられた作業項目**に移動します。

### <a name="job-family-field-missing-in-the-manage-changes-page-for-job-details-346031"></a>ジョブ詳細の変更の管理ページに、ジョブのファミリ フィールドがありません (346031)

このリリースにより、ジョブ詳細の**変更の管理**ページに、ジョブ ファミリ フィールドが追加されました。
...
詳細については、[合理化された従業員の入力とナビゲーション](./streamlined-employee-entry.md) を参照してください。 変更を確認するには、ビデオ [Dynamics 365 for Talent 2019 リリース ウェーブ 2 の概要](https://aka.ms/ROGT19RW2ROV) をご覧ください。
