...
- <span data-ttu-id="b50f8-110">人事管理データ</span><span class="sxs-lookup"><span data-stu-id="b50f8-110">Human resources data</span></span>
...
- [<span data-ttu-id="b50f8-127">Azure ストレージ アカウントについて</span><span class="sxs-lookup"><span data-stu-id="b50f8-127">About Azure storage accounts</span></span>](https://docs.microsoft.com/azure/storage/common/storage-create-storage-account?toc=%2fazure%2fstorage%2ffiles%2ftoc.json)
...
### <a name="human-resource-data"></a><span data-ttu-id="b50f8-144">人事管理データ</span><span class="sxs-lookup"><span data-stu-id="b50f8-144">Human resource data</span></span>
...
##### <a name="supported-frequencies"></a><span data-ttu-id="b50f8-166">サポートされる頻度</span><span class="sxs-lookup"><span data-stu-id="b50f8-166">Supported frequencies</span></span> 
...
#### <a name="compensation"></a><span data-ttu-id="b50f8-191">報酬</span><span class="sxs-lookup"><span data-stu-id="b50f8-191">Compensation</span></span> 
...
- [<span data-ttu-id="b50f8-209">職務のコンポーネントの設定</span><span class="sxs-lookup"><span data-stu-id="b50f8-209">Setting up the components of a job</span></span>](https://docs.microsoft.com/dynamics365/unified-operations/talent/create-job)
...
<span data-ttu-id="b50f8-229">詳細については、次のトピックを参照してください。</span><span class="sxs-lookup"><span data-stu-id="b50f8-229">For more information, see the following topics:</span></span>
...
<span data-ttu-id="b50f8-248">次の情報は、Dayforce で使用されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-248">The following information is used in Dayforce:</span></span>
...
<span data-ttu-id="b50f8-267">作業者には次の情報を管理できます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-267">You can maintain the following information for workers:</span></span>
...
#### <a name="address-information"></a><span data-ttu-id="b50f8-286">住所情報</span><span class="sxs-lookup"><span data-stu-id="b50f8-286">Address information</span></span>
...
##### <a name="payroll-information"></a><span data-ttu-id="b50f8-307">給与情報</span><span class="sxs-lookup"><span data-stu-id="b50f8-307">Payroll information</span></span>
...
<span data-ttu-id="b50f8-329">従業員の重要な日付は、次の情報を使用して派生されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-329">An employee's key dates are derived by using the following information.</span></span>
...
##### <a name="social-security-identifier"></a><span data-ttu-id="b50f8-353">社会保障 ID</span><span class="sxs-lookup"><span data-stu-id="b50f8-353">Social Security identifier</span></span> 
...
#### <a name="address-information"></a><span data-ttu-id="b50f8-376">住所情報</span><span class="sxs-lookup"><span data-stu-id="b50f8-376">Address information</span></span>
...
### <a name="job-types"></a><span data-ttu-id="b50f8-395">職務タイプ</span><span class="sxs-lookup"><span data-stu-id="b50f8-395">Job types</span></span>
...
<span data-ttu-id="b50f8-420">次の理由コードと説明が必要です。</span><span class="sxs-lookup"><span data-stu-id="b50f8-420">The following reason codes and descriptions are required.</span></span>
...
| <span data-ttu-id="b50f8-461">登録済パートナーシップ</span><span class="sxs-lookup"><span data-stu-id="b50f8-461">Registered Partnership</span></span> | <span data-ttu-id="b50f8-462">ドメスティック パートナーシップ</span><span class="sxs-lookup"><span data-stu-id="b50f8-462">Domestic Partnership</span></span> |
...
- <span data-ttu-id="b50f8-494">1 か月および 2 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-494">1N2OFMTH</span></span>
...
- <span data-ttu-id="b50f8-511">年の 11 月および 12 月 - 年の 11 月および 12 月</span><span class="sxs-lookup"><span data-stu-id="b50f8-511">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="b50f8-512">住所</span><span class="sxs-lookup"><span data-stu-id="b50f8-512">Addresses</span></span>

<span data-ttu-id="b50f8-513">特定の国または地域、都道府県、および市区郡 (自治体) の ID には、Dayforce および国内または地域内のプロバイダーが認識できる特定の形式が必要です。</span><span class="sxs-lookup"><span data-stu-id="b50f8-513">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="b50f8-514">市町村の形式は柔軟ですが、すべての市町村が都道府県と関連付けられている必要があります。</span><span class="sxs-lookup"><span data-stu-id="b50f8-514">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="b50f8-515">Talent</span><span class="sxs-lookup"><span data-stu-id="b50f8-515">Talent</span></span>          | <span data-ttu-id="b50f8-516">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b50f8-516">Dayforce</span></span>              |
|-----------------|-----------------------|
| <span data-ttu-id="b50f8-517">国/地域</span><span class="sxs-lookup"><span data-stu-id="b50f8-517">Country/Region</span></span>  | <span data-ttu-id="b50f8-518">国コード</span><span class="sxs-lookup"><span data-stu-id="b50f8-518">Country Code</span></span>          |
| <span data-ttu-id="b50f8-519">郵便番号</span><span class="sxs-lookup"><span data-stu-id="b50f8-519">Zip/Postal Code</span></span> | <span data-ttu-id="b50f8-520">郵便番号</span><span class="sxs-lookup"><span data-stu-id="b50f8-520">Postal Code</span></span>           |
| <span data-ttu-id="b50f8-521">行政単位 (区画)</span><span class="sxs-lookup"><span data-stu-id="b50f8-521">State</span></span>           | <span data-ttu-id="b50f8-522">都道府県コード</span><span class="sxs-lookup"><span data-stu-id="b50f8-522">State Code</span></span>            |
| <span data-ttu-id="b50f8-523">市町村</span><span class="sxs-lookup"><span data-stu-id="b50f8-523">City</span></span>            | <span data-ttu-id="b50f8-524">市町村</span><span class="sxs-lookup"><span data-stu-id="b50f8-524">City</span></span>                  |
| <span data-ttu-id="b50f8-525">郡</span><span class="sxs-lookup"><span data-stu-id="b50f8-525">County</span></span>          | <span data-ttu-id="b50f8-526">市区郡 (自治体)</span><span class="sxs-lookup"><span data-stu-id="b50f8-526">County (Municipality)</span></span> |
| <span data-ttu-id="b50f8-527">住所</span><span class="sxs-lookup"><span data-stu-id="b50f8-527">Street</span></span>          | <span data-ttu-id="b50f8-528">住所行 1</span><span class="sxs-lookup"><span data-stu-id="b50f8-528">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="b50f8-529">税地域</span><span class="sxs-lookup"><span data-stu-id="b50f8-529">Tax regions</span></span>

<span data-ttu-id="b50f8-530">税地域は、給与の生成時に適用する適切な税を決定するために使用されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-530">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="b50f8-531">税地域は、場所の住所として Dayforce にマップされます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-531">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="b50f8-532">既定の税地域は、作業者の有効な職位に関連付けられている必要があります。</span><span class="sxs-lookup"><span data-stu-id="b50f8-532">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="b50f8-533">税地域 (必須)</span><span class="sxs-lookup"><span data-stu-id="b50f8-533">Tax region (required)</span></span>
- <span data-ttu-id="b50f8-534">国/地域 (必須)</span><span class="sxs-lookup"><span data-stu-id="b50f8-534">Country/Region (required)</span></span>
- <span data-ttu-id="b50f8-535">都道府県 (必須)</span><span class="sxs-lookup"><span data-stu-id="b50f8-535">State (required)</span></span>
- <span data-ttu-id="b50f8-536">郡</span><span class="sxs-lookup"><span data-stu-id="b50f8-536">County</span></span> 
- <span data-ttu-id="b50f8-537">市町村 (必須)</span><span class="sxs-lookup"><span data-stu-id="b50f8-537">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="b50f8-538">メキシコの給与を生成するためのデータ コンフィギュレーション</span><span class="sxs-lookup"><span data-stu-id="b50f8-538">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="b50f8-539">メキシコの従業員のために支払を生成している場合、次の要素をコンフィギュレーションする必要があります。</span><span class="sxs-lookup"><span data-stu-id="b50f8-539">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="b50f8-540">職位に部門が必要です。</span><span class="sxs-lookup"><span data-stu-id="b50f8-540">Departments are required on positions.</span></span>
- <span data-ttu-id="b50f8-541">原価部門を財務分析コードとして設定し、既定の財務分析コード文字列の最初の要素とする必要があります。</span><span class="sxs-lookup"><span data-stu-id="b50f8-541">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="b50f8-542">ジョブ タイプ</span><span class="sxs-lookup"><span data-stu-id="b50f8-542">Job types</span></span>

<span data-ttu-id="b50f8-543">職務タイプは、類似した職務をカテゴリにグループ化するために使用されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-543">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="b50f8-544">職務タイプは、メキシコでの給与を処理するために必要です。</span><span class="sxs-lookup"><span data-stu-id="b50f8-544">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="b50f8-545">職務タイプの例には、フルタイムおよびパートタイム、または給与払いおよび時給払いが含まれます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-545">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="b50f8-546">職務タイプは、従業員が時給払いかあるいは給与払いなのかを示す支払タイプとして Dayforce にマップされます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-546">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="b50f8-547">次の職務タイプと説明が必要です。</span><span class="sxs-lookup"><span data-stu-id="b50f8-547">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="b50f8-548">ジョブ タイプ</span><span class="sxs-lookup"><span data-stu-id="b50f8-548">Job type</span></span>   | <span data-ttu-id="b50f8-549">説明</span><span class="sxs-lookup"><span data-stu-id="b50f8-549">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="b50f8-550">時間</span><span class="sxs-lookup"><span data-stu-id="b50f8-550">Hourly</span></span>     | <span data-ttu-id="b50f8-551">MX 時給払い</span><span class="sxs-lookup"><span data-stu-id="b50f8-551">MX Hourly</span></span>   |
| <span data-ttu-id="b50f8-552">給与払い</span><span class="sxs-lookup"><span data-stu-id="b50f8-552">Salaried</span></span>   | <span data-ttu-id="b50f8-553">MX 給与払い</span><span class="sxs-lookup"><span data-stu-id="b50f8-553">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="b50f8-554">職位タイプ</span><span class="sxs-lookup"><span data-stu-id="b50f8-554">Position types</span></span> 

<span data-ttu-id="b50f8-555">職位がフルタイム、パートタイム、またはその他のタイプかどうかを説明するために職位タイプを使用します。</span><span class="sxs-lookup"><span data-stu-id="b50f8-555">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="b50f8-556">職位タイプは、従業員がフルタイムかあるいはパートタイムなのかを示す支払クラスとして Dayforce にマップされます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-556">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="b50f8-557">次の職位タイプと説明が必要です。</span><span class="sxs-lookup"><span data-stu-id="b50f8-557">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="b50f8-558">職位タイプ</span><span class="sxs-lookup"><span data-stu-id="b50f8-558">Position type</span></span>   | <span data-ttu-id="b50f8-559">説明</span><span class="sxs-lookup"><span data-stu-id="b50f8-559">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="b50f8-560">フルタイム</span><span class="sxs-lookup"><span data-stu-id="b50f8-560">Full-time</span></span>       | <span data-ttu-id="b50f8-561">フルタイム従業員</span><span class="sxs-lookup"><span data-stu-id="b50f8-561">Full time employee</span></span> |
| <span data-ttu-id="b50f8-562">パートタイム</span><span class="sxs-lookup"><span data-stu-id="b50f8-562">Part-time</span></span>       | <span data-ttu-id="b50f8-563">パートタイム従業員</span><span class="sxs-lookup"><span data-stu-id="b50f8-563">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="b50f8-564">理由コード</span><span class="sxs-lookup"><span data-stu-id="b50f8-564">Reason codes</span></span>

<span data-ttu-id="b50f8-565">理由コードは、従業員のステータスに関する情報を指定します。</span><span class="sxs-lookup"><span data-stu-id="b50f8-565">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="b50f8-566">理由コードは、従業員の職位または雇用ステータスへの変更の理由を示すステータス理由として Dayforce にマップされます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-566">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="b50f8-567">次の理由コードと説明が必要です。</span><span class="sxs-lookup"><span data-stu-id="b50f8-567">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="b50f8-568">理由コード</span><span class="sxs-lookup"><span data-stu-id="b50f8-568">Reason code</span></span>            | <span data-ttu-id="b50f8-569">説明</span><span class="sxs-lookup"><span data-stu-id="b50f8-569">Description</span></span>                    | <span data-ttu-id="b50f8-570">適用可能なシナリオ</span><span class="sxs-lookup"><span data-stu-id="b50f8-570">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="b50f8-571">支払前の除籍</span><span class="sxs-lookup"><span data-stu-id="b50f8-571">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="b50f8-572">最初の給与の前の除籍</span><span class="sxs-lookup"><span data-stu-id="b50f8-572">Departure before first payroll</span></span> | <span data-ttu-id="b50f8-573">作業者の退職</span><span class="sxs-lookup"><span data-stu-id="b50f8-573">Terminate worker</span></span>     |
| <span data-ttu-id="b50f8-574">辞職</span><span class="sxs-lookup"><span data-stu-id="b50f8-574">RESIGNATION</span></span>            | <span data-ttu-id="b50f8-575">辞職</span><span class="sxs-lookup"><span data-stu-id="b50f8-575">Resignation</span></span>                    | <span data-ttu-id="b50f8-576">作業者の退職</span><span class="sxs-lookup"><span data-stu-id="b50f8-576">Terminate worker</span></span>     |
| <span data-ttu-id="b50f8-577">年金</span><span class="sxs-lookup"><span data-stu-id="b50f8-577">PENSION</span></span>                | <span data-ttu-id="b50f8-578">年金</span><span class="sxs-lookup"><span data-stu-id="b50f8-578">Pension</span></span>                        | <span data-ttu-id="b50f8-579">作業者の退職</span><span class="sxs-lookup"><span data-stu-id="b50f8-579">Terminate worker</span></span>     |
| <span data-ttu-id="b50f8-580">終了</span><span class="sxs-lookup"><span data-stu-id="b50f8-580">TERMINATION</span></span>            | <span data-ttu-id="b50f8-581">終了</span><span class="sxs-lookup"><span data-stu-id="b50f8-581">Termination</span></span>                    | <span data-ttu-id="b50f8-582">作業者の退職</span><span class="sxs-lookup"><span data-stu-id="b50f8-582">Terminate worker</span></span>     |
| <span data-ttu-id="b50f8-583">定年退職</span><span class="sxs-lookup"><span data-stu-id="b50f8-583">RETIREMENT</span></span>             | <span data-ttu-id="b50f8-584">償却</span><span class="sxs-lookup"><span data-stu-id="b50f8-584">Retirement</span></span>                     | <span data-ttu-id="b50f8-585">作業者の退職</span><span class="sxs-lookup"><span data-stu-id="b50f8-585">Terminate worker</span></span>     |
| <span data-ttu-id="b50f8-586">休暇者</span><span class="sxs-lookup"><span data-stu-id="b50f8-586">ABSENTEE</span></span>               | <span data-ttu-id="b50f8-587">休暇者</span><span class="sxs-lookup"><span data-stu-id="b50f8-587">Absentee</span></span>                       | <span data-ttu-id="b50f8-588">作業者の退職</span><span class="sxs-lookup"><span data-stu-id="b50f8-588">Terminate worker</span></span>     |
| <span data-ttu-id="b50f8-589">その他</span><span class="sxs-lookup"><span data-stu-id="b50f8-589">OTHER</span></span>                  | <span data-ttu-id="b50f8-590">その他の理由</span><span class="sxs-lookup"><span data-stu-id="b50f8-590">Other Reasons</span></span>                  | <span data-ttu-id="b50f8-591">作業者の退職</span><span class="sxs-lookup"><span data-stu-id="b50f8-591">Terminate worker</span></span>     |
| <span data-ttu-id="b50f8-592">休業</span><span class="sxs-lookup"><span data-stu-id="b50f8-592">CLOSURE</span></span>                | <span data-ttu-id="b50f8-593">業務休業</span><span class="sxs-lookup"><span data-stu-id="b50f8-593">Business Closure</span></span>               | <span data-ttu-id="b50f8-594">作業者の退職</span><span class="sxs-lookup"><span data-stu-id="b50f8-594">Terminate worker</span></span>     |
| <span data-ttu-id="b50f8-595">死亡</span><span class="sxs-lookup"><span data-stu-id="b50f8-595">DEATH</span></span>                  | <span data-ttu-id="b50f8-596">死亡</span><span class="sxs-lookup"><span data-stu-id="b50f8-596">Death</span></span>                          | <span data-ttu-id="b50f8-597">作業者の退職</span><span class="sxs-lookup"><span data-stu-id="b50f8-597">Terminate worker</span></span>     |
| <span data-ttu-id="b50f8-598">休暇</span><span class="sxs-lookup"><span data-stu-id="b50f8-598">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="b50f8-599">休暇</span><span class="sxs-lookup"><span data-stu-id="b50f8-599">Leave of Absence</span></span>               | <span data-ttu-id="b50f8-600">作業者の退職</span><span class="sxs-lookup"><span data-stu-id="b50f8-600">Terminate worker</span></span>     |
| <span data-ttu-id="b50f8-601">契約の終了</span><span class="sxs-lookup"><span data-stu-id="b50f8-601">CONTRACTEND</span></span>            | <span data-ttu-id="b50f8-602">契約の終了</span><span class="sxs-lookup"><span data-stu-id="b50f8-602">End of Contract</span></span>                | <span data-ttu-id="b50f8-603">作業者の退職</span><span class="sxs-lookup"><span data-stu-id="b50f8-603">Terminate worker</span></span>     |
| <span data-ttu-id="b50f8-604">給与の変更</span><span class="sxs-lookup"><span data-stu-id="b50f8-604">SALARYCHANGE</span></span>           | <span data-ttu-id="b50f8-605">給与の変更</span><span class="sxs-lookup"><span data-stu-id="b50f8-605">Change of Salary</span></span>               | <span data-ttu-id="b50f8-606">報酬</span><span class="sxs-lookup"><span data-stu-id="b50f8-606">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="b50f8-607">雇用条件</span><span class="sxs-lookup"><span data-stu-id="b50f8-607">Terms of employment</span></span>

<span data-ttu-id="b50f8-608">雇用条件は、雇用条件のカテゴリを作成するために使用されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-608">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="b50f8-609">条件は、雇用インジケーターの値として Dayforce にマップされます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-609">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="b50f8-610">次の雇用条件および説明が必要です。</span><span class="sxs-lookup"><span data-stu-id="b50f8-610">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="b50f8-611">雇用条件</span><span class="sxs-lookup"><span data-stu-id="b50f8-611">Terms of employment</span></span>   | <span data-ttu-id="b50f8-612">説明</span><span class="sxs-lookup"><span data-stu-id="b50f8-612">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="b50f8-613">通常</span><span class="sxs-lookup"><span data-stu-id="b50f8-613">Regular</span></span>               | <span data-ttu-id="b50f8-614">通常</span><span class="sxs-lookup"><span data-stu-id="b50f8-614">Regular</span></span>     |
| <span data-ttu-id="b50f8-615">直接</span><span class="sxs-lookup"><span data-stu-id="b50f8-615">Direct</span></span>                | <span data-ttu-id="b50f8-616">直接</span><span class="sxs-lookup"><span data-stu-id="b50f8-616">Direct</span></span>      |
| <span data-ttu-id="b50f8-617">インターンシップ</span><span class="sxs-lookup"><span data-stu-id="b50f8-617">Internship</span></span>            | <span data-ttu-id="b50f8-618">インターンシップ</span><span class="sxs-lookup"><span data-stu-id="b50f8-618">Internship</span></span>  |
| <span data-ttu-id="b50f8-619">永続的</span><span class="sxs-lookup"><span data-stu-id="b50f8-619">Permanent</span></span>             | <span data-ttu-id="b50f8-620">永続的</span><span class="sxs-lookup"><span data-stu-id="b50f8-620">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="b50f8-621">配偶者の有無</span><span class="sxs-lookup"><span data-stu-id="b50f8-621">Marital status</span></span>

<span data-ttu-id="b50f8-622">配偶者有無の値は、Dayforce にマップされ、統合時に必要に応じて許容される値に翻訳されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-622">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="b50f8-623">次の表に、配偶者有無の値がどのように Dayforce にマップされるかを示します。</span><span class="sxs-lookup"><span data-stu-id="b50f8-623">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="b50f8-624">Talent</span><span class="sxs-lookup"><span data-stu-id="b50f8-624">Talent</span></span>                 | <span data-ttu-id="b50f8-625">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b50f8-625">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="b50f8-626">既婚</span><span class="sxs-lookup"><span data-stu-id="b50f8-626">Married</span></span>                | <span data-ttu-id="b50f8-627">既婚</span><span class="sxs-lookup"><span data-stu-id="b50f8-627">Married</span></span>                   |
| <span data-ttu-id="b50f8-628">未婚</span><span class="sxs-lookup"><span data-stu-id="b50f8-628">Single</span></span>                 | <span data-ttu-id="b50f8-629">未婚</span><span class="sxs-lookup"><span data-stu-id="b50f8-629">Single</span></span>                    |
| <span data-ttu-id="b50f8-630">死別</span><span class="sxs-lookup"><span data-stu-id="b50f8-630">Widowed</span></span>                | <span data-ttu-id="b50f8-631">死別</span><span class="sxs-lookup"><span data-stu-id="b50f8-631">Widowed</span></span>                   |
| <span data-ttu-id="b50f8-632">離婚</span><span class="sxs-lookup"><span data-stu-id="b50f8-632">Divorced</span></span>               | <span data-ttu-id="b50f8-633">離婚</span><span class="sxs-lookup"><span data-stu-id="b50f8-633">Divorced</span></span>                  |
| <span data-ttu-id="b50f8-634">登録済パートナーシップ</span><span class="sxs-lookup"><span data-stu-id="b50f8-634">Registered Partnership</span></span> | <span data-ttu-id="b50f8-635">ドメスティック パートナーシップ</span><span class="sxs-lookup"><span data-stu-id="b50f8-635">Domestic Partnership</span></span>      |
| <span data-ttu-id="b50f8-636">None</span><span class="sxs-lookup"><span data-stu-id="b50f8-636">None</span></span>                   | <span data-ttu-id="b50f8-637">*メキシコではサポートされていません*</span><span class="sxs-lookup"><span data-stu-id="b50f8-637">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="b50f8-638">同棲中</span><span class="sxs-lookup"><span data-stu-id="b50f8-638">Cohabiting</span></span>             | <span data-ttu-id="b50f8-639">*メキシコではサポートされていません*</span><span class="sxs-lookup"><span data-stu-id="b50f8-639">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="b50f8-640">種類</span><span class="sxs-lookup"><span data-stu-id="b50f8-640">Gender</span></span>

<span data-ttu-id="b50f8-641">性別の指定は、Dayforce にマップされ、統合時に必要に応じて許容される値に翻訳されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-641">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="b50f8-642">次の表に、性別の指定がどのように Dayforce にマップされるかを示します。</span><span class="sxs-lookup"><span data-stu-id="b50f8-642">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="b50f8-643">Talent</span><span class="sxs-lookup"><span data-stu-id="b50f8-643">Talent</span></span>       | <span data-ttu-id="b50f8-644">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b50f8-644">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="b50f8-645">男性</span><span class="sxs-lookup"><span data-stu-id="b50f8-645">Male</span></span>         | <span data-ttu-id="b50f8-646">男性</span><span class="sxs-lookup"><span data-stu-id="b50f8-646">Male</span></span>                      |
| <span data-ttu-id="b50f8-647">女性</span><span class="sxs-lookup"><span data-stu-id="b50f8-647">Female</span></span>       | <span data-ttu-id="b50f8-648">女性</span><span class="sxs-lookup"><span data-stu-id="b50f8-648">Female</span></span>                    |
| <span data-ttu-id="b50f8-649">不特定</span><span class="sxs-lookup"><span data-stu-id="b50f8-649">Non-specific</span></span> | <span data-ttu-id="b50f8-650">*メキシコではサポートされていません*</span><span class="sxs-lookup"><span data-stu-id="b50f8-650">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="b50f8-651">支払方法</span><span class="sxs-lookup"><span data-stu-id="b50f8-651">Payment method</span></span>

<span data-ttu-id="b50f8-652">支払方法は、従業員に支払が行われる方法を従業員および会社に説明します。</span><span class="sxs-lookup"><span data-stu-id="b50f8-652">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="b50f8-653">支払方法は、Dayforce にマップされ、統合時に必要に応じて許容される値に翻訳されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-653">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="b50f8-654">次の表に、支払方法がどのように Dayforce にマップされるかを示します。</span><span class="sxs-lookup"><span data-stu-id="b50f8-654">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="b50f8-655">Talent</span><span class="sxs-lookup"><span data-stu-id="b50f8-655">Talent</span></span>             | <span data-ttu-id="b50f8-656">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b50f8-656">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="b50f8-657">現金</span><span class="sxs-lookup"><span data-stu-id="b50f8-657">Cash</span></span>               | <span data-ttu-id="b50f8-658">現金</span><span class="sxs-lookup"><span data-stu-id="b50f8-658">Cash</span></span>                      |
| <span data-ttu-id="b50f8-659">電子支払</span><span class="sxs-lookup"><span data-stu-id="b50f8-659">Electronic Payment</span></span> | <span data-ttu-id="b50f8-660">転送</span><span class="sxs-lookup"><span data-stu-id="b50f8-660">Transfer</span></span>                  |
| <span data-ttu-id="b50f8-661">確認</span><span class="sxs-lookup"><span data-stu-id="b50f8-661">Check</span></span>              | <span data-ttu-id="b50f8-662">小切手</span><span class="sxs-lookup"><span data-stu-id="b50f8-662">Cheque</span></span>                    |
| <span data-ttu-id="b50f8-663">銀行為替手形</span><span class="sxs-lookup"><span data-stu-id="b50f8-663">Bank Draft</span></span>         | <span data-ttu-id="b50f8-664">*メキシコではサポートされていません*</span><span class="sxs-lookup"><span data-stu-id="b50f8-664">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="b50f8-665">外</span><span class="sxs-lookup"><span data-stu-id="b50f8-665">Other</span></span>              | <span data-ttu-id="b50f8-666">*メキシコではサポートされていません*</span><span class="sxs-lookup"><span data-stu-id="b50f8-666">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="b50f8-667">銀行口座の種類</span><span class="sxs-lookup"><span data-stu-id="b50f8-667">Bank account type</span></span>

<span data-ttu-id="b50f8-668">銀行口座の種類は、従業員への電子支払のために使用されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-668">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="b50f8-669">銀行口座の種類は、振替口座情報として Dayforce にマップされます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-669">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="b50f8-670">銀行口座の種類は、統合時に必要に応じて許容される値に翻訳されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-670">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="b50f8-671">Talent</span><span class="sxs-lookup"><span data-stu-id="b50f8-671">Talent</span></span>            | <span data-ttu-id="b50f8-672">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b50f8-672">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="b50f8-673">当座預金口座</span><span class="sxs-lookup"><span data-stu-id="b50f8-673">Checking Account</span></span>  | <span data-ttu-id="b50f8-674">当座預金口座</span><span class="sxs-lookup"><span data-stu-id="b50f8-674">CheckingAccount</span></span>           |
| <span data-ttu-id="b50f8-675">給与口座</span><span class="sxs-lookup"><span data-stu-id="b50f8-675">Payroll Account</span></span>   | <span data-ttu-id="b50f8-676">給与口座</span><span class="sxs-lookup"><span data-stu-id="b50f8-676">PayrollAccount</span></span>            |
| <span data-ttu-id="b50f8-677">普通預金口座</span><span class="sxs-lookup"><span data-stu-id="b50f8-677">Savings Account</span></span>   | <span data-ttu-id="b50f8-678">*メキシコではサポートされていません*</span><span class="sxs-lookup"><span data-stu-id="b50f8-678">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="b50f8-679">BankGirot 口座</span><span class="sxs-lookup"><span data-stu-id="b50f8-679">BankGirot account</span></span> | <span data-ttu-id="b50f8-680">*メキシコではサポートされていません*</span><span class="sxs-lookup"><span data-stu-id="b50f8-680">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="b50f8-681">PlusGirot 口座</span><span class="sxs-lookup"><span data-stu-id="b50f8-681">PlusGirot account</span></span> | <span data-ttu-id="b50f8-682">*メキシコではサポートされていません*</span><span class="sxs-lookup"><span data-stu-id="b50f8-682">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="b50f8-683">所得コード</span><span class="sxs-lookup"><span data-stu-id="b50f8-683">Earning codes</span></span>

<span data-ttu-id="b50f8-684">所得コードは、作業者が受け取るすべての収益のタイプを一意に識別します。</span><span class="sxs-lookup"><span data-stu-id="b50f8-684">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="b50f8-685">コードには、会計ルール、税法、レポート要件、およびグロスアップ能力など、所得に関連付けられている複数のパラメーターが含まれます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-685">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="b50f8-686">サポートされていない頻度を使用する場合、既定で**すべての支払**頻度が計算に使用されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-686">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="b50f8-687">サポートされる頻度</span><span class="sxs-lookup"><span data-stu-id="b50f8-687">Supported frequencies</span></span>

- <span data-ttu-id="b50f8-688">All</span><span class="sxs-lookup"><span data-stu-id="b50f8-688">All</span></span>
- <span data-ttu-id="b50f8-689">すべての支払</span><span class="sxs-lookup"><span data-stu-id="b50f8-689">EVERYPAY</span></span>
- <span data-ttu-id="b50f8-690">各支払期間</span><span class="sxs-lookup"><span data-stu-id="b50f8-690">EACHPAYPERIOD</span></span>
- <span data-ttu-id="b50f8-691">他のすべての奇数支払</span><span class="sxs-lookup"><span data-stu-id="b50f8-691">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="b50f8-692">他のすべての偶数支払</span><span class="sxs-lookup"><span data-stu-id="b50f8-692">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="b50f8-693">1 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-693">1OFMTH</span></span>
- <span data-ttu-id="b50f8-694">月の最終日</span><span class="sxs-lookup"><span data-stu-id="b50f8-694">LASTOFMTH</span></span>
- <span data-ttu-id="b50f8-695">2 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-695">2OFMTH</span></span>
- <span data-ttu-id="b50f8-696">3 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-696">3OFMTH</span></span>
- <span data-ttu-id="b50f8-697">4 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-697">4OFMTH</span></span>
- <span data-ttu-id="b50f8-698">5 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-698">5OFMTH</span></span>
- <span data-ttu-id="b50f8-699">1 か月および 2 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-699">1N2OFMTH</span></span>
- <span data-ttu-id="b50f8-700">3 か月および 4 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-700">3N4OFMTH</span></span>
- <span data-ttu-id="b50f8-701">1 か月および 3 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-701">1N3OFMTH</span></span>
- <span data-ttu-id="b50f8-702">1 か月および 4 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-702">1N4OFMTH</span></span>
- <span data-ttu-id="b50f8-703">2 か月および 3 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-703">2N3OFMTH</span></span>
- <span data-ttu-id="b50f8-704">2 か月および 4 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-704">2N4OFMTH</span></span>
- <span data-ttu-id="b50f8-705">1 か月、2 か月および 3 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-705">1N2N3OFMTH</span></span>
- <span data-ttu-id="b50f8-706">1 か月、2 か月および 4 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-706">1N2N4OFMTH</span></span>
- <span data-ttu-id="b50f8-707">1 か月、3 か月および 4 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-707">1N3N4OFMTH</span></span>
- <span data-ttu-id="b50f8-708">2 か月、3 か月および 4 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-708">2N3N4OFMTH</span></span>
- <span data-ttu-id="b50f8-709">1 か月、2 か月、3 か月および 4 か月 - 1 か月、2 か月、3 か月および 4 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-709">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="b50f8-710">2 か月、3 か月、4 か月および 5 か月 - 2 か月、3 か月、4 か月および 5 か月</span><span class="sxs-lookup"><span data-stu-id="b50f8-710">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="b50f8-711">四半期の 1 - 四半期の 1</span><span class="sxs-lookup"><span data-stu-id="b50f8-711">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="b50f8-712">四半期の最終日 – 四半期の最終日</span><span class="sxs-lookup"><span data-stu-id="b50f8-712">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="b50f8-713">四半期の最後の月 – 四半期の最後の月</span><span class="sxs-lookup"><span data-stu-id="b50f8-713">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="b50f8-714">1 年 - 1 年</span><span class="sxs-lookup"><span data-stu-id="b50f8-714">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="b50f8-715">年の最終日 – 年の最終日</span><span class="sxs-lookup"><span data-stu-id="b50f8-715">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="b50f8-716">年の 11 月および 12 月 - 年の 11 月および 12 月</span><span class="sxs-lookup"><span data-stu-id="b50f8-716">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="b50f8-717">住所</span><span class="sxs-lookup"><span data-stu-id="b50f8-717">Addresses</span></span>

<span data-ttu-id="b50f8-718">特定の国または地域、都道府県、および市区郡 (自治体) の ID には、Dayforce および国内または地域内のプロバイダーが認識できる特定の形式が必要です。</span><span class="sxs-lookup"><span data-stu-id="b50f8-718">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="b50f8-719">市町村の形式は柔軟ですが、すべての市町村が都道府県と関連付けられている必要があります。</span><span class="sxs-lookup"><span data-stu-id="b50f8-719">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="b50f8-720">Talent</span><span class="sxs-lookup"><span data-stu-id="b50f8-720">Talent</span></span>              | <span data-ttu-id="b50f8-721">Dayforce</span><span class="sxs-lookup"><span data-stu-id="b50f8-721">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="b50f8-722">国/地域</span><span class="sxs-lookup"><span data-stu-id="b50f8-722">Country/Region</span></span>      | <span data-ttu-id="b50f8-723">国コード</span><span class="sxs-lookup"><span data-stu-id="b50f8-723">Country Code</span></span>          |
| <span data-ttu-id="b50f8-724">郵便番号</span><span class="sxs-lookup"><span data-stu-id="b50f8-724">Zip/Postal Code</span></span>     | <span data-ttu-id="b50f8-725">郵便番号</span><span class="sxs-lookup"><span data-stu-id="b50f8-725">Postal Code</span></span>           |
| <span data-ttu-id="b50f8-726">行政単位 (区画)</span><span class="sxs-lookup"><span data-stu-id="b50f8-726">State</span></span>               | <span data-ttu-id="b50f8-727">都道府県コード</span><span class="sxs-lookup"><span data-stu-id="b50f8-727">State Code</span></span>            |
| <span data-ttu-id="b50f8-728">市町村</span><span class="sxs-lookup"><span data-stu-id="b50f8-728">City</span></span>                | <span data-ttu-id="b50f8-729">市町村</span><span class="sxs-lookup"><span data-stu-id="b50f8-729">City</span></span>                  |
| <span data-ttu-id="b50f8-730">郡</span><span class="sxs-lookup"><span data-stu-id="b50f8-730">County</span></span>              | <span data-ttu-id="b50f8-731">市区郡 (自治体)</span><span class="sxs-lookup"><span data-stu-id="b50f8-731">County (Municipality)</span></span> |
| <span data-ttu-id="b50f8-732">住所</span><span class="sxs-lookup"><span data-stu-id="b50f8-732">Street</span></span>              | <span data-ttu-id="b50f8-733">住所行 1</span><span class="sxs-lookup"><span data-stu-id="b50f8-733">Address Line 1</span></span>        |
| <span data-ttu-id="b50f8-734">番地</span><span class="sxs-lookup"><span data-stu-id="b50f8-734">Street Number</span></span>       | <span data-ttu-id="b50f8-735">住所行 2</span><span class="sxs-lookup"><span data-stu-id="b50f8-735">Address Line 2</span></span>        |
| <span data-ttu-id="b50f8-736">建物名</span><span class="sxs-lookup"><span data-stu-id="b50f8-736">Building Complement</span></span> | <span data-ttu-id="b50f8-737">住所行 5</span><span class="sxs-lookup"><span data-stu-id="b50f8-737">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="b50f8-738">パスポート番号</span><span class="sxs-lookup"><span data-stu-id="b50f8-738">Passport number</span></span>

<span data-ttu-id="b50f8-739">従業員は、パスポート情報を申告できます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-739">Employees can declare passport information.</span></span> <span data-ttu-id="b50f8-740">この情報は、**パスポート** ID タイプになり、従業員のメキシコ固有の情報の一部として Dayforce に統合されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-740">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="b50f8-741">ID タイプ = "Passport"</span><span class="sxs-lookup"><span data-stu-id="b50f8-741">Identification Type = "Passport"</span></span>
- <span data-ttu-id="b50f8-742">発行日付</span><span class="sxs-lookup"><span data-stu-id="b50f8-742">Issued Date</span></span>
- <span data-ttu-id="b50f8-743">有効期限</span><span class="sxs-lookup"><span data-stu-id="b50f8-743">Expiration Date</span></span>

<span data-ttu-id="b50f8-744">従業員は、**パスポート** ID タイプの複数の ID 番号を申告できます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-744">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="b50f8-745">ただし、現在の有効なパスポート入力のみが Dayforce に統合されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-745">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="b50f8-746">すべてのパスポート入力が期限切れの場合、最後に発行されたパスポートが Dayforce に統合されます。</span><span class="sxs-lookup"><span data-stu-id="b50f8-746">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
