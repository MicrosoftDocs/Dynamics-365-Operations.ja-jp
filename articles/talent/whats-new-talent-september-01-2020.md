---
title: Dynamics 365 Talent (2020 年 9 月 1 日) の新機能および変更された機能
...
今回のリリースでは、Attract における LinkedIn Recruiter 統合への次のような変更が含まれています。

- 採用担当者のメモ、InMail 活動、および候補者の却下活動を表示する新しい **採用活動** タブ

- Attract から離れなくても InMail を送信したりジョブに保存したりする機能

- ユーザーがプライベートなノートやその他の公開ノートを表示する機能など、LinkedIn Recruiter メモの更新
