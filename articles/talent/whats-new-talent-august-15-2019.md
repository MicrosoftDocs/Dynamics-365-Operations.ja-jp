...
このセクションに記載された変更は、ビルド番号 8.1.2421.0 に適用されます
...
従業員レコードに対する変更が、直すぐに有効になることはほとんどありません。 従業員の開始日の時点でデータを更新する必要があります。これは今後頻繁に発生し、過去の情報も更新する必要があります。 この合理化されたナビゲーション モデルにより、複数のフォームに移動したり、日付コンテキストを変更したりすることなく、未来および過去のデータを更新できます。 また、この変更により、従業員レコードの上部バナー領域に重要な情報が動的に促進および表示されます。
