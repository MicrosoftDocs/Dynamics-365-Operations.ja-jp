...
---
# <a name="configure-email-settings-in-attract"></a>Attract の電子メール設定のコンフィギュレーション
...
- 会社の Microsoft Exchange メール サービス アカウントが使用されるように電子メール設定をコンフィギュレーションします。 このようにして、候補者は電子メールがあなたの会社から送られているということを認知します。 たとえば、候補者が `contoso@microsoft.com` の代わりに、`recruiting@contoso.com` から電子メールを受け取るように設定することができます。
