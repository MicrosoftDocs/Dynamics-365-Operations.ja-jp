...
個人用設定ツールバーが Finance and Operations のプラットフォーム更新プログラム 22 で再編成され、ユーザーが Talent でエクスペリエンスを簡単にカスタマイズできるようになりました。 次の変更が加えられました。 
...
| Common Data Service 値   | Finance and Operations 値 | | ------------|------------------ -----------| | 75440000    | 男性                         | | 75440001    | 女性                       | | 75440002    | なし                         | | 75440003    | 不特定                  |
