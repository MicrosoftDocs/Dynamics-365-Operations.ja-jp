...
ms.locfileid: "2896661"
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>Dynamics 365 Talent (2019 年 11 月 12 日) の新機能または変更された機能
...
このセクションに記載された変更は、ビルド番号 8.1.2604 に適用されます。 ヘッダーにあるかっこ内の数字は、Microsoft Dynamics Lifecycle Services (LCS) のサポート番号を参照していることがあります。

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>Excel ブックから Office の場所が更新されない (369727)

この変更により、Office ブック デザイナーを使用して、Office の場所を更新できるようになります。
