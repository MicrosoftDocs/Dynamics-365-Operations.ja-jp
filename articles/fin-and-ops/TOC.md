...
#### [標準データ エンティティに関する情報を検索します。](../dev-itpro/data-entities/data-entities-report.md)
...
#### [財務インサイト](../dev-itpro/analytics/financial-insights.md)
...
##### [電子申告用の形式コンフィギュレーションを使用して支払用の電子ドキュメントを生成する](../dev-itpro/analytics/tasks/er-electronic-payments.md)
...
#### [宛先](../dev-itpro/analytics/electronic-reporting-destinations.md)
...
##### [電子申告 (ER) (Part 1) 用の画像が埋め込まれた Microsoft Office 形式のレポートを生成するためのコンフィギュレーションを設計する](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-july-2017.md)
...
#### [アプリケーションのデータを更新するために受信したドキュメントを解析する](../dev-itpro/analytics/parse-incoming-electronic-documents.md)
#### [CSV 形式で受信したドキュメントを解析する](../dev-itpro/analytics/parse-incoming-electronic-documents-csv-format.md)

##### [Application update 7.3 での電子申告フレームワーク API の変更](../dev-itpro/analytics/er-apis-app73.md)
