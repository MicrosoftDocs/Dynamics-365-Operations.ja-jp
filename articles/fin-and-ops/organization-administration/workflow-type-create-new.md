...
3. 作成するメニュー項目のタイプを指定します。 Microsoft Dynamics 365 for Finance and Operations クライアント、エンタープライズ ポータルの web メニュー項目、またはクライアントとエンタープライズ ポータルの両方の項目について、メニュー項目を作成できます。
