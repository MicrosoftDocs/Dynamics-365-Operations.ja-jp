...
# <a name="workflow-types-report"></a><span data-ttu-id="20add-103">ワークフロー タイプのレポート</span><span class="sxs-lookup"><span data-stu-id="20add-103">Workflow types report</span></span>

[!include [banner](../includes/banner.md)]

<span data-ttu-id="20add-104">このトピックでは、Finance and Operations で使用できるワークフロー タイプを一覧表示するレポートを示します。</span><span class="sxs-lookup"><span data-stu-id="20add-104">This topic points you to a report that lists the workflow types that are available in Finance and Operations.</span></span>
