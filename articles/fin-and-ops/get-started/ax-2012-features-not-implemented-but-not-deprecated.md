...
<thead>
<tr class="header">
<th><span data-ttu-id="f8719-108">延期された AX 2012 の機能</span><span class="sxs-lookup"><span data-stu-id="f8719-108">AX 2012 feature that was postponed</span></span></th>
<th><span data-ttu-id="f8719-109">説明</span><span class="sxs-lookup"><span data-stu-id="f8719-109">Description</span></span></th>
<th><span data-ttu-id="f8719-110">現在の状態 (2018 年 10 月現在)</span><span class="sxs-lookup"><span data-stu-id="f8719-110">Current status (as of October 2018)</span></span>
</tr>
</thead>
<tbody>

<tr class="even">
<td><span data-ttu-id="f8719-111">人事管理における休暇管理</span><span class="sxs-lookup"><span data-stu-id="f8719-111">Absence management in Human resources</span></span></td>
<td><span data-ttu-id="f8719-112">休暇トランザクションを入力するための機能は Finance and Operations に含まれません。</span><span class="sxs-lookup"><span data-stu-id="f8719-112">Functionality for entering absence transactions isn&#39;t included in Finance and Operations.</span></span> <span data-ttu-id="f8719-113">また、マネージャーとして休暇トランザクションを承認する機能は含まれていません。</span><span class="sxs-lookup"><span data-stu-id="f8719-113">Additionally, functionality for approving absence transactions as a manager isn&#39;t included.</span></span> <span data-ttu-id="f8719-114">他のモジュールとの統合に必要な設定機能は、<strong>Human Resources 2</strong> コンフィギュレーション キーから使用できます。</span><span class="sxs-lookup"><span data-stu-id="f8719-114">Setup capabilities that are required for integration with other modules are available through the <strong>Human Resources 2</strong> configuration key.</span></span></td>
<td><span data-ttu-id="f8719-115">Dynamics 365 for Talent で実装済み</span><span class="sxs-lookup"><span data-stu-id="f8719-115">Implemented in Dynamics 365 for Talent</span></span></td>
</tr>

</tr><tr class="odd">
<td><span data-ttu-id="f8719-116">警告</span><span class="sxs-lookup"><span data-stu-id="f8719-116">Alerts</span></span></td>
<td><span data-ttu-id="f8719-117">警告はユーザーがシステム内のデータの変更を追跡するのに役立ちます。</span><span class="sxs-lookup"><span data-stu-id="f8719-117">Alerts help users keep track of data changes in the system.</span></span></td>
<td><span data-ttu-id="f8719-118">プラットフォーム更新 15 で実装済み</span><span class="sxs-lookup"><span data-stu-id="f8719-118">Implemented in Platform update 15</span></span></td>
</tr>

<tr class="odd">
<td><span data-ttu-id="f8719-119">ラトビアとリトアニア用の支払指図</span><span class="sxs-lookup"><span data-stu-id="f8719-119">Bank payment order for Latvia and Lithuania</span></span></td>
<td><span data-ttu-id="f8719-120">ラトビアとリトアニア用の支払指図を印刷することができます。</span><span class="sxs-lookup"><span data-stu-id="f8719-120">You can print a payment order for Latvia and Lithuania.</span></span> <span data-ttu-id="f8719-121">この機能は、将来の更新で利用可能になります。</span><span class="sxs-lookup"><span data-stu-id="f8719-121">This feature will be available in a future update.</span></span></td>
<td><span data-ttu-id="f8719-122">実装されていません</span><span class="sxs-lookup"><span data-stu-id="f8719-122">Not implemented</span></span></td>
</tr>
...
<td><span data-ttu-id="f8719-182">調達サイト</span><span class="sxs-lookup"><span data-stu-id="f8719-182">Procurement site</span></span></td>
...
<tbody>
<tr class="odd">
<td><span data-ttu-id="f8719-202">ChqBen</span><span class="sxs-lookup"><span data-stu-id="f8719-202">ChqBen</span></span></td>
...
<th><span data-ttu-id="f8719-243">フォーマットの説明をエクスポート</span><span class="sxs-lookup"><span data-stu-id="f8719-243">Export format description</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<td><span data-ttu-id="f8719-263">振込用紙/郵便振替</span><span class="sxs-lookup"><span data-stu-id="f8719-263">Transfer form/giro payment</span></span></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td><span data-ttu-id="f8719-297">EasyAccountTransfer</span><span class="sxs-lookup"><span data-stu-id="f8719-297">EasyAccountTransfer</span></span></td>
...
<td><span data-ttu-id="f8719-328">一般的な仕入先要求</span><span class="sxs-lookup"><span data-stu-id="f8719-328">Vendor requests in general</span></span></td>
...
<td><span data-ttu-id="f8719-333">法人は、レジスターを使用して、収益と経費を開示できます。</span><span class="sxs-lookup"><span data-stu-id="f8719-333">Legal entities can use registers to disclose their revenues and expenses.</span></span> <span data-ttu-id="f8719-334">レジスターは、売上請求書や配送メモなどの基本ドキュメントが、生産の原価価格の計算を使って最初に入力されたときからの収益および経費データを追跡するために使用されます。</span><span class="sxs-lookup"><span data-stu-id="f8719-334">The registers are used to track revenue and expense data from the time that primary documents, such as sales invoices and delivery notes, are first entered by using the calculation of cost prices for production.</span></span> <span data-ttu-id="f8719-335">レジスターからのデータは、法人の宣言された利益を確認するために使用されます。</span><span class="sxs-lookup"><span data-stu-id="f8719-335">The data from the registers is used to confirm the declared profit of the legal entity.</span></span> <span data-ttu-id="f8719-336">この機能には次の機能が含まれています。</span><span class="sxs-lookup"><span data-stu-id="f8719-336">This functionality includes the following features:</span></span> <ul>
 ...
 <li> <span data-ttu-id="f8719-355">FA/IA 販売</span><span class="sxs-lookup"><span data-stu-id="f8719-355">FA/IA sale</span></span></li>
