...
**注記:** [**検索**] ボックスは、ページの検索や移動に役立ちます。 特定のデータまたはアクションの検索には役立ちません。 
...
ページの検索時には、入力はページ タイトル、ナビゲーション パスと照合されます。 たとえば、**検索** ボックスに売掛金と入力した場合、ページ タイトルに売掛金という語を含んでいない場合にも、売掛金勘定エリアで使用できるページの結果が表示されます。 
