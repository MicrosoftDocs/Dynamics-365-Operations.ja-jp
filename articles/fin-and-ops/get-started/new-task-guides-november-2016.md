...
(2016 年 11 月 -- すべての言語) APQC 統合ライブラリでは、Microsoft Dynamics 365 for Operations、Microsoft Dynamics 365 for Operations プラットフォーム更新プログラム 3、Microsoft Dynamics AX Platform 更新プログラム 2、Dynamics AX 2016 年 5 月の更新プログラム、Microsoft Dynamics AX 2016 年 2 月のリリースが含まれます。 これらのリリースに関する詳細については、「[新規または変更](whats-new-changed.md)」を参照してください。 ローカライズ版のタスク ガイドは、このライブラリで使用できます。 タスク ガイド ライブラリのヘルプ システムを接続する方法の詳細については、「[ヘルプの入門](help-overview.md)」を参照してください。 <strong>注記:</strong> ビジネス プロセス モデラー (BPM) 行のタイトルの横にあるアスタリスク (<strong>\</strong>*) は、そのビジネス プロセスのタスク ガイドが、Dynamics 365 for Operations 2016 年 11 月更新のために作成されたことを示しており、Microsoft Dynamics AX の以前のバージョンでサポートされていません。
...
|                                                       オーストラリア BAS の理由コードの設定                                                       |     オーストラリアおよびニュージーランド     |
|                                                <strong>\</strong>*中国の伝票の連続性確認                                                |               中国               |
|                                         <strong>\</strong>*CN-00010 中国の勘定科目表の階層                                          |               中国               |
|                                       <strong>\</strong>*CN-00016 中国の作業ルールを使用したユーザー操作ログ                                        |               中国               |
|                                              <strong>\</strong>*金税の統合エクスポートの設定                                               |               中国               |
|                                     <strong>\</strong>*売上請求書など他のモジュールからの伝票の転記                                      |               中国               |
|                                             <strong>\</strong>*一般仕訳帳からの伝票の転記                                             |               中国               |
|                                         <strong>\</strong>*中国の基本的な税統合プロファイルの設定                                         |               中国               |
|                                                    <strong>\</strong>*中国の伝票の設定                                                     |               中国               |
...
|                                                            支払伝票形式の設定                                                             |              デンマーク              |
|                                             <strong>\</strong>*EEU-00047 従業員への前払                                              |          東ヨーロッパ           |
|                                          ISO20022 支払形式を使用した仕入先支払の作成とエクスポート                                          |              ヨーロッパ               |
|                                            口座引落命令がある顧客の支払の作成                                            |              ヨーロッパ               |
|                                           <strong>\</strong>*EE-00015 支払参照生成ツール                                           |              ヨーロッパ               |
|                                                  EUR-00002 EU イントラスタット申告の生成                                                   |              ヨーロッパ               |
|                             <strong>\</strong>*EUR-00002 EU 内トランザクションの船積住所の指定                              |              ヨーロッパ               |
...
|                                              <strong>\</strong>*EUR-00015 VAT ID を使用する関係者の検索                                               |              ヨーロッパ               |
|                                            <strong>\</strong>*EUR-00015 仕入先 VAT ID の登録                                             |              ヨーロッパ               |
|                                                    <strong>\</strong>*EUR-00015 VAT ID の設定                                                     |              ヨーロッパ               |
|                                               <strong>\</strong>*HU-00001 為替レート計算                                               |              ヨーロッパ               |
|                                                   ISO20022 口座振替コンフィギュレーションのインポート                                                   |              ヨーロッパ               |
|                                                    ISO20022 口座引落コンフィギュレーションのインポート                                                     |              ヨーロッパ               |
|  <strong>\</strong>*LT-00003 社内の商品移動の移動文書/内部在庫移動の移動文書の生成  |              ヨーロッパ               |
| <strong>\</strong>*LT-00003 社内の商品移動の移動文書/社内の商品移動に関する移動文書の設定 |              ヨーロッパ               |
|                                         <strong>\</strong>*NO-00002 支払 ID に基づいた顧客支払                                          |              ヨーロッパ               |
...
|                                              <strong>\</strong>*EUR-00018 VAT 調整レポート                                               |              アイスランド              |
...
|                                          BPM ライン                                           | 国/地域 |
|---------------------------------------------------------------------------------------------|----------------|
| <strong>\</strong>*生産需要に基づく委託販売在庫の所有権の変更 |     グローバル     |
|                 <strong>\</strong>*委託販売補充注文の作成                 |     グローバル     |
|         <strong>\</strong>*仕入先コラボレーションを使用した委託販売在庫の監視         |     グローバル     |
...
|                                   BPM ライン                                    | 国/地域 |
|-------------------------------------------------------------------------------|----------------|
| <strong>\</strong>*業績仕訳への追加および称賛の送信 |     グローバル     |
|                       <strong>\</strong>*目標の作成                        |     グローバル     |
|                <strong>\</strong>*業績の確認の作成                 |     グローバル     |
...
| 製品のバーコードの作成                                         | グローバル         |
| \* 事前定義済製品バリアントの製品番号に関する用語の作成 | グローバル         |
| \* コンフィギュレーション済製品バリアントにおける製品番号の分類の作成 | グローバル         |
| \* 品目の既定の注文設定を定義                            | グローバル         |
...
| <strong>\</strong>*機械学習を利用する製品の推奨事項のコンフィギュレーション |     グローバル     |
|        販売担当者の機能プロファイルのコンフィギュレーション         |     グローバル     |
|        <strong>\</strong>*視覚プロファイルの作成 (2016 年 11 月)         |     グローバル     |
|                        レジスターの作成と関連付け                         |     グローバル     |
|                           コール センター注文の作成                           |     グローバル     |
...
|                          連続スケジュールの定義                           |     グローバル     |
|         <strong>\</strong>*小売チャンネル通信 (CDX) の定義         |     グローバル     |
|                          ロイヤルティ報酬調整                          |     グローバル     |
|                              品揃えの管理                               |     グローバル     |
...
|-------------------------------------------------------------------------------------|----------------|
|                              場所プロファイルの作成                              |     グローバル     |
| <strong>\</strong>*ライセンス プレートの連結用のモバイル デバイス メニュー項目の作成 |     グローバル     |
|                             運賃の手動調整                              |     グローバル     |
