...
ms.sourcegitcommit: c1bdbe20e9cb9c8583970305d85f664eb391c1df
ms.openlocfilehash: da84ec98b0a624d068abd25b575bba7dc5f42250
...
Dynamics AX 2009 Service Pack 1 (SP1)、Dynamics AX 2012、Dynamics AX 2012 R2 のメインストリーム サポートは、2018 年 10 月 9 日に終了します。 その日より後は、2021 年 10 月 12 日まで続く延長サポート期間の終わりまで、これら 3 つのバージョンのセキュリティ修正プログラムのみ提供され続けます。 詳細については、[support.microsoft.com](https://support.microsoft.com/en-us/lifecycle/search?alpha=Dynamics%20AX) を参照してください。
...
-  Dynamics AX 2009 Service Pack 1 ユーザーは、入手可能な[移行ツール](https://docs.microsoft.com/en-us/dynamics365/unified-operations/dev-itpro/migration-upgrade/upgrade-home-page)を使用してください。
...
はい、[support.microsoft.com](https://support.microsoft.com/en-us/lifecycle/search?alpha=Dynamics%20AX) にある Microsoft Support Lifecycle サイトで常に公開されています。
