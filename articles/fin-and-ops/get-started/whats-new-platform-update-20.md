...
Finance and Operations Web クライアントは、Microsoft Fluent Design に合わせて調整のプロセスを開始しました。 その結果、プラットフォーム更新 20 を使用しているユーザーには、次の再編成された要素を含む製品内の複数で、いくつかの再編成された要素が表示されます。 
...
| 以前    | 変更後    |
|-----------------------------|----------------------------|
| ![古いダッシュボード](media/prePU20-dashboard.png  "古いダッシュボード")  |  ![新しいダッシュボード](media/postPU20-dashboard.png  "新しいダッシュボード") |
| ![古いリスト ページ](media/prePU20-customers.png  "古いリスト ページ")  |  ![新しいリスト ページ](media/postPU20-customers.png  "新しいリスト ページ") |
| ![古い詳細ページ](media/prePU20-customerDetails.png  "古い詳細ページ")  |  ![新しい詳細ページ](media/postPU20-customerDetails.png  "新しい詳細ページ") |
| ![古い情報ボックス ウィンドウ](media/prePU20-expandedFactBox.png  "古い情報ボックス ウィンドウ")  |  ![新しい情報ボックス ウィンドウ](media/postPU20-expandedFactBox.png  "新しい情報ボックス ウィンドウ") |
