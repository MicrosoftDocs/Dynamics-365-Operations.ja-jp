...
[![新しいウィンドウで開くアイコン](./media/open-in-new-window-icon.png)](./media/open-in-new-window-icon.png) 
...
[![ページを並べて表示する](./media/pages-show-side-by-side.png)](./media/pages-show-side-by-side.png) 
