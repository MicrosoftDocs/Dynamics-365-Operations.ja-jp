...
---
# <a name="before-you-buy-home-page"></a>ホーム ページを購入する前に
...
Microsoft クラウド ソリューション プロバイダーはお客様と密接に協力して、企業や組織のニーズを理解します。 [Microsoft パートナー センター ポータルを使用し、ニーズに合わせてパートナーを検索する](https://partnercenter.microsoft.com/partner/home)。
