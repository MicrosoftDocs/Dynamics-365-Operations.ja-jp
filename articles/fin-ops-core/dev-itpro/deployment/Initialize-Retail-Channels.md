...
| EMEA            | 西ヨーロッパ         | 能力上限    | 現時点では LCS で使用できません。 |
| EMEA            | 北ヨーロッパ        | 能力上限    | 現時点では LCS で使用できません。 |
| EMEA            | イギリス南部            | 一般に入手可能 |    コメントはありません。                          |
| EMEA            | イギリス西部             | 一般に入手可能 |    コメントはありません。                          |
