...
<span data-ttu-id="35069-109">次の表に、今回のリリースで現在ハード シールされているモデルの一覧が含まれています。</span><span class="sxs-lookup"><span data-stu-id="35069-109">The following table includes a list of models that are now hard-sealed with this release.</span></span>
...
|<span data-ttu-id="35069-150">SourceDocumentationTypes</span><span class="sxs-lookup"><span data-stu-id="35069-150">SourceDocumentationTypes</span></span> | <span data-ttu-id="35069-151">SourceDocumentationTypes</span><span class="sxs-lookup"><span data-stu-id="35069-151">SourceDocumentationTypes</span></span> |
...
|<span data-ttu-id="35069-182">LedgerAccrualPeriod</span><span class="sxs-lookup"><span data-stu-id="35069-182">LedgerAccrualPeriod</span></span>|
...
<span data-ttu-id="35069-211">一般なプラクティスとして、テーブルのデータ メソッドを使用して、アプリケーションの拡張に使用できるイベントを発生させます。</span><span class="sxs-lookup"><span data-stu-id="35069-211">As a general practice, you use data methods on tables to raise events that can be used for extending the application.</span></span> <span data-ttu-id="35069-212">コード ベースは、必ずしもこのプラクティスに従っていませんでした。</span><span class="sxs-lookup"><span data-stu-id="35069-212">The code base has not always followed this practice.</span></span> <span data-ttu-id="35069-213">たとえば、**doInsert**、**doUpdate**、および **doDelete** データ メソッドと特定のテーブルの実装では、データ メソッドで **super()** の呼び出しは行われませんでした。</span><span class="sxs-lookup"><span data-stu-id="35069-213">For example, the **doInsert**, **doUpdate**, and **doDelete** data methods and certain table implementations did not make a call to **super()** in the data method.</span></span>
...
|<span data-ttu-id="35069-238">クラス CostSheetPanel.build</span><span class="sxs-lookup"><span data-stu-id="35069-238">Class CostSheetPanel.build</span></span>|
...
|<span data-ttu-id="35069-268">クラス InventLedgerPostingDefinitionEntityHelper.inventAccountTypeX2InventAccountType</span><span class="sxs-lookup"><span data-stu-id="35069-268">Class InventLedgerPostingDefinitionEntityHelper.inventAccountTypeX2InventAccountType</span></span>|
...
|<span data-ttu-id="35069-296">クラス InventUpd_Physical.updatePhysicalIssue</span><span class="sxs-lookup"><span data-stu-id="35069-296">Class InventUpd_Physical.updatePhysicalIssue</span></span>|
...
|<span data-ttu-id="35069-325">クラス PdsApprovedVendorListCheck.newBasedOnTableType</span><span class="sxs-lookup"><span data-stu-id="35069-325">Class PdsApprovedVendorListCheck.newBasedOnTableType</span></span>|
...
|<span data-ttu-id="35069-356">クラス ProjProposalTotals.calc</span><span class="sxs-lookup"><span data-stu-id="35069-356">Class ProjProposalTotals.calc</span></span>|
...
|<span data-ttu-id="35069-385">クラス PurchPackingSlipDP.createProductReceiptLines</span><span class="sxs-lookup"><span data-stu-id="35069-385">Class PurchPackingSlipDP.createProductReceiptLines</span></span>|
...
|<span data-ttu-id="35069-412">クラス RetailSalesOrderCalculator.saveSalesOrder</span><span class="sxs-lookup"><span data-stu-id="35069-412">Class RetailSalesOrderCalculator.saveSalesOrder</span></span>|
...
|<span data-ttu-id="35069-442">クラス SalesQuotationEditLinesForm</span><span class="sxs-lookup"><span data-stu-id="35069-442">Class SalesQuotationEditLinesForm</span></span>|
...
|<span data-ttu-id="35069-473">クラス WrkCtrReservedSum.calcReservationSumWrkCtrId</span><span class="sxs-lookup"><span data-stu-id="35069-473">Class WrkCtrReservedSum.calcReservationSumWrkCtrId</span></span>|
...
|<span data-ttu-id="35069-501">フォーム MarkupAllocation.init</span><span class="sxs-lookup"><span data-stu-id="35069-501">Form MarkupAllocation.init</span></span>|
...
|<span data-ttu-id="35069-533">テーブル InventQualityOrderTable.initQtyFromAssocation</span><span class="sxs-lookup"><span data-stu-id="35069-533">Table InventQualityOrderTable.initQtyFromAssocation</span></span>|
...
|<span data-ttu-id="35069-550">テーブル PurchLine.setPriceDisc</span><span class="sxs-lookup"><span data-stu-id="35069-550">Table PurchLine.setPriceDisc</span></span>|
|<span data-ttu-id="35069-551">テーブル RouteVersion.selectRouteVersion</span><span class="sxs-lookup"><span data-stu-id="35069-551">Table RouteVersion.selectRouteVersion</span></span>|
|<span data-ttu-id="35069-552">テーブル SalesLine.checkItemId</span><span class="sxs-lookup"><span data-stu-id="35069-552">Table SalesLine.checkItemId</span></span>|
|<span data-ttu-id="35069-553">テーブル SalesLine.getSourcingFields</span><span class="sxs-lookup"><span data-stu-id="35069-553">Table SalesLine.getSourcingFields</span></span>|
|<span data-ttu-id="35069-554">テーブル SalesLine.setPriceAgreement</span><span class="sxs-lookup"><span data-stu-id="35069-554">Table SalesLine.setPriceAgreement</span></span>|
|<span data-ttu-id="35069-555">テーブル SalesLine.setPriceDisc</span><span class="sxs-lookup"><span data-stu-id="35069-555">Table SalesLine.setPriceDisc</span></span>|
|<span data-ttu-id="35069-556">テーブル SalesLine.setSourcingFields</span><span class="sxs-lookup"><span data-stu-id="35069-556">Table SalesLine.setSourcingFields</span></span>|
|<span data-ttu-id="35069-557">テーブル SalesQuotationLine.IsCategoryBased</span><span class="sxs-lookup"><span data-stu-id="35069-557">Table SalesQuotationLine.IsCategoryBased</span></span>|
|<span data-ttu-id="35069-558">テーブル SalesQuotationLine.mcrCreateFromTmpFrmVirtualFromContract</span><span class="sxs-lookup"><span data-stu-id="35069-558">Table SalesQuotationLine.mcrCreateFromTmpFrmVirtualFromContract</span></span>|
|<span data-ttu-id="35069-559">テーブル SalesQuotationLine.setPriceAgreement</span><span class="sxs-lookup"><span data-stu-id="35069-559">Table SalesQuotationLine.setPriceAgreement</span></span>|
|<span data-ttu-id="35069-560">テーブル SalesQuotationLine.setPriceDisc</span><span class="sxs-lookup"><span data-stu-id="35069-560">Table SalesQuotationLine.setPriceDisc</span></span>|
|<span data-ttu-id="35069-561">テーブル Salesline.splitReturnLine</span><span class="sxs-lookup"><span data-stu-id="35069-561">Table Salesline.splitReturnLine</span></span>|
|<span data-ttu-id="35069-562">テーブル SuppItemCreate.createLine</span><span class="sxs-lookup"><span data-stu-id="35069-562">Table SuppItemCreate.createLine</span></span>|
|<span data-ttu-id="35069-563">テーブル TmpInventTransMark.packTmpMark</span><span class="sxs-lookup"><span data-stu-id="35069-563">Table TmpInventTransMark.packTmpMark</span></span>|
|<span data-ttu-id="35069-564">テーブル VendInvoiceMatchingLine.initFromPurchLine</span><span class="sxs-lookup"><span data-stu-id="35069-564">Table VendInvoiceMatchingLine.initFromPurchLine</span></span>|
|<span data-ttu-id="35069-565">テーブル VendTable.updateOnHold</span><span class="sxs-lookup"><span data-stu-id="35069-565">Table VendTable.updateOnHold</span></span>|
|<span data-ttu-id="35069-566">テーブル WHSInvent.checkNonPhysicalDims</span><span class="sxs-lookup"><span data-stu-id="35069-566">Table WHSInvent.checkNonPhysicalDims</span></span>|
|<span data-ttu-id="35069-567">テーブル WHSShipmentTable.consolidateShipments</span><span class="sxs-lookup"><span data-stu-id="35069-567">Table WHSShipmentTable.consolidateShipments</span></span>|
|<span data-ttu-id="35069-568">テーブル WHSShipmentTable.transferShipment</span><span class="sxs-lookup"><span data-stu-id="35069-568">Table WHSShipmentTable.transferShipment</span></span>|
|<span data-ttu-id="35069-569">テーブル WHSTmpPackingLine.addTmpPackLine</span><span class="sxs-lookup"><span data-stu-id="35069-569">Table WHSTmpPackingLine.addTmpPackLine</span></span>|
|<span data-ttu-id="35069-570">テーブル salesLine.initFromProjTable</span><span class="sxs-lookup"><span data-stu-id="35069-570">Table salesLine.initFromProjTable</span></span>|
|<span data-ttu-id="35069-571">テーブル smmBusRelTable.updateReferences</span><span class="sxs-lookup"><span data-stu-id="35069-571">Table smmBusRelTable.updateReferences</span></span>|
|<span data-ttu-id="35069-572">テーブル smmLeadTable</span><span class="sxs-lookup"><span data-stu-id="35069-572">Table smmLeadTable</span></span>|
|<span data-ttu-id="35069-573">テーブル smmOpportunityTable</span><span class="sxs-lookup"><span data-stu-id="35069-573">Table smmOpportunityTable</span></span>|


## <a name="maps-enabled-for-extensibility"></a><span data-ttu-id="35069-574">拡張性に対して使用可能なマップ</span><span class="sxs-lookup"><span data-stu-id="35069-574">Maps enabled for extensibility</span></span>

<span data-ttu-id="35069-575">拡張機能によるフィールドとメソッドの追加を可能にするマップ実装に対して、新しいパターンが導入されました。</span><span class="sxs-lookup"><span data-stu-id="35069-575">New patterns have been introduced for maps implementation that will allow you to add fields and methods by extensions.</span></span> <span data-ttu-id="35069-576">これの実行方法の詳細は、インターフェイスとして使用されるマップが含まれるドキュメントとバージョン管理実装のためのドキュメントの両方にあります。</span><span class="sxs-lookup"><span data-stu-id="35069-576">Details on how this is done is available in the documentation both with maps that are used as interfaces and for versioning implementations.</span></span>

<span data-ttu-id="35069-577">次の表に、拡張性を有効にするために変更が適用されたマップとその関連テーブルを一覧表示します。</span><span class="sxs-lookup"><span data-stu-id="35069-577">The following table lists the maps and related tables where changes have been applied for enabling extensibility.</span></span>

| <span data-ttu-id="35069-578">マップ</span><span class="sxs-lookup"><span data-stu-id="35069-578">Maps</span></span> |
| -------------------|
|<span data-ttu-id="35069-579">CustVendSettlement</span><span class="sxs-lookup"><span data-stu-id="35069-579">CustVendSettlement</span></span>|
|<span data-ttu-id="35069-580">JmgStampTransMap</span><span class="sxs-lookup"><span data-stu-id="35069-580">JmgStampTransMap</span></span>|
|<span data-ttu-id="35069-581">PriceDiscResultFields</span><span class="sxs-lookup"><span data-stu-id="35069-581">PriceDiscResultFields</span></span>|
|<span data-ttu-id="35069-582">SalesPurchLine</span><span class="sxs-lookup"><span data-stu-id="35069-582">SalesPurchLine</span></span>|

## <a name="inventory-dimensions"></a><span data-ttu-id="35069-583">在庫分析コード</span><span class="sxs-lookup"><span data-stu-id="35069-583">Inventory dimensions</span></span>

<span data-ttu-id="35069-584">今回のリリースでは、拡張機能による複数のシナリオのサポートをすべて対象とする在庫分析コードの追加のために、新しいモデルにマイナーな改良を加えました。</span><span class="sxs-lookup"><span data-stu-id="35069-584">This release made minor improvements to the new model for adding inventory dimensions, all targeted at supporting more scenarios through extensions.</span></span> 

| <span data-ttu-id="35069-585">変更</span><span class="sxs-lookup"><span data-stu-id="35069-585">Change</span></span> |
| -------------|
|<span data-ttu-id="35069-586">BOM 階層はコンフィギュレーション分析コードとのみ連携します</span><span class="sxs-lookup"><span data-stu-id="35069-586">BOM hierarchy works only with the config dimension</span></span>|
|<span data-ttu-id="35069-587">フォーム BOMDesigner は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-587">Form BOMDesigner should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-588">フォーム EcoResProductSearchLookup は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-588">Form EcoResProductSearchLookup should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-589">フォーム FactureJournal_RU は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-589">Form FactureJournal_RU should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-590">フォーム InventDimParmFixed.InventDimensionXXFlag.Style は正しくありません</span><span class="sxs-lookup"><span data-stu-id="35069-590">Form InventDimParmFixed.InventDimensionXXFlag.Style is incorrect</span></span>|
|<span data-ttu-id="35069-591">フォーム InventItemOrderSetup は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-591">Form InventItemOrderSetup should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-592">フォーム InventTransferParmPick は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-592">Form InventTransferParmPick should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-593">フォーム InventTransferReleaseOrderPicking は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-593">Form InventTransferReleaseOrderPicking should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-594">フォーム KanbanCreateScheduled は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-594">Form KanbanCreateScheduled should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-595">フォーム KanbanJobPickingListPart は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-595">Form KanbanJobPickingListPart should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-596">フォーム KanbanRules は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-596">Form KanbanRules should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-597">フォーム LeanPeggingTree は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-597">Form LeanPeggingTree should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-598">フォーム MCRItemDisplay は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-598">Form MCRItemDisplay should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-599">フォーム MCRPriceDiscGroupItem は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-599">Form MCRPriceDiscGroupItem should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-600">フォーム PlanActivityServiceWizard は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-600">Form PlanActivityServiceWizard should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-601">フォーム ProdBOMVendor は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-601">Form ProdBOMVendor should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-602">フォーム PurchAgreementGenerateReleaseOrder は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-602">Form PurchAgreementGenerateReleaseOrder should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-603">フォーム PurchAgreementHistory は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-603">Form PurchAgreementHistory should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-604">フォーム PurchComplementaryInvoice は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-604">Form PurchComplementaryInvoice should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-605">フォーム PurchRFQCompareLineDimensions は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-605">Form PurchRFQCompareLineDimensions should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-606">フォーム PurchTable.TrackingDimesions のスペルが正しくありません</span><span class="sxs-lookup"><span data-stu-id="35069-606">Form PurchTable.TrackingDimesions has incorrect spelling</span></span>|
|<span data-ttu-id="35069-607">フォーム PurchVendorPortalAllResponse は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-607">Form PurchVendorPortalAllResponse should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-608">フォーム PurchVendorPortalConfirmedOrders は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-608">Form PurchVendorPortalConfirmedOrders should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-609">フォーム PurchVendorPortalOriginalOrder は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-609">Form PurchVendorPortalOriginalOrder should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-610">フォーム PurchVendorPortalRequests は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-610">Form PurchVendorPortalRequests should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-611">フォーム PurchVendorPortalResponses は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-611">Form PurchVendorPortalResponses should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-612">フォーム ReqDemPlanEasyItemAllocator は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-612">Form ReqDemPlanEasyItemAllocator should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-613">フォーム ReqOutboundIntercompanyDemand は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-613">Form ReqOutboundIntercompanyDemand should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-614">フォーム ReqSupplyDemandScheduleFilters は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-614">Form ReqSupplyDemandScheduleFilters should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-615">フォーム RetailVariantLookup は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-615">Form RetailVariantLookup should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-616">フォーム RouteVersionFeasibility は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-616">Form RouteVersionFeasibility should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-617">フォーム SMAAgreementTable は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-617">Form SMAAgreementTable should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-618">フォーム SalesAgreementGenerateReleaseOrder は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-618">Form SalesAgreementGenerateReleaseOrder should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-619">フォーム SalesAgreementHistory は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-619">Form SalesAgreementHistory should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-620">フォーム SalesComplementaryInvoice は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-620">Form SalesComplementaryInvoice should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-621">フォーム SalesLineDeliveryDetails は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-621">Form SalesLineDeliveryDetails should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-622">フォーム SalesQuotationProjTable は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-622">Form SalesQuotationProjTable should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-623">フォーム SalesQuotationTable は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-623">Form SalesQuotationTable should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-624">フォーム SalesTable は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-624">Form SalesTable should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-625">フォーム TAMFundManagement は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-625">Form TAMFundManagement should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-626">フォーム TAMTradePromotions は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-626">Form TAMTradePromotions should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-627">フォーム VendEditInvoice は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-627">Form VendEditInvoice should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-628">フォーム VendJournalMatch_PackingSlip は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-628">Form VendJournalMatch_PackingSlip should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-629">フォーム WHSLoadPlanningWorkBench は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-629">Form WHSLoadPlanningWorkBench should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-630">フォーム WHSLoadPlanningWorkbench は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-630">Form WHSLoadPlanningWorkbench should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-631">フォーム WHSLoadTable は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-631">Form WHSLoadTable should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-632">フォーム WHSLoadTable は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-632">Form WHSLoadTable should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-633">フォーム WHSProdWaveTableManageBOMPool は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-633">Form WHSProdWaveTableManageBOMPool should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-634">フォーム WHSWorkTable は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-634">Form WHSWorkTable should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-635">フォーム WMSOrderTransUnPick は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-635">Form WMSOrderTransUnPick should use field group for showing dimensions</span></span>|
|<span data-ttu-id="35069-636">フォーム WMSPickingRegistration は、分析コードの表示にフィールド グループを使用する必要があります</span><span class="sxs-lookup"><span data-stu-id="35069-636">Form WMSPickingRegistration should use field group for showing dimensions</span></span> |
|<span data-ttu-id="35069-637">レポート InventAging は追加の分析コードをサポートしません</span><span class="sxs-lookup"><span data-stu-id="35069-637">Report InventAging does not support extra dimensions</span></span>|
|<span data-ttu-id="35069-638">テーブル EcoResProductVariantStaging.StagingIdx は、追加の分析コード フィールドを必要とします</span><span class="sxs-lookup"><span data-stu-id="35069-638">Table EcoResProductVariantStaging.StagingIdx need extra dimension fields</span></span>|

## <a name="other-changes"></a><span data-ttu-id="35069-639">その他の変更</span><span class="sxs-lookup"><span data-stu-id="35069-639">Other changes</span></span>

<span data-ttu-id="35069-640">次の表に、拡張機能に対して行われた追加の変更を一覧表示します。</span><span class="sxs-lookup"><span data-stu-id="35069-640">The following table lists additional changes that have been made for extensibility.</span></span>

| <span data-ttu-id="35069-641">変更</span><span class="sxs-lookup"><span data-stu-id="35069-641">Change</span></span> |
| -------------|
|<span data-ttu-id="35069-642">フィルター インターフェイスの追加: form InventQualityOrderTable</span><span class="sxs-lookup"><span data-stu-id="35069-642">Add filter interface: form InventQualityOrderTable</span></span>|
|<span data-ttu-id="35069-643">住所管理: 新しい住所フィールドの追加</span><span class="sxs-lookup"><span data-stu-id="35069-643">Address management: Adding new address fields</span></span>|
|<span data-ttu-id="35069-644">AxMaps - TradePostalAddress - partyTable</span><span class="sxs-lookup"><span data-stu-id="35069-644">AxMaps - TradePostalAddress - partyTable</span></span>|
|<span data-ttu-id="35069-645">銀行トランザクション コメント - BankReconciliationDataInitializer</span><span class="sxs-lookup"><span data-stu-id="35069-645">Bank Trans Comments - BankReconciliationDataInitializer</span></span>|
|<span data-ttu-id="35069-646">取消ログ要件 - 販売配送残量の更新</span><span class="sxs-lookup"><span data-stu-id="35069-646">Cancellation Log Requirements - Update Sales Deliver Remainder</span></span>|
|<span data-ttu-id="35069-647">購買要求明細行から購買明細行にグループ分けするメカニズムの拡張</span><span class="sxs-lookup"><span data-stu-id="35069-647">Extend the grouping mechanisme from purch req line to purch line</span></span>|
|<span data-ttu-id="35069-648">購買要求明細行から購買明細行に分割するメカニズムの拡張</span><span class="sxs-lookup"><span data-stu-id="35069-648">Extend the splitting mechanisme from purch req line to purch line</span></span>|
|<span data-ttu-id="35069-649">在庫品目要求と共に複数の資金調達ソースを許可</span><span class="sxs-lookup"><span data-stu-id="35069-649">Allow multiple funding sources in conjunction with item requirements</span></span>|
|<span data-ttu-id="35069-650">為替レート プロバイダー フレームワークの実装</span><span class="sxs-lookup"><span data-stu-id="35069-650">Implementing exchange rate provider framework</span></span>|
|<span data-ttu-id="35069-651">すべての使用で PriceDiscPartyCodeType を拡張可能にする</span><span class="sxs-lookup"><span data-stu-id="35069-651">Make the PriceDiscPartyCodeType extensible in all usages</span></span>|
|<span data-ttu-id="35069-652">すべての使用で PriceDiscProductCodeType を拡張可能にする</span><span class="sxs-lookup"><span data-stu-id="35069-652">Make the PriceDiscProductCodeType extensible in all usages</span></span>|
|<span data-ttu-id="35069-653">テーブル RetailChannelTable には ReplacementKey がありません</span><span class="sxs-lookup"><span data-stu-id="35069-653">Table RetailChannelTable does not have ReplacementKey</span></span>|
|<span data-ttu-id="35069-654">テーブル RetailSeasonTable CreateRecIdIndex True</span><span class="sxs-lookup"><span data-stu-id="35069-654">Table RetailSeasonTable CreateRecIdIndex True</span></span>|
|<span data-ttu-id="35069-655">インデックスの変更: テーブル InventTestAssociationTable</span><span class="sxs-lookup"><span data-stu-id="35069-655">Modify index: table InventTestAssociationTable</span></span>|
|<span data-ttu-id="35069-656">パブリックに切り替えられたエンティティ UnitOfMeasureEntity</span><span class="sxs-lookup"><span data-stu-id="35069-656">Entity UnitOfMeasureEntity switched to public</span></span>|
|<span data-ttu-id="35069-657">パブリックに切り替えられたエンティティ UnitOfMeasureTranslationEntity</span><span class="sxs-lookup"><span data-stu-id="35069-657">Entity UnitOfMeasureTranslationEntity switched to public</span></span>|
