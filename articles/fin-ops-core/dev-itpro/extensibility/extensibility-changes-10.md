...
ms.custom: ''
ms.assetid: ''
ms.openlocfilehash: 9de6da7bd639ccfc8ee8f669364a30aba6a9b99a
ms.sourcegitcommit: 87e727005399c82cbb6509f5ce9fb33d18928d30
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 08/12/2022
ms.locfileid: "9270919"
---
...
これは、Dynamics 365 for Finance and Operations バージョン 10.0 に実装された拡張機能の一覧です。 拡張性をサポートする変更のスケジュールの詳細については、「[アプリケーション機能拡張計画](extensibility-roadmap.md)」を参照してください。
...
|AOT/Data Model/Tables/CategoryTable.Create RecId インデックス|
...
|複数の EDT に "小数点以下の桁数は拡張可能" プロパティ|
|RetailLoyaltyRewardPoint.Replacement キー|
...
|BankPaymAdvicePrint.BankPaymAdvicePrint (変数)|
...
|InterCompanyTransferInventDim.Entire クラス|
...
|InventUpd_ChildReference updateLess* メソッド|
