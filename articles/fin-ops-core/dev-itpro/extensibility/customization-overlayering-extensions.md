---
title: 拡張機能およびオーバーレイによるカスタマイズ
description: この記事では、モデル要素のソース コードとメタ データをカスタマイズするオーバーレイと拡張機能の 2 つの方法について説明します。
author: jorisdg
ms.date: 09/25/2018
ms.topic: article
ms.prod: ''
...
ms.openlocfilehash: c03903a1f06bb2c50e2a8ae1f5a7d4dd509e1fd0
ms.sourcegitcommit: 52b7225350daa29b1263d8e29c54ac9e20bcca70
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 06/03/2022
ms.locfileid: "8866948"
---
# <a name="customize-through-extension-and-overlayering"></a>拡張機能およびオーバーレイによるカスタマイズ

[!include [banner](../includes/banner.md)]

この記事では、モデル要素のソース コードとメタ データをカスタマイズするオーバーレイと拡張機能の 2 つの方法、およびサポートされている拡張機能の詳細について説明します。
...
開始するには、 [拡張機能を使用してモデル要素をカスタマイズする](customize-model-elements-extensions.md) チュートリアルを確認、または完了してください。

## <a name="extension-models-and-packages"></a>拡張モデルおよびパッケージ
新しいモデル要素、新しいコード、または拡張機能のみを含むモデルを作成することができます。 このモデルは独自の独立したアセンブリにコンパイルされます。 これらのアセンブリは、関連するメタデータおよびランタイム コンポーネントと一緒に (展開可能なパッケージ ファイルとして) パッケージ化し、ランタイム サンドボックスまたは運用環境に展開することができます。 拡張モデルを作成するには、モデルの作成ウィザードを開き、2番目のステップで **新しいパッケージを作成** を選択します。
...
クラスの拡張機能を使用すると、既存のクラス、テーブル、フォームにメソッドや変数を追加して、クラスを拡張することができます。 詳細については、記事 [X++ におけるクラスの拡張機能](class-extensions.md)を参照してください。
...
[レポート メニュー項目を拡張してユーザー ナビゲーションに リダイレクトする](../analytics/extend-report-menu-items.md): この記事では、最小限のコード変更で、既存のアプリケーション メニューを拡大してナビゲーションをリダイレクトするプロセスについて説明します。 この手法を使用すると、既存のアプリケーションに対するすべての参照を追跡し、置き換えることの不便を避けることができます。
