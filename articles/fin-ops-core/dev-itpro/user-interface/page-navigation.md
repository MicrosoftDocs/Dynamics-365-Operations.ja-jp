...
| 種類     | 例                                                                                                                                                           | 説明                                                                                                                                  |
|----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| 標準 |  [![5\_Nav\_テーブル](./media/5_nav_table.png)](./media/5_nav_table.png) | このタイプのタイルでは、ビジネス データは表示されません。                                                                                           |
| COUNT    |  [![6\_Nav\_テーブル](./media/6_nav_table.png)](./media/6_nav_table.png) | このタイプのタイルは、参照されたフォームのクエリ内のアイテムの数を示します。 この例でのタイルは **ShortWide** サイズを使用することに注意してください。 |
| KPI      |  [![7\_Nav\_テーブル](./media/7_nav_table.png)](./media/7_nav_table.png) | このタイプのタイルは、KPI からのデータの要約を示します。                                                                                        |
| リンク     |  [![8\_Nav\_テーブル](./media/8_nav_table.png)](./media/8_nav_table.png) | このタイプのタイルは URL を指します。 タイルは**標準**タイプのタイルと同じ外観を持ちます。                                      |
