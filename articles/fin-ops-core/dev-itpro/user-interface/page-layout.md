...
ms.openlocfilehash: 479abb2b769f6be92eb7fb5b2827bbe2d77e2b76
ms.sourcegitcommit: 87e727005399c82cbb6509f5ce9fb33d18928d30
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 08/12/2022
ms.locfileid: "9273935"
---
...
**ColumnsMode** プロパティの場合、財務と運用アプリにはレスポンシブ レイアウトをサポートする **入力** オプションがあります。 プロパティをこの値に設定すると、列は必要に応じて自動的にフローされます。 次のテーブルでは、**ColumnsMode** プロパティのさまざまなオプションについて説明しています。
