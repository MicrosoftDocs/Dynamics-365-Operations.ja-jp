...
> [!NOTE]
> この機能は、財務と運用 (バージョン 7.2 以降) でサポートされています。
...
これでアプリケーション フォームの定義を拡張するためのタスクが完了しました。 カスタマイズを行うために拡張機能を使用する方法に関する詳細については、[拡張機能およびオーバーレイによるカスタマイズ](../extensibility/customization-overlayering-extensions.md) を参照してください。
