...
## <a name="Transformation"></a>データの書式設定
...
## <a name="Validation"></a>プロセス フローの制御
...
## <a name="Enabled"></a>ドキュメント コンテンツ コントロール
...
## <a name="TestFormula"></a>構成された式の検証
