...
## <a name="Transformation">データの書式設定</a>
...
## <a name="Validation">プロセス フローの制御</a>
...
## <a name="Enabled">ドキュメント コンテンツ コントロール</a>
...
## <a name="TestFormula">構成された式の検証</a>
