...
| 現在のすべての会社の財務分析の表示   | Microsoft Dynamics 365 for Finance and Operations Enterprise Edition 7.3 では、この職務はロールに割り当てられていません。 次のリリースで、最高財務責任者ロールにこの職務が割り当てられます。 | この職務は、CFO の概要ワークスペースのメニュー項目にアクセスを提供します。 既定では、有効な会社はフィルタとして使用されます。 ただし、ユーザーが他の法人へのアクセスできるかどうかに関係なく、すべての法人を追加することができます。 |
