...
電子申告 (ER) では、強力なデータ変換経験を提供します。 ER フォーミュラ デザイナーで必要なデータ操作を表すために使用される言語は、Microsoft Excel の数式言語に似ています。
