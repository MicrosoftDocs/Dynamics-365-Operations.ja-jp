...
description: この記事では、生産パフォーマンス Power BI コンテンツに何が含まれているのか説明します。
author: AndersGirke
ms.date: 12/19/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8881464"
---
# <a name="production-performance-power-bi-content"></a>生産パフォーマンス Power BI コンテンツ

[!include [banner](../includes/banner.md)]

この記事では、**生産パフォーマンス** Microsoft Power BI コンテンツに何が含まれているのか説明します。 Power BI レポートにアクセスする方法を説明し、コンテンツを作成するために使用したデータ モデルおよびエンティティについての情報を提供します。
...
| レポート ページ                                | グラフ | タイル |
|--------------------------------------------|--------|-------|
| 生産パフォーマンス                     | <ul><li>日付による生産数</li><li>製品および品目グループ別の生産数</li><li>日付による計画製造数</li><li>期限遵守 &amp; 完了時による下位 10 の製品</li></ul> | <ul><li>注文の合計</li><li>期限遵守 &amp; 完了 %</li><li>未完了 (%)</li><li>期日前 (%)</li><li>遅延 (%)</li></ul> |
...
| エンティティ                   | キー集計の測定  | Finance and Operations アプリのデータ ソース | フィールド              |
|--------------------------|-----------------------------|----------------------------------------|--------------------|
...
| 未完了 (%)             | IFERROR( IF('製造オーダー'\[未完了\] \<\> 0、'製造オーダー'\[未完了\]、IF('製造オーダー'\[注文の合計\] = 0、BLANK()、0)) / '製造オーダー'\[注文の合計\]、BLANK()) |
