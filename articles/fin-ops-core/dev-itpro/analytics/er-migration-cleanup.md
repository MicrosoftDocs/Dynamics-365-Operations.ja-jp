---
title: ER 移行クリーンアップ
description: この記事では、ER 移行クリーンアップ機能を使用して ER テンプレートに関する問題を解決する方法について説明します。
author: kfend
ms.date: 04/29/2020
ms.topic: article
ms.prod: ''
