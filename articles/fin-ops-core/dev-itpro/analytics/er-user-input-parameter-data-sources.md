...
description: このトピックでは、ユーザー入力パラメータデータ ソースを使用して、生成するレポートのパラメータを指定する方法について説明します。
author: NickSelin
ms.date: 04/20/2022
ms.topic: article
ms.prod: ''
