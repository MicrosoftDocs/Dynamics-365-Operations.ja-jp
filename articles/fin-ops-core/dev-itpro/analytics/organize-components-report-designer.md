...
2. **ファイル** メニューで、**新規** &gt; **レポート グループの定義** をクリックしてビューア ウィンドウで新しいレポート グループを開きます。 または、ツールバーにある **レポート グループ** ボタン ![レポート グループ。](media/report-group.gif "レポート グループ") をクリックします。
