...
[![電子メール ソース属性アカウントのコンフィギュレーション](./media/ER_Destinations-EmailDefineAddressSourceAttributes.png)](./media/ER_Destinations-EmailDefineAddressSourceAttributes.png)
