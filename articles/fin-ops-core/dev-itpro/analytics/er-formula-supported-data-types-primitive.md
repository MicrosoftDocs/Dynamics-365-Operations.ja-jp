...
description: この記事では、電子申告 (ER) の式でサポートされるプリミティブ データ型について説明します。
author: NickSelin
ms.date: 06/02/2021
...
ms.locfileid: "8891878"
---
# <a name="supported-primitive-data-types-for-electronic-reporting-formulas"></a>電子レポート形式でサポートされるプリミティブ データ型

[!include [banner](../includes/banner.md)]

この記事では、[電子申告 (ER)](general-electronic-reporting.md) の式でサポートされるプリミティブ データ型について説明します。 プリミティブ データ型の一覧を次に示します。
