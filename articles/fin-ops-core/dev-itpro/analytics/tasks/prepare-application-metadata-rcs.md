...
description: この記事では、アプリケーション メタデータを含む新しいレポート構成を作成する方法について説明します。
author: kfend
ms.date: 06/28/2019
