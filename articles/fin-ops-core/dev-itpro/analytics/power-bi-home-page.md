...
description: この記事では、使用可能な PowerBI.com ソリューションの一覧を示し、ソリューションに関するリソースについて詳しく知ることができます。
author: sericks007
ms.date: 10/02/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9206355"
---
# <a name="power-bi-content-home-page"></a>Power BI コンテンツのホーム ページ

[!include [banner](../includes/banner.md)]

次の PowerBI.com ソリューションは、アプリケーション環境で使用可能です。
...
> [!NOTE]
> 次の一覧に含まれる PowerBI.com ソリューションのほとんどは、最新バージョンの分析ワークスペースに埋め込まれています。 分析ワークスペースを使用すると、LCS の共有資産ライブラリからこれらのソリューションをダウンロードする必要がなくなります。 この一覧のトピックでは、これらの PowerBI.com ソリューションがどこに埋め込まれているかを示します (該当する場合)。

- [実績対予算](ledger-budgets-power-bi.md)
- [現金の概要](../../../finance/cash-bank-management/Cash-Overview-Power-BI-content.md)
- [報酬と給付金](compensation-and-benefits-analysis-power-bi-content-pack.md)
- [原価会計分析](cost-accounting-analysis-content-pack.md)
- [与信および回収管理](../../../finance/accounts-receivable/credit-collections-power-bi.md)
...
- [固定資産管理](../../../finance/fixed-assets/Fixed-asset-management-workspace.md)
...
- [仕入先支払](../../../finance/accounts-payable/Vendor-payments-workspace.md)
