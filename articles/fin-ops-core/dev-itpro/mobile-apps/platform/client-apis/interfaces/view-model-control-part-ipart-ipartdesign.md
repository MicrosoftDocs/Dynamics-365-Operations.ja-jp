...
ms.openlocfilehash: 4836999e43117ad89b0644353c053633cf5592cf
ms.sourcegitcommit: 708ca25687a4e48271cdcd6d2d22d99fb94cf140
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 10/10/2020
ms.locfileid: "3980560"
---
...
* [バックグラウンド](view-model-control-part-ipart-ipartdesign.md#background)
* [バインディング](view-model-control-part-ipart-ipartdesign.md#bindings)
* [枠線](view-model-control-part-ipart-ipartdesign.md#border)
* [色](view-model-control-part-ipart-ipartdesign.md#color)
* [デザイン](view-model-control-part-ipart-ipartdesign.md#design)
...
* [品目](view-model-control-part-ipart-ipartdesign.md#items)
* [justifyItems](view-model-control-part-ipart-ipartdesign.md#justifyitems)
* [ラベル](view-model-control-part-ipart-ipartdesign.md#label)
* [labelPosition](view-model-control-part-ipart-ipartdesign.md#labelposition)
* [名前](view-model-control-part-ipart-ipartdesign.md#name)
* [スペース](view-model-control-part-ipart-ipartdesign.md#padding)
* [ターゲット](view-model-control-part-ipart-ipartdesign.md#target)
* [タイプ](view-model-control-part-ipart-ipartdesign.md#type)
...
target: [PageTarget](view-model-ipage-ipagetarget.md) (省略可) 
