...
コンテナー コントロール デザイン オブジェクトには、すべてのコンテナー コントロール固有のプロパティがあります。
...
* [バックグラウンド](view-model-control-container-icontainercontrol-icontainercontroldesign.md#background)
* [バインディング](view-model-control-container-icontainercontrol-icontainercontroldesign.md#bindings)
* [枠線](view-model-control-container-icontainercontrol-icontainercontroldesign.md#border)
* [色](view-model-control-container-icontainercontrol-icontainercontroldesign.md#color)
...
* [品目](view-model-control-container-icontainercontrol-icontainercontroldesign.md#items)
* [justifyItems](view-model-control-container-icontainercontrol-icontainercontroldesign.md#justifyitems)
* [ラベル](view-model-control-container-icontainercontrol-icontainercontroldesign.md#label)
* [labelPosition](view-model-control-container-icontainercontrol-icontainercontroldesign.md#labelposition)
* [名前](view-model-control-container-icontainercontrol-icontainercontroldesign.md#name)
* [スペース](view-model-control-container-icontainercontrol-icontainercontroldesign.md#padding)
* [タイプ](view-model-control-container-icontainercontrol-icontainercontroldesign.md#type)
