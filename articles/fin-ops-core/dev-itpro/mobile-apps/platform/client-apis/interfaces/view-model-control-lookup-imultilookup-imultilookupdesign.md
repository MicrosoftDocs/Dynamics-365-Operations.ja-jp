...
ms.author: tfehr
ms.openlocfilehash: a4e7fccbedcef6f20cafdc0b433f1f44e56802d0
ms.sourcegitcommit: 336a0ad772fb55d52b4dcf2fafaa853632373820
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 05/28/2022
ms.locfileid: "8811304"
---
...
* [バインディング](view-model-control-lookup-imultilookup-imultilookupdesign.md#bindings)
* [枠線](view-model-control-lookup-imultilookup-imultilookupdesign.md#border)
* [色](view-model-control-lookup-imultilookup-imultilookupdesign.md#color)
...
* [ラベル](view-model-control-lookup-imultilookup-imultilookupdesign.md#label)
* [labelPosition](view-model-control-lookup-imultilookup-imultilookupdesign.md#labelposition)
* [名前](view-model-control-lookup-imultilookup-imultilookupdesign.md#name)
* [スペース](view-model-control-lookup-imultilookup-imultilookupdesign.md#padding)
* [タイプ](view-model-control-lookup-imultilookup-imultilookupdesign.md#type)
