...
Finance and Operations アプリ    | その他の Dynamics 365 アプリ
--------------------------|---------------------------------
顧客 V3               | 口座
顧客 V3               | 連絡
CDS 連絡先 V2           | 連絡
...
このテンプレートは、Finance and Operations アプリと Common Data Service 間で、商業および組織顧客の顧客マスター情報を同期します。
...
このテンプレートは、Finance and Operations とその他の Dynamics 365 アプリ間で、消費者およびエンド ユーザーの顧客マスターデータを同期します。
...
このテンプレートは、Finance and Operations とその他の Dynamics 365 アプリ間で、顧客および仕入先のすべての基本、二次、三次の連絡先情報を同期します。
...
このテンプレートは、Finance and Operations とその他の Dynamics 365 アプリ間で、顧客グループ情報を同期します。
...
このテンプレートは、Finance and Operations とその他の Dynamics 365 アプリ間で、顧客支払方法の情報を同期します。
...
このテンプレートは、Finance and Operations とその他の Dynamics 365 アプリ間で、顧客ロイヤリティ カード情報を同期します。
...
このテンプレートは、Finance and Operations とその他の Dynamics 365 アプリ間で、顧客および仕入先の支払スケジュールに関する参照データを同期します。
...
Finance and Operations とその他の Dynamics 365 アプリ間で、顧客および仕入先の支払スケジュール明細行に関する参照データを同期します。
...
このテンプレートは、Finance and Operations とその他の Dynamics 365 アプリ間で、顧客および仕入先の支払期日に関する参照データを同期します。
...
このテンプレートは、Finance and Operations とその他の Dynamics 365 アプリ間で、顧客および仕入先の支払期日明細行に関する参照データを同期します。
...
このテンプレートは、Finance and Operations とその他の Dynamics 365 アプリ間で、顧客および仕入先の支払条件 (支払に関する条件) に関する参照データを同期します。
...
このテンプレートは、Finance and Operations とその他の Dynamics 365 アプリ間で、顧客および仕入先の名前の接辞に関する参照データを同期します。
