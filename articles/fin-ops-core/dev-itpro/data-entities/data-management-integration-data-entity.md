...
description: この記事では、同期と非同期の統合の仕組みについて簡単に説明します。
author: peakerbl
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
