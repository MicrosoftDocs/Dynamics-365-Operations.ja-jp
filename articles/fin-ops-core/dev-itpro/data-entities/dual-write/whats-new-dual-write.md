...
ms.openlocfilehash: 7034a8e17e5cd5569d6d0122f3e526de7e8d59d8
ms.sourcegitcommit: 1ecfc1d8afb2201ab895ae6f93304ba2b120f14b
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 10/21/2022
ms.locfileid: "9710696"
---
...
10 月リリースの二重書き込みグローバル アドレス帳ソリューション バージョン 3.5.1.55 には、次のバグ修正が含まれます。

| 機能 | Description | Status |
|---|---|---|
| バグ修正 | **当事者の連絡先** ページが **顧客または仕入先の連絡先** に新しいレコードを作成するときに OnLoad エラーが発生しました。 | 一般提供 |
| バグ修正 | 一部のリード資格シナリオでは、郵便住所と電子住所が、連絡先エンティティから当事者エンティティに同期されていませんでした。 これらのシナリオでは、グローバル アドレス帳プラグインが呼び出されませんでした。 | 一般提供 |
| エラー処理 | **アカウント** ページに会社 ID が含まれていない場合は、アクション可能なエラー メッセージを表示します。 | 一般提供 |
| バグ修正 | **住所** ページの住所情報は、**住所 2** 情報がない場合は、**配送先住所** ページの **住所** フィールドに正しく表示されません。 | 一般提供 |
| バグ修正 | 顧客住所の国情報は、財務と運用アプリと顧客エンゲージメント アプリ間で同期されませんでした。 この問題に対処するために、グローバル アドレス帳プラグインが修正されました。 | 一般提供 |

## <a name="august-2022-release"></a>2022 年 8 月リリース

8 月リリースの二重書き込みグローバル アドレス帳ソリューション バージョン 3.5.1.22 には、次のバグ修正が含まれます。

| 機能 | Description | Status |
|---|---|---|
| バグ修正 | マーケティング ポータルから、そしてリード資格シナリオ中に作成された連絡先には有効な当事者 ID がありませんでした。 | 一般提供 |
| バグ修正 | 連絡先が CRM ポータルから作成されたときに発生した次のエラー (「'contact' エンティティは既定 (null) または変更されていない状態である必要があります」) を修正しました。 | 一般提供 |

### <a name="solution-details"></a>ソリューションの詳細

| ソリューション名 | 新たな変更がありますか? | 以前のバージョン | 新しいバージョン |
|---|---|---|---|
| 関係者 | 有効 | 3.5.1.22 | 3.5.1.55 |
| Dynamics365GABExtended | 有効 | 3.5.1.22 | 3.5.1.55 |
| Dynamics365GABDualWriteEntityMaps | 有効 | 3.5.1.22 | 3.5.1.55 |
| Dynamics365GABPartyAnchor | 有効 | 3.5.1.22 | 3.5.1.55 |
| Dynamics365GABPartyCommon | 有効 | 3.5.1.22 | 3.5.1.55 |
