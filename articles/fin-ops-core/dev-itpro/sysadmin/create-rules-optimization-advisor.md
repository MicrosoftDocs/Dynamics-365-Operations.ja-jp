---
title: 最適化アドバイザーのルールを作成する
description: この記事では、最適化アドバイザーのための新しいルールを追加する方法について説明します。
author: kamaybac
ms.date: 02/04/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9273920"
---
# <a name="create-rules-for-optimization-advisor"></a>最適化アドバイザーのルールを作成する

[!include [banner](../includes/banner.md)]

この記事では、**最適化アドバイザー** のための新しいルールを作成する方法について説明します。 例えば、見積依頼 (RFQ) のケースに空のタイトルがあるかどうかを識別する新しいルールを作成できます。 ケースのタイトルを使用して、識別および検索を容易にします。 非常に単純ですが、この例では最適化ルールで何が達成できるかを示しています。 
...
詳細については、[Dynamics 365 Finance の最適化アドバイザー](https://www.youtube.com/watch?v=MRsAzgFCUSQ) という短い YouTube ビデオを確認する
