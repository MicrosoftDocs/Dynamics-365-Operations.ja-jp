---
title: 財務と運用アプリのバージョン 10.0.10 (2020 年 5 月) のプラットフォーム更新プログラム
description: この記事では、財務と運用アプリのバージョン 10.0.10 のプラットフォーム更新プログラムに含まれる機能の一覧を表示します。
author: sericks007
ms.date: 04/08/2020
ms.topic: article
ms.prod: ''
...
ms.openlocfilehash: 892af077575a244dca44e374e6e2fe82a6916057
ms.sourcegitcommit: 28a726b3b0726ecac7620b5736f5457bc75a5f84
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 06/29/2022
ms.locfileid: "9067746"
---
# <a name="platform-updates-for-version-10010-of-finance-and-operations-apps-may-2020"></a>財務と運用アプリのバージョン 10.0.10 (2020 年 5 月) のプラットフォーム更新プログラム

[!include [banner](../includes/banner.md)]

この記事では、財務と運用アプリ バージョン 10.0.10 のプラットフォーム更新プログラムを一覧表示します。 この更新プログラムは、*プラットフォーム更新プログラム 34* と呼ばれていました。このバージョンには、ビルド番号 7.0.5600 が付与されており、次のスケジュールで利用できます：
