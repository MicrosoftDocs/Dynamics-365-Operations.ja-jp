...
1. <span data-ttu-id="3d0be-143">クライアントにサイン インします。</span><span class="sxs-lookup"><span data-stu-id="3d0be-143">Sign in to the client.</span></span>
