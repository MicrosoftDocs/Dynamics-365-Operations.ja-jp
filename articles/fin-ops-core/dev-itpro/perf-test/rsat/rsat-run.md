...
ms.openlocfilehash: fcdb20e5f41508cea4b4b7c55122707d32238eaf
ms.sourcegitcommit: c08a9d19eed1df03f32442ddb65a2adf1473d3b6
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/06/2021
ms.locfileid: "6357534"
---
...
![テスト ケースを読み込みます。](media/load-test-cases.png)
...
![テスト実行ファイルのみのメニュー項目を生成します。](media/generate-execution-files.png)
...
![テスト結果です。](media/test-results.png)
...
![コンプライアンス ファイルを処理します。](media/rsat-process-compliance-settings.png)
