...
- **バイナリ更新プログラム**は、コンパイル済みで累積されています。 その後のバイナリ更新には、これまでのすべての更新が含まれます。 これらの更新は、開発環境でコンパイルする必要はなく、LCS から非開発環境に直接適用することもできます。
    ...
    バージョン 8.1 以降の Retail および Finance のすべてのバージョンでは、アプリケーション モデルの更新を含むすべての更新はバイナリ更新プログラムとしてリリースされます。
...
- **アプリケーション バージョン 8.1 以降** - 次のセクションで説明するように、これにはバージョン 8.1 以降と同じ更新オプションが含まれます。
