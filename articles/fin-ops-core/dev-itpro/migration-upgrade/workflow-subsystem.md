...
ms.openlocfilehash: 9b3ec79a03593ff67b237e7543c77d69d8ceaa2f
ms.sourcegitcommit: 873d66c03a51ecb7082e269f30f5f980ccd9307f
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/06/2022
ms.locfileid: "9124242"
---
# <a name="workflow-subsystem-updates-in-finance-and-operations"></a>財務と運用でのワークフロー サブシステムの更新

[!include [banner](../includes/banner.md)]

この記事では、財務と運用のワークフロー システムについて説明します。 Microsoft Dynamics AX 2012 以降に実装された変更について説明し、ワークフロー システムに関する詳細へのリンクも示します。 

Dynamics AX 2012 を使用していれば、財務と運用のワークフロー システムはおなじみのものです。 Dynamics AX 2012 のワークフロー サブシステムの詳細については、次のトピックを参照してください。
...
-   ワークフロー エディターは、1 回クリックしてダウンロードするプログラムになりました。 このエディターは、サービスを使用して財務と運用と通信します。つまり Dynamics AX 2012 からの豊富でグラフィカルなワークフロー設計操作を引き継ぐことができます。
