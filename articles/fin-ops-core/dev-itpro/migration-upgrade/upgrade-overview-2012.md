...
description: このトピックでは、Microsoft Dynamics AX 2012 を現在実行している顧客が、データとコードを Finance and Operations に移動するために使用できるプロセスについて説明します。
author: LaneSwenka
ms.date: 08/27/2021
ms.topic: overview
ms.prod: ''
...
ms.openlocfilehash: 7df807acbb9498af512d6e24486184e962c23545
