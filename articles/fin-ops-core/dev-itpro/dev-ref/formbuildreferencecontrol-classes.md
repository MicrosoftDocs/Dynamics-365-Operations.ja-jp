...
ms.openlocfilehash: 06639c6a9f9a31ad77563d21ef5537774273e943
ms.sourcegitcommit: 3ba95d50b8262fa0f43d4faad76adac4d05eb3ea
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 09/27/2019
ms.locfileid: "2183374"
---
...
FormButtonSeparatorControl から FormBuildReferenceControl までのクラスの API 参照。

<a name="class-formbuildreferencecontrol"></a>クラス FormBuildReferenceControl
-------------------------------
...
## <a name="class-formbuildreferencegroupcontrol"></a>クラス FormBuildReferenceGroupControl
...
## <a name="class-formbuildrichtextcontrol"></a>クラス FormBuildRichTextControl
...
## <a name="class-formbuildsegmentedentrycontrol"></a>クラス FormBuildSegmentedEntryControl
...
### <a name="method-contextflyout"></a>メソッド contextFlyout
...
## <a name="class-formbuildstatictextcontrol"></a>クラス FormBuildStaticTextControl
    class FormBuildStaticTextControl extends FormBuildControl

FormBuildStaticTextControl クラスを使用すると、X++ コードとメタデータの作成、読み取り、更新、および削除を行うことができます。
...
## <a name="class-formbuildstringcontrol"></a>クラス FormBuildStringControl
    class FormBuildStringControl extends FormBuildControl

FormBuildStringControl クラスを使用すると、X++ コードとメタデータの作成、読み取り、更新、および削除を行うことができます。
...
## <a name="class-formbuildtabcontrol"></a>クラス FormBuildTabControl
    class FormBuildTabControl extends FormBuildControl

FormBuildTabControl クラスを使用すると、X++ コードとメタデータの作成、読み取り、更新、および削除を行うことができます。
...
## <a name="class-formbuildtabpagecontrol"></a>クラス FormBuildTabPageControl
    class FormBuildTabPageControl extends FormBuildControl

FormBuildTabPageControl クラスを使用すると、X++ コードとメタデータの作成、読み取り、更新、および削除を行うことができます。
...
### <a name="method-labelaction"></a>メソッド labelAction
...
## <a name="class-formbuildtimecontrol"></a>クラス FormBuildTimeControl
    class FormBuildTimeControl extends FormBuildControl

FormBuildTimeControl クラスを使用すると、X++ コードとメタデータの作成、読み取り、更新、および削除を行うことができます。
...
## <a name="class-formbuildtreecontrol"></a>クラス FormBuildTreeControl
    class FormBuildTreeControl extends FormBuildControl

FormBuildTreeControl クラスを使用すると、X++ コードとメタデータの作成、読み取り、更新、および削除を行うことができます。
...
## <a name="class-formbuildwindowcontrol"></a>クラス FormBuildWindowControl
    class FormBuildWindowControl extends FormBuildControl

FormBuildWindoControl クラスを使用すると、X++ コードとメタデータの作成、読み取り、更新、および削除を行うことができます。
...
ラベルは、コントロールに表示されるテキスト、またはプロパティ値が 250 文字を超えることができないラベルの横にあるテキストを指定します。
...
## <a name="class-formbuttoncontrol"></a>クラス FormButtonControl
...
返される整数値には、次のようなコントロールの境界線のスタイルが含まれます。
...
|                                  |                                                                                                                                   |
|----------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| FormAllowUserSetup::No 0         | コントロールに対する変更は加えられません。 この値が neededSetupRights パラメーターで使用されている場合、メソッドは常に true を返します。 |
...
## <a name="class-formbuttongroupcontrol"></a>クラス FormButtonGroupControl
...
## <a name="class-formbuttonseparatorcontrol"></a>クラス FormButtonSeparatorControl
