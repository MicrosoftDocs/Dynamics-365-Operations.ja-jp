...
- **TODO** 文字列は、**//** スタイル、または **/\** _ スタイルを使うコメントに表示されます。
- _ *TODO** 文字列は、コメント内の最初の空白文字以外の文字列にする必要があります。 キャリッジ リターン、改行、タブ、およびスペース、すべて空白と見なされます。
...
- **/\** _ コメント スタイルが使用されている場合、**TODO** タスクの説明は複数行にまたがることができます。

### <a name="examples-of-todo-comments"></a>TODO コメントの例

次の例は、_ *TODO** コメントを示します。
