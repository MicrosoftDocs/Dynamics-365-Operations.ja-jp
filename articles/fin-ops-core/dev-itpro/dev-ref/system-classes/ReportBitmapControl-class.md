...
---
# <a name="class-reportbitmapcontrol"></a>クラス ReportBitmapControl
...
ReportBitmapControl クラスは、X++ コードおよびメタデータの作成、読み取り、更新、および削除を行います。

## <a name="remarks"></a>備考

この API を呼び出す前に、開発セキュリティ キー (SysDevelopment) にアクセスする必要があります。
...
## <a name="method-resizebitmap"></a>メソッド resizeBitmap

```xpp
public boolean resizeBitmap([boolean value])
```

### <a name="parameters---resizebitmap"></a>パラメーター - resizeBitmap

値  

### <a name="return-value---resizebitmap"></a>戻り値 - resizeBitmap
...
## <a name="method-showpicastext"></a>メソッド showPicAsText

```xpp
public boolean showPicAsText([boolean value])
```

### <a name="parameters---showpicastext"></a>パラメーター - showPicAsText

値  

### <a name="return-value---showpicastext"></a>戻り値 - showPicAsText
...
## <a name="method-warnifmissing"></a>メソッド warnIfMissing

```xpp
public boolean warnIfMissing([boolean value])
```

### <a name="parameters---warnifmissing"></a>パラメーター - warnIfMissing

値  

### <a name="return-value---warnifmissing"></a>戻り値 - warnIfMissing
