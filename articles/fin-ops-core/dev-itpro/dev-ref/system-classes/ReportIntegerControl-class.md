...
---
# <a name="class-reportintegercontrol"></a>クラス ReportIntegerControl
...
ReportIntegerControl クラスを使用すると、X++ コードとメタデータの作成、読み取り、更新、および削除を行うことができます。
...
## <a name="method-sumall"></a>メソッド sumAll

```xpp
public boolean sumAll([boolean value])
```

### <a name="parameters---sumall"></a>パラメーター - sumAll

値  

### <a name="return-value---sumall"></a>戻り値 - sumAll
