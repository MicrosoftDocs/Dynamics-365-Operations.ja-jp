...
---
# <a name="class-reportlibrarynode"></a>クラス ReportLibraryNode
...
## <a name="method-designs"></a>メソッド designs

```xpp
public str designs([str value])
```

### <a name="parameters---designs"></a>パラメーター - designs

値  

### <a name="return-value---designs"></a>戻り値 - designs
...
## <a name="method-projectguid"></a>メソッド projectGuid

```xpp
public str projectGuid([str value])
```

### <a name="parameters---projectguid"></a>パラメーター - projectGuid

値  

### <a name="return-value---projectguid"></a>戻り値 - projectGuid
