...
---
# <a name="class-reportsumcontrol"></a>クラス ReportSumControl
...
ReportSumcontrol クラスを使用すると、X++ コードとメタデータの作成、読み取り、更新、および削除を行うことができます。
...
### <a name="parameters---datafieldname"></a>パラメーター - dataFieldName
...
## <a name="method-extrasumwidthmode"></a>メソッド extraSumWidthMode

```xpp
public int extraSumWidthMode([int value])
```

### <a name="parameters---extrasumwidthmode"></a>パラメーター - extraSumWidthMode

値  

### <a name="return-value---extrasumwidthmode"></a>戻り値 - extraSumWidthMode

## <a name="method-extrasumwidthstr"></a>メソッド extraSumWidthStr

```xpp
public str extraSumWidthStr([str value])
```

### <a name="parameters---extrasumwidthstr"></a>パラメーター - extraSumWidthStr

値  

### <a name="return-value---extrasumwidthstr"></a>戻り値 - extraSumWidthStr

## <a name="method-extrasumwidthunit"></a>メソッド extraSumWidthUnit

```xpp
public Units extraSumWidthUnit([Units value])
```

### <a name="parameters---extrasumwidthunit"></a>パラメーター - extraSumWidthUnit

値  

### <a name="return-value---extrasumwidthunit"></a>戻り値 - extraSumWidthUnit

## <a name="method-extrasumwidthvalue"></a>メソッド extraSumWidthValue

```xpp
public Real extraSumWidthValue([Real value])
```

### <a name="parameters---extrasumwidthvalue"></a>パラメーター - extraSumWidthValue

値  

### <a name="return-value---extrasumwidthvalue"></a>戻り値 - extraSumWidthValue
...
## <a name="method-sumtype"></a>メソッド sumType

```xpp
public int sumType([int value])
```

### <a name="parameters---sumtype"></a>パラメーター - sumType

値  

### <a name="return-value---sumtype"></a>戻り値 - sumType
