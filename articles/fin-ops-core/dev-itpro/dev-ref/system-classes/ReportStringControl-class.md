...
---
# <a name="class-reportstringcontrol"></a>クラス ReportStringControl
...
ReportStringControl クラスを使用すると、X++ コードとメタデータの作成、読み取り、更新、および削除を行うことができます。
...
## <a name="method-dynamicheight"></a>メソッド dynamicHeight

```xpp
public boolean dynamicHeight([boolean value])
```

### <a name="parameters---dynamicheight"></a>パラメーター - dynamicHeight

値  

### <a name="return-value---dynamicheight"></a>戻り値 - dynamicHeight
