...
### <a name="parameters---checked"></a>パラメーター - checked

小切手  
チェック ボックスが選択されているかどうかを示すブール値; オプション。 true の値は、チェック ボックスをオンにし、false の値は、オフにします。

### <a name="return-value---checked"></a>戻り値 - checked

チェック ボックスがオンになっている場合は true。それ以外の場合は false。

### <a name="remarks---checked"></a>備考 - checked
...
### <a name="parameters---drawfocusrect"></a>パラメーター - drawFocusRect

値  

### <a name="return-value---drawfocusrect"></a>戻り値 - drawFocusRect
...
### <a name="parameters---optionalrecordcontrol"></a>パラメーター - optionalRecordControl

値  

### <a name="return-value---optionalrecordcontrol"></a>戻り値 - optionalRecordControl
