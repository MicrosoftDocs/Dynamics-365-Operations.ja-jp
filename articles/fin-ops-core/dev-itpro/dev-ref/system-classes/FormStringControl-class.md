...
### <a name="parameters---lookuponly"></a>パラメーター - lookupOnly

値  

### <a name="return-value---lookuponly"></a>戻り値 - lookupOnly
...
### <a name="parameters---multiline"></a>パラメーター - multiLine

値  

### <a name="return-value---multiline"></a>戻り値 - multiLine
...
### <a name="parameters---passwordstyle"></a>パラメーター - passwordStyle

値  

### <a name="return-value---passwordstyle"></a>戻り値 - passwordStyle
...
### <a name="parameters---presencedatafield"></a>パラメーター - presenceDataField

値  

### <a name="return-value---presencedatafield"></a>戻り値 - presenceDataField
...
### <a name="parameters---presencedatasource"></a>パラメーター - presenceDataSource

値  

### <a name="return-value---presencedatasource"></a>戻り値 - presenceDataSource
...
### <a name="parameters---presenceindicatorallowed"></a>パラメーター - presenceIndicatorAllowed

値  

### <a name="return-value---presenceindicatorallowed"></a>戻り値 - presenceIndicatorAllowed
...
### <a name="return-value---disambiguationlookuptarget"></a>戻り値 - disambiguationLookupTarget
...
### <a name="parameters---lookupdisambiguatereference"></a>パラメーター - lookupDisambiguateReference

fieldBinding  

### <a name="return-value---lookupdisambiguatereference"></a>戻り値 - lookupDisambiguateReference
