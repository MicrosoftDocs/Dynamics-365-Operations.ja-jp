...
### <a name="parameters---containerscrollhorizontaloffset"></a>パラメーター - containerScrollHorizontalOffset

値  

### <a name="return-value---containerscrollhorizontaloffset"></a>戻り値 - containerScrollHorizontalOffset
...
### <a name="parameters---containerscrollverticaloffset"></a>パラメーター - containerScrollVerticalOffset

値  

### <a name="return-value---containerscrollverticaloffset"></a>戻り値 - containerScrollVerticalOffset
...
### <a name="return-value---getactivepage"></a>戻り値 - getActivePage
...
### <a name="return-value---hascontrolpositionoverride"></a>戻り値 - hasControlPositionOverride
...
### <a name="parameters---horizontalscrollbarvisible"></a>パラメーター - horizontalScrollBarVisible

値  

### <a name="return-value---horizontalscrollbarvisible"></a>戻り値 - horizontalScrollBarVisible
...
### <a name="parameters---showtabs"></a>パラメーター - showTabs

値  

### <a name="return-value---showtabs"></a>戻り値 - showTabs
...
### <a name="return-value---stylevalue"></a>戻り値 - styleValue
...
### <a name="parameters---tab"></a>パラメーター - tab
...
### <a name="return-value---tab"></a>戻り値 - tab
...
### <a name="parameters---tabappearance"></a>パラメーター - tabAppearance

値  

### <a name="return-value---tabappearance"></a>戻り値 - tabAppearance
...
### <a name="parameters---tabautochange"></a>パラメーター - tabAutoChange

値  

### <a name="return-value---tabautochange"></a>戻り値 - tabAutoChange
...
### <a name="parameters---tabchange"></a>パラメーター - tabChange

FromTab  

### <a name="return-value---tabchange"></a>戻り値 - tabChange
...
### <a name="parameters---tablayout"></a>パラメーター - tabLayout

値  

### <a name="return-value---tablayout"></a>戻り値 - tabLayout
...
### <a name="parameters---tabmode"></a>パラメーター - tabMode

モード  

### <a name="return-value---tabmode"></a>戻り値 - tabMode
...
### <a name="parameters---tabplacement"></a>パラメーター - tabPlacement

値  

### <a name="return-value---tabplacement"></a>戻り値 - tabPlacement
...
### <a name="parameters---tabs"></a>パラメーター - tabs

値  

### <a name="return-value---tabs"></a>戻り値 - tabs
...
### <a name="parameters---tabvalue"></a>パラメーター - tabValue

値  

### <a name="return-value---tabvalue"></a>戻り値 - tabValue
...
### <a name="parameters---verticalscrollbarvisible"></a>パラメーター - verticalScrollBarVisible

値  

### <a name="return-value---verticalscrollbarvisible"></a>戻り値 - verticalScrollBarVisible
...
### <a name="parameters---ontabchanged"></a>パラメーター - OnTabChanged
