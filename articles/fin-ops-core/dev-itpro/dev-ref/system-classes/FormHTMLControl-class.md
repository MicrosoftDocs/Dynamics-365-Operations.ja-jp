...
### <a name="parameters---processpicture"></a>パラメーター - processPicture

picture  

### <a name="return-value---processpicture"></a>戻り値 - processPicture
...
### <a name="parameters---inserttext"></a>パラメーター - insertText
...
### <a name="parameters---processbase"></a>パラメーター - processBase
...
### <a name="parameters---setfont"></a>パラメーター - setFont
...
### <a name="parameters---getfont"></a>パラメーター - getFont
...
### <a name="parameters---processlink"></a>パラメーター - processLink
...
### <a name="parameters---processtitle"></a>パラメーター - processTitle
...
### <a name="parameters---insertlink"></a>パラメーター - insertLink
...
### <a name="parameters---processform"></a>パラメーター - processForm
...
### <a name="parameters---setmargin"></a>パラメーター - setMargin
