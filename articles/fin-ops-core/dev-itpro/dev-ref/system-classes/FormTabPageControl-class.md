...
### <a name="return-value---allowpagedeactivate"></a>戻り値 - allowPageDeactivate
...
### <a name="parameters---fasttabexpanded"></a>パラメーター - fastTabExpanded

値  

### <a name="return-value---fasttabexpanded"></a>戻り値 - fastTabExpanded
...
### <a name="return-value---isactivepage"></a>戻り値 - isActivePage
...
### <a name="return-value---isexpanded"></a>戻り値 - isExpanded
...
### <a name="parameters---panelstyle"></a>パラメーター - panelStyle

値  

### <a name="return-value---panelstyle"></a>戻り値 - panelStyle
...
### <a name="parameters---onpageactivated"></a>パラメーター - OnPageActivated
...
### <a name="parameters---onallowpagedeactivate"></a>パラメーター - OnAllowPageDeactivate
