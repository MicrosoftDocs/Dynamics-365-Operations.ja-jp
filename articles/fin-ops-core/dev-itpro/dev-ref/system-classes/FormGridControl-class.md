...
### <a name="parameters---getlinedata"></a>パラメーター - getLineData

lineNumber  

### <a name="return-value---getlinedata"></a>戻り値 - getLineData
...
### <a name="return-value---getselecteddata"></a>戻り値 - getSelectedData
...
### <a name="parameters---applyquickfilter"></a>パラメーター - applyQuickFilter
...
### <a name="parameters---autosizecolumns"></a>パラメーター - autoSizeColumns
...
### <a name="parameters---quickfilterprovider"></a>パラメーター - quickFilterProvider
