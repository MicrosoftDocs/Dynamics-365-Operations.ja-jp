...
### <a name="return-value---menufunction"></a>戻り値 - menufunction
...
### <a name="remarks---neededpermission"></a>備考 - neededPermission
...
### <a name="parameters---sendexternalcontext"></a>パラメーター - sendExternalContext

値  

### <a name="return-value---sendexternalcontext"></a>戻り値 - sendExternalContext
...
### <a name="parameters---ondialogclosed"></a>パラメーター - OnDialogClosed
...
### <a name="parameters---dialogclosed"></a>パラメーター - dialogClosed
...
### <a name="parameters---dialoginitialized"></a>パラメーター - dialogInitialized
