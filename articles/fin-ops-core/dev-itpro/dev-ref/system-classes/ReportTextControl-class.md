...
---
# <a name="class-reporttextcontrol"></a>クラス ReportTextControl
...
ReportTextControl クラスを使用すると、X++ コードとメタデータの作成、読み取り、更新、および削除を行うことができます。
...
取得される整数値は、次のテーブルに従って文字セットを示します。
...
## <a name="method-eval"></a>メソッド eval

```xpp
public str eval()
```

### <a name="return-value---eval"></a>戻り値 - eval
...
## <a name="method-textextentx100mm"></a>メソッド textExtentX100mm

```xpp
public int textExtentX100mm()
```

### <a name="return-value---textextentx100mm"></a>戻り値 - textExtentX100mm

## <a name="method-textextenty100mm"></a>メソッド textExtentY100mm

```xpp
public int textExtentY100mm()
```

### <a name="return-value---textextenty100mm"></a>戻り値 - textExtentY100mm
