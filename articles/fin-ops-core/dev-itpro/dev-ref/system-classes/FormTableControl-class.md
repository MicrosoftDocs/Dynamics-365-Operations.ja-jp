...
### <a name="parameters---cell"></a>パラメーター - cell
...
### <a name="return-value---cell"></a>戻り値 - cell
...
### <a name="parameters---collabel"></a>パラメーター - colLabel

column  

### <a name="return-value---collabel"></a>戻り値 - colLabel
...
### <a name="parameters---editcontrol"></a>パラメーター - editControl
...
### <a name="return-value---editcontrol"></a>戻り値 - editControl
...
### <a name="parameters---rowlabel"></a>パラメーター - rowLabel

 行   

### <a name="return-value---rowlabel"></a>戻り値 - rowLabel
...
### <a name="parameters---setcollabel"></a>パラメーター - setColLabel
...
### <a name="parameters---deleterows"></a>パラメーター - deleteRows
...
### <a name="parameters---deletecols"></a>パラメーター - deleteCols
...
### <a name="parameters---insertrows"></a>パラメーター - insertRows
...
### <a name="parameters---setrowlabel"></a>パラメーター - setRowLabel
...
## <a name="method-updatecell"></a>パラメーター - update

```xpp
public void updateCell(int column, int row)
```

### <a name="parameters---updatecell"></a>パラメーター - updateCell
...
### <a name="parameters---insertcols"></a>パラメーター - insertCols
