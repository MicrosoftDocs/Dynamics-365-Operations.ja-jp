...
| <span data-ttu-id="88395-108">パラメーター</span><span class="sxs-lookup"><span data-stu-id="88395-108">Parameter</span></span> | <span data-ttu-id="88395-109">説明</span><span class="sxs-lookup"><span data-stu-id="88395-109">Description</span></span>                     |
|-----------|---------------------------------|
...
## <a name="any2guid"></a><span data-ttu-id="88395-131">any2Guid</span><span class="sxs-lookup"><span data-stu-id="88395-131">any2Guid</span></span>
...
### <a name="remarks"></a><span data-ttu-id="88395-149">備考</span><span class="sxs-lookup"><span data-stu-id="88395-149">Remarks</span></span>
...
| <span data-ttu-id="88395-155">パラメーター</span><span class="sxs-lookup"><span data-stu-id="88395-155">Parameter</span></span> | <span data-ttu-id="88395-156">説明</span><span class="sxs-lookup"><span data-stu-id="88395-156">Description</span></span>                        |
|-----------|------------------------------------|
...
## <a name="char2num"></a><span data-ttu-id="88395-199">char2Num</span><span class="sxs-lookup"><span data-stu-id="88395-199">char2Num</span></span>
...
| <span data-ttu-id="88395-214">パラメーター</span><span class="sxs-lookup"><span data-stu-id="88395-214">Parameter</span></span> | <span data-ttu-id="88395-215">説明</span><span class="sxs-lookup"><span data-stu-id="88395-215">Description</span></span>          |
|-----------|----------------------|
...
#### <a name="right-to-left-local-settings"></a><span data-ttu-id="88395-274">右から左 (ローカル設定)</span><span class="sxs-lookup"><span data-stu-id="88395-274">Right-to-left local settings</span></span>
...
<span data-ttu-id="88395-287">文字列形式での列挙値。</span><span class="sxs-lookup"><span data-stu-id="88395-287">The value of the enumeration as a string.</span></span>
...
## <a name="int2str"></a><span data-ttu-id="88395-301">int2Str</span><span class="sxs-lookup"><span data-stu-id="88395-301">int2Str</span></span>
...
| <span data-ttu-id="88395-314">パラメーター</span><span class="sxs-lookup"><span data-stu-id="88395-314">Parameter</span></span> | <span data-ttu-id="88395-315">説明</span><span class="sxs-lookup"><span data-stu-id="88395-315">Description</span></span>                       |
|-----------|-----------------------------------|
...
### <a name="parameters"></a><span data-ttu-id="88395-345">パラメーター</span><span class="sxs-lookup"><span data-stu-id="88395-345">Parameters</span></span>
...
-   <span data-ttu-id="88395-374">**4** – スペース ( )、列挙値 ThousandSeparator::Space</span><span class="sxs-lookup"><span data-stu-id="88395-374">**4** – Space ( ), enumeration value ThousandSeparator::Space</span></span>
...
| <span data-ttu-id="88395-383">パラメーター</span><span class="sxs-lookup"><span data-stu-id="88395-383">Parameter</span></span>  | <span data-ttu-id="88395-384">説明</span><span class="sxs-lookup"><span data-stu-id="88395-384">Description</span></span>                                                                                              |
|------------|----------------------------------------------------------------------------------------------------------|
...
## <a name="str2datetime"></a><span data-ttu-id="88395-400">str2Datetime</span><span class="sxs-lookup"><span data-stu-id="88395-400">str2Datetime</span></span>
...
### <a name="remarks"></a><span data-ttu-id="88395-435">備考</span><span class="sxs-lookup"><span data-stu-id="88395-435">Remarks</span></span>
...
## <a name="str2guid"></a><span data-ttu-id="88395-446">str2Guid</span><span class="sxs-lookup"><span data-stu-id="88395-446">str2Guid</span></span>
...
### <a name="return-value"></a><span data-ttu-id="88395-464">戻り値</span><span class="sxs-lookup"><span data-stu-id="88395-464">Return value</span></span>
...
## <a name="str2num"></a><span data-ttu-id="88395-477">str2Num</span><span class="sxs-lookup"><span data-stu-id="88395-477">str2Num</span></span>
...
|--------------|-----------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="88395-506">\_タイム</span><span class="sxs-lookup"><span data-stu-id="88395-506">\_time</span></span>       | <span data-ttu-id="88395-507">**timeOfDay** 値。</span><span class="sxs-lookup"><span data-stu-id="88395-507">A **timeOfDay** value.</span></span>                                                                                                            |
| <span data-ttu-id="88395-508">\_区切り記号</span><span class="sxs-lookup"><span data-stu-id="88395-508">\_separator</span></span>  | <span data-ttu-id="88395-509">**TimeSeparator** は、出力文字列の時、分、秒の間の文字を示す列挙値です。</span><span class="sxs-lookup"><span data-stu-id="88395-509">A **TimeSeparator** enumeration value that indicates the characters between the hours, minutes, and seconds in the output string.</span></span> |
| <span data-ttu-id="88395-510">\_timeFormat</span><span class="sxs-lookup"><span data-stu-id="88395-510">\_timeFormat</span></span> | <span data-ttu-id="88395-511">**TimeFormat** は、12時間制または24時間制のどちらを使用するかを示す列挙値です。</span><span class="sxs-lookup"><span data-stu-id="88395-511">A **TimeFormat** enumeration value that indicates whether a 12-hour clock or a 24-hour clock is used.</span></span>                             |

### <a name="return-value"></a><span data-ttu-id="88395-512">戻り値</span><span class="sxs-lookup"><span data-stu-id="88395-512">Return value</span></span>

<span data-ttu-id="88395-513">指定された時間を表す文字列。</span><span class="sxs-lookup"><span data-stu-id="88395-513">A string that represents the specified time.</span></span>

### <a name="remarks"></a><span data-ttu-id="88395-514">備考</span><span class="sxs-lookup"><span data-stu-id="88395-514">Remarks</span></span>

<span data-ttu-id="88395-515">*\_time* パラメーターの値は、深夜 0 時からの秒数です。</span><span class="sxs-lookup"><span data-stu-id="88395-515">The value of the *\_time* parameter is the number of seconds since midnight.</span></span>

### <a name="example"></a><span data-ttu-id="88395-516">例</span><span class="sxs-lookup"><span data-stu-id="88395-516">Example</span></span>
...
## <a name="uint2str"></a><span data-ttu-id="88395-517">uint2Str</span><span class="sxs-lookup"><span data-stu-id="88395-517">uint2Str</span></span>
<span data-ttu-id="88395-518">整数を文字列に変換します。</span><span class="sxs-lookup"><span data-stu-id="88395-518">Converts an integer to a string.</span></span> <span data-ttu-id="88395-519">整数が符号なしであることを前提としています。</span><span class="sxs-lookup"><span data-stu-id="88395-519">The assumption is that the integer is unsigned.</span></span>

```xpp
str uint2Str(int integer)
```

### <a name="parameters"></a><span data-ttu-id="88395-520">パラメーター</span><span class="sxs-lookup"><span data-stu-id="88395-520">Parameters</span></span>

| <span data-ttu-id="88395-521">パラメーター</span><span class="sxs-lookup"><span data-stu-id="88395-521">Parameter</span></span> | <span data-ttu-id="88395-522">説明</span><span class="sxs-lookup"><span data-stu-id="88395-522">Description</span></span>             |
|-----------|-------------------------|
| <span data-ttu-id="88395-523">integer</span><span class="sxs-lookup"><span data-stu-id="88395-523">integer</span></span>   | <span data-ttu-id="88395-524">変換する整数。</span><span class="sxs-lookup"><span data-stu-id="88395-524">The integer to convert.</span></span> |

### <a name="return-value"></a><span data-ttu-id="88395-525">戻り値</span><span class="sxs-lookup"><span data-stu-id="88395-525">Return value</span></span>

<span data-ttu-id="88395-526">指定された符号なし整数に同等の文字列。</span><span class="sxs-lookup"><span data-stu-id="88395-526">The string equivalent to the specified unsigned integer.</span></span>

### <a name="remarks"></a><span data-ttu-id="88395-527">備考</span><span class="sxs-lookup"><span data-stu-id="88395-527">Remarks</span></span>

<span data-ttu-id="88395-528">レコード ID などの非常に大きな整数の場合は、**int2str** 関数の代わりにこの関数を使用します。</span><span class="sxs-lookup"><span data-stu-id="88395-528">Use this function instead of the **int2str** function for very large integers, such as record IDs.</span></span>
