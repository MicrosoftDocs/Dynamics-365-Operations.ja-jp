---
title: 環境の開始と停止
description: LCS 環境 API を介した Microsoft Dynamics Lifecycle Services (LCS) を通じて、環境の開始および停止をすることができます。
author: jorichar
ms.date: 08/17/2021
ms.topic: reference
...
ms.openlocfilehash: cfcbce25584f9d6ced7ca8617cfdbf06643f7820
ms.sourcegitcommit: 7aa7d756e1e98a53da62e03c608a9597ef9893ea
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 08/20/2021
ms.locfileid: "7404445"
---
# <a name="start-and-stop-environments"></a>環境の開始と停止

[!include [banner](../../../includes/banner.md)]

LCS 環境 API を介した Microsoft Dynamics Lifecycle Services (LCS) を通じて、環境の開始および停止をすることができます。 これらの API を使用することにより、確実に LCS 環境の状態を実際の環境と同期させることができます。 
...
この API を呼び出すには、次のアクセス許可の 1 つが必要です。 アクセス許可およびその選択方法の詳細については、[データベース移動 API の認証](../../../database/api/dbmovement-api-authentication.md)のコンテンツを参照してください。
