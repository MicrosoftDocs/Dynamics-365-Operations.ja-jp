---
title: 稼働停止をレポートする
description: この記事では、Lifecycle Services (LCS) を通じて生産停止を報告する方法について説明します。
...
Lifecycle Services (LCS) には、**レポート生産停止** と呼ばれる機能があります。 この機能は、1 つ以上の Dynamics 365 財務と運用アプリを購入し、LCS に配置された運用環境の実装プロジェクトを持つすべての顧客が使用できます。 この機能は、運用環境のサービスが低下または使用不可能になった場合、Microsoft サポートに問題をエスカレートを迅速かつ有効なチャンネルを提供します。
...
1. 運用環境で、顧客は稼働停止やその他の業務を続行できない状況が発生します。
