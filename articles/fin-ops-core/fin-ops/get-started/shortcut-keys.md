...
| フィルター ペインを開く (すでにフィルタ ウィンドウが開かれている場合、フィルター ペインとメイン ページの間でフォーカスを切り替え) | Alt+M、F または Ctrl+F3       |
...
## <a name="page-shortcuts"></a>ページのショートカット
...
| データの更新                                  | Shift + F5          |
| ページに表示されている最初のフィールドに移動   | Alt + Shift + F       |
| 編集モードの切り替え                              | F2                |
...
| ページを閉じる ([戻る] ボタンを選択)<br><br>**注記:** ポップアップ ウィンドウ (ツールヒント、日付ピッカー、ドロップダウンなど) が開いている場合、Esc を最初に使用するとポップアップが非表示になります。       | Esc               |
| ページを閉じて明示的に保存             | Shift + Esc         |
| ページを閉じて、保存されていない変更を破棄する | Alt + Shift + Q       |

## <a name="page-navigation-shortcuts"></a>ページ ナビゲーションのショートカット
...
-  通常、ボタンを選択すると、アクションが処理され、フォーカスがページに戻る場合があります。 このような場合は、選択したボタン コントロールに戻る必要があります。 これは、アクション ペインまたはツール バーにボタンが位置する場合 **以外** は、財務と運用アプリに当てはまります。 このような場合、アクションが完了すると、ボタンが選択される前にフォーカスがあった \[アクション ペイン\] (またはツール バー) の *外部* の最後のコントロールにフォーカスが戻ります。
