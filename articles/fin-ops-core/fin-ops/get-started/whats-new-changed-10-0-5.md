...
バージョン 10.0.5 には、プラットフォーム更新プログラム 29 が含まれています。 プラットフォーム更新プロフラム 29 についての詳細は、[プラットフォーム更新プログラム 29 (2019 年 10 月) の新機能と変更](whats-new-platform-update-29.md)をご覧ください。
