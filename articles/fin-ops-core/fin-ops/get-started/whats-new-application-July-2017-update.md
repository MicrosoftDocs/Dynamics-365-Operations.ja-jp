---
title: Dynamics 365 Finance、Enterprise edition の新機能および変更された機能 (2017 年 7 月)
description: この記事では、Microsoft Dynamics 365 財務と運用、Enterprise edition (2017 年 7 月) の新機能または変更された機能について説明します。 このバージョンは 2017 年 7 月にリリースされ、ビルド番号は 7.2.11792.56024 です。
author: tonyafehr
ms.date: 11/20/2020
ms.topic: article
ms.prod: ''
...
ms.openlocfilehash: fdf336f7833f2ed0ba7b91a323ffc9085c4106b5
ms.sourcegitcommit: 873d66c03a51ecb7082e269f30f5f980ccd9307f
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/06/2022
ms.locfileid: "9125134"
---
...
倉庫マネージャーとオペレーション マネージャは、重要な入庫、出庫、および在庫の各指標を監視できます。 この機能は、Dynamics 365 財務と運用からの製品および他のトランザクション データを使用して、顧客、仕入先、製品グループ、製品サイト、および倉庫の倉庫パフォーマンスと内訳の両方の集計ビューを提供します。 詳細については、[倉庫パフォーマンス Power BI コンテンツ](../../dev-itpro/analytics/warehouse-power-bi-content.md) を参照してください。
...
- [AX 2012 から財務と運用へのアップグレード](../../dev-itpro/migration-upgrade/upgrade-overview-2012.md)
...
- [AX 2012 からのアップグレード - サンドボックス環境でのデータ アップグレード](/d365F-O/fin-ops-core/fin-ops/get-started/data-upgrade-self-service)
