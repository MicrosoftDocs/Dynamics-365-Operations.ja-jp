...
> [!NOTE]
> 次の情報が提供されており、それに応じた計画を立てることができます。 バージョン 10.0.13 のリリース スケジュールの詳細については、[サービス更新プログラムの可用性](../../fin-ops/get-started/public-preview-releases.md) を参照してください。

- [KB 4563317] 画像のツールチップは表示されません。
