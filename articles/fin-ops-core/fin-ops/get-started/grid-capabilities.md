...
## <a name="pinned-system-columns"></a>固定されたシステム列
グリッドの左端の部分で、新しいグリッドの行選択列と行ステータス列が固定または凍結されます。 したがって、これらの列がグリッドに含まれている場合、グリッドの水平スクロール位置に関係なく、常にユーザーに表示されます。   
...
-  [KB 4582723] フォームのライフサイクルで後に行われる場合に表示されない表示オプション
