...
description: この記事では、 Dynamics 365 for Operations バージョン 1611 の新機能および変更された機能について説明します。
author: sericks007
ms.date: 10/15/2019
ms.topic: article
ms.prod: ''
...
この記事では、 Dynamics 365 for Operations バージョン 1611 の新機能および変更された機能について説明します。
