...
採用プロジェクトには、空いている職位を宣伝するために **従業員セルフ サービス** ページで使用される **ジョブ広告** が含まれています。 従業員に空きを表示するには、採用プロジェクトに、**ジョブ広告** の値が含まれており、**従業員セルフ サービスに表示** フィールドが **はい** に設定され、**申請の期限** フィールドが未来の日付になっており、採用プロジェクトが **開始済** の **プロジェクトの状態** になっている必要があります。 次の表は、可能な採用プロジェクトの状態と説明を示します。
...
申請者とは、企業内で就職を希望する者のことです。 申請者は、組織内のすべての法人間で共有されます。 したがって、検索する人材の大きなプールがあります。 申請者の能力、照会先、宿舎施設のリクエスト、および個人情報を管理できます。 申請者レコードを作成すると、その申請者の人物のレコードはグローバル アドレス帳で作成されます。 **申請者** ページを使用して、申請者に対して次のグローバル アドレス帳情報を更新できます。
...
申請の対応状況により、申請を提出した申請者と連絡するために使用するドキュメントまたはメール テンプレートが決まります。 対応するアクションと **申請ブックマーク** を関連付けて、申請者との連絡時に、**申請**、**申請者**、**面接**、**採用プロジェクト** ページの値を使用することができます。 対応するアクションに合わせて作成できる **申請用メール テンプレート** で、特定のステータスや対応するアクションの特定の組み合わせがある申請者に簡単にメールを送信できます。 たとえば、**ステータス** が **受取済** および **対応するアクション** が **受信済** のすべての申請に確認メールを送信できます。 メール送信後、申請のステータスを自動更新するオプションがあります。
