...
2. [新規] をクリックします。
3. [けが/病気のタイプ] フィールドで、値を入力します。
    * 例: 挫傷  
4. [説明] フィールドに値を入力します。
    * 例 : 骨折  
5. [身体部位] タブをクリックします。
6. [新規] をクリックします。
7. [身体部位] フィールドに値を入力します。
    * 例 : 手首  
8. [説明] フィールドに値を入力します。
    * 例 : 手首  
9. [処置のタイプ] タブをクリックします。
10. [新規] をクリックします。
11. [処置のタイプ] フィールドに値を入力します。
    * 例: そえ木  
12. [説明] フィールドに値を入力します。
    * 例 : そえ木を当てる  
13. [コスト タイプ] タブをクリックします。
14. [新規] をクリックします。
15. [コスト タイプ] フィールドに値を入力します。
    * 例 : X線  
16. [説明] フィールドに値を入力します。
    * 例 : X線  
17. [結果タイプ] タブをクリックします。
18. [新規] をクリックします。
19. [結果タイプ] フィールドに値を入力します。
    * 例 : 療法  
20. [説明] フィールドに値を入力します。
    * 例 : 理学療法  
21. [重要度レベル] タブをクリックします。
