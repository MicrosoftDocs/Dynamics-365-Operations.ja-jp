...
ms.openlocfilehash: 8c613a76387bb37cae93428d9f01609f30ad9940
ms.sourcegitcommit: 52b7225350daa29b1263d8e29c54ac9e20bcca70
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 06/03/2022
ms.locfileid: "8910304"
---
...
- **ドキュメント管理パラメーター** ページの、**一般** タブで、**新しいウィンドウで添付ファイルを開く** オプションを使用して、添付ファイルを所定の場所で開くか、新しいウィンドウまたはタブで開くかを決定します。これにより、添付ファイルを開いたときに財務と運用のユーザー セッションがリセットされるのを防ぐことができるため、特に添付ファイルの格納に SharePoint を使用している場合は、このオプションを有効にすることを考慮する必要があります。 このオプションは、バージョン 10.0.23 以降で使用できることに注意してください。 
