...
オリジナルの元伝票が計算と異なる税額を表示している場合、転記前にこれらの金額を調整できます。 このタスクでは、USMF というデモ会社を使用します。
...
11. [相殺勘定] フィールドで、任意の値を指定します。
12. [売上税] をクリックします。
13. [実際の売上税の合計金額] フィールドに、数値を入力します。
14. [OK] をクリックします。
15. [保存] をクリックします。
16. [売上税] をクリックします。
17. [調整] タブで、売上税コードごとに売上税金額を調整できます。
18. [計算上の金額から実績をリセット] をクリックします。
19. [OK] をクリックします。
20. [保存] をクリックします。
