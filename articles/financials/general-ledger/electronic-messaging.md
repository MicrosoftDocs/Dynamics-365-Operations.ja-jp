...
- メッセージ項目として、データ ソースからの情報を収集し処理します。 データソースは Finance and Operations テーブルです。
...
- 必要に応じて、Web サービスからの応答の受信、応答の解釈、Finance and Operations のデータの更新を行います。
