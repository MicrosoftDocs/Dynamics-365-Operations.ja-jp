...
- <strong>請求書の合計の支払</strong> – <strong>負の支払の削除</strong>オプションで<strong>あり</strong>が設定され、仕入先に未決済の請求書や支払がある場合、未決済の請求書や支払が支払対象として選択され、金額を合算して合計支払額にします。 唯一の例外は、合計が払戻になった場合に発生します。 この場合、請求書も支払も選択されません。 <strong>負の支払の削除オプションで**削除オプション**でなし</strong>が選択され、請求書や支払が未決済の場合、請求書と支払の両方が選択され、金額を合算して合計支払額にします。
...
エイプリルは **期日別** を提案タイプとして選択します。 日付の範囲に、6 月 26 日から 7 月 10 日までを入力します。 次の請求書が提案に含まれます。
