...
2. トランザクションを持つ仕入先を選択してから、**仕入先 \> トランザクション**を選択します。
3. トランザクションを選択して、調査します。
4. アクション ウィンドウの**決済の表示**タブを選択します。

    **決済の表示**ダイアログ ボックスは、選択したトランザクションとそれに対して決済されるすべてのドキュメントを開き表示します。 このダイアログ ボックスは、決済履歴の表示と似ていますが、関連するすべてのドキュメントが含まれています。
