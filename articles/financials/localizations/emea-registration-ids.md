...
次の表に、Finance および Operations でサポートされている登録タイプを示します。 登録 ID について Microsoft Dynamics AX 2012 のフィールドで使い慣れている場合、この表を使って Finance and Operations の登録カテゴリにそれらのフィールドをマップします。
...
| 調査されていません                                                  | スペイン             | AX 2012 R3 では使用できません|
