...
WBS の作成は、通常、長期にわたって実施される、さまざま人からのコラボレーションや情報を必要とする、集中的なプロセスです。 このトピックでは、見積もりと追跡の要件を満たす Microsoft Dynamics 365 for Finance and Operations の WBS 拡張機能の使用方法について説明します。
...
Finance and Operations には、プロジェクトに関する WBS の 3 つのビュー : 計画ビュー、工数追跡ビュー、および原価追跡ビューがあります。
