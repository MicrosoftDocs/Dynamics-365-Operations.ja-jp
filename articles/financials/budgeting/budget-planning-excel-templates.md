...
> [!NOTE] 
> Excel を使用した予算計画データの表示および編集で起こる可能性のある問題を回避するには、同じユーザーが、Microsoft Dynamics 365 for Finance and Operations および Microsoft Dynamics Office アドインのデータ コネクタの両方にログインする必要があります。
