...
- 領収書の写真を撮り、Microsoft Dynamics 365 for Finance and Operations にアップロードします。 その後にユーザーはその写真を経費精算書に添付できます。
...
Microsoft Dynamics 365 for Finance and Operations を使用している場合は、これらの機能を使用することもできます:
