...
[Microsoft Dynamics AX 製品チームのブログ](https://blogs.msdn.microsoft.com/dax/)には、現金および銀行管理に関する多くの投稿があります。 これらの投稿の一部は現金および銀行管理の以前のバージョンに関して書かれていますが、現在のバージョンでも同じ概念を適用でき、手順も類似しています。
