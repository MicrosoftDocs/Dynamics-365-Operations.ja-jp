...
12. [対象に含めるレコード] で追加のクエリの制限を入力します。
    * 一般に、フィルターは、仕入先グループまたは支払方法により支払に対して選択される請求書を制限するために使用します。 たとえば、この支払を行った際の小切手で支払った請求書のみに制限するフィルターを追加できます。  
...
28. 生成する支払の支払方法を選択します。
    * 支払仕訳帳には、小切手と電子支払の両方の支払が含まれますが、一度に 1 つの支払タイプのみが生成できます。  
