...
ms.locfileid: "6345479"
---
# <a name="year-end-activities-faq"></a>年度末の活動に関するよく寄せられる質問 

[!include [banner](../includes/banner.md)]

このトピックは、年度末締処理の活動を支援するためにまとめられています。 このトピックの情報は、主に一般会計と買掛金勘定の年度末締処理に関する質問に焦点を当てています。
...
 
## <a name="general-ledger--what-does-the-period-close--year-end-close-do"></a>一般会計 – 決算期間 – 年度末決算では、何が行われますか。
