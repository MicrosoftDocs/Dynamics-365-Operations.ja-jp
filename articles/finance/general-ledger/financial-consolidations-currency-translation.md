...
description: この記事では、一般会計での財務連結と為替換算について説明します。
author: jinniew
ms.date: 10/07/2021
ms.topic: overview
ms.prod: ''
...
この記事では、Microsoft Dynamics 365 Finance および Financial Reporting の両方が連結のために使用するアプローチについて説明します。 複数の会社のレポート、集計、削除、および少数株主持分に関連するシナリオについて説明します。 異なる会計年度期間、またはさまざまな勘定科目表がある法人のシナリオなどの、特殊な状況を処理する方法についても説明します。

この記事は、ユーザーおよび機能コンサルタントのために作成されており、読者が財務および財務諸表に関する一般的な知識を持っていることを前提としています。 基本設定は対象外です。

> [!NOTE]
> *法人* という用語は財務で使用され、*会社* という用語は財務諸表で使用します。 これらの用語の両方がこの記事で使用されます。 ただし、この記事の目的上、それらの用語の意味は同じです。
