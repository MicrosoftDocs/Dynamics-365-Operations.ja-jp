...
この機能により、通貨交換による損益を明確にする会計項目が追加されます。 消費税の精算時に再評価を行う際には、実現通貨調整の損益勘定で入力します。 詳細については、このトピックの後半の [レポート通貨での税決済の自動残高](#tax-settlement-auto-balance-in-reporting-currency)を参照してください。
