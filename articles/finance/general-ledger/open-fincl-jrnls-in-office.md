...
description: この記事では、Microsoft Excel テンプレートを使用してカスタム財務仕訳帳を作成するときに発生する可能性がある問題について説明します。
author: kweekley
ms.date: 05/14/2021
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "8896350"
---
# <a name="open-financial-journal-templates-in-office"></a>Office で財務仕訳帳テンプレートを開く

[!include [banner](../includes/banner.md)]

この記事では、Microsoft Excel テンプレートを使用してカスタム財務仕訳帳を作成するときに発生する可能性がある問題について説明します。
