...
description: この記事では、一般仕訳帳明細行のさまざまなタイプの勘定 (仕入先、顧客、元帳、およびプロジェクト) に対する消費税がどのように計算されるかについて説明します。
author: EricWangChen
ms.date: 02/16/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8845290"
---
# <a name="sales-tax-calculation-on-general-journal-lines"></a>一般仕訳帳明細行での消費税計算
[!include [banner](../includes/banner.md)]

この記事では、一般仕訳帳明細行のさまざまなタイプの勘定 (仕入先、顧客、元帳、およびプロジェクト) に対する消費税がどのように計算されるかについて説明します。
