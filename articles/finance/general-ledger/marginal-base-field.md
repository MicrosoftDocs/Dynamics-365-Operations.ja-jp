...
description: この記事では、フィールドの基準金額および計算方法の値が、どのように販売および購買トランザクションの税率を決定するかについて説明します。
author: kailiang
ms.date: 10/26/2017
ms.topic: article
ms.prod: ''
