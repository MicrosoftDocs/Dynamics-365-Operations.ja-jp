...
description: この記事では、自動化された回収プロセスに影響を与えるパラメーターについて説明し、自動化されたプロセスが顧客の意図や期待を反映するように設定するガイダンスを提供します。
...
この記事では、自動化された回収プロセスに影響を与えるパラメーターについて説明し、自動化されたプロセスが顧客の意図や期待を反映するように設定するガイダンスを提供します。 回収プロセスを自動化する方法については、[回収プロセスの自動化](collections-process-automate.md)を参照してください。
