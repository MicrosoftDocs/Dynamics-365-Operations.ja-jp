...
- **請求書の合計と登録された合計が等しくありません。** 請求書を送信したユーザーに、合計が一致していないという警告が表示されます。 この警告により、ユーザーは、ワークフロー システムに請求書を再送信する前に残高を修正できます。 この機能は、**機能管理** ページの **請求書の合計と登録済請求書の合計が一致しない場合に、ワークフローへの送信を禁止します** パラメーターと **買掛金勘定パラメーター** ページの **請求と登録済合計が一致しない場合のワークフロー オプション** パラメーターが有効になっている場合のみ使用できます。 
- **請求書には未配賦の料金が含まれます。** 請求書を送信したユーザーに、請求書に未配賦の料金があるという警告が表示されます。 これにより、ユーザーは請求書を修正してからワークフロー システムに再送信することができます。 この機能は、**機能管理** ページの **仕入先請求書に配賦されていない費用がある場合は、ワークフローへの送信を禁止する** パラメーターと **買掛金勘定パラメーター** ページの **未配賦費用が存在する場合のワークフロー オプション** が有効になっている場合に使用できます。
- **請求書には、別の転記済請求書と同じ請求書番号が含まれています。** 請求書を送信したユーザーに、重複する番号ある請求書が見つかったという警告が表示されます。 ユーザーは重複する番号を修正してから請求書をワークフロー システムに再送信することができます。 この警告は、買掛金勘定の **使用されている請求書番号の確認** パラメータが **複製の禁止** に設定されている場合に表示されます。 この機能は、**機能の管理** ページで **請求書番号が転記済みの請求書にすでに存在し、システムが重複した請求書番号を受け入れるように設定されていない場合に、ワークフローへの送信を禁止する** のパラメーターが有効になっている場合に使用できます。
- **請求書には、請求数量が照合された製品受領書の数量より少ない明細行が含まれています。** 請求書の送信または転記を試みたユーザーに、数量が等しくないというメッセージが表示されます。 このメッセージにより、ユーザーは、ワークフロー システムに請求書を再送信する前に値を修正できます。 この機能は、**機能管理** ページの **ワークフローへの仕入先請求書の転記と送信のブロック** パラメーターが有効で、**買掛金勘定パラメーター** ページの **ワークフローへの転記と送信のブロック** が有効になっている場合に使用できます。
