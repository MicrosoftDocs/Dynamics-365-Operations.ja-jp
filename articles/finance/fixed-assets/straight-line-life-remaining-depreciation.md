...
**_償却年_*_フィールドで **カレンダー** を選択すると、会計カレンダーを別に定義した場合でも、1 年は 1 月 1 日から 12 月 31 日までとみなされます。_* カレンダー** オプション を使用すると、毎年 1 月 1 日に償却基礎額が更新されます。 通常、償却基礎額は、正味簿価額から救済価格を差し引いた額です。 この記事の後の例では、計算列の最初の式の分子が減価償却基準です。 償却年として **暦年** を選択すると、**期間の頻度** フィールドで次のオプションが使用できます。
