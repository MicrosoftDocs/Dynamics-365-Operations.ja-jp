---
title: 耐用年数残減価償却
description: このトピックは、減価償却の定額法残余耐用年数の概要を示します。
author: moaamer
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8726700"
---
# <a name="straight-line-life-remaining-depreciation"></a>耐用年数残減価償却

[!include [banner](../includes/banner.md)]

このトピックは、減価償却の定額法残余耐用年数の概要を示します。
