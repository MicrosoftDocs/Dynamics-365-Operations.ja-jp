---
title: 分析コード階層
description: この記事では、分析コード階層について説明します。 分析コード階層を使用して、原価会計のレポート構造、コスト ポリシー、およびセキュリティ設定を定義します。
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8848638"
---
# <a name="dimension-hierarchy"></a>分析コード階層

[!include [banner](../includes/banner.md)]

この記事では、分析コード階層について説明します。 分析コード階層を使用して、原価会計のレポート構造、コスト ポリシー、およびセキュリティ設定を定義します。  
