...
10. **OK** をクリックします。
11. **品目番号グループ** フィールドで、値を入力または選択します。
...
2. **銀行番号** フィールドに値を入力します。
    * 計算された **利益幅** と **経費** ィールドの値を確認します。  
3. **OK** をクリックします。
4. **アクション** セクションを展開します。
    * 「銀行から受信」レコードを確認します。  
5. クリックして、**仕訳帳バッチ番号** フィールドのリンク先を表示します。
6. **行** をクリックします。
    * 仕訳入力の転記を確認します。  
7. ページを閉じます。
...
15. クリックして、**仕訳帳バッチ番号** フィールドのリンク先を表示します。
16. **行** をクリックします。
    * 転記済みの仕訳入力を確認します。  
...
14. クリックして、**仕訳帳バッチ番号** フィールドのリンク先を表示します。
15. **行** をクリックします。
    * 転記済みの仕訳入力を確認します。  
16. ページを閉じます。
