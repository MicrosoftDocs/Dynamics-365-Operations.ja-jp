...
13. ページを閉じます。
14. **アクション ウィンドウ** で、**明細行** をクリックします。 **明細行** を開くと、**顧客支払の入力** のページに記録した支払と、仕訳帳に保存した支払がすべて表示されます。 また、このページを使用すると、転記の前に新しい顧客支払を入力したり、既存の顧客支払を編集したりすることもできます。
