...
<*支払い予測を日付に変換する方法について、Jarek または Dave が提供するテキストが必要です*> 請求書残高の支払日は、支払予測から概算で[*見積もる*] ことができます。これを行うには、予測されたバケットの確率から得られる累積分布関数の 50 ％ に対応する日付を選択します。
