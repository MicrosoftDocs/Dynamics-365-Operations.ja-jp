---
title: 機械学習モデルの結果
description: この記事では、機械学習 (ML) モデルの混乱マトリックス、分類に関する問題、および正確性について説明します。 ML の予測結果の正確性について理解を深めることを目的としています。
...
ms.locfileid: "8910174"
---
# <a name="results-of-machine-learning-models"></a>機械学習モデルの結果
...
この記事の[モデルの精度](#model-accuracy)セクションでは、次の 2 つの混乱マトリックスを比較しています。 1 つ目のモデルでは精度が低かったにもかかわらず、定時払いの既定の推測よりも改善が見られたため、より有用なモデルと判断されました。
