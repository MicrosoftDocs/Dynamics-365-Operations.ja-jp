...
- [資金の説明責任に関する日次計算書](https://docs.microsoft.com/dynamics365-release-plan/2020wave1/dynamics365-finance/daily-statement-treasurers-accountability)
 ...
 - [イタリアの拡張ローカライズ: 梱包明細行での販売請求書明細行の並べ替え](https://docs.microsoft.com/dynamics365-release-plan/2020wave1/dynamics365-finance/extended-italian-localization-sales-invoice-lines-sorting-packing-slips)
 
 - [イタリアのローカライズの拡張: イントラスタット申告でのキログラムあたりの雑費](https://docs.microsoft.com/dynamics365-release-plan/2020wave1/dynamics365-finance/extended-italian-localization-miscellaneous-charges-per-kilogram-intrastat-declaration)
 
 - [イタリアの拡張ローカリゼーション: 銀行口座の設定の拡張](https://docs.microsoft.com/dynamics365-release-plan/2020wave1/dynamics365-finance/extended-italian-localization-bank-account-setup-enhancement)
 
 - [イタリアの拡張ローカライズ: 金額がゼロの請求書の転記](https://docs.microsoft.com/dynamics365-release-plan/2020wave1/dynamics365-finance/extended-italian-localization-posting-invoices-zero-amount)
 
 - [イタリアの拡張ローカライズ: 高度なメモ管理](https://docs.microsoft.com/dynamics365-release-plan/2020wave1/dynamics365-finance/extended-italian-localization-advanced-notes-management)

- [イタリアの拡張ローカリゼーション: 借方/貸方の照会の改善](https://docs.microsoft.com/dynamics365-release-plan/2020wave1/dynamics365-finance/extended-italian-localization-improved-inquiry-debitcredit)

- [イタリアの拡張ローカリゼーション: 無料で配送される商品の税金請求書](https://docs.microsoft.com/dynamics365-release-plan/2020wave1/dynamics365-finance/extended-italian-localization-tax-invoice-goods-delivered-free)

- [スイスの拡張ローカリゼーション: QR-bill 実装](https://docs.microsoft.com/dynamics365-release-plan/2020wave1/dynamics365-finance/extended-swiss-localization-qr-bill-implementation)

- [フランスの拡張ローカリゼーション: 国際支払と財務振替のための ISO 20022 形式](https://docs.microsoft.com/dynamics365-release-plan/2020wave1/dynamics365-finance/extended-french-localization-iso20022-format-international-payment-treasury-transfer)
