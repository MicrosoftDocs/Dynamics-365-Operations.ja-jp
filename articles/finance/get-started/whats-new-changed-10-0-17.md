---
title: Dynamics 365 Finance 10.0.17 (2021 年 4 月) の新機能および変更された機能
description: この記事では、Dynamics 365 Finance バージョン 10.0.17 プレビュー リリースの新機能または変更された機能について説明します。
author: kfend
ms.date: 01/25/2021
ms.topic: article
ms.prod: ''
...
この記事では、Microsoft Dynamics 365 Finance バージョン 10.0.17 の新機能または変更された機能について説明します。 このバージョンには 10.0.761 のビルド番号が含まれており、次のように使用できます。

- **プレビュー リリース:** 2021 年 2 月
- **一般提供 (自己更新):** 2021 年 3 月
- **一般提供 (自動更新) :**  2021 年 4 月
...
Dynamics 365 Finance 10.0.17 には、プラットフォーム更新プログラムが含まれています。 詳細については、[財務と運用アプリのバージョン 10.0.17 のプラットフォーム更新プログラム](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-17.md) を参照してください。 
