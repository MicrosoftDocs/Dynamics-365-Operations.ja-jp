...
ms.openlocfilehash: 340b1207900edfbf3ee6f7fe8d873a8264c1637c
ms.sourcegitcommit: 52b7225350daa29b1263d8e29c54ac9e20bcca70
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 06/03/2022
ms.locfileid: "8883198"
---
...
| (インド) 輸出請求書に対する貸方票/借方票の有効化 | 2021/9/1 | 2020/6/24 | 既定で有効 | 税 |
...
| (インド) 輸出請求書に対する貸方票/借方票の有効化 | この機能を使用すると、転記された輸出請求書に対して貸方票または借方票を発行できます。 貸方票または借方票は、一般仕訳帳、自由書式の請求書、または輸出販売注文を使用して発行できます。 貸方票または借方票をエクスポートする異なる番号順序は、**GST 参照番号順序グループ** ページで設定する必要があります。 出荷請求書番号と日付は、参照用の貸方表または借方表に記録できます。 |
...
| 発注書貸方伝票における請求日の消費税率 | この機能により、**計算日タイプ** フィールドが総勘定元帳パラメーターで **文書日付** に設定されている場合に、発注書貸方伝票の元の請求日に基づいて消費税率が決定されます。 |
