...
description: この記事では、Dynamics 365 Finance バージョン 10.0.12 プレビュー リリースの新機能または変更された機能について説明します。
author: kfend
ms.date: 05/20/2020
ms.topic: article
ms.prod: ''
...
ms.openlocfilehash: bfee4430915f7fad721a8407ea848d2b1fe1df63
ms.sourcegitcommit: 52b7225350daa29b1263d8e29c54ac9e20bcca70
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 06/03/2022
ms.locfileid: "8877962"
---
...
この記事では、Microsoft Dynamics 365 Finance バージョン 10.0.12 の新機能または変更された機能について説明します。 このバージョンには 10.0.507 のビルド番号が含まれており、次のように使用できます。
