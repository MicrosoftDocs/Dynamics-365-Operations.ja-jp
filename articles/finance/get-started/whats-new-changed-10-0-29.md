...
ms.openlocfilehash: 24a050274aa2a8288df08f486446b76e4b150218
ms.sourcegitcommit: 91f58a9863f4e8f30ac787c2a9771c1ff6a05f72
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 08/03/2022
ms.locfileid: "9224254"
---
...
| グローバリゼーション | 電子請求サービス - フランス電子請求書と Chorus Pro の統合 | コンフィギュレーション可能な電子請求サービスは、フランスの Chorus Pro との統合をサポートしており、PEPPOL UBL Biz 3 形式の電子請求書を Chorus Pro プラットフォームへ自動送信することが可能です。 | パラメーター |
| グローバリゼーション | 電子請求サービス - コンフィギュレーション可能なポーランドの請求書および統合 | コンフィギュレーション可能な電子請求サービスでは、ポーランド当局が法的に要求する形式で、電子請求書を生成して送信することができます。 | パラメーター |
