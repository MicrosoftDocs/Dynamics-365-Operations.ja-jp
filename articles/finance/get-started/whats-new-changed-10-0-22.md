...
description: この記事では、Dynamics 365 Finance バージョン 10.0.22 プレビュー リリースの新機能または変更された機能について説明します。
author: kfend
ms.date: 09/03/2021
ms.topic: article
ms.prod: ''
...
ms.openlocfilehash: 38a63e92e2d9a9a5d5fe0929ee35f15d97bdd7c9
ms.sourcegitcommit: 28a726b3b0726ecac7620b5736f5457bc75a5f84
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 06/29/2022
ms.locfileid: "9067082"
---
# <a name="preview-features-in-dynamics-365-finance-10022-november-2021"></a>Dynamics 365 Finance 10.0.22 (2021 年 11 月) のプレビュー機能

[!include [banner](../includes/banner.md)]

この記事では、Microsoft Dynamics 365 Finance バージョン 10.0.22 の新機能または変更された機能について説明します。 このバージョンには 10.0.995 のビルド番号が含まれており、次のように使用できます。
...
Dynamics 365 Finance 10.0.22 には、プラットフォーム更新プログラムが含まれています。 詳細については、[財務と運用アプリのバージョン 10.0.22 のプラットフォーム更新プログラム](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-22.md) を参照してください。 
