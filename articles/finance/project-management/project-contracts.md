...
この記事では、さまざまな種類のプロジェクトや資金調達ソースで作成できるプロジェクト契約について、また契約を管理しプロジェクト顧客に請求する方法についての説明と例を提供します。
...
Dynamics 365 Finance では、1 つのトランザクションまたはプロジェクト全体の請求を複数の顧客、付与、または組織の間で分割できます。 
