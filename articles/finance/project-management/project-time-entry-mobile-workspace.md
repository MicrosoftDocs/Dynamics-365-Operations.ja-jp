...
Finance を組織に配置している場合、システム管理者は**プロジェクト時間の入力**モバイル ワークスペースを公開する必要があります。 手順については、「[モバイル ワークスペースの公開](../../dev-itpro/mobile-apps/publish-mobile-workspace.md)」を参照してください。
