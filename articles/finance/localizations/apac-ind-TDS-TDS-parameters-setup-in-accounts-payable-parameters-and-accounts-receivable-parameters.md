...
description: この記事では、源泉徴収税 (TDS) 控除をサポートするために買掛金勘定と売掛金勘定のパラメータを設定する方法について説明します。
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
