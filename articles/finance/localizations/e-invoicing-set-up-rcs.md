...
description: このトピックでは、Regulatory Configuration Service (RCS) を設定する方法について説明します。
author: dkalyuzh
ms.date: 02/09/2022
ms.topic: article
ms.prod: ''
