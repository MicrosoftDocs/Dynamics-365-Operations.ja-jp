...
4. **Ward 番号** フィールドに、TDS 当局の Ward 番号を入力します。
5. **課税担当者** フィールドに、TDS 当局の課税担当者の詳細を入力します。
6. **控除担当者のタイプ** フィールドで、法人の控除担当者タイプ カテゴリを選択します。
