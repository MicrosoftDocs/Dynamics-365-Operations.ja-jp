---
title: 税計算サービスから Dynamics 365 Finance に税務設定を同期する
description: このトピックでは、税計算サービスからMicrosoft Dynamics 365 Finance に税設定マスターデータを同期する方法について説明します。
author: wangchen
ms.date: 01/05/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "7965142"
---
# <a name="sync-the-tax-setup-from-the-tax-calculation-service-to-dynamics-365-finance"></a>税計算サービスから Dynamics 365 Finance に税務設定を同期する

[!include [banner](../includes/banner.md)]

このトピックでは、税計算サービスからMicrosoft Dynamics 365 Finance に税設定マスターデータを同期する方法について説明します。
