...
description: この記事では、Dynamics 365 Supply Chain Management から Dynamics 365 Field Service に在庫調整と振替を同期させるために使用されるテンプレートと基本的なタスクについて説明します。
author: Henrikan
ms.date: 04/30/2019
ms.topic: article
ms.prod: ''
...
この記事では、Dynamics 365 Supply Chain Management から Dynamics 365 Field Service に在庫調整と振替を同期させるために使用されるテンプレートと基本的なタスクについて説明します。
...
[![データ統合のテンプレート マッピング、在庫調整 (Field Service から Supply Chain Management): 在庫調整。](./media/FSAdj1.png)](./media/FSAdj1.png)
...
[![データ統合のテンプレート マッピング、在庫移動 (Field Service から Supply Chain Management): 在庫移動。](./media/FSTrans1.png)](./media/FSTrans1.png)
