...
- 倉庫管理モバイル アプリを使用した販売および移動オーダーの倉庫作業の処理 (補充作業を含む)
- 倉庫管理モバイルアプリを使用した手持在庫の照会
- 倉庫管理モバイル アプリを使用した在庫移動の作成と実行
- 倉庫管理モバイル アプリを使用した発注書の登録と、プットアウェイの処理
...
| テンプレートによる移動                               | あり | あり                          |
| 倉庫間の移動                                 | あり | なし                           |
| 倉庫管理モバイル アプリからの移動オーダーの作成           | あり | なし                           |
| 調整 (入/出)                                | あり | なし                           |
| 在庫状態の変更                            | あり | なし                           |
| 循環棚卸と不一致計算の処理 | あり | なし                           |
