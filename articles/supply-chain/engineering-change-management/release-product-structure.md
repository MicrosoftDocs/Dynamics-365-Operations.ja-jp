---
title: リリース製品構造
description: この記事では、製品をエンジニアリング バージョンと共にリリースすることに加えて、完全な製品構造をリリースする方法について説明します。 このようにして、エンジニアリングに関連する製品データを、異なる法人で簡単に再利用できるようにすることができます。
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
...
| 製造タイプ | このフィールドは、システムで [フォーミュラ変更管理](manage-formula-changes.md) を有効にした場合にのみ表示されます。 このリリース ポリシーが適用される生産のタイプを選択します:<ul><li>**連産品** – このリリース ポリシーを使用して、連産品を管理します。 連産品はプロセス製造中に生産され、バージョン管理された製品やエンジニアリング製品ではありません。 連産品のリリース ポリシーを使用すると、**保管分析コード グループ** や **追跡用分析コード グループ** などの重要な設定を会社にリリースする前に、リリース済製品テンプレートを使用して設定することができます。</li><li>**副産物** – このリリース ポリシーを使用して、副産物を管理します。 副産物はプロセス製造中に生産され、バージョン管理された製品やエンジニアリング製品ではありません。 副産物のリリース ポリシーを使用すると、**保管分析コード グループ** や **追跡用分析コード グループ** などの重要な設定を会社にリリースする前に、リリース済製品テンプレートを使用して設定することができます。</li><li>**なし** – このポリシーを使用して、バージョン管理された製品、エンジニアリング製品、または連産品や副産物ではない標準製品を管理します。</li><li>**計画品目** – このリリース ポリシーは、プロセス製造を使用して生産された計画品目を管理するために使用します。 計画品目ではフォーミュラを使用します。 フォーミュラ品目と似ていますが、完成品ではなく、連産品および副産物の生産にのみ使用されます。</li><li>**BOM** – このリリース ポリシーは、フォーミュラを使用せず、通常 (ただし、必ずしもそうではありません) BOMを含むエンジニアリング製品を管理するために使用します。</li><li>**フォーミュラ** – このリリース ポリシーは、プロセス製造を使用して生産された完成品目を管理するために使用します。 これらの品目にはフォーミュラがありますが、BOM はありません。</li></ul> |
