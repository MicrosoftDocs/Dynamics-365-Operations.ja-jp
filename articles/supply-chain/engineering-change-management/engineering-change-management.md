...
> [!IMPORTANT]
> **生産の通知** ボタンは、システムで *生産に対するエンジニアリングの通知* 機能がで有効になっている場合のみ使用可能です。 手順については、[エンジニアリング変更管理の概要](product-engineering-overview.md)を参照してください。
...
> [!IMPORTANT]
> 製造オーダーの通知を送信する機能は、システムで *生産に対するエンジニアリングの通知* 機能を有効にしている必要があります。 手順については、[エンジニアリング変更管理の概要](product-engineering-overview.md)を参照してください。
