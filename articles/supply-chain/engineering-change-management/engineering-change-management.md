...
description: この記事では、エンジニアリング変更管理に関する情報を提供します。 エンジニアリング変更管理では、提案から、要求、変更、変更のレビュー、承認、既存のトランザクションへの影響の評価、それらに対するフォローアップを行うことまでエンジニアリング製品に対する変更を管理するための体系的なプロセスを提供します。
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
