...
このセクションで説明する機能がシステムにまだ含まれていない場合、[機能管理](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md)に移動して、*エンジニアリング変更管理の属性継承の改善* 機能を有効にします。
