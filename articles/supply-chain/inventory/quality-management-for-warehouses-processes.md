...
description: この記事では、倉庫プロセスの品質管理の機能に関する情報について説明します。 この機能は、品質管理の機能を拡張し、倉庫管理プロセス (WMS) を使用して、品目サンプリングの管理を倉庫の入荷プロセスに統合できるようにします。
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9069245"
---
# <a name="quality-management-for-warehouse-processes"></a>倉庫プロセスに対する品質管理

[!include [banner](../includes/banner.md)]

この _倉庫プロセスの品質管理_ 機能は、倉庫管理プロセス (WMS) を使用して、品目サンプリングの管理を倉庫の入荷プロセスに統合できるようにします。 在庫を品質管理場所に移動するために、割合または固定数量に基づいて、または各 *n* 番目のライセンスプレートに基づいて、倉庫作業を自動的に生成することができます。 品質指示が完了した後、品質結果に応じて、作業を自動的に生成して、プロセスの次の場所に在庫を移動することができます。
...
この設定を完了する方法を示すステップ バイ ステップの例については、この記事の最後にある [シナリオの例](#example-scenario) を参照してください。
...
1. **倉庫** クイック タブで、**倉庫プロセスの品質指示の有効化** オプションを _はい_ に設定します。 (このオプションは、倉庫管理プロセス (WMS) を使用する倉庫に対してのみ、_はい_ に設定できます。)
...
> [!NOTE]
> _倉庫プロセスの品質管理_ 機能が有効になるのは、元伝票の明細行の品目が倉庫管理プロセス (WMS) の詳細設定を使用しており、**倉庫プロセスの品質指示を有効にする** オプションが元伝票の明細行の倉庫で _はい_ に設定されている場合のみです。
...
|---|---|---|---|---|---|---|
| 注文 | フル ライセンス プレート | はい _(ロック / 編集不可)_ | <p>場所: はい</p><p>ライセンスプレート: はい _(ロック / 編集不可)_</p> | なし | 3 | <p>**注文明細行の数量: 100 個**</p><ol><li>倉庫モバイル管理 アプリに、20 EA、 LP1 での受領を登録する<p>20 個の品質品目サンプリング作業</p><p>20 個の品質指示 1</p></li><li>倉庫モバイル管理 アプリに、20 EA、 LP2 での受領を登録する<p>20 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、20 EA、 LP3 での受領を登録する<p>20 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、20 EA、 LP4 での受領を登録する<p>20 個の品質品目サンプリング作業</p></li><li>倉庫モバイル管理 アプリに、20 EA、 LP5 での受領を登録する<p>20 個の発注書作業 (プット アウェイ)</p></li></ol> |
| 注文 | 固定数量 = 1 | 有 | <p>場所: はい</p><p>ライセンス プレート: はい</p> | 無 | 適用できません | <p>**注文明細行の数量: 100**</p><ol><li>倉庫モバイル管理 アプリに、20 EA、 LP1 での受領を登録する<p>1 個の品質品目サンプリング作業</p><p>1 個の品質指示 1</p><p>19 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、20 EA、 LP2 での受領を登録する<p>1 個の品質品目サンプリング作業</p><p>1 個の品質指示 1</p><p>19 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、20 EA、 LP3 での受領を登録する<p>1 個の品質品目サンプリング作業</p><p>1 個の品質指示 1</p><p>19 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、20 EA、 LP4 での受領を登録する<p>1 個の品質品目サンプリング作業</p><p>1 個の品質指示 1</p><p>19 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、20 EA、 LP5 での受領を登録する<p>1 個の品質品目サンプリング作業</p><p>1 個の品質指示 1</p><p>19 個の発注書作業 (プット アウェイ)</p></li></ol> |
| 注文 | パーセント = 10 | 無 | <p>保管場所: いいえ</p><p>ライセンス プレート: いいえ</p> | 無 | 適用できません | <p>**注文明細行の数量: 100 個**</p><ol><li>倉庫モバイル管理 アプリに、50 EA、 LP1 での受領を登録する<p>10 個の品質品目サンプリング作業</p><p>10 個の品質指示 1</p><p>40 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、50 EA、 LP2 での受領を登録する<p>50 個の発注書作業 (プット アウェイ)</p></li></ol> |
| 積載量 | パーセント = 5 | はい _(ロック / 編集不可)_ | <p>保管場所: いいえ</p><p>ライセンス プレート: いいえ</p> | 無 | 該当なし | <p>**注文明細行の数量: 500 個**</p><p>**2 つの積荷: 最初の積荷 200 個、2 番目の積荷 300 個**</p><ol><li>倉庫管理モバイル アプリに、100 EA での最初の積荷の受領を登録する<p>5 個の品質品目サンプリング作業</p><p>5 個の品質指示 1</p><p>95 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理モバイル アプリに、100 EA での最初の積荷の受領を登録する<p>5 個の品質品目サンプリング作業</p><p>5 個の品質指示 1</p><p>95 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理モバイル アプリに、300 EA での2番目の積荷の受領を登録する<p>15 個の品質品目サンプリング作業</p><p>15 個の品質指示 1</p><p>285 個の発注書作業 (プット アウェイ)</p></li></ol> |
| 順序 | パーセント = 10 | あり | <p>場所: はい</p><p>ライセンス プレート: はい</p> | なし | 適用できません | <p>**注文明細行の数量: 100**</p><ol><li>倉庫モバイル管理 アプリに、50 EA、 LP1 での受領を登録する<p>5 個の品質品目サンプリング作業</p><p>5 個の品質指示 1</p><p>45 個の発注書の作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、50 EA、 LP2 での受領を登録する<p>5 個の品質品目サンプリング作業</p><p>5 個の品質指示 1</p><p>45 の発注書の作業 (プット アウェイ)</p></li></ol> |
| 積載 | フル ライセンス プレート | はい _(ロック / 編集不可)_ | <p>場所: はい</p><p>ライセンスプレート: はい _(ロック / 編集不可)_</p> | 無 | 3 | <p>**2 品目:**</p><ul><li>**品目 A の注文明細行の数量: 120 個 (4 パレット)**</li><li>**品目 B の注文明細行の数量: 90 個 (3 パレット)**</li></ul><p>**それぞれ注文明細行を持つ 1 積荷、2 積荷の明細行**</p><ol><li>倉庫モバイル管理 アプリに、品目 A、30 EA、 LP1 での受領を登録する<p>30 個の品質品目サンプリング作業</p><p>30 個の品質指示 1</p></li><li>倉庫モバイル管理 アプリに、品目 A、30 EA、 LP2 での受領を登録する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、品目 A、30 EA、 LP3 での受領を登録する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、品目 A、30 EA、 LP4 での受領を登録する<p>30 個の品質品目サンプリング作業</p><p>30 個の品質指示 1</p></li><li>倉庫モバイル管理 アプリに、品目 B、30 EA、 LP5 での受領を登録する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、品目 B、30 EA、 LP6 での受領を登録する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、品目 A、30 EA、 LP7 での受領を登録する<p>30 個の品質品目サンプリング作業</p><p>30 個の品質指示 1</p></li></ol> |
| 積載 | フル ライセンス プレート | はい _(ロック / 編集不可)_ | <p>場所: はい</p><p>ライセンスプレート: はい _(ロック / 編集不可)_</p> | 有 | 3 | <p>**2 品目:**</p><ul><li>**品目 A の注文明細行の数量: 120 個 (4 パレット)**</li><li>**品目 B の注文明細行の数量: 90 個 (3 パレット)**</li></ul><p>**それぞれ注文明細行を持つ 1 積荷、2 積荷の明細行**</p><ol><li>倉庫モバイル管理 アプリに、品目 A、30 EA、 LP1 での受領を登録する<p>30 個の品質品目サンプリング作業</p><p>30 個の品質指示 1</p></li><li>倉庫モバイル管理 アプリに、品目 A、30 EA、 LP2 での受領を登録する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、品目 A、30 EA、 LP3 での受領を登録する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、品目 A、30 EA、 LP4 での受領を登録する<p>30 個の品質品目サンプリング作業</p><p>30 個の品質指示 1</p></li><li>倉庫モバイル管理 アプリに、品目 B、30 EA、 LP5 での受領を登録する<p>30 個の品質品目サンプリング作業</p><p>30 個の品質指示 1</p></li><li>倉庫モバイル管理 アプリに、品目 B、30 EA、 LP6 での受領を登録する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、品目 A、30 EA、 LP7 での受領を登録する<p>30 個の発注書作業 (プット アウェイ)</p></li></ol> |
| 積載 | パーセント = 10 | はい _(ロック / 編集不可)_ | <p>場所: いいえ</p><p>ライセンス プレート: いいえ</p> | 無 | 該当なし | <p>**注文明細行の数量: 100 個**</p><p>**積荷は作成されていません。注文の範囲が適用されます。**</p><ol><li>倉庫モバイル管理 アプリに、50 EA、 LP1 での受領を登録する<p>5 個の品質品目サンプリング作業</p><p>5 個の品質指示 1</p><p>45 個の発注書の作業 (プット アウェイ)</p></li><li>倉庫モバイル管理 アプリに、50 EA、 LP2 での受領を登録する<p>5 個の品質品目サンプリング作業</p><p>5 個の品質指示 1</p><p>45 個の発注書の作業 (プット アウェイ)</p></li></ol> |

作業者が前の表に示した品質指示のいずれかを検証すると、システムによって品質指示作業が自動的に生成され、品質管理の場所から _品質指示_ の作業順序タイプの場所のディレクティブで定義されている場所に在庫が移動します。 この目的では、品質指示のテスト結果に応じて、返品場所や保管場所など、任意の場所を設定できます。 この設定の例については、この記事の最後にある [シナリオの例](#example-scenario) を参照してください。
