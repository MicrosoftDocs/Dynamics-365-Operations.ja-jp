...
![![品質管理エンティティ](media/quality-management-entity-diagram.png "品質管理エンティティ")](media/quality-management-entity-diagram.png "Quality management entities")
...
1. _品質品目サンプリング_ と _品質指示_ の作業指示タイプに対して別の作業クラスを作成します。 このように、2 つの作業指示書のタイプに基づいて適切な作業を自動的に生成し、この作業を倉庫管理アプリを使用して実行できるようにする必要があります。
...
倉庫プロセス__ の品質管理機能を有効にすると、該当する倉庫タイプが品質関連検索階層の 4 番目の検索グループに論理的に挿入されます。 次の表に、検索階層の論理表記を示します。
...
作業者が倉庫管理アプリを使用して品目を受け取ると、システムが入荷品目ごとに品質関連が設定されているかどうかを検証します。 品質関連が設定されている場合は、その品質関連に対して構成されている品目サンプリング レコードを使用して、品質指示、品質品目サンプリング作業、および発注書の作業をどのように作成するかが決定されます。
...
|---|---|---|---|---|---|---|
| 注文 | フル ライセンス プレート | はい _(ロック / 編集不可)_ | <p>場所: はい</p><p>ライセンスプレート: はい _(ロック / 編集不可)_</p> | 無 | 3 | <p>**注文明細行の数量: 100 個**</p><ol><li>倉庫管理アプリで 20 EA、 LP1 に入庫する<p>20 個の品質品目サンプリング作業</p><p>20 個の品質指示 1</p></li><li>倉庫管理アプリで 20 EA、 LP2 に入庫する<p>20 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 20 EA、 LP3 に入庫する<p>20 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 20 EA、 LP4 に入庫する<p>20 個の品質品目サンプリング作業</p></li><li>倉庫管理アプリで 20 EA、 LP5 に入庫する<p>20 個の発注書作業 (プット アウェイ)</p></li></ol> |
| 注文 | 固定数量 = 1 | 有 | <p>場所: はい</p><p>ライセンス プレート: はい</p> | 無 | 該当なし | <p>**注文明細行の数量: 100**</p><ol><li>倉庫管理アプリで 20 EA、 LP1 に入庫する<p>1 個の品質品目サンプリング作業</p><p>1 個の品質指示 1</p><p>19 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 20 EA、 LP2 に入庫する<p>1 個の品質品目サンプリング作業</p><p>1 個の品質指示 1</p><p>19 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 20 EA、 LP3 に入庫する<p>1 個の品質品目サンプリング作業</p><p>1 個の品質指示 1</p><p>19 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 20 EA、 LP4 に入庫する<p>1 個の品質品目サンプリング作業</p><p>1 個の品質指示 1</p><p>19 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 20 EA、 LP5 に入庫する<p>1 個の品質品目サンプリング作業</p><p>1 個の品質指示 1</p><p>19 個の発注書作業 (プット アウェイ)</p></li></ol> |
| 注文 | パーセント = 10 | 無 | <p>保管場所: いいえ</p><p>ライセンス プレート: いいえ</p> | 無 | 該当なし | <p>**注文明細行の数量: 100 個**</p><ol><li>倉庫管理アプリで 50 EA、 LP1 に入庫する<p>10 個の品質品目サンプリング作業</p><p>10 個の品質指示 1</p><p>40 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 50 EA、 LP2 に入庫する<p>50 個の発注書作業 (プット アウェイ)</p></li></ol> |
| 積載 | パーセント = 5 | はい _(ロック / 編集不可)_ | <p>保管場所: いいえ</p><p>ライセンス プレート: いいえ</p> | 無 | 該当なし | <p>**注文明細行の数量: 500 個**</p><p>**2 つの積荷: 最初の積荷 200 個、2 番目の積荷 300 個**</p><ol><li>倉庫管理アプリで 100 EA の初回入庫をする<p>5 個の品質品目サンプリング作業</p><p>5 個の品質指示 1</p><p>95 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 100 EA の初回入庫をする<p>5 個の品質品目サンプリング作業</p><p>5 個の品質指示 1</p><p>95 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 300 EA の 2 回目の入庫をする<p>15 個の品質品目サンプリング作業</p><p>15 個の品質指示 1</p><p>285 個の発注書作業 (プット アウェイ)</p></li></ol> |
| 注文 | パーセント = 10 | 無 | <p>場所: はい</p><p>ライセンス プレート: はい</p> | 無 | 該当なし | <p>**注文明細行の数量: 100**</p><ol><li>倉庫管理アプリで 50 EA、 LP1 に入庫する<p>5 個の品質品目サンプリング作業</p><p>5 個の品質指示 1</p><p>45 個の発注書の作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 50 EA、 LP2 に入庫する<p>5 個の品質品目サンプリング作業</p><p>5 個の品質指示 1</p><p>45 の発注書の作業 (プット アウェイ)</p></li></ol> |
| 積載 | フル ライセンス プレート | はい _(ロック / 編集不可)_ | <p>場所: はい</p><p>ライセンスプレート: はい _(ロック / 編集不可)_</p> | 無 | 3 | <p>**2 品目:**</p><ul><li>**品目 A の注文明細行の数量: 120 個 (4 パレット)**</li><li>**品目 B の注文明細行の数量: 90 個 (3 パレット)**</li></ul><p>**それぞれ注文明細行を持つ 1 積荷、2 積荷の明細行**</p><ol><li>倉庫管理アプリで 品目 A を 30 EA、 LP1 に入庫する<p>30 個の品質品目サンプリング作業</p><p>30 個の品質指示 1</p></li><li>倉庫管理アプリで 品目 A を 30 EA、 LP2 に入庫する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 品目 A を 30 EA、 LP3 に入庫する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 品目 A を 30 EA、 LP4 に入庫する<p>30 個の品質品目サンプリング作業</p><p>30 個の品質指示 1</p></li><li>倉庫管理アプリで 品目 B を 30 EA、 LP5 に入庫する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 品目 B を 30 EA、 LP6 に入庫する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 品目 A を 30 EA、 LP7 に入庫する<p>30 個の品質品目サンプリング作業</p><p>30 個の品質指示 1</p></li></ol> |
| 積載 | フル ライセンス プレート | はい _(ロック / 編集不可)_ | <p>場所: はい</p><p>ライセンスプレート: はい _(ロック / 編集不可)_</p> | 有 | 3 | <p>**2 品目:**</p><ul><li>**品目 A の注文明細行の数量: 120 個 (4 パレット)**</li><li>**品目 B の注文明細行の数量: 90 個 (3 パレット)**</li></ul><p>**それぞれ注文明細行を持つ 1 積荷、2 積荷の明細行**</p><ol><li>倉庫管理アプリで 品目 A を 30 EA、 LP1 に入庫する<p>30 個の品質品目サンプリング作業</p><p>30 個の品質指示 1</p></li><li>倉庫管理アプリで 品目 A を 30 EA、 LP2 に入庫する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 品目 A を 30 EA、 LP3 に入庫する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 品目 A を 30 EA、 LP4 に入庫する<p>30 個の品質品目サンプリング作業</p><p>30 個の品質指示 1</p></li><li>倉庫管理アプリで 品目 B を 30 EA、 LP5 に入庫する<p>30 個の品質品目サンプリング作業</p><p>30 個の品質指示 1</p></li><li>倉庫管理アプリで 品目 B を 30 EA、 LP6 に入庫する<p>30 個の発注書作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 品目 A を 30 EA、 LP7 に入庫する<p>30 個の発注書作業 (プット アウェイ)</p></li></ol> |
| 積載 | パーセント = 10 | はい _(ロック / 編集不可)_ | <p>場所: いいえ</p><p>ライセンス プレート: いいえ</p> | 無 | 該当なし | <p>**注文明細行の数量: 100 個**</p><p>**積荷は作成されていません。注文の範囲が適用されます。**</p><ol><li>倉庫管理アプリで 50 EA、 LP1 に入庫する<p>5 個の品質品目サンプリング作業</p><p>5 個の品質指示 1</p><p>45 個の発注書の作業 (プット アウェイ)</p></li><li>倉庫管理アプリで 50 EA、 LP2 に入庫する<p>5 個の品質品目サンプリング作業</p><p>5 個の品質指示 1</p><p>45 個の発注書の作業 (プット アウェイ)</p></li></ol> |
...
仕入先 104 に対して、数量 10 の品目 A0001 の発注書が作成されました。 その場合、数量 10 の発注書明細行は、倉庫管理アプリを使用して 1 つのライセンス プレートで受領済として登録されます。 結果を次に示します。
...
1. **倉庫管理 \> 設定 \> 場所のディレクティブ** に移動します。
1. **作業指示書のタイプ** フィールドを _発注書_を選択します。
...
1. 倉庫管理アプリを実行しているモバイル デバイスまたはエミュレーターに移動し、ユーザー ID とパスワードに *1* を使用して、倉庫 *51* にログインします。
