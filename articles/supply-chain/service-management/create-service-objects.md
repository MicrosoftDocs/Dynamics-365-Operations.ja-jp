...
2. ツール バーの **新規** をクリックします。
3. **説明** フィールドに、オブジェクトの説明を入力します。
4. **サービス対象グループ**フィールドで、オブジェクトが属するグループを選択します。 
5. オプション: サービス対象明細行で品目を選択するか、テンプレート部品表 (BOM) を選択します。
