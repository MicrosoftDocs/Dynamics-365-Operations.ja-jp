...
2.  訂正票を作成するサブスクリプション トランザクションに関連付けられているサブスクリプションを選択します。

3.  **分析** タブを選択し、アクション ウィンドウで **手数料トランザクション** ボタンをクリックします。

4.  **手数料トランザクション** フォームから、訂正票を作成するトランザクションを選択します。

5.  **機能** \> **訂正票の選択** の順にクリックします。

6.  **訂正票の選択** フォームで、貸方転記するトランザクションを選択し、**OK** をクリックします。


> [!NOTE]
> <P>訂正票を作成する場合は、必ず<STRONG>訂正票</STRONG>を選択してください。 これは、<STRONG>請求書の作成</STRONG>ダイアログ ボックスの<STRONG>請求方法</STRONG>リストにあります。</P>

**サービス管理パラメーター** フォームの **見越計上を貸方にリバース仕訳** フィールドが **手動** に設定されている場合は、トランザクションの訂正票提案を作成する前に、各未収収益トランザクションを個別に取り消す必要があります。
