...
ジョブ カード デバイスは、バッチ品目に関するレポートのための 3 つのシナリオをサポートします。 これらのシナリオは、倉庫管理プロセス (WMS) で有効になっている品目と、WMS で有効になっていない品目の両方に適用されます。
...
ジョブ カード デバイスは、シリアル管理された品目に関するレポートのための 3 つのシナリオをサポートします。 これらのシナリオは、倉庫管理プロセス (WMS) で有効になっている品目と、WMS で有効になっていない品目の両方に適用されます。
...
倉庫管理プロセス (WMS) では、ライセンス プレート分析コードを使用して、この目的のために設定された倉庫の場所で在庫を追跡できます。 この場合、作業者が完了報告済数量を報告するときに、ライセンス プレート番号が必要になります。
