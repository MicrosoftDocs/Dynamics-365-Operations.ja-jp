...
次の図では、(a) は製品 H およびパーツ F と G の BOM、(b) は製品 H およびパーツ F の工順シートです。

![2 つのレベルでの BOM 構造の例。](media/product-H-part-F.png)
...
![製品 H のエンジニアリング BOM。](media/product-H-part-B.png)
...
![複数レベルの BOM 構造で使用されるファントム明細行タイプ。](media/product-G-route-sheet-G.png)
...
![複数レベルの BOM で使用される工順ネットワークの例。](media/product-G-part-F.png)

次の図では、(a) は製品 G およびパーツ F の BOM、(b) は製品 G およびパーツ F の工順シートです。

![製品 G とパーツ F のBOMと、製品 G とパーツ F の工順シート。](media/product-G-part-F-with-route-sheet.png)
