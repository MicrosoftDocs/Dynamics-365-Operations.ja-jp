...
<span data-ttu-id="5d98d-105">材料消費の計算に関連付けられる次のオプションは、**部品表**ページの**明細行の詳細**クイック タブの**設定**タブおよび**ステップ消費**タブで使用することができます。</span><span class="sxs-lookup"><span data-stu-id="5d98d-105">The following options that are related to the calculation of material consumption are available on the **Setup** and **Step consumption** tabs on the **Line details** FastTab of the **Bill of materials** page.</span></span>

## <a name="variable-and-constant-consumption"></a><span data-ttu-id="5d98d-106">変動消費と定量消費</span><span class="sxs-lookup"><span data-stu-id="5d98d-106">Variable and constant consumption</span></span>
<span data-ttu-id="5d98d-107">[消費量] フィールドで、消費を定数数量または変動数量として計算するかどうかを選択できます。</span><span class="sxs-lookup"><span data-stu-id="5d98d-107">In the **Consumption is** field, you can select whether consumption should be calculated as a constant quantity or a variable quantity.</span></span> <span data-ttu-id="5d98d-108">生産する数量に関係なく、固定の数量や量が生産に必要な場合は、[定量] を選択します。</span><span class="sxs-lookup"><span data-stu-id="5d98d-108">Select **Constant** if a fixed quantity or volume is required for the production, regardless of the quantity that is produced.</span></span> <span data-ttu-id="5d98d-109">完成品での材料の要求数量が生産される完成品の数に比例する場合は、**変動**を選択します。これが既定の設定です。</span><span class="sxs-lookup"><span data-stu-id="5d98d-109">Select **Variable**, which is the default setting, if the required amount of material in the finished goods is proportional to the number of finished goods that are produced.</span></span>
...
### <a name="quantity"></a><span data-ttu-id="5d98d-122">件数</span><span class="sxs-lookup"><span data-stu-id="5d98d-122">Quantity</span></span>

<span data-ttu-id="5d98d-123">丸め方法として**数量**を選択した場合、数量は指定した数量の倍数である必要があります。</span><span class="sxs-lookup"><span data-stu-id="5d98d-123">If you select **Quantity** as the rounding-up mechanism, the quantity must be a multiple of the specified quantity.</span></span> <span data-ttu-id="5d98d-124">たとえば、数量を自然数にする場合は、**倍数**フィールドに「**1**」を指定します。</span><span class="sxs-lookup"><span data-stu-id="5d98d-124">For example, if whole numbers are required, select **1** in the **Multiples** field.</span></span> <span data-ttu-id="5d98d-125">そうすることで、番号は 1 で割り切れる数量に切り上げられます。</span><span class="sxs-lookup"><span data-stu-id="5d98d-125">Numbers are then rounded up to a quantity that is divisible by 1.</span></span>
...
<span data-ttu-id="5d98d-136">消費される管 5 個あたり 0.5 メートルの管が仕損されると仮定します。</span><span class="sxs-lookup"><span data-stu-id="5d98d-136">It's assumed that 0.5 meter of tube is scrapped for every five pieces of tube that are consumed.</span></span>

### <a name="consumption"></a><span data-ttu-id="5d98d-137">消耗</span><span class="sxs-lookup"><span data-stu-id="5d98d-137">Consumption</span></span>

<span data-ttu-id="5d98d-138">原材料を、製品の取り扱い単位の整数倍でピッキングする必要がある場合、通常、丸め方法として**消費**を選択します。</span><span class="sxs-lookup"><span data-stu-id="5d98d-138">Typically, you select **Consumption** as the rounding-up mechanism when raw material must be picked in whole quantities of a specific handling unit of the product.</span></span> <span data-ttu-id="5d98d-139">たとえば、完成品 1 つあたり 2 クオートの塗料が使用され、塗料は 25 クオート缶でピッキングされるとします。</span><span class="sxs-lookup"><span data-stu-id="5d98d-139">For example, 2 quarts of paint are used to produce one piece of a finished good, and the paint is picked in 25-quart cans.</span></span> <span data-ttu-id="5d98d-140">この場合、**消費**の切り上げ方法を使用すると、25 クオート缶の整数倍に消費を切り上げることができます。</span><span class="sxs-lookup"><span data-stu-id="5d98d-140">In this case, the **Consumption** rounding-up mechanism can be used to round up consumption to whole numbers of 25-quart cans.</span></span> <span data-ttu-id="5d98d-141">完成品を 180 個生産する場合に必要な塗料の数量の計算を次に示します。</span><span class="sxs-lookup"><span data-stu-id="5d98d-141">Here is the calculation for the amount of paint that is required if 180 pieces of the finished good must be produced:</span></span>

1.  <span data-ttu-id="5d98d-142">必要な塗料 (仕損を除く): 180 × 2 = 360 クオート</span><span class="sxs-lookup"><span data-stu-id="5d98d-142">Paint that is required, excluding scrap: 180 × 2 = 360 quarts</span></span>
2.  <span data-ttu-id="5d98d-143">缶の数量: 360 ÷ 25 = 14.4、これは 15 に切り上げられます</span><span class="sxs-lookup"><span data-stu-id="5d98d-143">Number of cans: 360 ÷ 25 = 14.4, which is rounded up to 15</span></span>
3.  <span data-ttu-id="5d98d-144">必要な塗料 (仕損を含む): 15 × 25 = 375 クオート</span><span class="sxs-lookup"><span data-stu-id="5d98d-144">Paint that is required, including scrap: 15 × 25 = 375 quarts</span></span>

## <a name="step-consumption"></a><span data-ttu-id="5d98d-145">ステップ消費</span><span class="sxs-lookup"><span data-stu-id="5d98d-145">Step consumption</span></span>
<span data-ttu-id="5d98d-146">ステップ消費を使用すると、数量間隔で定量消費を計算できます。</span><span class="sxs-lookup"><span data-stu-id="5d98d-146">Step consumption is used to calculate constant consumption in quantity intervals.</span></span> <span data-ttu-id="5d98d-147">[設定] タブの [式] フィールドで [ステップ消費] を選択すると、[ステップ消費] タブでステップに関する情報を追加できます。固定消費数量は、生産数量の間隔に設定できます。</span><span class="sxs-lookup"><span data-stu-id="5d98d-147">If you select **Step consumption** in the **Formula** field on the **Setup** tab, you can add information about the steps on the **Step consumption** tab. The fixed consumed quantity can be set up in intervals of the produced quantity.</span></span> <span data-ttu-id="5d98d-148">たとえば、ステップ消費は次の表のように設定します。</span><span class="sxs-lookup"><span data-stu-id="5d98d-148">For example, step consumption is set up as shown in the following table.</span></span>

| <span data-ttu-id="5d98d-149">シリーズの開始</span><span class="sxs-lookup"><span data-stu-id="5d98d-149">From series</span></span> | <span data-ttu-id="5d98d-150">件数</span><span class="sxs-lookup"><span data-stu-id="5d98d-150">Quantity</span></span> |
|-------------|----------|
| <span data-ttu-id="5d98d-151">0.00</span><span class="sxs-lookup"><span data-stu-id="5d98d-151">0.00</span></span>        | <span data-ttu-id="5d98d-152">10.0000</span><span class="sxs-lookup"><span data-stu-id="5d98d-152">10.0000</span></span>  |
| <span data-ttu-id="5d98d-153">100.00</span><span class="sxs-lookup"><span data-stu-id="5d98d-153">100.00</span></span>      | <span data-ttu-id="5d98d-154">20.0000</span><span class="sxs-lookup"><span data-stu-id="5d98d-154">20.0000</span></span>  |
| <span data-ttu-id="5d98d-155">200.00</span><span class="sxs-lookup"><span data-stu-id="5d98d-155">200.00</span></span>      | <span data-ttu-id="5d98d-156">40.0000</span><span class="sxs-lookup"><span data-stu-id="5d98d-156">40.0000</span></span>  |

<span data-ttu-id="5d98d-157">部品表 (BOM) の数量が 1 で、生産数量は 110 です。</span><span class="sxs-lookup"><span data-stu-id="5d98d-157">The bill of materials (BOM) quantity is 1, and the production quantity is 110.</span></span> <span data-ttu-id="5d98d-158">消費の式は、[シリーズの開始 (数量)] = [消費] です。</span><span class="sxs-lookup"><span data-stu-id="5d98d-158">The formula for the consumption is From series (Quantity) = Consumption.</span></span> <span data-ttu-id="5d98d-159">生産数量が 110 のため、「100 シリーズから」になります。</span><span class="sxs-lookup"><span data-stu-id="5d98d-159">Because the production quantity is 110, it falls into the "From 100 series."</span></span> <span data-ttu-id="5d98d-160">このため、数量は 20 です。</span><span class="sxs-lookup"><span data-stu-id="5d98d-160">Therefore, the quantity is 20.</span></span>
