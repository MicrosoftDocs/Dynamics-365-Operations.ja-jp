...
このトピックは、ミックス モードの計画に関する情報を提供します。 ミックス モードの計画では、材料フローに基づいてサプライ チェーンをシミュレーションできます。 Dynamics 365 Supply Chain Management は、選択した供給ポリシー (かんばん、製造オーダー、発注書、バッチ オーダー、または移動オーダー) に関係なく、材料フローがモデルにならうことを確認します。 
