---
title: 部品消費ルール
description: この記事では、原材料消費に使用される次の 4 つの部品消費ルールについて説明します。
...
> [!NOTE]
> 終了の部品消費ルールを計画品目と共に使用することはできません。 代わりに、開始の部品消費ルールに使用することをお勧めします。 計画品目には *計画品目* の生産タイプがあり、計画品目に対して作成されたバッチ オーダーでは、連産品および副産物のみが完了として報告されます。
