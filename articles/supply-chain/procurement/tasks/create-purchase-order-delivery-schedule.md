...
## <a name="process-product-receipt-using-delivery-schedules"></a>配送スケジュールを使用して製品受領書を処理
    * 製品受領を処理する前に発注書を確定する必要があります。 この例では、受領は発注書に直接記録されます。 入庫は商品が倉庫に到着したときに記録される場合があります。  
1. アクション ウィンドウで、[購買] をクリックします。
2. [確認] をクリックします。
3. アクション ウィンドウで、[入庫] をクリックします。
4. [製品受領書] をクリックします。
5. [製品受領書] フィールドで、任意の値を入力します。
