...
必要に応じて、作業者は別の作業者にクラスターを渡すことができます。 これにより、クラスターの状態が [引渡済み] に変わります。 作業者がモバイル デバイスを使用してピッキングとプット アウェイ作業が完了したことを示したとき、出荷または積荷を Dynamics 365 for Finance and Operations のクライアントで確認する必要があります。
