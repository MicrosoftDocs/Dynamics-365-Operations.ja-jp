...
- <span data-ttu-id="49451-126">ウェーブ ステップ自由書式のテキストが重複して存在します。</span><span class="sxs-lookup"><span data-stu-id="49451-126">Duplicate wave step free texts exist.</span></span>
