...
**メモ:** 原価計算には **プロジェクト カテゴリ** ページが含まれますが、このページはこの記事で説明する機能とは関係ありません。 プロジェクトで原価カテゴリを使用する場合、**原価カテゴリ** ページには追加のプロジェクト関連情報を表示する追加のタブがあります。 この情報には、カテゴリ グループ、明細行プロパティ、および原価カテゴリに割り当てられている勘定科目が含まれます。
