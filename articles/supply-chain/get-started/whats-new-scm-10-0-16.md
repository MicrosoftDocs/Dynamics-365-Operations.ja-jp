...
description: この記事では、Dynamics 365 Supply Chain Management 10.0.16 の新機能および変更された機能について説明します。
author: kamaybac
ms.date: 11/20/2020
ms.topic: article
ms.prod: ''
...
この記事では、Microsoft Dynamics 365 Supply Chain Management バージョン 10.0.16 の新機能または変更された機能について一覧表示します。 このバージョンには 10.0.689 のビルド番号が含まれており、次のように使用できます。
...
- [危険物の概要](../pim/hazmat-overview.md) (および関連記事)
...
Microsoft Dynamics 365 Supply Chain Management 10.0.16 には、Platform updates が含まれています。 詳細については、[財務と運用アプリのバージョン 10.0.16 のプラットフォーム更新プログラム (2021 年 2 月)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-16.md) を参照してください。
