---
title: Dynamics 365 Supply Chain Management のラーニング カタログ
description: Dynamics 365 Supply Chain Management のすべてのトレーニング オプションを見つけます。
author: margoc
ms.topic: article
ms.date: 07/23/2020
ms.author: margoc
...
<!-- ![Universal Windows Platform (UWP)](images/platform-uwp.png)  -->  
    ...
    [サプライ チェーン マネジメント](learning-catalog-business-user.md#supply-chain-management)
