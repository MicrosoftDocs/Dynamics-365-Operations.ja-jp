...
| 在庫仕訳帳の測定単位と単位数量を使用します。 | 2021/9/1 | 2019/11/11 | 既定で有効 | 在庫および倉庫管理 |
...
| 新しい [休暇を中止] ボタンが [ジョブ カード ターミナル] ページに追加されました。 | 2021/9/1 | 2020/2/19 | 既定で有効 | 生産管理 |
...
| 画面ジョブカード デバイスとジョブ カード ターミナルを校正できるようにロックする機能。 | 2021/9/1 | 2020/5/10 | 既定で有効 | 生産管理 |
