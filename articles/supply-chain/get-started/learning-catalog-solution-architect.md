...
| [財務と運用: PowerApps を使用して財務と運用アプリを拡張する (DYN558PAL2)](https://community.dynamics.com/365/b/techtalks/posts/finance-and-operations-extending-dynamics-365-with-powerapps-2-6-2019) | Microsoft PowerApps およびフローを使用した人材アプリケーションの拡張について詳しく説明し、デモンストレーションする Tech Talkです。 | Web カンファレンスの無料録画 | 43 分 |
...
| [財務と運用アプリ内の統合フレームワーク (DYN385PAL)](https://community.dynamics.com/365/b/techtalks/posts/integration-frameworks-within-dynamics-365-for-finance-amp-operations-october-31-2017) | このセッションでは、Dynamics 365 for Finance & Operations 内の統合フレームワークの概要を示し、これらのフレームワークを使用するうえでの考慮事項について説明します。 | Web カンファレンスの無料録画 | 64 分 |
| [Dataverse 経由の Dynamics 365 for Sales と財務と運用アプリ間の統合 (DYN340PAL)](https://community.dynamics.com/365/b/techtalks/posts/integration-between-dynamics-365-for-sales-and-dynamics-365-for-finance-amp-operations-via-cds-september-25-2017) | この Tech Talk では、Dynamics 365 Sales での販売およびマーケティング活動と、財務と運用アプリのフルフィルメントを含む、見込顧客を現金化と呼ばれる統合シナリオを紹介します。 また、データ インテグレーターおよび統合を変更する方法も確認します。 | Web カンファレンスの無料録画 | 54 分 |
| [モバイル フレームワーク (VIR824PAL) ](https://community.dynamics.com/365/b/techtalks/posts/mobile-framework-april-11-2017) | この Tech Talk では、財務と運用でアプリを構築するためのモバイル フレームワーク機能について説明します。 このセッションでは、最近構築されたアプリの一部も紹介します。 | Web カンファレンスの無料録画 | 58 分 |
| [統合 (VIR806PAL)](https://community.dynamics.com/365/b/techtalks/posts/integration-february-16-2017) | この Tech Talk では、コード サンプルおよびデモンストレーションを含めた Dynamics 365 Supply Chain Management のさまざまな統合オプションについて説明します。 | Web カンファレンスの無料録画 | 58 分 |
