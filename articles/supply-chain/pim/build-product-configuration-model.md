...
## <a name="configure-products"></a>製品のコンフィギュレーション

### <a name="configure-one-or-more-products"></a>1 つ以上の製品のコンフィギュレーション
...
### <a name="multiple-sites-and-intercompany-considerations"></a>複数のサイトと会社の考慮事項
