...
## <a name="find-the-dimension-based-product-master"></a>分析コード ベースの製品マスターを検索します
1. [リリース済製品の保守] をクリックします。
2. [リリース済製品] をクリックします。
3. 一覧で、選択された行をマークします。
    * この一連の 8 つの記録において、最初の記録を作成した分析コード ベースの製品マスターを選択します。  

## <a name="create-configurations"></a>コンフィギュレーションを作成します
1. [技術アクション ペイン] で、[コンフィギュレーション管理] をクリックします。
2. [コンフィギュレーション] をクリックします。
3. 一覧で、選択された行をマークします。
4. [品目番号] フィールドで、値を入力または選択します。
    * 最初のコンフィギュレーション グループのどの品目も選択できます。  
5. 一覧で、目的のレコードを見つけ、選択します。
6. [品目番号] フィールドで、値を入力または選択します。
    * 2 番目のコンフィギュレーション グループから任意の品目を選択します。  
7. [OK] をクリックします。
8. 一覧で、選択された行をマークします。
9. [コンフィギュレーション] フィールドに値を入力します。
    * コンフィギュレーションの識別を容易にするためコンフィギュレーション名を入力します。  
10. [説明] フィールドに値を入力します。
