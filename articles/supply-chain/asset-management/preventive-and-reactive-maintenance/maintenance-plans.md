---
title: メンテナンス計画
description: この記事では、資産管理におけるメンテナンス計画について説明します。
...
![トラック サービス メンテナンス計画の例。](media/07-preventive-maintenance.png "トラックサービスメンテナンス計画の例")
...
## <a name="counter-based-maintenance-enhancements"></a>カウンターに基づくメンテナンス機能拡張
...
- *集計値に対して繰り返し* という名前の新しいタイプのメンテナンス計画 間隔 (カウンターのみ)。 このタイプは、集計されたカウンターが特定の値の倍数に達したときにメンテナンスをトリガーします。 たとえば、10,000 時間ごとにメンテナンスをトリガーできます。 詳細については、この記事で前述した [間隔タイプの概要](#interval-types) セクションを参照してください。
