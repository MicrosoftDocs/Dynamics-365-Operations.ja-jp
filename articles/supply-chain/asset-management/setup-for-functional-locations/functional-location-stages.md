---
title: 機能の場所のライフサイクルの状態
description: この記事では、資産管理に機能的な場所の状態とライフサイクル モデルを設定する方法について説明します。
...
---
# <a name="functional-location-lifecycle-states"></a>機能の場所のライフサイクルの状態

[!include [banner](../../includes/banner.md)]

 

この記事では、資産管理に機能的な場所のライフサイクルの状態とライフサイクル モデルを設定する方法について説明します。 機能的な場所のライフサイクルの状態は、機能的な場所が経由できる状態 (作成、アクティブ、終了など) を定義します。 **すべての機能的な場所** のリスト ページで、ライフサイクルの状態に関係なく、すべての機能的な場所を表示することができます。 機能的な場所の状態を変更するには、**すべての機能的な場所** リスト ページで機能場所の状態を選択し、**機能的な場所の状態を更新** を選択します。
