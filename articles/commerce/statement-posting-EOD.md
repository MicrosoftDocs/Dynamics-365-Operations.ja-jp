...
集計トランザクションの **トランザクションの詳細** タブは、集計されたトランザクションで引き出されたすべてのトランザクションを表示します。 集計されたトランザクションの集計行は、トランザクションから集計されたすべてのレコードを表示します。 集計行は、品目、バリアント、数量、価格、正味金額、単位、および倉庫などの詳細も表示します。 基本的に、各集計行は、1 つの販売注文明細行に対応します。
