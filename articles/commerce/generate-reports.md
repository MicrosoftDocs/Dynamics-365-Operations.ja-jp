...
description: この記事では、Microsoft Dynamics 365 Commerce でオンライン チャネルのレポートを生成する方法について説明します。
author: josaw1
ms.date: 10/01/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9268327"
---
# <a name="generate-online-channel-reports"></a>オンライン チャネル レポートの生成

[!include [banner](includes/banner.md)]

この記事では、Microsoft Dynamics 365 Commerce でオンライン チャネルのレポートを生成する方法について説明します。
