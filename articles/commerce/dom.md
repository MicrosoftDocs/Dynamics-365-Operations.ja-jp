...
![![DOM のコンテキストにおける販売注文のライフサイクル](./media/flow.png "DOM のコンテキストにおける販売注文のライフサイクル")](./media/flow.png "Sales order lifecycle in the context of DOM")
...
![![販売注文の基準](./media/ordercriteria.png "販売注文の基準")](./media/ordercriteria.png "Sales order criteria")
