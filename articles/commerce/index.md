...
このリリースでは、組み込みの Web 作成開発ツールを使用してデジタル エクスペリエンスを作成し、魅力的でインテリジェントなデジタル店舗を作成することができます。 接続されたマーケティングおよびヘッドレス コマース プラットフォームにより、すべてのチャネルでコンテンツ、資産、プロモーション、在庫、価格設定のシームレスな管理が可能になります。

- **デジタル コマースの構築と実行に必要なものすべて:** 従来のチャネルと新しいチャネルの両方でニーズに合わせて拡張できるビジネスおよびエンド ツー エンドのコマース ソリューションを合理化します。 組み込み Web 作成開発ツールを使用すると、魅力的でインテリジェントなデジタル店舗を作成することができます。また、接続されたマーケティングおよびヘッドレス コマース プラットフォームにより、コンテンツ、資産、プロモーション、在庫、および価格設定をシームレスに管理できます。

- **ロイヤルティを構築し、顧客の期待を上回る:** クライアンテリング ツールを使用して顧客の包括的なビューを取得し、物理的およびデジタル チャネル全体にフローする顧客のプロファイル、履歴、および好みに基づいて、あらゆる契約レベルでニーズに対応します。 AI による推奨事項、顧客への洞察、およびブランドの魅力を高めるロイヤルティ プログラムを使用して、従業員が継続的に関係を育成できるようにします。
...
- [Commerce 開発と拡張性](dev-itpro/retail-sdk/sdk-github.md)

## <a name="elearning-courses"></a>eLearning コース

オンライン コースおよびトレーニングについては、[Microsoft Learn の Dynamics 365 Commerce](/learn/browse/?expanded=dynamics-365&products=dynamics-commerce&resource_type=learning%20path) をご確認ください。
