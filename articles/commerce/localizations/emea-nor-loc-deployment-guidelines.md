...
> [!WARNING]
> このサンプル会計統合機能は、[会計統合フレームワーク](./fiscal-integration-for-retail-channel.md)を利用しておらず、今後の更新で非推奨になります。 代わりに、[会計統合フレームワークに基づく機能](./emea-nor-fi-deployment.md) を使用する必要があります。
