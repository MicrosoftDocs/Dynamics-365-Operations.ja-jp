---
title: 小売明細書の番号順序の設定
description: このトピックでは、Microsoft Dynamics 365 Commerce で小売明細書に必要な番号順序を構成する方法について説明します。
author: analpert
ms.date: 04/27/2022
ms.topic: article
...
ms.locfileid: "8649213"
---
# <a name="set-up-number-sequences-for-retail-statements"></a>小売明細書の番号順序の設定

[!include [banner](includes/banner.md)]
[!include [banner](includes/preview-banner.md)]

このトピックでは、Microsoft Dynamics 365 Commerce で小売明細書に必要な番号順序を構成する方法について説明します。
