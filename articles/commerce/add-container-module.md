---
title: コンテナー モジュール
description: この記事では、コンテナー モジュールと、Microsoft Dynamics 365 Commerce のサイト ページへの追加方法について説明します。
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
1. **新しいページの作成** ダイアログ ボックスの **ページ名** に **コンテナ― ページ** と入力し、**次へ** を選択します。
1. **テンプレートの選択** で、作成した **コンテナ― テンプレート** テンプレート を選択して **次へ** を選択します。
