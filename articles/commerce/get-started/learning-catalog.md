...
<!-- ![Universal Windows Platform (UWP).](images/platform-uwp.png)  -->  
    ...
    [E コマース](learning-catalog-business-user.md#e-commerce)
...
:::row:::
    ...
    [E コマース](learning-catalog-administrator.md#e-commerce)
...
:::row:::
    ...
    [E コマース](learning-catalog-functional-consultant.md#e-commerce)
