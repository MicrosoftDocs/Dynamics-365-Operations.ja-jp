...
description: この記事では、Dynamics 365 Commerce 10.0.9 の新機能および変更された機能について説明します。
author: josaw1
ms.date: 03/12/2020
ms.topic: article
ms.prod: ''
...
この記事では、Microsoft Dynamics 365 Commerce 10.0.9 の新機能または変更された機能を示します。 このバージョンには 10.0.383 のビルド番号が含まれており、次のように使用できます。
