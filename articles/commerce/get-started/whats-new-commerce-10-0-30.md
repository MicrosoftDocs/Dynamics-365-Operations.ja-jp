...
| インサイト  |  自分 Application Insights アカウントに対する販売時点 (POS) 運用情報イベントを配信 します。 | [Application Insights のログへのアクセス](../dev-itpro/operational-insights.md#enable-diagnostic-events-in-application-insights)   |  IT Pro/開発者のオプトイン   |
