...
詳細については [POS 拡張パッケージ情報を表示する](../dev-itpro/view-pos-extension-package-details.md) を参照してください。
...
詳細については [ヘッダー請求金額を一致する販売明細行に比例配分する](../pro-rate-charges-matching-lines.md) を参照してください。
