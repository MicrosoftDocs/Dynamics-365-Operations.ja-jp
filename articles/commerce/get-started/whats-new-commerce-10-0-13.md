...
description: この記事では、Dynamics 365 Commerce 10.0.13 の新機能および変更された機能について説明します。
author: josaw1
ms.date: 09/14/2020
ms.topic: article
ms.prod: ''
...
ms.openlocfilehash: c46a7a5c6fe43bcee4862824df5c4702e2d62b78
...
この記事では、Microsoft Dynamics 365 Commerce 10.0.13 の新機能または変更された機能を示します。 このバージョンのビルド番号は 10.0.569 で、次のスケジュールで使用できます。
...
Dynamics 365 Commerce 10.0.13 には、プラットフォーム更新プログラムが含まれています。 詳細については、[財務と運用アプリのバージョン 10.0.13 のプラットフォーム更新プログラム](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-13.md) を参照してください。
