...
詳細については、[レシートのなしの返金の支払方法を制限](../payment-methods-restrictions.md) を参照してください。
...
詳細については、[Omni チャンネルの高度な自動請求](../omni-auto-charges.md) を参照してください。

## <a name="retail-price-reports"></a>小売価格レポート

この新しい機能により、店舗管理者は最近または今後の価格変更の詳細を示すレポートを作成できます。

詳細については、[小売価格レポート](../price-report.md) を参照してください。
...
詳細については、[複数の顧客注文と請求書間で品目を返品](../multireturn.md) を参照してください。

## <a name="loyalty-changes"></a>ロイヤリティの変更

Retail のロイヤリティ機能を強化するための機能が追加されました。

詳細については、[ロイヤリティの概要](../set-up-customer-loyalty-program.md) を参照してください。
