...
description: このトピックでは、Dynamics 365 Commerce 10.0.27 の新機能または変更された機能について説明します。
author: josaw1
ms.date: 04/29/2022
ms.topic: article
ms.technology: ''
...
ms.openlocfilehash: 814d0910e8dc30b4ba382d6d4bec02fbd5199dcd
ms.sourcegitcommit: 367e323bfcfe41976e5d8aa5f5e24a279909d8ac
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 04/29/2022
ms.locfileid: "8660395"
---
...
このトピックでは、Microsoft Dynamics 365 Commerce 10.0.27 の新機能または変更された機能について列挙します。 このバージョンのビルド番号は 10.0.1227 で、次のスケジュールで使用できます。
