...
description: この記事では、Dynamics 365 Commerce 10.0.12 の新機能および変更された機能について説明します。
author: josaw1
ms.date: 07/23/2020
ms.topic: article
ms.prod: ''
...
ms.openlocfilehash: d4a459c5f7baa4ddcec783cd49aba758c70febb8
...
Dynamics 365 Commerce 10.0.12 には、プラットフォーム更新プログラムが含まれています。 詳細については、[財務と運用アプリのバージョン 10.0.12 のプラットフォーム更新プログラム](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-10-0-12.md) を参照してください。
