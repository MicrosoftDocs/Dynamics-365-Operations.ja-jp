...
description: この記事では、Dynamics 365 Commerce 10.0.11 の新機能および変更された機能について説明します。
author: josaw1
ms.date: 05/27/2020
ms.topic: article
ms.prod: ''
...
ms.openlocfilehash: aff5b855bd62614c53a8a8ab943885f6fd958f4b
ms.sourcegitcommit: 52b7225350daa29b1263d8e29c54ac9e20bcca70
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 06/03/2022
ms.locfileid: "8858952"
---
...
この記事では、Microsoft Dynamics 365 Commerce 10.0.11 の新機能または変更された機能を示します。 このバージョンには 10.0.464 のビルド番号が含まれており、次のように使用できます。
...
Dynamics 365 Commerce 10.0.11 には、プラットフォーム更新プログラムが含まれています。 詳細については、[財務と運用アプリのバージョン 10.0.11 のプラットフォーム更新プログラム](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-35.md) を参照してください。
