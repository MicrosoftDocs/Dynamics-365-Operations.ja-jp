...
description: この記事では、Microsoft Dynamics 365 Commerce のサイトにプライバシー ポリシー ページを追加する方法について説明します。
author: v-chgri
ms.date: 08/31/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9272074"
---
# <a name="add-a-privacy-policy-page"></a>プライバシー ポリシー ページの追加

[!include [banner](includes/banner.md)]

この記事では、Microsoft Dynamics 365 Commerce のサイトにプライバシー ポリシー ページを追加する方法について説明します。
