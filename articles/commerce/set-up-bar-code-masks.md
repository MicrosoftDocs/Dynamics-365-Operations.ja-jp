---
title: バーコード マスクの設定
description: この記事では、バーコード マスク文字、バーコード マスクの設定方法、バーコードにバーコード マスクを割り当てる方法について説明します。
author: BrianShook
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8853715"
---
# <a name="set-up-bar-code-masks"></a>バーコード マスクの設定

[!include [banner](includes/banner.md)]

この記事では、バーコード マスク文字、バーコード マスクの設定方法、バーコードにバーコード マスクを割り当てる方法について説明します。
