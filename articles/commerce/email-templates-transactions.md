...
| `pickupstoreopenfrom` | 集荷店舗の開店時間。 |
| `pickupstoreopento` | 集荷店舗の閉店時間。 |
...
1. Commerce 本部で、**小売とコマース \> 本社の設定 \> 組織の電子メール テンプレート** または、**組織管理 \> 設定 \> 組織の電子メール テンプレート** に移動します。
1. **新規** を選択します。
...
1. Commerce 本部で、**小売とコマース \> 本部の設定 \> 組織の電子メールのテンプレート** に移動します。
