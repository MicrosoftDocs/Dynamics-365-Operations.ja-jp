...
- **顧客勘定での支払いを有効にする** - このプロパティでは、ユーザーが顧客勘定を使用して注文に対する支払を行います。 使用可能な値は、**B2B 顧客に有効化**、**B2C 顧客に有効化**、**すべての顧客に有効化**、**べての顧客に無効化** です。 B2B サイトが顧客勘定に対応している場合は、**B2C 顧客に有効化** を選択する必要があります。
