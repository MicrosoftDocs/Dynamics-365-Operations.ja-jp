...
このページには、IT プロとコマースをサポートする開発者が利用できるリソースが一覧表示されています。

## <a name="online-channel"></a>オンライン チャネル
...
- [バックオフィスからのアカウントとデバイスの管理](../set-up-activation-accounts-validate-devices-hq.md)
...
- [Modern POS のコンフィギュレーションとインストール](../retail-modern-pos-device-activation.md)
...
- [POS 支払 SDK でのチップのサポート](tipping.md)
- [販売時点管理 (POS) サンプルを実行](pos-run-samples.md)
- [POS ビューの拡張によるカスタム列およびアプリ バー ボタンの追加](pos-view-extension.md)
- [Modern POS (MPOS) トランザクション ページへのカスタム コントロールの追加](pos-custom-transaction.md)
...
- [Typescript および小売販売時点管理 (POS) の C# プロキシ](typescript-proxy-retail-pos.md)
- [小売販売時点管理 (POS) サンプルを実行](pos-run-samples.md)
- [POS ビューの拡張によるカスタム列およびアプリ バー ボタンの追加](pos-view-extension.md)
- [Modern POS (MPOS) トランザクション ページへのカスタム コントロールの追加](pos-custom-transaction.md)
- [販売時点管理 (POS) トランザクション グリッドへのカスタム列の追加](pos-custom-transaction-column.md)
- [販売時点管理 (POS) API または POS 拡張からの工程を呼び出す](pos-api-extension.md)
