...
-   各店舗が自己ホストまたはクラウドにホストされる Commerce Scale Unit トポロジを使用して運用するための店舗トポロジ構成を慎重に選択します。 ライブ店舗を、自己ホストからクラウド ホストの Commerce Scale Unitへ (またはその逆) 再度コンフィギュレーションすると、サービスが中断される可能性があります。
