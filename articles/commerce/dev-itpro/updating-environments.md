---
title: Commerce プロジェクトのコードと環境の更新
description: この記事では、Microsoft Dynamics 365 Commerce の更新コード、および環境の推奨事項について説明します。
...
詳細については、[Azure SQL から SQL Server へのデータベースのコピー](/dynamics365/fin-ops-core/dev-itpro/database/dbmovement-operations)を参照してください。 ソースおよび宛先の環境に同じ binary バージョンがない場合、ビルドおよびデータベースの同期 (開発環境の) または配置 (サンドボックスまたは運用環境の) のいずれかを行う必要があります。
