...
この記事では、Microsoft Dynamics Lifecycle Services (LCS) を使用して Dynamics 365 Human Resources プロジェクトにおける go live の準備方法を説明します。 
...
| 6 | 生産準備完了 | 前の手順すべてが完了した後 | パートナー/顧客 | 顧客/パートナーが運用環境を制御することができます。|
...
各実装プロジェクトにおける主要なマイルストーンは、運用環境への切替です。 ステップを完了するプロセスは 2 つの部分で成り立っています。 
...
- 本番前の偶発的なトランザクションや更新から運用環境を保護するために、強力なガバナンス プロセスを導入してください。
