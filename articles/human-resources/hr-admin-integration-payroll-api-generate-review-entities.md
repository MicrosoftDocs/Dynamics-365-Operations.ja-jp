...
description: この記事では、給与エンティティを生成および確認する方法について説明します。
author: twheeloc
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
...
## <a name="review-payroll-entities"></a>給与エンティティの確認

この API を使用して、正常に生成され、使用できる状態であるエンティティの一覧を取得します。
