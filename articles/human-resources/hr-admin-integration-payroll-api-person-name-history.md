---
title: 氏名の履歴
description: この記事では、Dynamics 365 Human Resources における氏名の履歴エンティティに対するクエリの詳細と例を示します。
author: twheeloc
ms.date: 09/01/2021
ms.topic: article
ms.prod: ''
...
この記事では、Dynamics 365 Human Resources の氏名の履歴エンティティについて説明します。
