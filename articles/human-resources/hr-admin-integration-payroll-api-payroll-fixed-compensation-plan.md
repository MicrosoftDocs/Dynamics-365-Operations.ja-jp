---
title: 固定報酬の報酬計画
description: この記事では、Dynamics 365 Human Resources における固定報酬の報酬計画エンティティに対するクエリの詳細および例を示します。
author: jcart
ms.date: 08/25/2021
ms.topic: article
ms.prod: ''
...
この記事では、Dynamics 365 Human Resources の固定報酬の報酬計画のエンティティについて説明します。
