...
11. **調整金額** フィールドで、数値を入力します。
12. **基準点** フィールドで、値を入力または選択します。
13. 一覧で、すべての行のマークを設定または解除します。
14. **グリッドに適用** をクリックします。
15. **調整金額** フィールドで、数値を入力します。
16. **基準点** フィールドで、値を入力または選択します。
17. 一覧で、すべての行のマークを設定または解除します。
18. **グリッドに適用** をクリックします。
