...
| 問題の番号 | 問題 | 説明 |
|---|---|---|
| 619774 | 住所の説明への編集は、リアルタイムでは Dataverse に同期されません。 | 作業者の住所の説明を編集しても、更新された説明が Dataverse にリアルタイムでは同期されません。 **ロジスティクスの場所** のテーブルのサブスプリプションが更新され、更新が送信されます。 |
