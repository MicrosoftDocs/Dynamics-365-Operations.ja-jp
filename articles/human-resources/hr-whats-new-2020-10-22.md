...
| 機能 | リリース計画 | ドキュメント |
| --- | --- | --- |
| プラットフォーム更新プログラム 10.0.14(38) | -- | [Finance and Operations アプリ のバージョン 10.0.14 のプラットフォーム更新プログラム (2020 年 11 月)](../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-14.md) |
