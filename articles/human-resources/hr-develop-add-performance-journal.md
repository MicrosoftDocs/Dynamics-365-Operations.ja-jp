...
description: パフォーマンスの仕訳帳には、従業員が目標を達成した方法、または期間中の業績についての情報が含まれています。
author: twheeloc
ms.date: 08/25/2021
...
5. **説明** フィールドで、値を入力します。
    * パフォーマンス仕訳帳の日付は、仕訳帳が作成された日付です。  
    * ソースは、パフォーマンス仕訳帳がどこから取得されたかを表します。 1 つを作成すると、[自分の仕訳] から取得されます。 マネージャーが 1 つを作成する場合、[マネージャーの仕訳帳] から取得されます。      * 仕訳帳をマネージャーと共有するか、または作成者だけが表示できるようにできます。  
6. **開始日** フィールドに日付を入力します。
7. **完了日** フィールドに日付を入力します。
8. **開発計画** フィールドで、**はい** を選択します。
...
13. グリッドに戻るには、**保存** ボタンの下のキャプション部分の **パフォーマンス仕訳帳** と呼ばれる領域をクリックします。
    * 目標を開いた場合に表示されるように、選択した仕訳帳または仕訳帳を目標に追加できます。 **リンク** のクイック タブにリンクが追加されます。目標に仕訳帳を追加し、その目標をレビューに追加した場合、仕訳帳は自動的にレビューに表示されます。  
    * レビューを開いた場合に表示されるように、選択した仕訳帳または仕訳帳をレビューに追加できます。 **リンク** のクイック タブにリンクが追加されます。  
14.  **クイック** 追加をクリックします。
15. **タイトル** フィールドに値を入力します。
16. **説明** フィールドで、値を入力します。
17. **保存** をクリックします。
18. **称賛の送信** をクリックします。
19. 会社の従業員の一覧から個人を選択します。
20. **説明** フィールドに、**会議での援助に対する感謝** と入力します。
21. **送信** をクリックします。
