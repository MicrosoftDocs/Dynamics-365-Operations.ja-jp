---
title: 開発の概要
description: この記事では、API とカスタム フィールドの参照資料を提供します。 また、他のアプリケーションとの統合についても説明します。
author: twheeloc
ms.date: 02/03/2020
ms.topic: overview
ms.prod: ''
...
この記事では、API とカスタム フィールドの参照資料を提供します。 また、他のアプリケーションとの統合についても説明します。

- [概要](hr-developer-overview.md)

- [Power Apps および Power Automate での拡張](hr-developer-power-apps.md)

- [Dataverse の Human Resources エンティティ](hr-developer-entities.md)

- [カスタム フィールド](hr-developer-custom-fields.md)
