---
title: 人事管理ワークスペース
description: この記事では、人事管理ワークスペースの概念に関する要素について説明します。
author: twheeloc
ms.date: 11/03/2021
ms.topic: article
ms.prod: ''
...
**人事管理** ワークスペースには、大量のコンテンツが含まれています。 従業員の異動、オープン職位、住所の変更、レコードの期限切れ、および分析を含む人事異動の他に特定の情報へのリンクが提供されます。 この記事では、ワークスペースの各パートに関する詳細情報を提供します。
