---
title: 採用で要求するスキル
description: この記事では、Dynamics 365 Human Resources の人物の採用スキルエンティティについて説明します。
author: jaredha
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
この記事では、Dynamics 365 Human Resources の人物の採用スキルエンティティについて説明します。
