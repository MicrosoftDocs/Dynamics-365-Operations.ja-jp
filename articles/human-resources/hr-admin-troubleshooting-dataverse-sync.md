...
description: この記事では、Microsoft Dynamics 365 Human Resources と Microsoft Dataverse のヒューマン キャピタル マネージメント (HCM) の共通のソリューションとの間でレコードが正しく同期されない場合のトラブルシューティングについて説明します。
author: jaredha
ms.date: 09/27/2021
ms.topic: article
ms.prod: ''
