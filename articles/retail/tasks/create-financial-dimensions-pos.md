...
2. [新規] をクリックします。
3. [値の使用元] フィールドでオプションを選択します。
4. [分析コード名] フィールドで、値を入力します。
5. [有効化] をクリックします。
6. [閉じる] をクリックします。
7. [有効化] をクリックします。
8. [分析コード値] をクリックします。
...
10. [保存] をクリックします。
11. ページを閉じます。
12. [小売りとコマース] > [チャンネル設定] > [POS 設定] > [レジスター] の順に移動します。
13. 一覧で、目的のレコードを見つけ、選択します。
14. [財務分析コード] セクションの展開を切り替えます。
15. [編集] をクリックします。
16. [ターミナル] フィールドで、ドロップ ダウン ボタンをクリックし、ルックアップを開きます。
