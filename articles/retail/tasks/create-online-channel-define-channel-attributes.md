...
1. [小売りとコマース] > [チャンネル] > [オンライン ストア] に移動します。
2. [新規] をクリックします。
3. [名前] フィールドに値を入力します。
...
## <a name="configure-orders-for-near-realtime-notification"></a>ほぼリアルタイム通知のコンフィギュレーション オーダー
1. 小売 > 本社の設定 > パラメーター > 小売パラメーター、へ移動します。
