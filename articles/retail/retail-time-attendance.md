...
コンフィギュレーション ステップについては、<https://technet.microsoft.com/en-us/library/aa496971.aspx> を参照してください。
...
時刻と出勤の登録を処理する方法については、<https://technet.microsoft.com/en-us/library/aa573180.aspx> を参照してください。
