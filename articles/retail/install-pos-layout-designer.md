...
ワンクリック デザイナーを使用して、店舗、レジスター、レジ担当者、およびマネージャー用に、ランドスケープ モードまたはポートレート モードで、異なる Retail Modern POS (MPOS) や Cloud POS のレイアウトを作成することができます。
...
[Retail Modern POS のコンフィギュレーション、ダウンロード、インストール、および有効化](retail-modern-pos-device-activation.md)
