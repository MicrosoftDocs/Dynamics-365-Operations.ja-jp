...
7. インストールが完了したら、支払商社情報のインストール ツールが起動します。 このインストーラーは、環境に接続し、選択したハードウェア ステーションの販売者の口座情報 (EFT IDなど) をインストールします。
...
12. 現在のコンピューターおよび Dynamics 365 for Retail で既に完了している Retail ハードウェア ステーション構成に基づいて、ホスト名と EFT ターミナル ID が正しことを確認します。 この情報を検証した後、**インストール**を選択します。
