...
## <a name="why-and-when-you-should-customer-attributes"></a>顧客属性が必要な理由および場合
...
5. 属性タイプに応じて、**既定値**フィールドに、属性が顧客に割り当てられたときに既定で表示される値または値の範囲を入力します。
...
1. **小売** > **照会およびレポート** > **小売店舗のトランザクション**の順に移動します。
