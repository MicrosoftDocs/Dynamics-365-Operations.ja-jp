...
12. **保存** を選択します。
13. **ボタン グリッド**ページを開きます。
14. ページの左側にあるナビゲーション バーで、**F2S1M** を検索してフィルター処理オプションを選択します。
15. アクション ウィンドウで、**デザイナー**を選択しボタン デザイナー アプリケーションをダウンロードします。
16. グリッド デザイナーが表示されたら、空の (灰色) 領域を右クリックして、**新規作成ボタン** を選択します。

    ![新しいボタン](./media/07.png)

17. 新しいボタンを右クリックし、**ボタン プロパティ** を選択します。
18. 次のマトリックスに従って **アクション**、**支払タイプ**、および**ボタンのテキスト** プロパティを設定します。
...
19. デザイナーを閉じます。
20. **配送スケジュール**を検索します。
21. ページの左側にあるナビゲーション バーで、**1090**、**1115**、および **1070** を検索します。
22. アクション ウィンドウで、**今すぐ実行**を選択します。
