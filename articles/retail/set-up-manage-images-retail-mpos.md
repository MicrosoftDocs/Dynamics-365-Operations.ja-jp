---
title: "Retail Modern POS (MPOS) の画像の設定および管理"
...
# <a name="set-up-and-manage-images-for-retail-modern-pos-mpos"></a>Retail Modern POS (MPOS) の画像の設定および管理
...
> [!NOTE]
> このデモ データの例では、メディア サーバーは、Retail サーバーに配置されます。 ただし、Dynamics 365 for Retail 外部の任意の場所で配置できます。
