...
# コール センター
## [コール センターの概要](call-center-functionality.md)
...
## [製品別の売上実績の評価](sales-performance-products.md)
...
## [機械学習を利用する製品の推奨事項のコンフィギュレーション](tasks/configure-machine-learning-product-recommendations.md)
