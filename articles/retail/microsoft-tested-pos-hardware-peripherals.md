---
title: "Microsoft によってテストされた販売時点管理 (POS) ハードウェア周辺機器"
...
# <a name="microsoft-tested-point-of-sale-pos-hardware-peripherals"></a>Microsoft によってテストされた販売時点管理 (POS) ハードウェア周辺機器
