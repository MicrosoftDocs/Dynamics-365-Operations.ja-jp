...
チャネル ナビゲーション階層の表示順序は、小売製品階層およびカテゴリ別のリリース済製品に対して HQ で反映されます。
...
1. **小売 \> 製品とカテゴリ \> チャネル ナビゲーション カテゴリ**の順に移動します。
...
チャネル ナビゲーション階層の表示順序は HQ、カタログ、および小売チャネルで反映されます。
