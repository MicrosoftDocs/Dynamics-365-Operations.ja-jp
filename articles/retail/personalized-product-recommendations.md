...
> [!NOTE]
> より良いアルゴリズムとより新しい小売指向の機能を加えたこの機能をデザインするため、製品レコメンデーション サービスの現在のバージョンを削除します。 詳細については、[削除済みまたは推奨されない機能](../dev-itpro/migration-upgrade/deprecated-features.md)を参照してください。 環境に対して既に有効な製品推奨事項で問題が発生している場合、ページの下に移動します。 
