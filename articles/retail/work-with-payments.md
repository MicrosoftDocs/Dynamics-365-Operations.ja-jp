...
| 職務            | 説明 |
|---------------------|-------------|
| 標準              | 現金または伝票の支払方法を定義するときは、支払方法に [**標準**] 機能を使用します。 これらの支払タイプがコール センターでの販売注文に適用されると、それらはすぐに前払としてに顧客口座に転記されます。 前払伝票は顧客トランザクションの履歴に転記され、請求書が作成されると販売注文の請求書に対して計画的に決済されます。 |
| 確認               | 支払フォームとして銀行小切手を定義するときは、[**確認**] 機能を使用します。 この支払のタイプが販売注文に適用されるときに、ユーザーは支払アプリケーション処理の一部として、顧客の小切手番号を入力する必要があります。 小切手支払は常に、適用時に前払として扱われます。 **標準** 支払機能の場合、これらの前払伝票は注文用に作成された請求書に対して計画的に決済されます。 |
