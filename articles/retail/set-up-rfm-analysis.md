...
<span data-ttu-id="ab03a-105">最新、頻度、金融 (RFM) 分析は、顧客の購買で生成されるデータを評価する際に組織が使用できるマーケティング手段です。</span><span class="sxs-lookup"><span data-stu-id="ab03a-105">Recency, frequency, and monetary (RFM) analysis is a marketing tool that your organization can use to evaluate the data that is generated by customer purchases.</span></span> <span data-ttu-id="ab03a-106">RFM 分析を設定すると、顧客が購買をしたとき、計算された RFM スコアが顧客に割り当てられます。</span><span class="sxs-lookup"><span data-stu-id="ab03a-106">After you set up RFM analysis, customers are assigned a calculated RFM score as they make purchases.</span></span> <span data-ttu-id="ab03a-107">RFM スコアは、組織が RFM 分析をコンフィギュレーションした方法に基づいた、3 桁の評価か、または合計値です。</span><span class="sxs-lookup"><span data-stu-id="ab03a-107">The RFM score can be a three-digit rating or an aggregate number, depending on how your organization has configured RFM analysis.</span></span> <span data-ttu-id="ab03a-108">ここでは、組織がスコアの 3 桁の評価を使用する場合、評価がどう機能するかを示します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-108">Here’s how the rating works if your organization uses a three-digit rating for the score:</span></span>

- <span data-ttu-id="ab03a-109">最初の桁は、顧客の recency 評価で、どれほど最近に顧客が組織から購買したかを示します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-109">The first digit is the customer's recency rating, which is how recently the customer made a purchase from your organization.</span></span> 
- <span data-ttu-id="ab03a-110">2 番目の桁は、顧客が購買を行う頻度の評価で、組織からの顧客の購買の頻度を示します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-110">The second digit is the customer's frequency rating, which is how often the customer makes purchases from your organization.</span></span> 
- <span data-ttu-id="ab03a-111">3 番目の桁は、顧客の金額の評価で、組織から購買を行うときに顧客が費やす金額を示します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-111">The third digit is the customer's monetary rating, which is how much the customer spends when he makes purchases from your organization.</span></span> 

<span data-ttu-id="ab03a-112">たとえば、1 から 5 のスケールで 5 が最も高い評価で、評価を設定します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-112">For example, your organization has set the ratings on a scale of 1 through 5, where 5 is the highest rating.</span></span> <span data-ttu-id="ab03a-113">この場合、535 の顧客の評価は、顧客に関する次の情報を示します:</span><span class="sxs-lookup"><span data-stu-id="ab03a-113">In this case, a customer rating of 535 tells you the following information about the customer:</span></span>

-   <span data-ttu-id="ab03a-114">**Recency 評価 5** - 顧客は最近購買をしました。</span><span class="sxs-lookup"><span data-stu-id="ab03a-114">**Recency rating of 5** – The customer recently made a purchase.</span></span>
-   <span data-ttu-id="ab03a-115">**頻度評価 3** - 顧客が中程度の頻度で組織から製品を購入します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-115">**Frequency rating of 3** – The customer purchases products from your organization moderately often.</span></span>
-   <span data-ttu-id="ab03a-116">**金額評価 5** – 顧客が購買を行うとき、かなりの金額を使用します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-116">**Monetary rating of 5** – When the customer makes a purchase, he spends a significant amount of money.</span></span>

<span data-ttu-id="ab03a-117">組織がこれらの数の合計を使用する場合は、スコアとして、個別の評価が合計されます。</span><span class="sxs-lookup"><span data-stu-id="ab03a-117">If your organization uses an aggregate number for the score, the individual ratings are added together.</span></span> <span data-ttu-id="ab03a-118">同じ例では、顧客の評価は 13 です (5 + 3 + 5)。</span><span class="sxs-lookup"><span data-stu-id="ab03a-118">For the same example, the customer has a rating of 13 (5 + 3 + 5).</span></span>

## <a name="to-set-up-rfm-analysis-for-the-customers-in-your-organization"></a><span data-ttu-id="ab03a-119">組織内の顧客に対して、RFM 分析を設定します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-119">To set up RFM analysis for the customers in your organization.</span></span>

1.  <span data-ttu-id="ab03a-120">**コール センター** > **定期処理** > **RFM 分析** の順に移動します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-120">Go to **Call center** > **Periodic** > **RFM analysis**.</span></span>

2.  <span data-ttu-id="ab03a-121">**RFM 分析** ページで、**新規** を選択します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-121">On **RFM analysis** page, select **New**.</span></span> <span data-ttu-id="ab03a-122">**RFM 定義** フィールドに、RFM 定義の名前を入力します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-122">In the **RFM definition** field, enter a name for the RFM definition.</span></span> <span data-ttu-id="ab03a-123">たとえば、定義に RFM-A という名前を付けることができます。</span><span class="sxs-lookup"><span data-stu-id="ab03a-123">For example, you could call the definition RFM-A.</span></span>

3.  <span data-ttu-id="ab03a-124">この RFM 定義の開始日と終了日を入力します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-124">Enter a start date and end date for this RFM definition.</span></span>

4.  <span data-ttu-id="ab03a-125">**一般** クイック タブで、次の操作を行います。</span><span class="sxs-lookup"><span data-stu-id="ab03a-125">On the **General** FastTab, do the following:</span></span> 
...
1.  <span data-ttu-id="ab03a-156">**コール センター** > **仕訳帳** > **顧客サービス** の順に移動します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-156">Go to **Call center** > **Journals** > **Customer service**.</span></span> 

2.  <span data-ttu-id="ab03a-157">**顧客サービス** ウィンドウの検索フィールドの **顧客サービス** ページで、検索するためのキーワード タイプを選択し、検索テキストを入力します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-157">On the **Customer service** page, in the **Customer service** pane, in the search fields, select the keyword type to search on and enter the search text.</span></span>

3.  <span data-ttu-id="ab03a-158">**検索** を選択します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-158">Select **Search**.</span></span>

4.  <span data-ttu-id="ab03a-159">**顧客検索** ページで、目的の顧客レコードを選択し、**顧客の選択** をクリックしします。</span><span class="sxs-lookup"><span data-stu-id="ab03a-159">On the **Customer search** page, select the customer record that you want, and then click **Select customer**.</span></span> 

<span data-ttu-id="ab03a-160">RFM スコアが **顧客サービス** ページの右側の **注文履歴** グループに表示されます。</span><span class="sxs-lookup"><span data-stu-id="ab03a-160">The RFM score is displayed in the **Order history** group on the right side of the **Customer service** page.</span></span> 

## <a name="view-or-clear-the-history-of-an-rfm-analysis-record"></a><span data-ttu-id="ab03a-161">RFM 分析レコードの履歴を表示またはクリアする</span><span class="sxs-lookup"><span data-stu-id="ab03a-161">View or clear the history of an RFM analysis record</span></span>
<span data-ttu-id="ab03a-162">この手順を使用して、RFM 分析レコードの履歴を表示またはクリアします。</span><span class="sxs-lookup"><span data-stu-id="ab03a-162">Use this procedure to view or clear the history of an RFM analysis record.</span></span> 

1.  <span data-ttu-id="ab03a-163">**コール センター** > **定期処理** > **RFM 分析** の順に移動します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-163">Go to **Call center** > **Periodic** > **RFM analysis**.</span></span>

2.  <span data-ttu-id="ab03a-164">**RFM 分析** ページで、表示するレコードを選択します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-164">On the **RFM analysis** page, select the record that you want to view.</span></span>

3.  <span data-ttu-id="ab03a-165">レコード履歴を表示するには、**履歴** クイックタブを選択します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-165">To view the record history, select the **History** FastTab.</span></span>

4.  <span data-ttu-id="ab03a-166">レコードの履歴をクリアするには、**履歴のクリア** を選択します。</span><span class="sxs-lookup"><span data-stu-id="ab03a-166">To clear the history of the record, select **Clear history**.</span></span>
