...
このトピックは、インドの Dynamics 365 Retail ローカライズで商品及びサービス税 (GST) の要件を有効にする方法を示す配置ガイドです。 インドの小売ローカライズの詳細については、[インドのキャッシュ レジスターの販売税統合](./apac-ind-cash-registers.md)を参照してください。
