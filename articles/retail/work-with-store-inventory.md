...
ms.locfileid: "2024686"
---
# <a name="store-inventory-management"></a>店舗在庫管理

[!include [banner](includes/banner.md)]

Dynamics 365 Retail で在庫処理および POS アプリケーションを使用する場合、POS は在庫分析コードおよび特定の在庫品目タイプに対して限定的なサポートを提供することに注意することが重要です。
