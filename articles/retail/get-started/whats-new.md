...
|--------|--------------|--------------|------------|
|Dynamics 365 for Retail 7.3.2 | 7.3.21971.64040 | 2018 年 3 月 | 1. [Dynamics 365 ロードマップ](https://roadmap.dynamics.com/) へ移動します。<br><br>2. [**新機能**] タブを選んでください。<br><br>3. [**Dynamics 365 for Retail**] チェック ボックスをクリックします。<br><br>4. 機能 **Dynamics 365 for Retail 7.3.2 でリリース済**を検索します。 |
