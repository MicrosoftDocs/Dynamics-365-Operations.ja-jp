...
## [オンプレミスの ISV ライセンス](dev-tools/isv-licensing-on-prem.md)
...
#### [Platform update 8 および 11 を使用してオンプレミス環境を配置](deployment/setup-deploy-on-premises-pu8-pu11.md)
...
## [環境サービスの再開](lifecycle-services/restart-environment-services.md)
