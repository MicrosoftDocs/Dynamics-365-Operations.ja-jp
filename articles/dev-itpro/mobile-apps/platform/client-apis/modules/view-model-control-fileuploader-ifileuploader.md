...
ms.openlocfilehash: a7c77eb897658abd256ae404736f4f68274e8a97
ms.contentlocale: ja-jp
ms.lasthandoff: 04/20/2018

---

# <a name="file-uploader"></a>ファイル アップローダー 
...
| [枠線](../interfaces/view-model-control-fileuploader-ifileuploader-ifileuploaderdesign.md#border) |border: "none" &#124; "solid" &#124; "left" &#124; "right" &#124; "top" &#124; "bottom" (optional)  <br>|コントロールの境界動作。 このプロパティは、子によって継承されません。<br>  [Design](../interfaces/view-model-ipage-idesign.md).[border](../interfaces/view-model-ipage-idesign.md#border) から継承 <br> |
