...
<xliff xmlns:logoport="urn:logoport:xliffeditor:xliff-extras:1.0" xmlns:tilt="urn:logoport:xliffeditor:tilt-non-translatables:1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:oasis:names:tc:xliff:document:1.2" xmlns:xliffext="urn:microsoft:content:schema:xliffextensions" version="1.2" xsi:schemaLocation="urn:oasis:names:tc:xliff:document:1.2 xliff-core-1.2-transitional.xsd">
  <file datatype="xml" source-language="en-US" original="view-model-control-part-ipart.md" target-language="ja-JP">
    <header>
      <tool tool-company="Microsoft" tool-version="1.0-7889195" tool-name="mdxliff" tool-id="mdxliff"/>
      <xliffext:skl_file_name>view-model-control-part-ipart.777581.e824fcde7e283fd618f4acf93f212b26bb4f15bc.skl</xliffext:skl_file_name>
      <xliffext:version>1.2</xliffext:version>
      <xliffext:ms.openlocfilehash>e824fcde7e283fd618f4acf93f212b26bb4f15bc</xliffext:ms.openlocfilehash>
      <xliffext:ms.sourcegitcommit>9d4c7edd0ae2053c37c7d81cdd180b16bf3a9d3b</xliffext:ms.sourcegitcommit>
      <xliffext:ms.lasthandoff>05/15/2019</xliffext:ms.lasthandoff>
      <xliffext:ms.openlocfilepath>articles\dev-itpro\mobile-apps\platform\client-apis\modules\view-model-control-part-ipart.md</xliffext:ms.openlocfilepath>
    </header>
    <body>
      <group extype="content" id="content">
        <trans-unit xml:space="preserve" translate="yes" id="101" restype="x-metadata">
          <source>Part module</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">パート モジュール</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="102" restype="x-metadata">
          <source>A part is a container control that contains only a page, allowing for a page to be embedded within a page.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">パーツは、ページのみを含むコンテナー コントロールで、ページがページ内に埋め込まれるのを許可します。</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>パーツ<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="111">
          <source>Part</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">パート</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="114">
          <source><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph>└─ Part</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph>└─ パート</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="119">
          <source><bpt id="p1">[</bpt>container<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#container)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>コンテナー<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#container)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="124">
          <source><bpt id="p1">[</bpt>generic<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#generic)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ジェネリック<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#generic)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="127">
          <source><bpt id="p1">[</bpt>getDataSource<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#getdatasource)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getDataSource<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#getdatasource)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="130">
          <source><bpt id="p1">[</bpt>hidden<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#hidden)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>非表示<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#hidden)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="138">
          <source><bpt id="p1">[</bpt>applyDesign<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#applydesign)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>applyDesign<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#applydesign)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="139">
          <source>applyDesign(IDesign: <bpt id="p1">[</bpt>PartDesign<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md)</ept>): void</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">applyDesign(IDesign: <bpt id="p1">[</bpt>PartDesign<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md)</ept>): void</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="142">
          <source><bpt id="p1">[</bpt>dataContext<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#datacontext)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>dataContext<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#datacontext)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="145">
          <source><bpt id="p1">[</bpt>getControl<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#getcontrol)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getControl<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#getcontrol)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="149">
          <source><bpt id="p1">[</bpt>getControlById<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#getcontrolbyid)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getControlById<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#getcontrolbyid)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="152">
          <source>Inherited from <bpt id="p1">[</bpt>ContainerControl<ept id="p1">](../interfaces/view-model-control-container-icontainercontrol-icontainercontrol.md)</ept>.<bpt id="p2">[</bpt>getControlById<ept id="p2">](../interfaces/view-model-control-container-icontainercontrol-icontainercontrol.md#getcontrolbyid)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ContainerControl<ept id="p1">](../interfaces/view-model-control-container-icontainercontrol-icontainercontrol.md)</ept>.<bpt id="p2">[</bpt>getControlById<ept id="p2">](../interfaces/view-model-control-container-icontainercontrol-icontainercontrol.md#getcontrolbyid)</ept> から継承</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="153">
          <source><bpt id="p1">[</bpt>getDesign<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#getdesign)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getDesign<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#getdesign)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="157">
          <source><bpt id="p1">[</bpt>getEntityRef<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#getentityref)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getEntityRef<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#getentityref)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="158">
          <source>getEntityRef(): string</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">getEntityRef(): string</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="159">
          <source>Gets value of entityRef binding to control.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">コントロールにバインドする entityRef の値を取得します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="160">
          <source><bpt id="p1">[</bpt>getPartPage<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#getpartpage)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getPartPage<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#getpartpage)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="161">
          <source>getPartPage(): <bpt id="p1">[</bpt>Page<ept id="p1">](../interfaces/view-model-ipage-ipage.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">getPartPage(): <bpt id="p1">[</bpt>Page<ept id="p1">](../interfaces/view-model-ipage-ipage.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="162">
          <source>Gets the page of the part.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">パーツのページを取得します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="163">
          <source><bpt id="p1">[</bpt>hasTarget<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#hastarget)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>hasTarget<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#hastarget)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="164">
          <source>hasTarget(): boolean</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">hasTarget(): boolean</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="165">
          <source>Returns true if the part has a target page.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">部品にターゲット ページがある場合は、true を返します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="166">
          <source><bpt id="p1">[</bpt>isEditable<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#iseditable)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>isEditable<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#iseditable)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="170">
          <source><bpt id="p1">[</bpt>metadata<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#metadata)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>メタデータ<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#metadata)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="171">
          <source>metadata(): <bpt id="p1">[</bpt>PartMetadata<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">metadata(): <bpt id="p1">[</bpt>PartMetadata<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="174">
          <source><bpt id="p1">[</bpt>parent<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#parent)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>親<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#parent)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="178">
          <source><bpt id="p1">[</bpt>root<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#root)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ルート<ept id="p1">](../interfaces/view-model-control-part-ipart-ipart.md#root)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">PartDesign</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="185">
          <source><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph>└─ PartDesign</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph>└─ PartDesign</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="190">
          <source><bpt id="p1">[</bpt>alignItems<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#alignitems)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>alignItems<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#alignitems)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="194">
          <source><bpt id="p1">[</bpt>alignSelf<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#alignself)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>alignSelf<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#alignself)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="197">
          <source><bpt id="p1">[</bpt>allowScroll<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#allowscroll)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>allowScroll<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#allowscroll)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="202">
          <source><bpt id="p1">[</bpt>background<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#background)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>バックグラウンド<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#background)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="206">
          <source><bpt id="p1">[</bpt>bindings<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#bindings)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>バインディング<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#bindings)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="209">
          <source><bpt id="p1">[</bpt>border<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#border)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>枠線<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#border)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="214">
          <source><bpt id="p1">[</bpt>color<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#color)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>色<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#color)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="218">
          <source><bpt id="p1">[</bpt>design<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#design)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>デザイン<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#design)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="219">
          <source>design: <bpt id="p1">[</bpt>PartDesign<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md)</ept> (optional)</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">design: <bpt id="p1">[</bpt>PartDesign<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md)</ept> (optional)</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="221">
          <source><bpt id="p1">[</bpt>flexFlow<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#flexflow)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>flexFlow<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#flexflow)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="225">
          <source><bpt id="p1">[</bpt>flexSize<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#flexsize)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>flexSize<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#flexsize)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="231">
          <source><bpt id="p1">[</bpt>fontSize<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#fontsize)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>fontSize<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#fontsize)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="235">
          <source><bpt id="p1">[</bpt>fontWeight<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#fontweight)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>fontWeight<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#fontweight)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="239">
          <source><bpt id="p1">[</bpt>itemBorder<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#itemborder)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>itemBorder<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#itemborder)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="243">
          <source><bpt id="p1">[</bpt>items<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#items)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>品目<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#items)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="247">
          <source><bpt id="p1">[</bpt>justifyItems<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#justifyitems)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>justifyItems<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#justifyitems)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="251">
          <source><bpt id="p1">[</bpt>label<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#label)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ラベル<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#label)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="254">
          <source><bpt id="p1">[</bpt>labelPosition<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#labelposition)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>labelPosition<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#labelposition)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="259">
          <source><bpt id="p1">[</bpt>name<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#name)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>名前<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#name)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="262">
          <source><bpt id="p1">[</bpt>padding<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#padding)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>スペース<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#padding)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="266">
          <source><bpt id="p1">[</bpt>target<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#target)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ターゲット<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#target)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="267">
          <source>target: <bpt id="p1">[</bpt>PageTarget<ept id="p1">](../interfaces/view-model-ipage-ipagetarget.md)</ept> (optional)</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">target: <bpt id="p1">[</bpt>PageTarget<ept id="p1">](../interfaces/view-model-ipage-ipagetarget.md)</ept> (省略可)</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="269">
          <source><bpt id="p1">[</bpt>type<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#type)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>タイプ<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md#type)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="273">
          <source>PartMetadata</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">PartMetadata</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="281">
          <source><bpt id="p1">[</bpt>BoundEntity<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#boundentity)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>BoundEntity<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#boundentity)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="285">
          <source><bpt id="p1">[</bpt>BoundField<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#boundfield)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>BoundField<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#boundfield)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="288">
          <source><bpt id="p1">[</bpt>Description<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#description)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>説明<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#description)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="292">
          <source><bpt id="p1">[</bpt>Design<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#design)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Design<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#design)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="293">
          <source>Design: <bpt id="p1">[</bpt>PartDesign<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md)</ept> (optional)</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">デザイン: <bpt id="p1">[</bpt>PartDesign<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartdesign.md)</ept> (オプション)</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="294">
          <source>Design for the target page.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">ターゲット ページの設計をします。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="295">
          <source><bpt id="p1">[</bpt>Editable<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#editable)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>編集可能<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#editable)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="299">
          <source><bpt id="p1">[</bpt>ExtType<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#exttype)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ExtType<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#exttype)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="305">
          <source><bpt id="p1">[</bpt>HelpText<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#helptext)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>HelpText<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#helptext)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="311">
          <source><bpt id="p1">[</bpt>Hidden<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#hidden)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>非表示<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#hidden)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="315">
          <source><bpt id="p1">[</bpt>Id<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#id)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ID<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#id)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="319">
          <source><bpt id="p1">[</bpt>Label<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#label)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ラベル<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#label)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="325">
          <source><bpt id="p1">[</bpt>Name<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#name)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>名前<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#name)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="329">
          <source><bpt id="p1">[</bpt>Order<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#order)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>注文<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#order)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="333">
          <source><bpt id="p1">[</bpt>Target<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#target)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ターゲット<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#target)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="334">
          <source>Target: <bpt id="p1">[</bpt>PageTarget<ept id="p1">](../interfaces/view-model-ipage-ipagetarget.md)</ept> (optional)</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">ターゲット: <bpt id="p1">[</bpt>PageTarget<ept id="p1">](../interfaces/view-model-ipage-ipagetarget.md)</ept> (オプション)</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="335">
          <source>Target page of the part.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">パーツのターゲット ページ。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="336">
          <source><bpt id="p1">[</bpt>Type<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#type)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">[<bpt id="p1">[</bpt>タイプ<ept id="p1">](../interfaces/view-model-control-part-ipart-ipartmetadata.md#type)</ept>]</target></trans-unit>
