...
#### <a name="returns-hyperlinkmetadataview-model-control-hyperlink-ihyperlink-ihyperlinkmetadatamd"></a>[HyperLinkMetadata](view-model-control-hyperlink-ihyperlink-ihyperlinkmetadata.md) を返します
