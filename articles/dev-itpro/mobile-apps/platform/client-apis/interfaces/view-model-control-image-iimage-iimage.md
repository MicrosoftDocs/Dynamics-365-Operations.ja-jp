...
<xliff xmlns:logoport="urn:logoport:xliffeditor:xliff-extras:1.0" xmlns:tilt="urn:logoport:xliffeditor:tilt-non-translatables:1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:oasis:names:tc:xliff:document:1.2" xmlns:xliffext="urn:microsoft:content:schema:xliffextensions" version="1.2" xsi:schemaLocation="urn:oasis:names:tc:xliff:document:1.2 xliff-core-1.2-transitional.xsd">
  <file datatype="xml" source-language="en-US" original="view-model-control-image-iimage-iimage.md" target-language="ja-JP">
    <header>
      <tool tool-company="Microsoft" tool-version="1.0-7889195" tool-name="mdxliff" tool-id="mdxliff"/>
      <xliffext:skl_file_name>view-model-control-image-iimage-iimage.b39acf.14cfb65eaaf6c2a963edd420caa5b022d147d52f.skl</xliffext:skl_file_name>
      <xliffext:version>1.2</xliffext:version>
      <xliffext:ms.openlocfilehash>14cfb65eaaf6c2a963edd420caa5b022d147d52f</xliffext:ms.openlocfilehash>
      <xliffext:ms.sourcegitcommit>9d4c7edd0ae2053c37c7d81cdd180b16bf3a9d3b</xliffext:ms.sourcegitcommit>
      <xliffext:ms.lasthandoff>05/15/2019</xliffext:ms.lasthandoff>
      <xliffext:ms.openlocfilepath>articles\dev-itpro\mobile-apps\platform\client-apis\interfaces\view-model-control-image-iimage-iimage.md</xliffext:ms.openlocfilepath>
    </header>
    <body>
      <group extype="content" id="content">
        <trans-unit xml:space="preserve" translate="yes" id="101" restype="x-metadata">
          <source>Image type</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">画像タイプ</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="102" restype="x-metadata">
          <source>Image control interface for representing images in the mobile app.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">モバイル アプリ内のイメージを表すためのイメージ コントロール インターフェイス。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="103" restype="x-metadata">
          <source>Images can be of any of the following types<ph id="ph1">&amp;amp;</ph>58 DataUri, Base64, URL, AOTResource, or Symbol.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">イメージは、次のいずれかの種類が使用できます<ph id="ph1">&amp;amp;</ph>58 DataUri、Base64、URL、AOTResource、または Symbol。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="106">
          <source>Images can be of any of the following types: DataUri, Base64, URL, AOTResource, or Symbol.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">イメージは、次のいずれかの種類を使用できます。DataUri、Base64、URL、AOTResource、または Symbol。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="109">
          <source><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph>└─ Image</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph>└─ 画像</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="112">
          <source><bpt id="p1">[</bpt>container<ept id="p1">](view-model-control-image-iimage-iimage.md#container)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>コンテナー<ept id="p1">](view-model-control-image-iimage-iimage.md#container)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="113">
          <source><bpt id="p1">[</bpt>generic<ept id="p1">](view-model-control-image-iimage-iimage.md#generic)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ジェネリック<ept id="p1">](view-model-control-image-iimage-iimage.md#generic)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="114">
          <source><bpt id="p1">[</bpt>getDataSource<ept id="p1">](view-model-control-image-iimage-iimage.md#getdatasource)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getDataSource<ept id="p1">](view-model-control-image-iimage-iimage.md#getdatasource)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="115">
          <source><bpt id="p1">[</bpt>hidden<ept id="p1">](view-model-control-image-iimage-iimage.md#hidden)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>非表示<ept id="p1">](view-model-control-image-iimage-iimage.md#hidden)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="116">
          <source><bpt id="p1">[</bpt>imageSource<ept id="p1">](view-model-control-image-iimage-iimage.md#imagesource)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>imageSource<ept id="p1">](view-model-control-image-iimage-iimage.md#imagesource)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="117">
          <source><bpt id="p1">[</bpt>imageView<ept id="p1">](view-model-control-image-iimage-iimage.md#imageview)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>imageView<ept id="p1">](view-model-control-image-iimage-iimage.md#imageview)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="118">
          <source><bpt id="p1">[</bpt>placeholderClass<ept id="p1">](view-model-control-image-iimage-iimage.md#placeholderclass)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>placeholderClass<ept id="p1">](view-model-control-image-iimage-iimage.md#placeholderclass)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="119">
          <source><bpt id="p1">[</bpt>symbol<ept id="p1">](view-model-control-image-iimage-iimage.md#symbol)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>記号<ept id="p1">](view-model-control-image-iimage-iimage.md#symbol)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="121">
          <source><bpt id="p1">[</bpt>applyDesign<ept id="p1">](view-model-control-image-iimage-iimage.md#applydesign)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>applyDesign<ept id="p1">](view-model-control-image-iimage-iimage.md#applydesign)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="122">
          <source><bpt id="p1">[</bpt>dataContext<ept id="p1">](view-model-control-image-iimage-iimage.md#datacontext)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>dataContext<ept id="p1">](view-model-control-image-iimage-iimage.md#datacontext)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="123">
          <source><bpt id="p1">[</bpt>getDesign<ept id="p1">](view-model-control-image-iimage-iimage.md#getdesign)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getDesign<ept id="p1">](view-model-control-image-iimage-iimage.md#getdesign)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="124">
          <source><bpt id="p1">[</bpt>isEditable<ept id="p1">](view-model-control-image-iimage-iimage.md#iseditable)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>isEditable<ept id="p1">](view-model-control-image-iimage-iimage.md#iseditable)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="125">
          <source><bpt id="p1">[</bpt>metadata<ept id="p1">](view-model-control-image-iimage-iimage.md#metadata)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>メタデータ<ept id="p1">](view-model-control-image-iimage-iimage.md#metadata)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="126">
          <source><bpt id="p1">[</bpt>parent<ept id="p1">](view-model-control-image-iimage-iimage.md#parent)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>親<ept id="p1">](view-model-control-image-iimage-iimage.md#parent)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="127">
          <source><bpt id="p1">[</bpt>root<ept id="p1">](view-model-control-image-iimage-iimage.md#root)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ルート<ept id="p1">](view-model-control-image-iimage-iimage.md#root)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">imageSource</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="144">
          <source>imageSource: string</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">imageSource: string</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="145">
          <source>Defines the imageSource.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">ImageSource を定義します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="146">
          <source>imageView</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">imageView</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="147">
          <source>imageView: string</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">imageView: string</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="148">
          <source>Dictates the style of the image.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">画像のスタイルを決定します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="149">
          <source>placeholderClass</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">placeholderClass</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="150">
          <source>placeholderClass: string</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">placeholderClass: string</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="152">
          <source>symbol: string</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">symbol: string</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="153">
          <source>Defines the symbol if the image is of type symbol.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">イメージがシンボル型である場合、シンボルを定義します。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="156">
          <source>applyDesign(design: <bpt id="p1">[</bpt>ImageDesign<ept id="p1">](view-model-control-image-iimage-iimagedesign.md)</ept>): void</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">applyDesign(design: <bpt id="p1">[</bpt>ImageDesign<ept id="p1">](view-model-control-image-iimage-iimagedesign.md)</ept>): void</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="165">
          <source><bpt id="p1">[</bpt>ImageDesign<ept id="p1">](view-model-control-image-iimage-iimagedesign.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ImageDesign<ept id="p1">](view-model-control-image-iimage-iimagedesign.md)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="187">
          <source>metadata(): <bpt id="p1">[</bpt>ImageMetadata<ept id="p1">](view-model-control-image-iimage-iimagemetadata.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">metadata(): <bpt id="p1">[</bpt>ImageMetadata<ept id="p1">](view-model-control-image-iimage-iimagemetadata.md)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="190">
          <source>Returns <bpt id="p1">[</bpt>ImageMetadata<ept id="p1">](view-model-control-image-iimage-iimagemetadata.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ImageMetadata<ept id="p1">](view-model-control-image-iimage-iimagemetadata.md)</ept> を返します</target></trans-unit>
