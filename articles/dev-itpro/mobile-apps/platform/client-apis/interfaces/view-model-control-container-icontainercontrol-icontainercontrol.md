...
<xliff xmlns:logoport="urn:logoport:xliffeditor:xliff-extras:1.0" xmlns:tilt="urn:logoport:xliffeditor:tilt-non-translatables:1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:oasis:names:tc:xliff:document:1.2" xmlns:xliffext="urn:microsoft:content:schema:xliffextensions" version="1.2" xsi:schemaLocation="urn:oasis:names:tc:xliff:document:1.2 xliff-core-1.2-transitional.xsd">
  <file datatype="xml" source-language="en-US" original="view-model-control-container-icontainercontrol-icontainercontrol.md" target-language="ja-JP">
    <header>
      <tool tool-company="Microsoft" tool-version="1.0-7889195" tool-name="mdxliff" tool-id="mdxliff"/>
      <xliffext:skl_file_name>view-model-control-container-icontainercontrol-icontainercontrol.199b35.026f07d75a9d8e1b59d025dc6c1f30d72f3b3028.skl</xliffext:skl_file_name>
      <xliffext:version>1.2</xliffext:version>
      <xliffext:ms.openlocfilehash>026f07d75a9d8e1b59d025dc6c1f30d72f3b3028</xliffext:ms.openlocfilehash>
      <xliffext:ms.sourcegitcommit>9d4c7edd0ae2053c37c7d81cdd180b16bf3a9d3b</xliffext:ms.sourcegitcommit>
      <xliffext:ms.lasthandoff>05/15/2019</xliffext:ms.lasthandoff>
      <xliffext:ms.openlocfilepath>articles\dev-itpro\mobile-apps\platform\client-apis\interfaces\view-model-control-container-icontainercontrol-icontainercontrol.md</xliffext:ms.openlocfilepath>
    </header>
    <body>
      <group extype="content" id="content">
        <trans-unit xml:space="preserve" translate="yes" id="101" restype="x-metadata">
          <source>ContainerControl type</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">ContainerControl タイプ</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="102" restype="x-metadata">
          <source>Container control interface with methods and attributes for all container controls.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">すべてのコンテナー コントロールのメソッドと属性を持つコンテナー コントロール インターフェイス。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="103" restype="x-metadata">
          <source>A container control can contain any number of controls.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">コンテナー コントロールは、コントロールの任意の数を含めることができます。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="108">
          <source><bpt id="p1">[</bpt>Control<ept id="p1">](view-model-control-basecontrol-icontrol-icontrol.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>コントロール<ept id="p1">](view-model-control-basecontrol-icontrol-icontrol.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="109">
          <source><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph>└─ ContainerControl</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph>└─ ContainerControl</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="110">
          <source><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph><ph id="ph4">&amp;nbsp;</ph><ph id="ph5">&amp;nbsp;</ph><ph id="ph6">&amp;nbsp;</ph>└─ <bpt id="p1">[</bpt>Group<ept id="p1">](view-model-control-group-igroup-igroup.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph><ph id="ph4">&amp;nbsp;</ph><ph id="ph5">&amp;nbsp;</ph><ph id="ph6">&amp;nbsp;</ph>└─ <bpt id="p1">[</bpt>グループ<ept id="p1">](view-model-control-group-igroup-igroup.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="111">
          <source><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph><ph id="ph4">&amp;nbsp;</ph><ph id="ph5">&amp;nbsp;</ph><ph id="ph6">&amp;nbsp;</ph>└─ <bpt id="p1">[</bpt>List<ept id="p1">](view-model-control-list-ilist-ilist.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph><ph id="ph4">&amp;nbsp;</ph><ph id="ph5">&amp;nbsp;</ph><ph id="ph6">&amp;nbsp;</ph>└─ <bpt id="p1">[</bpt>リスト<ept id="p1">](view-model-control-list-ilist-ilist.md)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="112">
          <source><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph><ph id="ph4">&amp;nbsp;</ph><ph id="ph5">&amp;nbsp;</ph><ph id="ph6">&amp;nbsp;</ph>└─ <bpt id="p1">[</bpt>Part<ept id="p1">](view-model-control-part-ipart-ipart.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph><ph id="ph4">&amp;nbsp;</ph><ph id="ph5">&amp;nbsp;</ph><ph id="ph6">&amp;nbsp;</ph>└─ <bpt id="p1">[</bpt>パート<ept id="p1">](view-model-control-part-ipart-ipart.md)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="115">
          <source><bpt id="p1">[</bpt>container<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#container)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>コンテナー<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#container)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="116">
          <source><bpt id="p1">[</bpt>generic<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#generic)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ジェネリック<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#generic)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="117">
          <source><bpt id="p1">[</bpt>getDataSource<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#getdatasource)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getDataSource<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#getdatasource)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="118">
          <source><bpt id="p1">[</bpt>hidden<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#hidden)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>非表示<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#hidden)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="120">
          <source><bpt id="p1">[</bpt>applyDesign<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#applydesign)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>applyDesign<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#applydesign)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="121">
          <source><bpt id="p1">[</bpt>dataContext<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#datacontext)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>dataContext<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#datacontext)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="122">
          <source><bpt id="p1">[</bpt>getControl<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#getcontrol)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getControl<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#getcontrol)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="123">
          <source><bpt id="p1">[</bpt>getControlById<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#getcontrolbyid)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getControlById<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#getcontrolbyid)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="124">
          <source><bpt id="p1">[</bpt>getDesign<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#getdesign)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getDesign<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#getdesign)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="125">
          <source><bpt id="p1">[</bpt>isEditable<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#iseditable)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>isEditable<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#iseditable)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="126">
          <source><bpt id="p1">[</bpt>metadata<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#metadata)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>メタデータ<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#metadata)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="127">
          <source><bpt id="p1">[</bpt>parent<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#parent)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>親<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#parent)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="128">
          <source><bpt id="p1">[</bpt>root<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#root)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ルート<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrol.md#root)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="146">
          <source>applyDesign(design: <bpt id="p1">[</bpt>Design<ept id="p1">](view-model-ipage-idesign.md)</ept>): void</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">applyDesign(design: <bpt id="p1">[</bpt>Design<ept id="p1">](view-model-ipage-idesign.md)</ept>): void</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="149">
          <source>Inherited from <bpt id="p1">[</bpt>Control<ept id="p1">](view-model-control-basecontrol-icontrol-icontrol.md)</ept>.<bpt id="p2">[</bpt>applyDesign<ept id="p2">](view-model-control-basecontrol-icontrol-icontrol.md#applydesign)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Control<ept id="p1">](view-model-control-basecontrol-icontrol-icontrol.md)</ept>.<bpt id="p2">[</bpt>applyDesign<ept id="p2">](view-model-control-basecontrol-icontrol-icontrol.md#applydesign)</ept> から継承</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="199">
          <source>metadata(): <bpt id="p1">[</bpt>ContainerControlMetadata<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrolmetadata.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">metadata(): <bpt id="p1">[</bpt>ContainerControlMetadata<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrolmetadata.md)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="201">
          <source>Overrides <bpt id="p1">[</bpt>Control<ept id="p1">](view-model-control-basecontrol-icontrol-icontrol.md)</ept>.<bpt id="p2">[</bpt>metadata<ept id="p2">](view-model-control-basecontrol-icontrol-icontrol.md#metadata)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>Control<ept id="p1">](view-model-control-basecontrol-icontrol-icontrol.md)</ept>.<bpt id="p2">[</bpt>metadata<ept id="p2">](view-model-control-basecontrol-icontrol-icontrol.md#metadata)</ept> をオーバーライドします。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="202">
          <source>Returns <bpt id="p1">[</bpt>ContainerControlMetadata<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrolmetadata.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ContainerControlMetadata<ept id="p1">](view-model-control-container-icontainercontrol-icontainercontrolmetadata.md)</ept> を返します</target></trans-unit>
