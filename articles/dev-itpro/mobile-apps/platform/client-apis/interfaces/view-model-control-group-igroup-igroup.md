...
<xliff xmlns:logoport="urn:logoport:xliffeditor:xliff-extras:1.0" xmlns:tilt="urn:logoport:xliffeditor:tilt-non-translatables:1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:oasis:names:tc:xliff:document:1.2" xmlns:xliffext="urn:microsoft:content:schema:xliffextensions" version="1.2" xsi:schemaLocation="urn:oasis:names:tc:xliff:document:1.2 xliff-core-1.2-transitional.xsd">
  <file datatype="xml" source-language="en-US" original="view-model-control-group-igroup-igroup.md" target-language="ja-JP">
    <header>
      <tool tool-company="Microsoft" tool-version="1.0-7889195" tool-name="mdxliff" tool-id="mdxliff"/>
      <xliffext:skl_file_name>view-model-control-group-igroup-igroup.e2cf88.5b1ef0ed797e3546701a81b8013a76df71796d24.skl</xliffext:skl_file_name>
      <xliffext:version>1.2</xliffext:version>
      <xliffext:ms.openlocfilehash>5b1ef0ed797e3546701a81b8013a76df71796d24</xliffext:ms.openlocfilehash>
      <xliffext:ms.sourcegitcommit>9d4c7edd0ae2053c37c7d81cdd180b16bf3a9d3b</xliffext:ms.sourcegitcommit>
      <xliffext:ms.lasthandoff>05/15/2019</xliffext:ms.lasthandoff>
      <xliffext:ms.openlocfilepath>articles\dev-itpro\mobile-apps\platform\client-apis\interfaces\view-model-control-group-igroup-igroup.md</xliffext:ms.openlocfilepath>
    </header>
    <body>
      <group extype="content" id="content">
        <trans-unit xml:space="preserve" translate="yes" id="101" restype="x-metadata">
          <source>Group type</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">グループ タイプ</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="102" restype="x-metadata">
          <source>Group container control type.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">グループ コンテナーのコントロール タイプ。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="105">
          <source>A group control is a container control that has any number of controls as children.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">グループ コントロールは、任意の数のコントロールを子として持つコンテナー コントロールです。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="108">
          <source><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph>└─ Group</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><ph id="ph1">&amp;nbsp;</ph><ph id="ph2">&amp;nbsp;</ph><ph id="ph3">&amp;nbsp;</ph>└─ グループ</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="111">
          <source><bpt id="p1">[</bpt>container<ept id="p1">](view-model-control-group-igroup-igroup.md#container)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>コンテナー<ept id="p1">](view-model-control-group-igroup-igroup.md#container)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="112">
          <source><bpt id="p1">[</bpt>generic<ept id="p1">](view-model-control-group-igroup-igroup.md#generic)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ジェネリック<ept id="p1">](view-model-control-group-igroup-igroup.md#generic)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="113">
          <source><bpt id="p1">[</bpt>getDataSource<ept id="p1">](view-model-control-group-igroup-igroup.md#getdatasource)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getDataSource<ept id="p1">](view-model-control-group-igroup-igroup.md#getdatasource)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="114">
          <source><bpt id="p1">[</bpt>hidden<ept id="p1">](view-model-control-group-igroup-igroup.md#hidden)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>非表示<ept id="p1">](view-model-control-group-igroup-igroup.md#hidden)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="116">
          <source><bpt id="p1">[</bpt>applyDesign<ept id="p1">](view-model-control-group-igroup-igroup.md#applydesign)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>applyDesign<ept id="p1">](view-model-control-group-igroup-igroup.md#applydesign)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="117">
          <source><bpt id="p1">[</bpt>dataContext<ept id="p1">](view-model-control-group-igroup-igroup.md#datacontext)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>dataContext<ept id="p1">](view-model-control-group-igroup-igroup.md#datacontext)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="118">
          <source><bpt id="p1">[</bpt>getChildren<ept id="p1">](view-model-control-group-igroup-igroup.md#getchildren)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getChildren<ept id="p1">](view-model-control-group-igroup-igroup.md#getchildren)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="119">
          <source><bpt id="p1">[</bpt>getControl<ept id="p1">](view-model-control-group-igroup-igroup.md#getcontrol)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getControl<ept id="p1">](view-model-control-group-igroup-igroup.md#getcontrol)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="120">
          <source><bpt id="p1">[</bpt>getControlById<ept id="p1">](view-model-control-group-igroup-igroup.md#getcontrolbyid)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getControlById<ept id="p1">](view-model-control-group-igroup-igroup.md#getcontrolbyid)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="121">
          <source><bpt id="p1">[</bpt>getDesign<ept id="p1">](view-model-control-group-igroup-igroup.md#getdesign)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>getDesign<ept id="p1">](view-model-control-group-igroup-igroup.md#getdesign)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="122">
          <source><bpt id="p1">[</bpt>isEditable<ept id="p1">](view-model-control-group-igroup-igroup.md#iseditable)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>isEditable<ept id="p1">](view-model-control-group-igroup-igroup.md#iseditable)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="123">
          <source><bpt id="p1">[</bpt>metadata<ept id="p1">](view-model-control-group-igroup-igroup.md#metadata)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>メタデータ<ept id="p1">](view-model-control-group-igroup-igroup.md#metadata)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="124">
          <source><bpt id="p1">[</bpt>parent<ept id="p1">](view-model-control-group-igroup-igroup.md#parent)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>親<ept id="p1">](view-model-control-group-igroup-igroup.md#parent)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="125">
          <source><bpt id="p1">[</bpt>root<ept id="p1">](view-model-control-group-igroup-igroup.md#root)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>ルート<ept id="p1">](view-model-control-group-igroup-igroup.md#root)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="144">
          <source>applyDesign(IDesign: <bpt id="p1">[</bpt>GroupDesign<ept id="p1">](view-model-control-group-igroup-igroupdesign.md)</ept>): void</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">applyDesign(IDesign: <bpt id="p1">[</bpt>GroupDesign<ept id="p1">](view-model-control-group-igroup-igroupdesign.md)</ept>): void</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="153">
          <source><bpt id="p1">[</bpt>GroupDesign<ept id="p1">](view-model-control-group-igroup-igroupdesign.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>GroupDesign<ept id="p1">](view-model-control-group-igroup-igroupdesign.md)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="160">
          <source>getChildren</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">getChildren</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="161">
          <source>getChildren(): <bpt id="p1">[</bpt>Control<ept id="p1">](view-model-control-basecontrol-icontrol-icontrol.md)</ept> [ ]</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">getChildren(): <bpt id="p1">[</bpt>Control<ept id="p1">](view-model-control-basecontrol-icontrol-icontrol.md)</ept> [ ]</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="162">
          <source>Returns the list of children associated with this group control.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">このグループ コントロールに関連付けられている子のリストを返します。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="203">
          <source>metadata(): <bpt id="p1">[</bpt>GroupMetadata<ept id="p1">](view-model-control-group-igroup-igroupmetadata.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">metadata(): <bpt id="p1">[</bpt>GroupMetadata<ept id="p1">](view-model-control-group-igroup-igroupmetadata.md)</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="206">
          <source>Returns <bpt id="p1">[</bpt>GroupMetadata<ept id="p1">](view-model-control-group-igroup-igroupmetadata.md)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt>GroupMetadata<ept id="p1">](view-model-control-group-igroup-igroupmetadata.md)</ept> を返します</target></trans-unit>
