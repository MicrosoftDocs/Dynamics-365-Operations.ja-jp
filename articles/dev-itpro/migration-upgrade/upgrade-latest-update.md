...
**データ アップグレードに失敗した場合は**、**パッケージを戻す** ボタンを使用してデータ アップグレード パッケージ ステップを元に戻した後、**アップグレード** メニューを使用して **ロールバック** を選択し、データ アップグレードが開始される前のポイントにデータベースを復元する必要があります。 これを行う前に、次のデータ アップグレードを円滑に実行できるように、ログをダウンロードしておき、失敗の原因を特定することを強くお勧めします。
