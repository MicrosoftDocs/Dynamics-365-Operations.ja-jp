...
1. ターゲット サンドボックスの **環境の詳細** ページにアクセスし、**メンテナンス** > **データベースの移動** メニューのオプションをクリックします。
...
>
> **2019 年 1 月 31 日より後のサービスの日付では、データベースの更新のためのサービス要求は認められなくなります**。 この日付の跡、すべての更新処理が上記のセルフサービス アクションを使用して実行されます。
