...
1.  Microsoft Dynamics Lifecycle Services (LCS) ウィンドウの左上にあるハンバーガー アイコンをクリックし、一覧から**作業項目**を選択します。 [![作業項目](./media/selectworkitems.png)](./media/selectworkitems.png)
2.  **作業項目**ページで、ツール バーの**追加**をクリックし、**データベース ポイントインタイム復元要求**をクリックします。 [![データベース ポイントインタイム復元要求](./media/createrequest.png)](./media/createrequest.png)
3.  **データベース ポイントインタイム復元要求**ダイアログ ボックスで、これらの手順に従います。
    1.  **環境名**フィールドで、復元する環境を選択します。 **注記:** Azure SQL データベース環境のみを復元することができます。 したがって、Microsoft SQL Server に基づく 1 つのボックス環境は選択できません。
