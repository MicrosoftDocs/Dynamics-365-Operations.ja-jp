...
### <a name="methods"></a><span data-ttu-id="06be7-108">方法</span><span class="sxs-lookup"><span data-stu-id="06be7-108">Methods</span></span>
...
<span data-ttu-id="06be7-125">AbsoluteFieldBinding クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="06be7-125">Initializes a new instance of the AbsoluteFieldBinding class.</span></span>
...
#### <a name="return-value"></a><span data-ttu-id="06be7-141">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-141">Return Value</span></span>
...
<span data-ttu-id="06be7-159">アクセス許可クラス オブジェクトのコピーを作成し、返します。</span><span class="sxs-lookup"><span data-stu-id="06be7-159">Creates and returns a copy of a permission class object.</span></span>
...
### <a name="method-new"></a><span data-ttu-id="06be7-175">メソッド new</span><span class="sxs-lookup"><span data-stu-id="06be7-175">Method new</span></span>
...
#### <a name="return-value"></a><span data-ttu-id="06be7-191">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-191">Return Value</span></span>
...
<span data-ttu-id="06be7-243">AOS セッションの ID。</span><span class="sxs-lookup"><span data-stu-id="06be7-243">The ID of the AOS session.</span></span>
...
#### <a name="remarks"></a><span data-ttu-id="06be7-283">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-283">Remarks</span></span>
...
#### <a name="parameters"></a><span data-ttu-id="06be7-294">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-294">Parameters</span></span>
...
### <a name="method-addstring"></a><span data-ttu-id="06be7-320">メソッド addString</span><span class="sxs-lookup"><span data-stu-id="06be7-320">Method addString</span></span>
...
<span data-ttu-id="06be7-332">現在のテーブルのフィールドのリストに実数型の新しいフィールドを追加します。</span><span class="sxs-lookup"><span data-stu-id="06be7-332">Adds a new field of the real type to the list of fields for the current table.</span></span>
...
#### <a name="parameters"></a><span data-ttu-id="06be7-344">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-344">Parameters</span></span>
...
#### <a name="remarks"></a><span data-ttu-id="06be7-358">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-358">Remarks</span></span>
...
### <a name="method-getselectednodemodelname"></a><span data-ttu-id="06be7-376">メソッド getSelectedNodeModelName</span><span class="sxs-lookup"><span data-stu-id="06be7-376">Method getSelectedNodeModelName</span></span>
...
| <span data-ttu-id="06be7-412">public str xml(\[int indent\])</span><span class="sxs-lookup"><span data-stu-id="06be7-412">public str xml(\[int indent\])</span></span>                      | <span data-ttu-id="06be7-413">現在のオブジェクトを表す XML 文字列を返します。</span><span class="sxs-lookup"><span data-stu-id="06be7-413">Returns an XML string that represents the current object.</span></span>                                           |
...
<span data-ttu-id="06be7-429">指数</span><span class="sxs-lookup"><span data-stu-id="06be7-429">index</span></span>  
...
<span data-ttu-id="06be7-436">配列に値を格納するために使用する最上位のインデックスを取得します。</span><span class="sxs-lookup"><span data-stu-id="06be7-436">Retrieves the highest index that is used to store a value in the array.</span></span>
...
-   <span data-ttu-id="06be7-447">コンテナのバージョン番号。</span><span class="sxs-lookup"><span data-stu-id="06be7-447">A version number for the container.</span></span>
...
<span data-ttu-id="06be7-455">配列の内容を説明する文字列を返します。</span><span class="sxs-lookup"><span data-stu-id="06be7-455">Returns a string that describes the contents of the array.</span></span>
...
<span data-ttu-id="06be7-464">配列の要素のデータ型。</span><span class="sxs-lookup"><span data-stu-id="06be7-464">The data type of the elements in the array.</span></span>
...
#### <a name="return-value"></a><span data-ttu-id="06be7-478">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-478">Return Value</span></span>
...
<span data-ttu-id="06be7-488">現在のオブジェクトを表す XML 文字列を返します。</span><span class="sxs-lookup"><span data-stu-id="06be7-488">Returns an XML string that represents the current object.</span></span>
...
#### <a name="remarks"></a><span data-ttu-id="06be7-504">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-504">Remarks</span></span>
...
#### <a name="examples"></a><span data-ttu-id="06be7-506">例</span><span class="sxs-lookup"><span data-stu-id="06be7-506">Examples</span></span>

<span data-ttu-id="06be7-507">次の例では、配列を作成し、2 つのセットを追加します。</span><span class="sxs-lookup"><span data-stu-id="06be7-507">The following example creates an array and adds two sets to it.</span></span> <span data-ttu-id="06be7-508">配列がパックされ、それを使用して、新しい配列が作成されます。</span><span class="sxs-lookup"><span data-stu-id="06be7-508">The array is packed and then used to create a new array.</span></span>
...
### <a name="method-createfromxml"></a><span data-ttu-id="06be7-509">メソッド createFromXML</span><span class="sxs-lookup"><span data-stu-id="06be7-509">Method createFromXML</span></span>

    public static Array createFromXML(Object xmlnode)

#### <a name="parameters"></a><span data-ttu-id="06be7-510">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-510">Parameters</span></span>

<span data-ttu-id="06be7-511">xmlnode</span><span class="sxs-lookup"><span data-stu-id="06be7-511">xmlnode</span></span>  

#### <a name="return-value"></a><span data-ttu-id="06be7-512">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-512">Return Value</span></span>

### <a name="method-new"></a><span data-ttu-id="06be7-513">メソッド new</span><span class="sxs-lookup"><span data-stu-id="06be7-513">Method new</span></span>

<span data-ttu-id="06be7-514">各要素が指定されたタイプを持つ配列を作成します。</span><span class="sxs-lookup"><span data-stu-id="06be7-514">Creates an array in which each element has the specified type.</span></span>

    public void new(Types Type)

#### <a name="parameters"></a><span data-ttu-id="06be7-515">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-515">Parameters</span></span>

<span data-ttu-id="06be7-516">種類</span><span class="sxs-lookup"><span data-stu-id="06be7-516">Type</span></span>  
<span data-ttu-id="06be7-517">配列要素のデータ型。</span><span class="sxs-lookup"><span data-stu-id="06be7-517">The data type of the array elements.</span></span>

#### <a name="remarks"></a><span data-ttu-id="06be7-518">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-518">Remarks</span></span>

<span data-ttu-id="06be7-519">可能な値は、Types システム列挙に使用可能な値です。</span><span class="sxs-lookup"><span data-stu-id="06be7-519">The possible values are those that are available for the Types system enumeration:</span></span>

-   <span data-ttu-id="06be7-520">AnyType</span><span class="sxs-lookup"><span data-stu-id="06be7-520">AnyType</span></span>
-   <span data-ttu-id="06be7-521">BLOB</span><span class="sxs-lookup"><span data-stu-id="06be7-521">BLOB</span></span>
-   <span data-ttu-id="06be7-522">クラス</span><span class="sxs-lookup"><span data-stu-id="06be7-522">Class</span></span>
-   <span data-ttu-id="06be7-523">コンテナー</span><span class="sxs-lookup"><span data-stu-id="06be7-523">Container</span></span>
-   <span data-ttu-id="06be7-524">日</span><span class="sxs-lookup"><span data-stu-id="06be7-524">Date</span></span>
-   <span data-ttu-id="06be7-525">日時</span><span class="sxs-lookup"><span data-stu-id="06be7-525">DateTime</span></span>
-   <span data-ttu-id="06be7-526">列挙</span><span class="sxs-lookup"><span data-stu-id="06be7-526">Enum</span></span>
-   <span data-ttu-id="06be7-527">Guid</span><span class="sxs-lookup"><span data-stu-id="06be7-527">Guid</span></span>
-   <span data-ttu-id="06be7-528">Int64</span><span class="sxs-lookup"><span data-stu-id="06be7-528">Int64</span></span>
-   <span data-ttu-id="06be7-529">整数</span><span class="sxs-lookup"><span data-stu-id="06be7-529">Integer</span></span>

#### <a name="examples"></a><span data-ttu-id="06be7-530">例</span><span class="sxs-lookup"><span data-stu-id="06be7-530">Examples</span></span>

<span data-ttu-id="06be7-531">次の例では、整数の配列を作成します。</span><span class="sxs-lookup"><span data-stu-id="06be7-531">The following example creates an array of integers.</span></span>

    Array intArray = new Array(Types::Integer);

## <a name="class-asciiio"></a><span data-ttu-id="06be7-532">クラス AsciiIo</span><span class="sxs-lookup"><span data-stu-id="06be7-532">Class AsciiIo</span></span>
    class AsciiIo extends CommaIo

<span data-ttu-id="06be7-533">AsciiIo クラスには、ASCII ファイルの読み取りと書き込みを行う機能があります。</span><span class="sxs-lookup"><span data-stu-id="06be7-533">The AsciiIo class provides functionality for reading and writing ASCII files.</span></span>

### <a name="remarks"></a><span data-ttu-id="06be7-534">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-534">Remarks</span></span>

<span data-ttu-id="06be7-535">TextIo クラスには、さまざまなコード ページを使用するファイルの読み取りと書き込みを行う機能があります。</span><span class="sxs-lookup"><span data-stu-id="06be7-535">The TextIo class provides functionality for reading and writing files that use various code pages.</span></span> <span data-ttu-id="06be7-536">AsciiIO クラスは、ANSI コード ページ (ACP) 文字のみサポートします。</span><span class="sxs-lookup"><span data-stu-id="06be7-536">The AsciiIO class supports only ANSI code page (ACP) characters.</span></span> <span data-ttu-id="06be7-537">AsciiIO クラスを使用する既存のコードは、ファイルに ACP 以外の文字が含まれている場合や、.xpo ファイルなどの Finance and Operations でのみ使用されるファイルの場合に TextIO クラスを使用するように変換する必要があります。</span><span class="sxs-lookup"><span data-stu-id="06be7-537">Existing code that uses the AsciiIO class must be converted to use the TextIO class if the file contains non-ACP characters, or if it is a file that is used only in Finance and Operations, such as an .xpo file.</span></span>

### <a name="examples"></a><span data-ttu-id="06be7-538">例</span><span class="sxs-lookup"><span data-stu-id="06be7-538">Examples</span></span>

### <a name="methods"></a><span data-ttu-id="06be7-539">メソッド</span><span class="sxs-lookup"><span data-stu-id="06be7-539">Methods</span></span>

| <span data-ttu-id="06be7-540">方法</span><span class="sxs-lookup"><span data-stu-id="06be7-540">Method</span></span>                                       | <span data-ttu-id="06be7-541">説明</span><span class="sxs-lookup"><span data-stu-id="06be7-541">Description</span></span>                                                                                                                      |
|----------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="06be7-542">public str inFieldDelimiter(\[str value\])</span><span class="sxs-lookup"><span data-stu-id="06be7-542">public str inFieldDelimiter(\[str value\])</span></span>   | <span data-ttu-id="06be7-543">AsciiIO オブジェクトによって表される入力ファイルのフィールド区切り記号として使用される文字を設定または取得します。</span><span class="sxs-lookup"><span data-stu-id="06be7-543">Sets or retrieves the character that is used as the field delimiter of an input file that is represented by an AsciiIO object.</span></span>   |
| <span data-ttu-id="06be7-544">public str inRecordDelimiter(\[str value\])</span><span class="sxs-lookup"><span data-stu-id="06be7-544">public str inRecordDelimiter(\[str value\])</span></span>  | <span data-ttu-id="06be7-545">AsciiIO オブジェクトによって表される入力ファイルのレコード区切り記号として使用される文字を設定または取得します。</span><span class="sxs-lookup"><span data-stu-id="06be7-545">Sets or retrieves the character that is used as the record delimiter of an input file that is represented by an AsciiIO object.</span></span>  |
| <span data-ttu-id="06be7-546">public int inRecordLength(\[int value\])</span><span class="sxs-lookup"><span data-stu-id="06be7-546">public int inRecordLength(\[int value\])</span></span>     | <span data-ttu-id="06be7-547">入力ファイルのレコードの長さを設定または取得します。</span><span class="sxs-lookup"><span data-stu-id="06be7-547">Sets or retrieves the record length for an input file.</span></span>                                                                           |
| <span data-ttu-id="06be7-548">public str outFieldDelimiter(\[str value\])</span><span class="sxs-lookup"><span data-stu-id="06be7-548">public str outFieldDelimiter(\[str value\])</span></span>  | <span data-ttu-id="06be7-549">AsciiIO オブジェクトによって表される出力ファイルのフィールド区切り記号として使用される文字を設定または取得します。</span><span class="sxs-lookup"><span data-stu-id="06be7-549">Sets or retrieves the character that is used as the field delimiter of an output file that is represented by an AsciiIO object.</span></span>  |
| <span data-ttu-id="06be7-550">public str outRecordDelimiter(\[str value\])</span><span class="sxs-lookup"><span data-stu-id="06be7-550">public str outRecordDelimiter(\[str value\])</span></span> | <span data-ttu-id="06be7-551">AsciiIO オブジェクトによって表される出力ファイルのレコード区切り記号として使用される文字を設定または取得します。</span><span class="sxs-lookup"><span data-stu-id="06be7-551">Sets or retrieves the character that is used as the record delimiter of an output file that is represented by an AsciiIO object.</span></span> |
| <span data-ttu-id="06be7-552">public container read()</span><span class="sxs-lookup"><span data-stu-id="06be7-552">public container read()</span></span>                      | <span data-ttu-id="06be7-553">Io オブジェクトから次の完全なレコードを読み取ります。</span><span class="sxs-lookup"><span data-stu-id="06be7-553">Reads the next full record from the Io object.</span></span>                                                                                   |
| <span data-ttu-id="06be7-554">public IO\_Status status()</span><span class="sxs-lookup"><span data-stu-id="06be7-554">public IO\_Status status()</span></span>                   | <span data-ttu-id="06be7-555">ファイルでの最後の操作のステータスを返します。</span><span class="sxs-lookup"><span data-stu-id="06be7-555">Returns the status of the last operation on the file.</span></span>                                                                            |
| <span data-ttu-id="06be7-556">public boolean write(VarArg values)</span><span class="sxs-lookup"><span data-stu-id="06be7-556">public boolean write(VarArg values)</span></span>          | <span data-ttu-id="06be7-557">単純型の値を記述します。</span><span class="sxs-lookup"><span data-stu-id="06be7-557">Writes values of a simple type.</span></span>                                                                                                  |
| <span data-ttu-id="06be7-558">public boolean writeChar(int int)</span><span class="sxs-lookup"><span data-stu-id="06be7-558">public boolean writeChar(int int)</span></span>            |                                                                                                                                  |
| <span data-ttu-id="06be7-559">public boolean writeExp(container data)</span><span class="sxs-lookup"><span data-stu-id="06be7-559">public boolean writeExp(container data)</span></span>      | <span data-ttu-id="06be7-560">コンテナのコンテンツをファイルに記述します。</span><span class="sxs-lookup"><span data-stu-id="06be7-560">Writes the content of a container to a file.</span></span>                                                                                     |
| <span data-ttu-id="06be7-561">public boolean writeRaw(str data)</span><span class="sxs-lookup"><span data-stu-id="06be7-561">public boolean writeRaw(str data)</span></span>            |                                                                                                                                  |
| <span data-ttu-id="06be7-562">public void finalize()</span><span class="sxs-lookup"><span data-stu-id="06be7-562">public void finalize()</span></span>                       | <span data-ttu-id="06be7-563">ファイルを閉じ、ファイル バッファーをディスクにフラッシュします。</span><span class="sxs-lookup"><span data-stu-id="06be7-563">Closes the file and then flushes the file buffers to disk.</span></span>                                                                       |
| <span data-ttu-id="06be7-564">public void new(str filename, str mode)</span><span class="sxs-lookup"><span data-stu-id="06be7-564">public void new(str filename, str mode)</span></span>      | <span data-ttu-id="06be7-565">AsciiIo クラスのインスタンスを作成します。</span><span class="sxs-lookup"><span data-stu-id="06be7-565">Creates an instance of the AsciiIo class.</span></span>                                                                                        |

### <a name="method-infielddelimiter"></a><span data-ttu-id="06be7-566">メソッド inFieldDelimiter</span><span class="sxs-lookup"><span data-stu-id="06be7-566">Method inFieldDelimiter</span></span>

<span data-ttu-id="06be7-567">AsciiIO オブジェクトによって表される入力ファイルのフィールド区切り記号として使用される文字を設定または取得します。</span><span class="sxs-lookup"><span data-stu-id="06be7-567">Sets or retrieves the character that is used as the field delimiter of an input file that is represented by an AsciiIO object.</span></span>

    public str inFieldDelimiter([str value])

#### <a name="parameters"></a><span data-ttu-id="06be7-568">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-568">Parameters</span></span>

<span data-ttu-id="06be7-569">値</span><span class="sxs-lookup"><span data-stu-id="06be7-569">value</span></span>  
<span data-ttu-id="06be7-570">フィールドの区切り記号として割り当てられる文字。</span><span class="sxs-lookup"><span data-stu-id="06be7-570">The character to assign as the field delimiter.</span></span>

#### <a name="return-value"></a><span data-ttu-id="06be7-571">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-571">Return Value</span></span>

<span data-ttu-id="06be7-572">フィールドの区切り記号として使用される文字。</span><span class="sxs-lookup"><span data-stu-id="06be7-572">The character that is used as the field delimiter.</span></span>

### <a name="method-inrecorddelimiter"></a><span data-ttu-id="06be7-573">メソッド inRecordDelimiter</span><span class="sxs-lookup"><span data-stu-id="06be7-573">Method inRecordDelimiter</span></span>

<span data-ttu-id="06be7-574">AsciiIO オブジェクトによって表される入力ファイルのレコード区切り記号として使用される文字を設定または取得します。</span><span class="sxs-lookup"><span data-stu-id="06be7-574">Sets or retrieves the character that is used as the record delimiter of an input file that is represented by an AsciiIO object.</span></span>

    public str inRecordDelimiter([str value])

#### <a name="parameters"></a><span data-ttu-id="06be7-575">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-575">Parameters</span></span>

<span data-ttu-id="06be7-576">値</span><span class="sxs-lookup"><span data-stu-id="06be7-576">value</span></span>  
<span data-ttu-id="06be7-577">レコードの区切り記号として割り当てられる文字。</span><span class="sxs-lookup"><span data-stu-id="06be7-577">The character to assign as the record delimiter.</span></span>

#### <a name="return-value"></a><span data-ttu-id="06be7-578">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-578">Return Value</span></span>

<span data-ttu-id="06be7-579">レコードの区切り記号として使用される文字。</span><span class="sxs-lookup"><span data-stu-id="06be7-579">The character that is used as the record delimiter.</span></span>

#### <a name="remarks"></a><span data-ttu-id="06be7-580">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-580">Remarks</span></span>

<span data-ttu-id="06be7-581">標準的なテキストについては、区切り記号は改行文字です。</span><span class="sxs-lookup"><span data-stu-id="06be7-581">For standard text, the delimiter is a newline character.</span></span>

### <a name="method-inrecordlength"></a><span data-ttu-id="06be7-582">メソッド inRecordLength</span><span class="sxs-lookup"><span data-stu-id="06be7-582">Method inRecordLength</span></span>

<span data-ttu-id="06be7-583">入力ファイルのレコードの長さを設定または取得します。</span><span class="sxs-lookup"><span data-stu-id="06be7-583">Sets or retrieves the record length for an input file.</span></span>

    public int inRecordLength([int value])

#### <a name="parameters"></a><span data-ttu-id="06be7-584">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-584">Parameters</span></span>

<span data-ttu-id="06be7-585">値</span><span class="sxs-lookup"><span data-stu-id="06be7-585">value</span></span>  
<span data-ttu-id="06be7-586">入力ファイルのレコード長として割り当てる値。</span><span class="sxs-lookup"><span data-stu-id="06be7-586">The value to assign as the record length for the input file.</span></span>

#### <a name="return-value"></a><span data-ttu-id="06be7-587">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-587">Return Value</span></span>

<span data-ttu-id="06be7-588">入力ファイルのレコードの長さ。</span><span class="sxs-lookup"><span data-stu-id="06be7-588">The record length for the input file.</span></span>

#### <a name="remarks"></a><span data-ttu-id="06be7-589">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-589">Remarks</span></span>

<span data-ttu-id="06be7-590">固定長形式になっているファイルについては、inRecordLength プロパティを使用して、各レコードに対して指定された文字数以上が読み取られていないことを保証します。</span><span class="sxs-lookup"><span data-stu-id="06be7-590">For files that have a fixed-length format, use the inRecordLength property to guarantee that no more than the specified number of characters is read for each record.</span></span> <span data-ttu-id="06be7-591">レコード フォーマットが指定された inRecordDelimiter プロパティ値で上書きされた場合 (つまり、固定長が読み込まれる前に inRecordDelimiter 値が満たされている場合)、レコードは受け入れられ、それ以上のデータは読み込まれません。</span><span class="sxs-lookup"><span data-stu-id="06be7-591">If the record format is overruled by a specified inRecordDelimiter property value (in other words, if the inRecordDelimiter value is met before the fixed length is read), the record is accepted, and no more data is read.</span></span> <span data-ttu-id="06be7-592">固定数の文字を確実に読み取るには、inRecordDelimiter プロパティ値を空の文字列に設定します。</span><span class="sxs-lookup"><span data-stu-id="06be7-592">To make sure that a fixed number of characters is read, set the inRecordDelimiter property value to an empty string.</span></span> <span data-ttu-id="06be7-593">inRecordDelimiter プロパティ値が見つからない場合、inRecordDelimiter プロパティ値は読み取れる最大文字数になります。</span><span class="sxs-lookup"><span data-stu-id="06be7-593">When no inRecordDelimiter property value is found, the inRecordDelimiter property value is the maximum limit of characters to read.</span></span> <span data-ttu-id="06be7-594">レコードの長さのチェックを無効にするには、inRecordDelimiter プロパティ値を 0 (ゼロ) に設定します。</span><span class="sxs-lookup"><span data-stu-id="06be7-594">Set the inRecordDelimiter property value to 0 (zero) to disable the check of the record length.</span></span>

### <a name="method-outfielddelimiter"></a><span data-ttu-id="06be7-595">メソッド outFieldDelimiter</span><span class="sxs-lookup"><span data-stu-id="06be7-595">Method outFieldDelimiter</span></span>

<span data-ttu-id="06be7-596">AsciiIO オブジェクトによって表される出力ファイルのフィールド区切り記号として使用される文字を設定または取得します。</span><span class="sxs-lookup"><span data-stu-id="06be7-596">Sets or retrieves the character that is used as the field delimiter of an output file that is represented by an AsciiIO object.</span></span>

    public str outFieldDelimiter([str value])

#### <a name="parameters"></a><span data-ttu-id="06be7-597">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-597">Parameters</span></span>

<span data-ttu-id="06be7-598">値</span><span class="sxs-lookup"><span data-stu-id="06be7-598">value</span></span>  
<span data-ttu-id="06be7-599">フィールドの区切り記号として割り当てられる文字。</span><span class="sxs-lookup"><span data-stu-id="06be7-599">The character to assign as the field delimiter.</span></span>

#### <a name="return-value"></a><span data-ttu-id="06be7-600">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-600">Return Value</span></span>

<span data-ttu-id="06be7-601">フィールドの区切り記号として使用される文字。</span><span class="sxs-lookup"><span data-stu-id="06be7-601">The character that is used as the field delimiter.</span></span>

### <a name="method-outrecorddelimiter"></a><span data-ttu-id="06be7-602">メソッド outRecordDelimiter</span><span class="sxs-lookup"><span data-stu-id="06be7-602">Method outRecordDelimiter</span></span>

<span data-ttu-id="06be7-603">AsciiIO オブジェクトによって表される出力ファイルのレコード区切り記号として使用される文字を設定または取得します。</span><span class="sxs-lookup"><span data-stu-id="06be7-603">Sets or retrieves the character that is used as the record delimiter of an output file that is represented by an AsciiIO object.</span></span>

    public str outRecordDelimiter([str value])

#### <a name="parameters"></a><span data-ttu-id="06be7-604">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-604">Parameters</span></span>

<span data-ttu-id="06be7-605">値</span><span class="sxs-lookup"><span data-stu-id="06be7-605">value</span></span>  
<span data-ttu-id="06be7-606">レコードの区切り記号として割り当てられる文字。</span><span class="sxs-lookup"><span data-stu-id="06be7-606">The character to assign as the record delimiter.</span></span>

#### <a name="return-value"></a><span data-ttu-id="06be7-607">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-607">Return Value</span></span>

<span data-ttu-id="06be7-608">レコードの区切り記号として使用される文字。</span><span class="sxs-lookup"><span data-stu-id="06be7-608">The character that is used as the record delimiter.</span></span>

#### <a name="remarks"></a><span data-ttu-id="06be7-609">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-609">Remarks</span></span>

<span data-ttu-id="06be7-610">標準的なテキスト ファイルについては、区切り記号は改行文字です。</span><span class="sxs-lookup"><span data-stu-id="06be7-610">For standard text files, the delimiter is a newline character.</span></span>

### <a name="method-read"></a><span data-ttu-id="06be7-611">メソッド read</span><span class="sxs-lookup"><span data-stu-id="06be7-611">Method read</span></span>

<span data-ttu-id="06be7-612">Io オブジェクトから次の完全なレコードを読み取ります。</span><span class="sxs-lookup"><span data-stu-id="06be7-612">Reads the next full record from the Io object.</span></span>

    public container read()

#### <a name="return-value"></a><span data-ttu-id="06be7-613">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-613">Return Value</span></span>

<span data-ttu-id="06be7-614">Io オブジェクトからの次の完全なレコード。</span><span class="sxs-lookup"><span data-stu-id="06be7-614">The next full record from the Io object.</span></span>

#### <a name="remarks"></a><span data-ttu-id="06be7-615">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-615">Remarks</span></span>

<span data-ttu-id="06be7-616">次の完全なレコードの定義は、次のプロパティ、inFieldDelimiter、inRecordDelimiter、および inRecordLength によって制御されます。</span><span class="sxs-lookup"><span data-stu-id="06be7-616">The definition of the next full record is controlled by the following properties: inFieldDelimiter, inRecordDelimiter, and inRecordLength.</span></span> <span data-ttu-id="06be7-617">レコードはコンテナーとして返されます。</span><span class="sxs-lookup"><span data-stu-id="06be7-617">The record is returned as a container.</span></span> <span data-ttu-id="06be7-618">コンテナー内の各エントリは、レコードの 1 つのフィールドを表します。</span><span class="sxs-lookup"><span data-stu-id="06be7-618">Each entry in the container represents one field in the record.</span></span> <span data-ttu-id="06be7-619">それぞれの特殊な Io クラスには、inFieldDelimiter、inRecordDelimiter、および inRecordLength のデフォルト設定があります。</span><span class="sxs-lookup"><span data-stu-id="06be7-619">Each of the specialized Io classes has default settings for inFieldDelimiter, inRecordDelimiter, and inRecordLength.</span></span> <span data-ttu-id="06be7-620">これらの設定では、最も一般的な形式の入力と出力が可能です。</span><span class="sxs-lookup"><span data-stu-id="06be7-620">These settings allow for input and output of the most common formats.</span></span> <span data-ttu-id="06be7-621">ただし、目的の形式をサポートするために、これらの設定の調整が生じる場合があります。</span><span class="sxs-lookup"><span data-stu-id="06be7-621">However, you might have to adjust these settings to support the desired format.</span></span>

### <a name="method-status"></a><span data-ttu-id="06be7-622">メソッド status</span><span class="sxs-lookup"><span data-stu-id="06be7-622">Method status</span></span>

<span data-ttu-id="06be7-623">ファイルでの最後の操作のステータスを返します。</span><span class="sxs-lookup"><span data-stu-id="06be7-623">Returns the status of the last operation on the file.</span></span>

    public IO_Status status()

#### <a name="return-value"></a><span data-ttu-id="06be7-624">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-624">Return Value</span></span>

<span data-ttu-id="06be7-625">最後のファイル操作の状態。</span><span class="sxs-lookup"><span data-stu-id="06be7-625">The status of the last file operation.</span></span>

### <a name="method-write"></a><span data-ttu-id="06be7-626">メソッド write</span><span class="sxs-lookup"><span data-stu-id="06be7-626">Method write</span></span>

<span data-ttu-id="06be7-627">単純型の値を記述します。</span><span class="sxs-lookup"><span data-stu-id="06be7-627">Writes values of a simple type.</span></span>

    public boolean write(VarArg values)

#### <a name="parameters"></a><span data-ttu-id="06be7-628">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-628">Parameters</span></span>

<span data-ttu-id="06be7-629">値</span><span class="sxs-lookup"><span data-stu-id="06be7-629">values</span></span>  
<span data-ttu-id="06be7-630">1 つ以上の値の、各単純型は、フィールドの区切り記号で区切られています。</span><span class="sxs-lookup"><span data-stu-id="06be7-630">One or more values, each of a simple type, separated by a field delimiter.</span></span> <span data-ttu-id="06be7-631">単純型は、文字列、整数、実数、列挙型、日付です。</span><span class="sxs-lookup"><span data-stu-id="06be7-631">The simple types are string, integer, real, enum, and date.</span></span>

#### <a name="return-value"></a><span data-ttu-id="06be7-632">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-632">Return Value</span></span>

<span data-ttu-id="06be7-633">書き込み操作が成功する場合は true。それ以外の場合は、false。</span><span class="sxs-lookup"><span data-stu-id="06be7-633">true if the write operation succeeds; otherwise, false.</span></span> <span data-ttu-id="06be7-634">書き込み操作が失敗すると、ステータスをチェックし、原因について確認できます。</span><span class="sxs-lookup"><span data-stu-id="06be7-634">If the write operation fails, you can check the status to learn the cause.</span></span>

#### <a name="remarks"></a><span data-ttu-id="06be7-635">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-635">Remarks</span></span>

<span data-ttu-id="06be7-636">このメソッドは、可変数の引数を受け入れます。</span><span class="sxs-lookup"><span data-stu-id="06be7-636">The method accepts a variable number of arguments.</span></span> <span data-ttu-id="06be7-637">指定された各値は、フィールドとして出力レコードに配置されます: 最初のフィールドとしての最初の引数、2 番目のフィールドとしての 2 番目の引数など。</span><span class="sxs-lookup"><span data-stu-id="06be7-637">Each value that is specified is put into the output record as a field: the first argument as the first field, the second argument as the second field, and so on.</span></span> <span data-ttu-id="06be7-638">フィールドは、outFieldDelimiter メソッドで指定される区切り記号で区切られます。</span><span class="sxs-lookup"><span data-stu-id="06be7-638">Fields are separated by the delimiter that is specified in the outFieldDelimiter method.</span></span> <span data-ttu-id="06be7-639">レコードは、outRecordDelimiter メソッドで指定される区切り記号で区切られます。</span><span class="sxs-lookup"><span data-stu-id="06be7-639">Records are separated by the delimiter that is specified in the outRecordDelimiter method.</span></span> <span data-ttu-id="06be7-640">完全なコンテナーを書き込むには、writeExp メソッドを使用します。</span><span class="sxs-lookup"><span data-stu-id="06be7-640">To write complete containers, use the writeExp method.</span></span>

### <a name="method-writechar"></a><span data-ttu-id="06be7-641">メソッド writeChar</span><span class="sxs-lookup"><span data-stu-id="06be7-641">Method writeChar</span></span>

    public boolean writeChar(int int)

#### <a name="parameters"></a><span data-ttu-id="06be7-642">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-642">Parameters</span></span>

<span data-ttu-id="06be7-643">int</span><span class="sxs-lookup"><span data-stu-id="06be7-643">int</span></span>  

#### <a name="return-value"></a><span data-ttu-id="06be7-644">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-644">Return Value</span></span>

### <a name="method-writeexp"></a><span data-ttu-id="06be7-645">メソッド writeExp</span><span class="sxs-lookup"><span data-stu-id="06be7-645">Method writeExp</span></span>

<span data-ttu-id="06be7-646">コンテナのコンテンツをファイルに記述します。</span><span class="sxs-lookup"><span data-stu-id="06be7-646">Writes the content of a container to a file.</span></span>

    public boolean writeExp(container data)

#### <a name="parameters"></a><span data-ttu-id="06be7-647">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-647">Parameters</span></span>

<span data-ttu-id="06be7-648">データ</span><span class="sxs-lookup"><span data-stu-id="06be7-648">data</span></span>  
<span data-ttu-id="06be7-649">レコードのデータを保持するコンテナー。</span><span class="sxs-lookup"><span data-stu-id="06be7-649">The container that holds data for the record.</span></span>

#### <a name="return-value"></a><span data-ttu-id="06be7-650">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-650">Return Value</span></span>

<span data-ttu-id="06be7-651">操作が成功する場合は true。それ以外の場合は、false。</span><span class="sxs-lookup"><span data-stu-id="06be7-651">true if the operation succeeds; otherwise, false.</span></span> <span data-ttu-id="06be7-652">工程が失敗すると、ステータスをチェックし原因について確認します。</span><span class="sxs-lookup"><span data-stu-id="06be7-652">If the operation fails, check the status to learn the cause.</span></span>

#### <a name="remarks"></a><span data-ttu-id="06be7-653">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-653">Remarks</span></span>

<span data-ttu-id="06be7-654">コンテナー内のエントリはフィールドとして扱われます。</span><span class="sxs-lookup"><span data-stu-id="06be7-654">The entries in the container are treated as fields.</span></span> <span data-ttu-id="06be7-655">コンテナーは、完全なレコードとして扱われます。</span><span class="sxs-lookup"><span data-stu-id="06be7-655">The container is treated as a full record.</span></span> <span data-ttu-id="06be7-656">フィールドは、outFieldDelimiter メソッドで指定される区切り記号で区切られます。</span><span class="sxs-lookup"><span data-stu-id="06be7-656">Fields are separated by the delimiter that is specified in the outFieldDelimiter method.</span></span> <span data-ttu-id="06be7-657">レコードは、outRecordDelimiter メソッドで指定される区切り記号で区切られます。</span><span class="sxs-lookup"><span data-stu-id="06be7-657">Records are separated by the delimiter that is specified in the outRecordDelimiter method.</span></span>

### <a name="method-writeraw"></a><span data-ttu-id="06be7-658">メソッド writeRaw</span><span class="sxs-lookup"><span data-stu-id="06be7-658">Method writeRaw</span></span>

    public boolean writeRaw(str data)

#### <a name="parameters"></a><span data-ttu-id="06be7-659">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-659">Parameters</span></span>

<span data-ttu-id="06be7-660">データ</span><span class="sxs-lookup"><span data-stu-id="06be7-660">data</span></span>  

#### <a name="return-value"></a><span data-ttu-id="06be7-661">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-661">Return Value</span></span>

### <a name="method-finalize"></a><span data-ttu-id="06be7-662">メソッド finalize</span><span class="sxs-lookup"><span data-stu-id="06be7-662">Method finalize</span></span>

<span data-ttu-id="06be7-663">ファイルを閉じ、ファイル バッファーをディスクにフラッシュします。</span><span class="sxs-lookup"><span data-stu-id="06be7-663">Closes the file and then flushes the file buffers to disk.</span></span>

    public void finalize()

#### <a name="remarks"></a><span data-ttu-id="06be7-664">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-664">Remarks</span></span>

<span data-ttu-id="06be7-665">AsciiIo オブジェクトは通常そのスコープの終了後に確定されます。</span><span class="sxs-lookup"><span data-stu-id="06be7-665">An AsciiIo object is usually finalized after its scope has ended.</span></span> <span data-ttu-id="06be7-666">このメソッドは、通常は直接呼び出されません。</span><span class="sxs-lookup"><span data-stu-id="06be7-666">This method is not usually called directly.</span></span> <span data-ttu-id="06be7-667">AsciiIo オブジェクトが確定済みになるまで、ファイルに書き込まれる出力は無効です。</span><span class="sxs-lookup"><span data-stu-id="06be7-667">Output that is written to the file is not valid until the AsciiIo object is finalized.</span></span>

### <a name="method-new"></a><span data-ttu-id="06be7-668">メソッド new</span><span class="sxs-lookup"><span data-stu-id="06be7-668">Method new</span></span>

<span data-ttu-id="06be7-669">AsciiIo クラスのインスタンスを作成します。</span><span class="sxs-lookup"><span data-stu-id="06be7-669">Creates an instance of the AsciiIo class.</span></span>

    public void new(str filename, str mode)

#### <a name="parameters"></a><span data-ttu-id="06be7-670">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-670">Parameters</span></span>

<span data-ttu-id="06be7-671">filename</span><span class="sxs-lookup"><span data-stu-id="06be7-671">filename</span></span>  
<span data-ttu-id="06be7-672">AsciiIo クラスのこのインスタンスを作成するために使用するモード。</span><span class="sxs-lookup"><span data-stu-id="06be7-672">The mode to use to create this instance of the AsciiIo class.</span></span>

<!-- -->

<span data-ttu-id="06be7-673">モード</span><span class="sxs-lookup"><span data-stu-id="06be7-673">mode</span></span>  
<span data-ttu-id="06be7-674">AsciiIo クラスのこのインスタンスを作成するために使用するモード。</span><span class="sxs-lookup"><span data-stu-id="06be7-674">The mode to use to create this instance of the AsciiIo class.</span></span>

#### <a name="remarks"></a><span data-ttu-id="06be7-675">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-675">Remarks</span></span>

<span data-ttu-id="06be7-676">攻撃者が新しいメソッドへの入力を制御できる場合、セキュリティ上のリスクが存在します。</span><span class="sxs-lookup"><span data-stu-id="06be7-676">If an attacker can control input to the new method, a security risk exists.</span></span> <span data-ttu-id="06be7-677">したがって、このメソッドは、コード アクセス セキュリティで実行されます。</span><span class="sxs-lookup"><span data-stu-id="06be7-677">Therefore, this method runs under Code Access Security.</span></span> <span data-ttu-id="06be7-678">サーバー上でこのメソッドを呼び出すには、FileIOPermission クラスからのアクセス許可が必要です。</span><span class="sxs-lookup"><span data-stu-id="06be7-678">Calls to this method on the server require permission from the FileIOPermission class.</span></span> <span data-ttu-id="06be7-679">ユーザーがこのメソッドを呼び出すコントロールで、SysDevelopment へのセキュリティ キーを設定して開発権限を持っていることを確認します。</span><span class="sxs-lookup"><span data-stu-id="06be7-679">Make sure that the user has development privileges by setting the security key to SysDevelopment on the control that calls this method.</span></span>

#### <a name="examples"></a><span data-ttu-id="06be7-680">例</span><span class="sxs-lookup"><span data-stu-id="06be7-680">Examples</span></span>

<span data-ttu-id="06be7-681">次の例では、AsciiIo クラスを使用してテキスト ファイルから読み込みます。</span><span class="sxs-lookup"><span data-stu-id="06be7-681">The following example uses the AsciiIo class to read from a text file.</span></span>
...
## <a name="class-assemblydeploymanager"></a><span data-ttu-id="06be7-682">クラス AssemblyDeployManager</span><span class="sxs-lookup"><span data-stu-id="06be7-682">Class AssemblyDeployManager</span></span>
    class AssemblyDeployManager extends Object

<span data-ttu-id="06be7-683">AssemblyDeployManager クラスを使用すると、.NET 呼び出し時に X++ ランタイムによって使用できる AOS VSAssemblies フォルダーに、AOT Visual Studio プロジェクトに格納されているアセンブリを展開することができます。</span><span class="sxs-lookup"><span data-stu-id="06be7-683">The AssemblyDeployManager class lets you deploy the assemblies that are stored in the AOT Visual Studio Projects to the AOS VSAssemblies folder that can be used by the X++ runtime during .NET calls.</span></span>

### <a name="remarks"></a><span data-ttu-id="06be7-684">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-684">Remarks</span></span>

### <a name="examples"></a><span data-ttu-id="06be7-685">例</span><span class="sxs-lookup"><span data-stu-id="06be7-685">Examples</span></span>

### <a name="methods"></a><span data-ttu-id="06be7-686">方法</span><span class="sxs-lookup"><span data-stu-id="06be7-686">Methods</span></span>

| <span data-ttu-id="06be7-687">方法</span><span class="sxs-lookup"><span data-stu-id="06be7-687">Method</span></span>                                                        | <span data-ttu-id="06be7-688">説明</span><span class="sxs-lookup"><span data-stu-id="06be7-688">Description</span></span>                                                                                             |
|---------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="06be7-689">::public static boolean isHotswappingEnabled()</span><span class="sxs-lookup"><span data-stu-id="06be7-689">::public static boolean isHotswappingEnabled()</span></span>                | <span data-ttu-id="06be7-690">ホット スワップが有効かどうかを示すブール値を返します。</span><span class="sxs-lookup"><span data-stu-id="06be7-690">Returns a Boolean value that indicates whether hot swapping is enabled.</span></span>                                 |
| <span data-ttu-id="06be7-691">::public static void deployAssemblyFromPath(str assemblyPath)</span><span class="sxs-lookup"><span data-stu-id="06be7-691">::public static void deployAssemblyFromPath(str assemblyPath)</span></span> |                                                                                                         |
| <span data-ttu-id="06be7-692">::public static void removeAssemblyFromPath(str assemblyPath)</span><span class="sxs-lookup"><span data-stu-id="06be7-692">::public static void removeAssemblyFromPath(str assemblyPath)</span></span> | <span data-ttu-id="06be7-693">サーバーへの配置用にマークされた特定のアセンブリを VSAssemblies フォルダーから削除します。</span><span class="sxs-lookup"><span data-stu-id="06be7-693">Removes one specific assembly that is marked for deployment to the server from the VSAssemblies folder.</span></span> |
| <span data-ttu-id="06be7-694">::public static void deployAssemblies()</span><span class="sxs-lookup"><span data-stu-id="06be7-694">::public static void deployAssemblies()</span></span>                       | <span data-ttu-id="06be7-695">サーバーへの配置用にマークされた特定のアセンブリを VSAssemblies フォルダーに展開します。</span><span class="sxs-lookup"><span data-stu-id="06be7-695">Deploys one specific assembly that is marked for deployment to server to the VSAssemblies folder.</span></span>       |

### <a name="method-ishotswappingenabled"></a><span data-ttu-id="06be7-696">メソッド isHotswappingEnabled</span><span class="sxs-lookup"><span data-stu-id="06be7-696">Method isHotswappingEnabled</span></span>

<span data-ttu-id="06be7-697">ホット スワップが有効かどうかを示すブール値を返します。</span><span class="sxs-lookup"><span data-stu-id="06be7-697">Returns a Boolean value that indicates whether hot swapping is enabled.</span></span>

    public static boolean isHotswappingEnabled()

#### <a name="return-value"></a><span data-ttu-id="06be7-698">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-698">Return Value</span></span>

<span data-ttu-id="06be7-699">ホット スワップが有効かどうかを示すブール値。</span><span class="sxs-lookup"><span data-stu-id="06be7-699">A Boolean value that indicates whether hot swapping is enabled.</span></span>

### <a name="method-deployassemblyfrompath"></a><span data-ttu-id="06be7-700">メソッド deployAssemblyFromPath</span><span class="sxs-lookup"><span data-stu-id="06be7-700">Method deployAssemblyFromPath</span></span>

    public static void deployAssemblyFromPath(str assemblyPath)

#### <a name="parameters"></a><span data-ttu-id="06be7-701">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-701">Parameters</span></span>

<span data-ttu-id="06be7-702">assemblyPath</span><span class="sxs-lookup"><span data-stu-id="06be7-702">assemblyPath</span></span>  

### <a name="method-removeassemblyfrompath"></a><span data-ttu-id="06be7-703">メソッド removeAssemblyFromPath</span><span class="sxs-lookup"><span data-stu-id="06be7-703">Method removeAssemblyFromPath</span></span>

<span data-ttu-id="06be7-704">サーバーへの配置用にマークされた特定のアセンブリを VSAssemblies フォルダーから削除します。</span><span class="sxs-lookup"><span data-stu-id="06be7-704">Removes one specific assembly that is marked for deployment to the server from the VSAssemblies folder.</span></span>

    public static void removeAssemblyFromPath(str assemblyPath)

#### <a name="parameters"></a><span data-ttu-id="06be7-705">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-705">Parameters</span></span>

<span data-ttu-id="06be7-706">assemblyPath</span><span class="sxs-lookup"><span data-stu-id="06be7-706">assemblyPath</span></span>  
<span data-ttu-id="06be7-707">アセンブリが格納されている Visual Studio プロジェクト パス。</span><span class="sxs-lookup"><span data-stu-id="06be7-707">The Visual Studio Project path where the assembly is stored.</span></span>

### <a name="method-deployassemblies"></a><span data-ttu-id="06be7-708">メソッド deployAssemblies</span><span class="sxs-lookup"><span data-stu-id="06be7-708">Method deployAssemblies</span></span>

<span data-ttu-id="06be7-709">サーバーへの配置用にマークされた特定のアセンブリを VSAssemblies フォルダーに展開します。</span><span class="sxs-lookup"><span data-stu-id="06be7-709">Deploys one specific assembly that is marked for deployment to server to the VSAssemblies folder.</span></span>

    public static void deployAssemblies()

## <a name="class-asynctaskresult"></a><span data-ttu-id="06be7-710">クラス AsyncTaskResult</span><span class="sxs-lookup"><span data-stu-id="06be7-710">Class AsyncTaskResult</span></span>
    class AsyncTaskResult extends Object

### <a name="remarks"></a><span data-ttu-id="06be7-711">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-711">Remarks</span></span>

### <a name="examples"></a><span data-ttu-id="06be7-712">例</span><span class="sxs-lookup"><span data-stu-id="06be7-712">Examples</span></span>

### <a name="methods"></a><span data-ttu-id="06be7-713">メソッド</span><span class="sxs-lookup"><span data-stu-id="06be7-713">Methods</span></span>

| <span data-ttu-id="06be7-714">方法</span><span class="sxs-lookup"><span data-stu-id="06be7-714">Method</span></span>                                                                               | <span data-ttu-id="06be7-715">説明</span><span class="sxs-lookup"><span data-stu-id="06be7-715">Description</span></span> |
|--------------------------------------------------------------------------------------|-------------|
| <span data-ttu-id="06be7-716">public container getResult()</span><span class="sxs-lookup"><span data-stu-id="06be7-716">public container getResult()</span></span>                                                         |             |
| <span data-ttu-id="06be7-717">public System.Exception getException()</span><span class="sxs-lookup"><span data-stu-id="06be7-717">public System.Exception getException()</span></span>                                               |             |
| <span data-ttu-id="06be7-718">public container getInfologData()</span><span class="sxs-lookup"><span data-stu-id="06be7-718">public container getInfologData()</span></span>                                                    |             |
| <span data-ttu-id="06be7-719">public container getAsyncState()</span><span class="sxs-lookup"><span data-stu-id="06be7-719">public container getAsyncState()</span></span>                                                     |             |
| <span data-ttu-id="06be7-720">::public static AsyncTaskResult getAsyncTaskResult(System.Threading.Tasks.Task task)</span><span class="sxs-lookup"><span data-stu-id="06be7-720">::public static AsyncTaskResult getAsyncTaskResult(System.Threading.Tasks.Task task)</span></span> |             |

### <a name="method-getresult"></a><span data-ttu-id="06be7-721">メソッド getResult</span><span class="sxs-lookup"><span data-stu-id="06be7-721">Method getResult</span></span>

    public container getResult()

#### <a name="return-value"></a><span data-ttu-id="06be7-722">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-722">Return Value</span></span>

### <a name="method-getexception"></a><span data-ttu-id="06be7-723">メソッド getException</span><span class="sxs-lookup"><span data-stu-id="06be7-723">Method getException</span></span>

    public System.Exception getException()

#### <a name="return-value"></a><span data-ttu-id="06be7-724">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-724">Return Value</span></span>

### <a name="method-getinfologdata"></a><span data-ttu-id="06be7-725">メソッド getInfologData</span><span class="sxs-lookup"><span data-stu-id="06be7-725">Method getInfologData</span></span>

    public container getInfologData()

#### <a name="return-value"></a><span data-ttu-id="06be7-726">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-726">Return Value</span></span>

### <a name="method-getasyncstate"></a><span data-ttu-id="06be7-727">メソッド getAsyncState</span><span class="sxs-lookup"><span data-stu-id="06be7-727">Method getAsyncState</span></span>

    public container getAsyncState()

#### <a name="return-value"></a><span data-ttu-id="06be7-728">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-728">Return Value</span></span>

### <a name="method-getasynctaskresult"></a><span data-ttu-id="06be7-729">メソッド getAsyncTaskResult</span><span class="sxs-lookup"><span data-stu-id="06be7-729">Method getAsyncTaskResult</span></span>

    public static AsyncTaskResult getAsyncTaskResult(System.Threading.Tasks.Task task)

#### <a name="parameters"></a><span data-ttu-id="06be7-730">パラメーター</span><span class="sxs-lookup"><span data-stu-id="06be7-730">Parameters</span></span>

<span data-ttu-id="06be7-731">タスク</span><span class="sxs-lookup"><span data-stu-id="06be7-731">task</span></span>  

#### <a name="return-value"></a><span data-ttu-id="06be7-732">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-732">Return Value</span></span>

## <a name="class-axaptacomconnectormonitor"></a><span data-ttu-id="06be7-733">クラス AxaptaCOMConnectorMonitor</span><span class="sxs-lookup"><span data-stu-id="06be7-733">Class AxaptaCOMConnectorMonitor</span></span>
    class AxaptaCOMConnectorMonitor extends Object

<span data-ttu-id="06be7-734">Microsoft 社内のみで使用。</span><span class="sxs-lookup"><span data-stu-id="06be7-734">Microsoft internal use only.</span></span>

### <a name="remarks"></a><span data-ttu-id="06be7-735">備考</span><span class="sxs-lookup"><span data-stu-id="06be7-735">Remarks</span></span>

### <a name="examples"></a><span data-ttu-id="06be7-736">例</span><span class="sxs-lookup"><span data-stu-id="06be7-736">Examples</span></span>

### <a name="methods"></a><span data-ttu-id="06be7-737">メソッド</span><span class="sxs-lookup"><span data-stu-id="06be7-737">Methods</span></span>

| <span data-ttu-id="06be7-738">方法</span><span class="sxs-lookup"><span data-stu-id="06be7-738">Method</span></span>                                     | <span data-ttu-id="06be7-739">説明</span><span class="sxs-lookup"><span data-stu-id="06be7-739">Description</span></span>                                                        |
|--------------------------------------------|--------------------------------------------------------------------|
| <span data-ttu-id="06be7-740">public int getBufferCount()</span><span class="sxs-lookup"><span data-stu-id="06be7-740">public int getBufferCount()</span></span>                |                                                                    |
| <span data-ttu-id="06be7-741">public str getCOMRegistration()</span><span class="sxs-lookup"><span data-stu-id="06be7-741">public str getCOMRegistration()</span></span>            |                                                                    |
| <span data-ttu-id="06be7-742">public int getContainerCount()</span><span class="sxs-lookup"><span data-stu-id="06be7-742">public int getContainerCount()</span></span>             |                                                                    |
| <span data-ttu-id="06be7-743">public int getLoggedOnAxaptaObjectCount()</span><span class="sxs-lookup"><span data-stu-id="06be7-743">public int getLoggedOnAxaptaObjectCount()</span></span>  |                                                                    |
| <span data-ttu-id="06be7-744">public int getObjectCount()</span><span class="sxs-lookup"><span data-stu-id="06be7-744">public int getObjectCount()</span></span>                |                                                                    |
| <span data-ttu-id="06be7-745">public int getRecordCount()</span><span class="sxs-lookup"><span data-stu-id="06be7-745">public int getRecordCount()</span></span>                |                                                                    |
| <span data-ttu-id="06be7-746">public int getReferenceCount()</span><span class="sxs-lookup"><span data-stu-id="06be7-746">public int getReferenceCount()</span></span>             |                                                                    |
| <span data-ttu-id="06be7-747">public boolean isAxaptaCOMConnector()</span><span class="sxs-lookup"><span data-stu-id="06be7-747">public boolean isAxaptaCOMConnector()</span></span>      |                                                                    |
| <span data-ttu-id="06be7-748">public boolean isAxaptaInternetConnector()</span><span class="sxs-lookup"><span data-stu-id="06be7-748">public boolean isAxaptaInternetConnector()</span></span> |                                                                    |
| <span data-ttu-id="06be7-749">public void finalize()</span><span class="sxs-lookup"><span data-stu-id="06be7-749">public void finalize()</span></span>                     | <span data-ttu-id="06be7-750">Microsoft 社内のみで使用。</span><span class="sxs-lookup"><span data-stu-id="06be7-750">Microsoftinternal use only.</span></span>                                        |
| <span data-ttu-id="06be7-751">public void new()</span><span class="sxs-lookup"><span data-stu-id="06be7-751">public void new()</span></span>                          | <span data-ttu-id="06be7-752">AxaptaCOMConnectorMonitor クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="06be7-752">Initializes a new instance of the AxaptaCOMConnectorMonitor class.</span></span> |

### <a name="method-getbuffercount"></a><span data-ttu-id="06be7-753">メソッド getBufferCount</span><span class="sxs-lookup"><span data-stu-id="06be7-753">Method getBufferCount</span></span>

    public int getBufferCount()

#### <a name="return-value"></a><span data-ttu-id="06be7-754">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-754">Return Value</span></span>

### <a name="method-getcomregistration"></a><span data-ttu-id="06be7-755">メソッド getCOMRegistration</span><span class="sxs-lookup"><span data-stu-id="06be7-755">Method getCOMRegistration</span></span>

    public str getCOMRegistration()

#### <a name="return-value"></a><span data-ttu-id="06be7-756">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-756">Return Value</span></span>

### <a name="method-getcontainercount"></a><span data-ttu-id="06be7-757">メソッド getContainerCount</span><span class="sxs-lookup"><span data-stu-id="06be7-757">Method getContainerCount</span></span>

    public int getContainerCount()

#### <a name="return-value"></a><span data-ttu-id="06be7-758">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-758">Return Value</span></span>

### <a name="method-getloggedonaxaptaobjectcount"></a><span data-ttu-id="06be7-759">メソッド getLoggedOnAxaptaObjectCount</span><span class="sxs-lookup"><span data-stu-id="06be7-759">Method getLoggedOnAxaptaObjectCount</span></span>

    public int getLoggedOnAxaptaObjectCount()

#### <a name="return-value"></a><span data-ttu-id="06be7-760">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-760">Return Value</span></span>

### <a name="method-getobjectcount"></a><span data-ttu-id="06be7-761">メソッド getObjectCount</span><span class="sxs-lookup"><span data-stu-id="06be7-761">Method getObjectCount</span></span>

    public int getObjectCount()

#### <a name="return-value"></a><span data-ttu-id="06be7-762">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-762">Return Value</span></span>

### <a name="method-getrecordcount"></a><span data-ttu-id="06be7-763">メソッド getRecordCount</span><span class="sxs-lookup"><span data-stu-id="06be7-763">Method getRecordCount</span></span>

    public int getRecordCount()

#### <a name="return-value"></a><span data-ttu-id="06be7-764">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-764">Return Value</span></span>

### <a name="method-getreferencecount"></a><span data-ttu-id="06be7-765">メソッド getReferenceCount</span><span class="sxs-lookup"><span data-stu-id="06be7-765">Method getReferenceCount</span></span>

    public int getReferenceCount()

#### <a name="return-value"></a><span data-ttu-id="06be7-766">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-766">Return Value</span></span>

### <a name="method-isaxaptacomconnector"></a><span data-ttu-id="06be7-767">メソッド isAxaptaCOMConnector</span><span class="sxs-lookup"><span data-stu-id="06be7-767">Method isAxaptaCOMConnector</span></span>

    public boolean isAxaptaCOMConnector()

#### <a name="return-value"></a><span data-ttu-id="06be7-768">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-768">Return Value</span></span>

### <a name="method-isaxaptainternetconnector"></a><span data-ttu-id="06be7-769">メソッド isAxaptaInternetConnector</span><span class="sxs-lookup"><span data-stu-id="06be7-769">Method isAxaptaInternetConnector</span></span>

    public boolean isAxaptaInternetConnector()

#### <a name="return-value"></a><span data-ttu-id="06be7-770">戻り値</span><span class="sxs-lookup"><span data-stu-id="06be7-770">Return Value</span></span>

### <a name="method-finalize"></a><span data-ttu-id="06be7-771">メソッド finalize</span><span class="sxs-lookup"><span data-stu-id="06be7-771">Method finalize</span></span>

<span data-ttu-id="06be7-772">Microsoft 社内のみで使用。</span><span class="sxs-lookup"><span data-stu-id="06be7-772">Microsoftinternal use only.</span></span>

    public void finalize()

### <a name="method-new"></a><span data-ttu-id="06be7-773">メソッド new</span><span class="sxs-lookup"><span data-stu-id="06be7-773">Method new</span></span>

<span data-ttu-id="06be7-774">AxaptaCOMConnectorMonitor クラスの新しいインスタンスを初期化します。</span><span class="sxs-lookup"><span data-stu-id="06be7-774">Initializes a new instance of the AxaptaCOMConnectorMonitor class.</span></span>
