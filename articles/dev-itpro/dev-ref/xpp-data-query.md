...
|     <span data-ttu-id="1c93f-142"><em>オプション</em></span><span class="sxs-lookup"><span data-stu-id="1c93f-142"><em>Options</em></span></span>     | = |                                                                                                                                                  <span data-ttu-id="1c93f-143"><strong>\[ 並べ替え</strong>、<strong>グループ化、</strong> <em>FieldIdentifier</em> <strong>\[ asc</strong></span><span class="sxs-lookup"><span data-stu-id="1c93f-143"><strong>\[ order by</strong> , <strong>group by ,</strong> <em>FieldIdentifier</em> <strong>\[ asc</strong></span></span>                                                                                                                                                   |
...
| <span data-ttu-id="1c93f-168">exists</span><span class="sxs-lookup"><span data-stu-id="1c93f-168">exists</span></span>            | <span data-ttu-id="1c93f-169">このキーワードは、ブール値と**結合**句を返すメソッドです。</span><span class="sxs-lookup"><span data-stu-id="1c93f-169">This keyword is a method that returns a Boolean value and a **join** clause.</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| <span data-ttu-id="1c93f-180">firstOnly1000</span><span class="sxs-lookup"><span data-stu-id="1c93f-180">firstOnly1000</span></span>     | <span data-ttu-id="1c93f-181">このキーワードは **firstOnly** と同じですが、1 つではなく 1,000 行を返します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-181">This keyword is the same as **firstOnly**, but it returns 1,000 rows instead of one.</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| <span data-ttu-id="1c93f-198">forceSelectOrder</span><span class="sxs-lookup"><span data-stu-id="1c93f-198">forceSelectOrder</span></span>  | <span data-ttu-id="1c93f-199">このキーワードを指定すると、SQL Server データベースは指定した順序で結合内のテーブルにアクセスします。</span><span class="sxs-lookup"><span data-stu-id="1c93f-199">This keyword forces the SQL Server database to access the tables in a join in the specified order.</span></span> <span data-ttu-id="1c93f-200">2 つのテーブルが結合している場合、明細書の最初のテーブルに最初にアクセスします。</span><span class="sxs-lookup"><span data-stu-id="1c93f-200">If two tables are joined, the first table in the statement is always accessed first.</span></span> <span data-ttu-id="1c93f-201">このキーワードは、**forceNestedLoop** キーワードと組み合わされることがよくあります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-201">This keyword is often combined with the **forceNestedLoop** keyword.</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| <span data-ttu-id="1c93f-238">pessimisticLock</span><span class="sxs-lookup"><span data-stu-id="1c93f-238">pessimisticLock</span></span>   | <span data-ttu-id="1c93f-239">このキーワードは、テーブルに異なる値が設定されていても、ペシミスティック同時実行制御を使用してステートメントを実行させます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-239">This keyword forces a statement to run by using pessimistic concurrency control, even if a different value is set on the table.</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| <span data-ttu-id="1c93f-251">validTimeState</span><span class="sxs-lookup"><span data-stu-id="1c93f-251">validTimeState</span></span>    | <span data-ttu-id="1c93f-252">このキーワードは、**ValidTimeStateFieldType** プロパティが**なし**以外の値に設定されているテーブルの行をフィルタリングします。</span><span class="sxs-lookup"><span data-stu-id="1c93f-252">This keyword filters rows from a table where the **ValidTimeStateFieldType** property is set to a value other than **None**.</span></span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
### <a name="group-by-and-order-by-example"></a><span data-ttu-id="1c93f-260">group by および order by の例</span><span class="sxs-lookup"><span data-stu-id="1c93f-260">group by and order by example</span></span>
...
### <a name="select-statement-that-has-an-outer-join"></a><span data-ttu-id="1c93f-268">外部結合を持つ select ステートメント</span><span class="sxs-lookup"><span data-stu-id="1c93f-268">select statement that has an outer join</span></span>
...
| <span data-ttu-id="1c93f-292">SalesOrderLineID (文字列、主キー)</span><span class="sxs-lookup"><span data-stu-id="1c93f-292">SalesOrderLineID (string, primary key)</span></span> | <span data-ttu-id="1c93f-293">数量 (整数)</span><span class="sxs-lookup"><span data-stu-id="1c93f-293">Quantity (integer)</span></span> | <span data-ttu-id="1c93f-294">SalesOrderID (整数、外部キー)</span><span class="sxs-lookup"><span data-stu-id="1c93f-294">SalesOrderID (integer, foreign key)</span></span> |
|----------------------------------------|--------------------|-------------------------------------|
...
## <a name="while-select-statements"></a><span data-ttu-id="1c93f-311">while select ステートメント</span><span class="sxs-lookup"><span data-stu-id="1c93f-311">while select statements</span></span>
...
### <a name="index-and-order-by-keywords-in-select-statements"></a><span data-ttu-id="1c93f-349">select ステートメント内の index および order by キーワード</span><span class="sxs-lookup"><span data-stu-id="1c93f-349">index and order by keywords in select statements</span></span>
...
| <span data-ttu-id="1c93f-369">注文が重要な場合は、レコードを選択し、特定のインデックスを強制的に使用します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-369">Select records when the order is significant, and force a specific index to be used.</span></span> | <span data-ttu-id="1c93f-370">select ..</span><span class="sxs-lookup"><span data-stu-id="1c93f-370">select ..</span></span> <span data-ttu-id="1c93f-371">index hint ... order by ... where ...</span><span class="sxs-lookup"><span data-stu-id="1c93f-371">index hint ... order by ... where ...</span></span> |

### <a name="index-and-order-by-example"></a><span data-ttu-id="1c93f-372">index および order by の例</span><span class="sxs-lookup"><span data-stu-id="1c93f-372">index and order by example</span></span>

<span data-ttu-id="1c93f-373">次の例は、顧客の範囲と期日に基づいて、SalesTable テーブルからトランザクションを選択する方法を示しています。</span><span class="sxs-lookup"><span data-stu-id="1c93f-373">The following example shows how to select transactions from the SalesTable table, based on a range of customers and due dates.</span></span>
...
### <a name="index-hint"></a><span data-ttu-id="1c93f-374">index hint</span><span class="sxs-lookup"><span data-stu-id="1c93f-374">index hint</span></span>

<span data-ttu-id="1c93f-375">クエリの**インデックス ヒント**を使用する前に、サーバー上で使用できるヒントを指定する必要があります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-375">Before you can use **index hint** in queries, you must specify that hints can be used on the server.</span></span>

1.  <span data-ttu-id="1c93f-376">**スタート** &gt; **管理ツール** &gt; **Microsoft Dynamics AX Server Configuration** の順に移動します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-376">Go to **Start** &gt; **Administrative Tools** &gt; **Microsoft Dynamics AX Server Configuration**.</span></span>
2.  <span data-ttu-id="1c93f-377">**データベースのチューニング**タブで、**Allow INDEX hints in queries** を選択し、**OK** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="1c93f-377">On the **Database Tuning** tab, select **Allow INDEX hints in queries**, and then click **OK**.</span></span>
3.  <span data-ttu-id="1c93f-378">Application Object Server (AOS) サービスの再起動を要求するメッセージ ボックスが表示されたら、**はい** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="1c93f-378">When a message box prompts you to restart the Application Object Server (AOS) service, click **Yes**.</span></span> <span data-ttu-id="1c93f-379">サービスが再起動されるまで、インデックス ヒントは有効化されません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-379">Index hints won't be enabled until the service is restarted.</span></span>

<span data-ttu-id="1c93f-380">**SELECT** ステートメント内の **インデックス ヒント** が非クラスター化インデックスを参照し、**WHERE** 句に同じテーブルのクラスタ化インデックスに存在するフィールドのみが含まれているときは、ヒントで指定されているインデックスではなく、クラスタ化インデックスが使用されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-380">When an **index hint** in a **select** statement refers to a non-clustered index, and the **where** clause contains only the fields that are found in a clustered index on the same table, the clustered index is used instead of the index that is specified in the hint.</span></span> <span data-ttu-id="1c93f-381">たとえば、SQL Server Management Studio で **sp\_helpindex InventTable** を実行し、InventTable テーブルが **DataAreaId** および **ItemId** 列でクラスター インデックスを、さらに **DataAreaId**、**ItemProductId**、および **ItemType** 列で非クラスター化インデックスを持っていることを確認します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-381">For example, you run **sp\_helpindex InventTable** in SQL Server Management Studio and you see that the InventTable table has a clustered index on the **DataAreaId** and **ItemId** columns, and a non-clustered index on the **DataAreaId**, **ItemProductId**, and **ItemType** columns.</span></span>

| <span data-ttu-id="1c93f-382">インデックス名</span><span class="sxs-lookup"><span data-stu-id="1c93f-382">Index name</span></span>       | <span data-ttu-id="1c93f-383">説明</span><span class="sxs-lookup"><span data-stu-id="1c93f-383">Description</span></span>                                        | <span data-ttu-id="1c93f-384">キーの列</span><span class="sxs-lookup"><span data-stu-id="1c93f-384">Key columns</span></span>                         |
|------------------|----------------------------------------------------|-------------------------------------|
| <span data-ttu-id="1c93f-385">I\_175ITEMIDX</span><span class="sxs-lookup"><span data-stu-id="1c93f-385">I\_175ITEMIDX</span></span>    | <span data-ttu-id="1c93f-386">プライマリにあるクラスタ化された一意の主キー</span><span class="sxs-lookup"><span data-stu-id="1c93f-386">Clustered, unique, primary key, located on PRIMARY</span></span> | <span data-ttu-id="1c93f-387">DATAAREAID、ITEMID</span><span class="sxs-lookup"><span data-stu-id="1c93f-387">DATAAREAID, ITEMID</span></span>                  |
| <span data-ttu-id="1c93f-388">I\_175PRODUCTIDX</span><span class="sxs-lookup"><span data-stu-id="1c93f-388">I\_175PRODUCTIDX</span></span> | <span data-ttu-id="1c93f-389">非集合、プライマリに配置</span><span class="sxs-lookup"><span data-stu-id="1c93f-389">Non-clustered, located on PRIMARY</span></span>                  | <span data-ttu-id="1c93f-390">DATAAREAID、ITEMPRODUCTID、ITEMTYPE</span><span class="sxs-lookup"><span data-stu-id="1c93f-390">DATAAREAID, ITEMPRODUCTID, ITEMTYPE</span></span> |

<span data-ttu-id="1c93f-391">次のコードでは、**インデックス ヒント**で指定される非クラスター化インデックスではなく、クラスター化インデックスが使用されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-391">In the following code, the clustered index is used instead of the non-clustered index that is specified by **index hint**.</span></span>
...
### <a name="writing-a-select-statement-as-an-expression"></a><span data-ttu-id="1c93f-392">選択したステートメントを式として記述</span><span class="sxs-lookup"><span data-stu-id="1c93f-392">Writing a select statement as an expression</span></span>

<span data-ttu-id="1c93f-393"><strong>select</strong> ステートメントを式として使用することができます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-393">You can use a <strong>select</strong> statement as an expression.</span></span> <span data-ttu-id="1c93f-394">この種の <strong>select</strong> 構文は <em>expression **select</em>* 構文として知られています<em>。テーブル バッファ変数は、expression **select</em>* 構文では使用できません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-394">This type of <strong>select</strong> statement is known as an <em>expression **select</em>* statement<em>. A table buffer variable can't be used in an expression **select</em>* statement.</span></span> <span data-ttu-id="1c93f-395">テーブルの名前は、<strong>from</strong> 句で使用する必要があります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-395">The name of the table must be used in the <strong>from</strong> clause.</span></span> <span data-ttu-id="1c93f-396">式<strong>選択</strong>明細書の 1 つの制限は、<strong>結合</strong>キーワードが式結合でサポートされていないことです。</span><span class="sxs-lookup"><span data-stu-id="1c93f-396">One limitation of expression <strong>select</strong> statements is that the <strong>join</strong> keyword isn't supported in an expression join.</span></span>

### <a name="expression-select-examples"></a><span data-ttu-id="1c93f-397">式選択の例</span><span class="sxs-lookup"><span data-stu-id="1c93f-397">expression select examples</span></span>

<span data-ttu-id="1c93f-398">次の例では、かっこ内の **select** ステートメントは 1 つの行を返します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-398">In the following example, the **select** statement inside the parentheses returns one row.</span></span> <span data-ttu-id="1c93f-399">データを取り込むことができる唯一の列は、**select** 句の **from** 句の前に名前が付けられている列です。</span><span class="sxs-lookup"><span data-stu-id="1c93f-399">The only column that can be populated with data is the column that is named before the **from** clause in the **select** clause.</span></span> <span data-ttu-id="1c93f-400">閉じ括弧の後に、その列の名前を使用してデータ値を参照します: **).AccountNum;**。</span><span class="sxs-lookup"><span data-stu-id="1c93f-400">After the closing parenthesis, the name of that column is used to reference the data value: **).AccountNum;**.</span></span> <span data-ttu-id="1c93f-401">この例は、**firstonly** キーワードを使用するため、最大で 1 行を返します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-401">This example returns a maximum of one row, because it uses the **firstonly** keyword.</span></span> <span data-ttu-id="1c93f-402">ただし、**firstonly** キーワードが省略されるとしても **sAccountNum** に割り当てられる値は同じです。</span><span class="sxs-lookup"><span data-stu-id="1c93f-402">However, the value that is assigned to **sAccountNum** is the same, even if the **firstonly** keyword is omitted.</span></span> <span data-ttu-id="1c93f-403">この例の **where** 句には、**where** 句が **order by** 句の後に配置されるべきであることを示し以外の目的がありません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-403">The **where** clause in this example serves no purpose except to show that the **where** clause must occur after the **order by** clause.</span></span> <span data-ttu-id="1c93f-404">**order by** 句でフィールド名を修飾するために、テーブル名を使用することはできません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-404">The table name can't be used to qualify a field name in the **order by** clause.</span></span>
...
<span data-ttu-id="1c93f-405">前の例と同じ結果を達成する単純な方法を次に示します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-405">Here is a simpler way to achieve the same result as the previous example.</span></span>
...
<span data-ttu-id="1c93f-406">次の例には、**where** 句が含まれています。</span><span class="sxs-lookup"><span data-stu-id="1c93f-406">The following example includes a **where** clause.</span></span> <span data-ttu-id="1c93f-407">**where** 句では、テーブル名をフィールドの修飾子として使用する必要があります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-407">In a **where** clause, the table name must be used as a qualifier of the field.</span></span> <span data-ttu-id="1c93f-408">ここで、**maxof** 集計関数が使用され、**RecId** フィールドが機能に記載されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-408">Here, the **maxof** aggregate function is used, and the **RecId** field is mentioned in the function.</span></span> <span data-ttu-id="1c93f-409">集計関数に記載されているフィールドは、閉じかっこの後のデータ値を参照するために使用されるフィールド名と同じでなければなりません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-409">The field that is mentioned in the aggregate function must be the same as the field name that is used to reference the data value after the closing parenthesis.</span></span> <span data-ttu-id="1c93f-410">それ以外の場合、空のデータが返されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-410">Otherwise, empty data is returned.</span></span>
...
<span data-ttu-id="1c93f-411">次の例では、フィールド名 (この場合は **RecId**) は **RecId** の値ではないデータ値を参照するために使用します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-411">In the following example, a field name (in this case, **RecId**) is used to reference a data value that isn't a **RecId** value.</span></span> <span data-ttu-id="1c93f-412">**count** 集計関数は、**RecId**値を返しません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-412">The **count** aggregate function doesn't return a **RecId** value.</span></span> <span data-ttu-id="1c93f-413">**RecId** フィールドは通常 **cound** 関数と共に使用されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-413">Typically, the **RecId** field is used with the **count** function.</span></span>
...
<span data-ttu-id="1c93f-414">**join** キーワードは、式 **select** ステートメントでサポートされていません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-414">The **join** keyword isn't supported in expression **select** statements.</span></span> <span data-ttu-id="1c93f-415">次の例は、サブセレクトを示しています。</span><span class="sxs-lookup"><span data-stu-id="1c93f-415">The following example shows a subselect.</span></span> <span data-ttu-id="1c93f-416">ただし、式選択の**ステートメント**は、標準の内部結合に相当するサブセレクトをサポートしていません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-416">However, expression select **statements** don't support subselects that are equivalent to a standard inner join.</span></span> <span data-ttu-id="1c93f-417">したがって、次の例では、1 つの式 **select** ステートメント内 (つまり、副選択内) に 2 つのテーブルが記述されているため、コンパイルは行われません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-417">Therefore, the following example doesn't compile, because it mentions two tables inside one expression **select** statement (that is, inside the subselect).</span></span> <span data-ttu-id="1c93f-418">この例に示すように、サブセレクトはサポートされていますが、制限された方法でのみサポートされます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-418">As this example shows, subselects are supported, but only in a limited manner.</span></span>
...
## <a name="update-method"></a><span data-ttu-id="1c93f-419">update メソッド</span><span class="sxs-lookup"><span data-stu-id="1c93f-419">update method</span></span>
<span data-ttu-id="1c93f-420">**update** テーブル メソッドは、バッファーの内容で現在のレコードを更新します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-420">The **update** table method updates the current record with the contents of the buffer.</span></span> <span data-ttu-id="1c93f-421">また、適切なシステム フィールドも更新されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-421">It also updates the appropriate system fields.</span></span> <span data-ttu-id="1c93f-422">**where** 句はオプションです。</span><span class="sxs-lookup"><span data-stu-id="1c93f-422">The **where** clause is optional.</span></span> <span data-ttu-id="1c93f-423">これが使用されるとき、**WHERE** 句は、テーブルの各行を処理するときに **更新** でテストされる条件を指定します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-423">When it's used, the **where** clause specifies a condition that **update** tests as it processes each row of the table.</span></span> <span data-ttu-id="1c93f-424">その条件に対する **true** をテストする行のみ新しい値で更新されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-424">Only those rows that test **true** against the condition are updated with the new values.</span></span> <span data-ttu-id="1c93f-425">**update\_recordset** 演算子は、同時に複数のレコードを更新するレコード セット ベースの演算子です。</span><span class="sxs-lookup"><span data-stu-id="1c93f-425">The **update\_recordset** operator is a record set–based operator that updates multiple records at the same time.</span></span> <span data-ttu-id="1c93f-426">**update** の動作をオーバーライドするには、**doUpdate** メソッドを使用します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-426">To override the behavior of **update**, use the **doUpdate** method.</span></span> <span data-ttu-id="1c93f-427">次の例では、更新する custTable テーブルを選択します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-427">The following example selects the custTable table for update.</span></span> <span data-ttu-id="1c93f-428">**AccountNum** フィールドの値が **4000** に等しいレコードは更新されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-428">Any records where the value of the **AccountNum** field is equal to **4000** are updated.</span></span> <span data-ttu-id="1c93f-429">(この場合、レコードは 1 つだけ更新されます。) **CreditMax** フィールドの値は **5000** に変更されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-429">(In this case, only one record is updated.) The value of the **CreditMax** field is changed to **5000**.</span></span>
...
## <a name="doupdate-method"></a><span data-ttu-id="1c93f-430">doUpdate メソッド</span><span class="sxs-lookup"><span data-stu-id="1c93f-430">doUpdate method</span></span>
<span data-ttu-id="1c93f-431">**doUpdate** メソッドは、バッファーの内容で現在のレコードを更新します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-431">The **doUpdate** method updates the current record with the contents of the buffer.</span></span> <span data-ttu-id="1c93f-432">このメソッドでは、適切なシステム フィールドも更新されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-432">This method also updates the appropriate system fields.</span></span> <span data-ttu-id="1c93f-433">テーブルでの **更新** メソッドをバイパスする必要があるときは、**doUpdate** メソッドを使用する必要があります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-433">You should use the **doUpdate** method when the **update** method on the table must be bypassed.</span></span> <span data-ttu-id="1c93f-434">**doUpdate** テーブル メソッドの構文は、**void doUpdate()** です。</span><span class="sxs-lookup"><span data-stu-id="1c93f-434">The syntax for a **doUpdate** table method is **void doUpdate()**.</span></span> <span data-ttu-id="1c93f-435">次の例では、**CreditMax** フィールドの値は 1,000 ずつ増加します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-435">In the following example, the value of the **CreditMax** field is increased by 1,000.</span></span>
...
## <a name="delete-method"></a><span data-ttu-id="1c93f-436">delete メソッド</span><span class="sxs-lookup"><span data-stu-id="1c93f-436">delete method</span></span>
<span data-ttu-id="1c93f-437">**削除** テーブル メソッドは、データベースから現在のレコードを削除します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-437">The **delete** table method deletes the current record from the database.</span></span> <span data-ttu-id="1c93f-438">このメソッドを使用するには、**where** 句を使用して削除する行を指定します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-438">To use this method, use a **where** clause to specify the rows to delete.</span></span> <span data-ttu-id="1c93f-439">一度に 1 つのレコードが、指定されたテーブルから削除されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-439">One record at a time is then removed from the specified table.</span></span> <span data-ttu-id="1c93f-440">**delete\_from** 演算子は、同時に複数のレコードを削除するレコード セット ベースの演算子です。</span><span class="sxs-lookup"><span data-stu-id="1c93f-440">The **delete\_from** operator is a record set–based operator that removes multiple records at the same time.</span></span> <span data-ttu-id="1c93f-441">**delete** メソッドは上書きすることができます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-441">The **delete** method can be overridden.</span></span> <span data-ttu-id="1c93f-442">たとえば、レコードが削除される前に、追加の検証を追加する場合があります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-442">For example, you might want to add extra validation before records are deleted.</span></span> <span data-ttu-id="1c93f-443">**削除**方法をオーバーライドする場合、**doDelete** を呼び出すことで、**削除**メソッドの元の (ベース) バージョンを実行できます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-443">If you override the **delete** method, you can run the original (base) version of the **delete** method by calling the **doDelete** method.</span></span> <span data-ttu-id="1c93f-444">したがって、**doDelete** メソッドへの呼び出しは**delete** メソッドの **super()** への呼び出しに相当します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-444">Therefore, a call to the **doDelete** method is equivalent to a call to **super()** in the **delete** method.</span></span> <span data-ttu-id="1c93f-445">次の例では、**where** 句の条件を満たす MyTable テーブル内のすべてのレコード (つまり、**AccountNum** フィールドの値が **1000** に等しいすべてのレコード) がデータベースから削除されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-445">In the following example, all records in the MyTable table that satisfy the criterion in the **where** clause (that is, all records where the value of the **AccountNum** field is equal to **1000**) are deleted from the database.</span></span> <span data-ttu-id="1c93f-446">一度に 1 つのレコードが削除されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-446">One record is deleted at a time.</span></span>
...
## <a name="dodelete-method"></a><span data-ttu-id="1c93f-447">doDelete メソッド</span><span class="sxs-lookup"><span data-stu-id="1c93f-447">doDelete method</span></span>
<span data-ttu-id="1c93f-448">**delete** テーブル メソッドと同様に、**doDelete** テーブル メソッドは、データベースから現在のレコードを削除します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-448">Like the **delete** table method, the **doDelete** table method deletes the current record from the database.</span></span> <span data-ttu-id="1c93f-449">**delete** テーブル メソッドがオーバーライドされていて、オーバーライドされているバージョンではなく **delete** メソッドの元の (基本) バージョンを実行する場合は **doDelete** メソッドを使用します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-449">Use the **doDelete** method if the **delete** table method has been overridden, and you want to run the original (base) version of the **delete** method instead of the overridden version.</span></span> <span data-ttu-id="1c93f-450">したがって、**doDelete** メソッドへの呼び出しは**delete** メソッドの **super()** への呼び出しに相当します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-450">Therefore, a call to the **doDelete** method is equivalent to a call to **super()** in the **delete** method.</span></span> <span data-ttu-id="1c93f-451">次の例では、**200** 以上のアカウント番号を持つ myTable テーブルのすべてのレコードを削除します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-451">The following example deletes all records in the myTable table that have an account number that is more than or equal to **200**.</span></span>
...
## <a name="insert-method"></a><span data-ttu-id="1c93f-452">insert メソッド</span><span class="sxs-lookup"><span data-stu-id="1c93f-452">insert method</span></span>
<span data-ttu-id="1c93f-453">**insert** メソッドは、一度に 1 つのレコードを更新します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-453">The **insert** method updates one record at a time.</span></span> <span data-ttu-id="1c93f-454">一度に複数のレコードを挿入するには、配列挿入、**挿入\_レコードセット**、または **RecordSortedList.insertDatabase** を挿入します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-454">To insert multiple records at a time, use array inserts, **insert\_recordset**, or **RecordSortedList.insertDatabase**.</span></span> <span data-ttu-id="1c93f-455">**insert** メソッドの動作をオーバーライドするには、**doInsert** メソッドを使用します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-455">To override the behavior of the **insert** method, use the **doInsert** method.</span></span> <span data-ttu-id="1c93f-456">**xRecord .insert** メソッドは、**RecId** フィールドおよびシステム フィールドの値を生成した後、データベースにバッファーの内容を挿入します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-456">The **xRecord .insert** method generates values for the **RecId** field and system fields, and then inserts the contents of the buffer into the database.</span></span> <span data-ttu-id="1c93f-457">**挿入**メソッドが作用する方法を次に示します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-457">Here is how the **insert** method works:</span></span>

-   <span data-ttu-id="1c93f-458">クエリによって選択されている行の指定された列のみ、名前付きテーブルに挿入されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-458">Only the specified columns of the rows that have been selected by the query are inserted into the named table.</span></span>
-   <span data-ttu-id="1c93f-459">コピー元のテーブルの列とコピー先のテーブルの列は、互換性のある型であることが必要です。</span><span class="sxs-lookup"><span data-stu-id="1c93f-459">The columns of the table that is copied from and the columns of the table that is copied to must be type-compatible.</span></span>
-   <span data-ttu-id="1c93f-460">両方のテーブルの列がタイプおよび順序において一致する場合、列リストは**挿入**句から省略されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-460">If the columns of both tables match in type and order, column list can be omitted from the **insert** clause.</span></span>

### <a name="insert-example-inserting-a-new-record"></a><span data-ttu-id="1c93f-461">insert の例: 新規レコードの挿入</span><span class="sxs-lookup"><span data-stu-id="1c93f-461">insert example: Inserting a new record</span></span>

<span data-ttu-id="1c93f-462">次の例では、新しいレコードを CustTable テーブルに挿入します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-462">The following example inserts a new record into the CustTable table.</span></span> <span data-ttu-id="1c93f-463">新しいレコードの **AccountNum** フィールドは **5000** に設定され、**Name** フィールドは **MyCompany** に設定されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-463">The **AccountNum** field of the new record is set to **5000**, and the **Name** field is set to **MyCompany**.</span></span> <span data-ttu-id="1c93f-464">(レコードの他のフィールドは空白になります。)</span><span class="sxs-lookup"><span data-stu-id="1c93f-464">(Other fields in the record will be blank.)</span></span>
...
### <a name="insert-example-transaction-and-duplicate-key"></a><span data-ttu-id="1c93f-465">insert の例: トランザクションと重複キー</span><span class="sxs-lookup"><span data-stu-id="1c93f-465">insert example: Transaction and duplicate key</span></span>

<span data-ttu-id="1c93f-466">次の例は、明示的なトランザクションのコンテキストで **DuplicateKeyException** 例外をキャッチする方法を示しています。</span><span class="sxs-lookup"><span data-stu-id="1c93f-466">The following example shows how you can catch a **DuplicateKeyException** exception in the context of an explicit transaction.</span></span> <span data-ttu-id="1c93f-467">既存の一意の値が重複しているため、**xRecord .insert**の 呼び出しが失敗した場合に例外がスローされます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-467">The exception is thrown when a call to **xRecord .insert** fails because an existing unique value is duplicated.</span></span> <span data-ttu-id="1c93f-468">**catch** ブロックでは、コードで修正アクションを実行するか、後で分析するためにエラーを記録したりできます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-468">In the **catch** block, your code can either take corrective action or log the error for later analysis.</span></span> <span data-ttu-id="1c93f-469">これにより、トランザクションの保留中のすべての作業が失うことなく、コードの実行を続けることできます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-469">Your code can then continue without losing all the pending work of the transaction.</span></span> <span data-ttu-id="1c93f-470">**挿入\_レコードセット** などのセットに基づく操作によって発生する重複キー例外を把握することはできません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-470">You can't catch a duplicate key exception that is caused by a set-based operation such as **insert\_recordset**.</span></span> <span data-ttu-id="1c93f-471">この例は、TableNumberAとTableNumberB という 2 つのテーブルによって異なります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-471">This example depends on two tables: TableNumberA and TableNumberB.</span></span> <span data-ttu-id="1c93f-472">両方のテーブルには 1 つの必須の整数フィールドがあります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-472">Both tables have one mandatory integer field.</span></span> <span data-ttu-id="1c93f-473">これらのフィールドはそれぞれ、**NumberAKey** および **NumberBKey** と命名されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-473">These fields are named **NumberAKey** and **NumberBKey**, respectively.</span></span> <span data-ttu-id="1c93f-474">固有インデックスは、各キー フィールドで定義されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-474">A unique index is defined on each key field.</span></span> <span data-ttu-id="1c93f-475">TableNumberA テーブルには、少なくとも 1 つのレコードが必要です。</span><span class="sxs-lookup"><span data-stu-id="1c93f-475">The TableNumberA table must have at least one record in it.</span></span>
...
## <a name="doinsert-method"></a><span data-ttu-id="1c93f-476">doInsert メソッド</span><span class="sxs-lookup"><span data-stu-id="1c93f-476">doInsert method</span></span>
<span data-ttu-id="1c93f-477">**doInsert** メソッドは、**RecId** フィールドおよびその他のシステム フィールドの値を生成した後、データベースにバッファーの内容を挿入します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-477">The **doInsert** method generates values for the **RecId** field and other system fields, and then inserts the contents of the buffer into the database.</span></span> <span data-ttu-id="1c93f-478">テーブルの **insert** メソッドをバイパスする必要がある場合は、このメソッドを使用します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-478">Use this method when the **insert** method on the table must be bypassed.</span></span> <span data-ttu-id="1c93f-479">次の例では、新しいレコードが挿入されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-479">In the following example, a new record is inserted.</span></span> <span data-ttu-id="1c93f-480">レコードの **name** フィールドは **Warren Langer** に設定され、**value** フィールドは **100** に設定されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-480">The **name** field of the record is set to **Warren Langer**, and the **value** field is set to **100**.</span></span>
...
## <a name="transactional-integrity"></a><span data-ttu-id="1c93f-481">トランザクションの整合性</span><span class="sxs-lookup"><span data-stu-id="1c93f-481">Transactional integrity</span></span>
<span data-ttu-id="1c93f-482">手順で、トランザクションの整合性を保証しなかった場合、データが破損する可能性があります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-482">If steps aren't taken to help guarantee the integrity of transactions, data corruption could occur.</span></span> <span data-ttu-id="1c93f-483">少なくとも、システム上の同時ユーザーに関してスケーラビリティが低下する可能性があります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-483">At the very least, you might experience poor scalability with respect to concurrent users on the system.</span></span> <span data-ttu-id="1c93f-484">**forUpdate** チェックと **tssLevel** チェックの 2 つの内部チェック機能がトランザクションの完全性を保証します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-484">Two internal checking features help guarantee the integrity of transactions: the **forUpdate** check and the **tssLevel** check.</span></span> <span data-ttu-id="1c93f-485">**forUpdate** チェックは、更新のために最初に選択されたレコードのみを更新または削除されるのを保証するのに役立ちます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-485">A **forUpdate** check helps guarantee that a record can be updated or deleted only if it has first been selected for update.</span></span> <span data-ttu-id="1c93f-486">**select** ステートメント内の **forUpdate** キーワードまたはテーブル上の **selectForUpdate** メソッドのいずれかを使用することで、更新プログラムのレコードを選択することができます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-486">You can select a record for update by using either the **forUpdate** keyword in the **select** statement or the **selectForUpdate** method on tables.</span></span> <span data-ttu-id="1c93f-487">**ttsLevel** チェックは、レコードが更新のために選択されたのと同じトランザクション範囲内でのみ更新または削除できることを保証するのに役立ちます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-487">A **ttsLevel** check helps guarantee that a record can be updated or deleted only within the same transaction scope where it was selected for update.</span></span> <span data-ttu-id="1c93f-488">整合性を保証するために、次のステートメントを使用します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-488">The following statements are used to help guarantee integrity:</span></span>

-   <span data-ttu-id="1c93f-489">**ttsBegin** – このステートメントは、トランザクションの開始位置を示します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-489">**ttsBegin** – This statement marks the beginning of a transaction.</span></span> <span data-ttu-id="1c93f-490">これにより、データの整合性が保証され、トランザクションが終了するまで (**ttsCommit** または **ttsAbort** を通じて) 実行されるすべての更新が一貫したもの (すべてまたはなし) であることも保証されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-490">It helps guarantee data integrity, and also helps guarantees that all updates that are done until the transaction ends (through **ttsCommit** or **ttsAbort**) are consistent (all or none).</span></span>
-   <span data-ttu-id="1c93f-491">**ttsCommit** – このステートメントは、トランザクションの正常終了を示します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-491">**ttsCommit** – This statement marks the successful end of a transaction.</span></span> <span data-ttu-id="1c93f-492">トランザクションを終了してコミットします。</span><span class="sxs-lookup"><span data-stu-id="1c93f-492">It ends and commits a transaction.</span></span> <span data-ttu-id="1c93f-493">Finance and Operations は、確定されたトランザクションが意図に従って実行されるのを保証するのに役立ちます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-493">Finance and Operations helps guarantee that a transaction that has been committed will be performed according to intentions.</span></span>
-   <span data-ttu-id="1c93f-494">**ttsAbort** – このステートメントを使用すると、現在のトランザクションのすべての変更を明示的に破棄できます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-494">**ttsAbort** – This statement lets you explicitly discard all changes in the current transaction.</span></span> <span data-ttu-id="1c93f-495">この場合、データベースは何も変更されていない元の状態にロールバックされます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-495">In this case, the database is rolled back to the original state where nothing has been changed.</span></span> <span data-ttu-id="1c93f-496">この文は通常、ユーザーが現在のジョブを中断したいことを検出した場合に使用します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-496">Typically, you use this statement if you've detected that the user wants to break the current job.</span></span> <span data-ttu-id="1c93f-497">**ttsAbort** ステートメントは、データベースが一貫していることを保証するのに役立ちます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-497">The **ttsAbort** statement helps guarantee that the database is consistent.</span></span>

<span data-ttu-id="1c93f-498">通常、**ttsAbort** の代わりに、例外処理を使用することをお勧めします。</span><span class="sxs-lookup"><span data-stu-id="1c93f-498">Usually, it's a better idea to use exception handling instead of **ttsAbort**.</span></span> <span data-ttu-id="1c93f-499">**throw** ステートメントは、自動的に現在のトランザクションを中断します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-499">The **throw** statement automatically aborts the current transaction.</span></span> <span data-ttu-id="1c93f-500">次の例が示すように、**ttsBegin** と **ttsCommit** の間の明細書には 1 つ以上のトランザクション ブロックを含めることができます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-500">As the following example shows, statements between **ttsBegin** and **ttsCommit** can include one or more transaction blocks.</span></span> <span data-ttu-id="1c93f-501">そのような場合、最後の **ttsCommit** ステートメントから正常に終了するまで実際にコミットされるものはありません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-501">In these cases, nothing is actually committed until the successful exit from the final **ttsCommit** statement.</span></span>
...
<span data-ttu-id="1c93f-502">次の例では、レコードのセットを選択し、**NameAlias** フィールドを更新します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-502">The following example selects a set of records and updates the **NameAlias** field.</span></span>
...
### <a name="example-of-code-that-is-rejected-by-the-two-transaction-integrity-checks"></a><span data-ttu-id="1c93f-503">2 つのトランザクションの整合性チェックが拒否したコード例</span><span class="sxs-lookup"><span data-stu-id="1c93f-503">Example of code that is rejected by the two transaction integrity checks</span></span>

<span data-ttu-id="1c93f-504">この例では、**forupdate** キーワードがないため、最初のエラーが発生します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-504">In this example, the first failure occurs because the **forupdate** keyword is missing.</span></span> <span data-ttu-id="1c93f-505">2 番目のエラーは、更新のトランザクション スコープが、レコードが **ttsCommit** の更新用に選択されたトランザクション スコープと異なるために発生します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-505">The second failure occurs because the transaction scope of the update differs from the transaction scope where the record was selected for update in **ttsCommit**.</span></span>
...
## <a name="speeding-up-sql-operations"></a><span data-ttu-id="1c93f-506">SQL 操作の高速化</span><span class="sxs-lookup"><span data-stu-id="1c93f-506">Speeding up SQL operations</span></span>
<span data-ttu-id="1c93f-507">次の構文では、複数のレコードを挿入、更新、または削除できます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-507">The following constructs let you insert, update, or delete multiple records.</span></span> <span data-ttu-id="1c93f-508">これらのコンストラクトを使用することにより、アプリケーションとデータベース間の通信が減少するためパフォーマンスが向上します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-508">By using these constructs, you reduce communication between the application and the database, and therefore help increase performance.</span></span> <span data-ttu-id="1c93f-509">場合によっては、レコードのセットに基づく操作をレコードごとの操作に戻すことができます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-509">In some situations, record set–based operations can fall back to record-by-record operations.</span></span>

| <span data-ttu-id="1c93f-510">構築</span><span class="sxs-lookup"><span data-stu-id="1c93f-510">Construct</span></span>         | <span data-ttu-id="1c93f-511">説明</span><span class="sxs-lookup"><span data-stu-id="1c93f-511">Description</span></span>                                                                                                                                                                                                      |
|-------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="1c93f-512">RecordSortedList</span><span class="sxs-lookup"><span data-stu-id="1c93f-512">RecordSortedList</span></span>  | <span data-ttu-id="1c93f-513">1 つのデータベース トリップに複数のレコードを挿入します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-513">Insert multiple records in one database trip.</span></span> <span data-ttu-id="1c93f-514">特定のテーブルのデータのサブセットを必要とし、現在インデックスとして存在しない順序でソートする場合は、このコンストラクトを使用します</span><span class="sxs-lookup"><span data-stu-id="1c93f-514">Use this construct when you want a subset of data from a specific table, and you want that data to be sorted in an order that doesn't currently exist as an index.</span></span> |
| <span data-ttu-id="1c93f-515">RecordInsertList</span><span class="sxs-lookup"><span data-stu-id="1c93f-515">RecordInsertList</span></span>  | <span data-ttu-id="1c93f-516">1 つのデータベース トリップに複数のレコードを挿入します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-516">Insert multiple records in one database trip.</span></span> <span data-ttu-id="1c93f-517">データをソートする必要がない場合は、この構文を使用します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-517">Use this construct when you don't have to sort the data.</span></span>                                                                                                           |
| <span data-ttu-id="1c93f-518">insert\_recordset</span><span class="sxs-lookup"><span data-stu-id="1c93f-518">insert\_recordset</span></span> | <span data-ttu-id="1c93f-519">複数のレコードを 1 つまたは複数のテーブルから別のテーブルに直接コピーします。</span><span class="sxs-lookup"><span data-stu-id="1c93f-519">Copy multiple records directly from one or more tables into another table in one database trip.</span></span>                                                                                                                  |
| <span data-ttu-id="1c93f-520">update\_recordset</span><span class="sxs-lookup"><span data-stu-id="1c93f-520">update\_recordset</span></span> | <span data-ttu-id="1c93f-521">1 回のデータベース トリップでテーブルの複数の行を更新します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-521">Update multiple rows in a table in one database trip.</span></span>                                                                                                                                                            |
| <span data-ttu-id="1c93f-522">delete\_from</span><span class="sxs-lookup"><span data-stu-id="1c93f-522">delete\_from</span></span>      | <span data-ttu-id="1c93f-523">1 回のデータベース トリップでデータベースから複数のレコードを削除します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-523">Delete multiple records from the database in one database trip.</span></span>                                                                                                                                                  |

## <a name="insertrecordset"></a><span data-ttu-id="1c93f-524">insert\_recordset</span><span class="sxs-lookup"><span data-stu-id="1c93f-524">insert\_recordset</span></span>
<span data-ttu-id="1c93f-525">**insert\_recordset** ステートメントは、1 回のサーバー トリップで、1 つ以上のソース テーブルからデータを直接 1 つのターゲット テーブルにコピーします。</span><span class="sxs-lookup"><span data-stu-id="1c93f-525">The **insert\_recordset** statement copies data directly from one or more source tables into one destination table in one server trip.</span></span> <span data-ttu-id="1c93f-526">配列挿入より **insert\_recordset** を使用したほうが高速です。</span><span class="sxs-lookup"><span data-stu-id="1c93f-526">It's faster to use **insert\_recordset** than an array insert.</span></span> <span data-ttu-id="1c93f-527">ただし、配列挿入は、データを挿入する前に処理する場合より柔軟になります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-527">However, array inserts are more flexible if you want to handle the data before you insert it.</span></span> <span data-ttu-id="1c93f-528">**挿入\_レコード セット**はレコード セットに基づく、一度に複数のレコードに対する操作を実行する演算子です。</span><span class="sxs-lookup"><span data-stu-id="1c93f-528">**insert\_recordset** is a record set–based operator that performs operations on multiple records at a time.</span></span> <span data-ttu-id="1c93f-529">ただし、多くの場合レコードごとの操作に戻れます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-529">However, it can fall back to record-by-record operations in many situations.</span></span>

### <a name="insertrecordset-syntax"></a><span data-ttu-id="1c93f-530">insert\_recordset 構文</span><span class="sxs-lookup"><span data-stu-id="1c93f-530">insert\_recordset syntax</span></span>

<span data-ttu-id="1c93f-531">*ListOfFields* 出力先テーブルは、ソース テーブル内のフィールドのリストと一致する必要があります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-531">*ListOfFields* in the destination table must match the list of fields in the source tables.</span></span> <span data-ttu-id="1c93f-532">データは、フィールドの一覧に表示されている順に転送されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-532">Data is transferred in the order in which it appears in the list of fields.</span></span> <span data-ttu-id="1c93f-533">フィールドの一覧に表示されていない出力先テーブルのフィールドは、他の領域と同じように、**0** (ゼロ) の値に割り当てられています。</span><span class="sxs-lookup"><span data-stu-id="1c93f-533">Fields in the destination table that aren't present in the list of fields are assigned **0** (zero) values, as in other areas.</span></span> <span data-ttu-id="1c93f-534">**RecId** などのシステム フィールドは、出力先テーブルのカーネルによって透過的に割り当てられます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-534">System fields, such as **RecId**, are assigned transparently by the kernel in the destination table.</span></span> <span data-ttu-id="1c93f-535">**挿入\_レコードセット** *DestinationTable* **(** *ListOfFields* **)** の、*WhereClause* **\]** **\[ にある** *SourceTable* **から** *ListOfFields1* **を選択**し、*JoinedWhereClause* **\]\]** **\[ にある** *JoinedSourceTable* **から** *ListOfFields2* **\[ を統合する**</span><span class="sxs-lookup"><span data-stu-id="1c93f-535">**insert\_recordset** *DestinationTable* **(** *ListOfFields* **)** **select** *ListOfFields1* **from** *SourceTable* **\[ where** *WhereClause* **\]** **\[ join** *ListOfFields2* **from** *JoinedSourceTable* **\[ where** *JoinedWhereClause* **\]\]**</span></span>

### <a name="example-inserting-data-from-another-table"></a><span data-ttu-id="1c93f-536">例: 別のテーブルからデータを挿入</span><span class="sxs-lookup"><span data-stu-id="1c93f-536">Example: Inserting data from another table</span></span>

<span data-ttu-id="1c93f-537">この例では、**myNum** および **mySum** レコードは anotherTable テーブルから取得され、myTable テーブルに挿入されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-537">In this example, the **myNum** and **mySum** records are retrieved from the anotherTable table and inserted into the myTable table.</span></span> <span data-ttu-id="1c93f-538">レコードは **myNum** に基づいてグループ化されます。**100** 以下の値を持つ **myNum** のみが挿入に含まれます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-538">The records are grouped according to **myNum**, and only **myNum** records that have a value that is less than or equal to **100** are included in the insertion.</span></span>
...
### <a name="example-inserting-data-from-variables"></a><span data-ttu-id="1c93f-539">例: 変数からデータを挿入</span><span class="sxs-lookup"><span data-stu-id="1c93f-539">Example: Inserting data from variables</span></span>

<span data-ttu-id="1c93f-540">次の例は、**insert\_recordset** ステートメントが変数で提供されるデータを挿入できることを示しています。</span><span class="sxs-lookup"><span data-stu-id="1c93f-540">The following example shows that the **insert\_recordset** statement can insert data that is provided in variables.</span></span> <span data-ttu-id="1c93f-541">この例では、1 行だけ挿入するために **firstonly** キーワードが使用されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-541">In this example, the **firstonly** keyword is used so that only one row is inserted.</span></span> <span data-ttu-id="1c93f-542">**128** または**このリテラル文字列**などのリテラルは、挿入されるデータのソースとして使用することはできません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-542">Literals, such as **128** or **"this literal string"**, can't be used as a source of data that is inserted.</span></span>
...
### <a name="example-inserting-data-by-using-a-join"></a><span data-ttu-id="1c93f-543">例: 結合を使用してデータを挿入</span><span class="sxs-lookup"><span data-stu-id="1c93f-543">Example: Inserting data by using a join</span></span>

<span data-ttu-id="1c93f-544">次の例は、サブセレクトを持つ **insert\_recordset** ステートメント上の 3 つのテーブルの結合を示しています。</span><span class="sxs-lookup"><span data-stu-id="1c93f-544">The following example shows a join of three tables on an **insert\_recordset** statement that has a subselect.</span></span> <span data-ttu-id="1c93f-545">また、同じ結合がある **while** **select** ステートメントも示します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-545">It also shows a **while** **select** statement that has a similar join.</span></span> <span data-ttu-id="1c93f-546">変数は、1 つの列に挿入された値を供給するために使用されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-546">A variable is used to supply the inserted value for one column.</span></span> <span data-ttu-id="1c93f-547">**str** 変数は、宣言する必要があり、長さを対応するデータベース フィールドの最大長さ以下にする必要があります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-547">The **str** variable must be declared, and must have a length that is less than or equal to the maximum length of the corresponding database field.</span></span> <span data-ttu-id="1c93f-548">この例では、tabEmplProj5 テーブルに対する **insert\_recordset** ステートメントがあります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-548">In this example, there is an **insert\_recordset** statement for the tabEmplProj5 table.</span></span> <span data-ttu-id="1c93f-549">ターゲット フィールドの 1 つに**説明**という名前が付けられ、フィールドのデータはローカル変数 **sDescriptionVariable** から取得されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-549">One of the target fields is named **Description**, and the field's data comes from the local variable **sDescriptionVariable**.</span></span> <span data-ttu-id="1c93f-550">**説明** フィールドの構成キーは無効の場合でも **insert\_recordset** ステートメントは成功します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-550">The **insert\_recordset** statement succeeds even when the configuration key for the **Description** field is turned off.</span></span> <span data-ttu-id="1c93f-551">システムでは、**Description** フィールドと **sDescriptionVariable** 変数の両方を無視します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-551">The system ignores both the **Description** field and the **sDescriptionVariable** variable.</span></span> <span data-ttu-id="1c93f-552">したがって、このコードは*コンフィギュレーション キーの自動化*の例を提供します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-552">Therefore, this code provides an example of *configuration key automation*.</span></span> <span data-ttu-id="1c93f-553">コンフィギュレーション キーの自動化は、コンフィギュレーション キーがオフになっているフィールドにデータを挿入する **insert\_ recordset** ステートメントの動作を、システムが自動的に調整できるときに発生します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-553">Configuration key automation occurs when the system can automatically adjust the behavior of an **insert\_recordset** statement that inserts data into fields that the configuration key is turned off for.</span></span>
...
## <a name="updaterecordset"></a><span data-ttu-id="1c93f-554">update\_recordset</span><span class="sxs-lookup"><span data-stu-id="1c93f-554">update\_recordset</span></span>
<span data-ttu-id="1c93f-555"><strong>update\_recordset</strong> ステートメントでは、サーバーへの 1 回のアクセスで複数の行を更新することができます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-555">The <strong>update\_recordset</strong> statement lets you update multiple rows in one trip to the server.</span></span> <span data-ttu-id="1c93f-556">したがって、SQL Server の機能は、一部のタスクのパフォーマンスを向上させるのに役立ちます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-556">Therefore, the power of SQL Server can help improve the performance of some tasks.</span></span> <span data-ttu-id="1c93f-557">*<strong><em>update\_recordset</em></strong>* ステートメントは、X++ の <strong>delete\_from</strong> と SQL の <strong>update set</strong> に似ています。</span><span class="sxs-lookup"><span data-stu-id="1c93f-557">The *<strong><em>update\_recordset</em></strong>* statement resembles <strong>delete\_from</strong> in X++ and <strong>update set</strong> in SQL.</span></span> <span data-ttu-id="1c93f-558">フェッチ、変更、更新によって個別に各レコードを取得しません。代わりに、データベース サーバー側で設定された SQL スタイル レコードで動作します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-558">It doesn't retrieve each record separately by fetching, changing, and updating, Instead, it works on an SQL-style record set on the database server side.</span></span> <span data-ttu-id="1c93f-559"><strong>更新</strong>メソッドがオーバーライドされた場合、実装は、一度に 1 つのレコードが更新される古典的なループ構造に戻されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-559">If the <strong>update</strong> method is overridden, the implementation falls back to a classic looping construction, where one record at a time is updated.</span></span> <span data-ttu-id="1c93f-560">(この動作は、削除対象の <strong>削除の\_対象</strong> の動作に似ています。) したがって、構築は、一時テーブルとテーブル全体 - キャッシュされたテーブルで、ループ構造を使用して動作します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-560">(This behavior resembles the behavior of <strong>delete\_from</strong> for deletions.) Therefore, the construction works on temporary tables and whole table–cached tables by using the looping construction.</span></span>

### <a name="example-update-that-is-based-on-a-calculated-value"></a><span data-ttu-id="1c93f-561">例: 計算値に基づく更新プログラム</span><span class="sxs-lookup"><span data-stu-id="1c93f-561">Example: Update that is based on a calculated value</span></span>

<span data-ttu-id="1c93f-562">次の例では、myTableBuffer テーブルを更新して、テーブルのすべてのレコードで **field1**フィールドの値を 10% 増分します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-562">The following example updates the myTableBuffer table and increments the value of the **field1** field by ten percent in all records in the table.</span></span>

    MyTable myTableBuffer;
    update_recordset myTableBuffer
    setting field1 = field1 * 1.10;

### <a name="example-update-that-uses-a-where-clause"></a><span data-ttu-id="1c93f-563">例: where 句を使用する更新プログラム</span><span class="sxs-lookup"><span data-stu-id="1c93f-563">Example: Update that uses a where clause</span></span>

<span data-ttu-id="1c93f-564">次の例では、**field1** フィールドの値が **0** の myTable テーブルのすべてのレコードを更新します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-564">The following example updates all records in the myTable table where the **field1** field has the value **0**.</span></span> <span data-ttu-id="1c93f-565">**field1** フィールドには、新しい値 **1** が割り当てられます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-565">The **field1** field is assigned a new value of **1**.</span></span> <span data-ttu-id="1c93f-566">**field2** フィールドには、**fieldX** および **fieldY** の合計値が割り当てられます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-566">The **field2** field is assigned a value that is the sum of **fieldX** and **fieldY**.</span></span> <span data-ttu-id="1c93f-567">この例では、複数のフィールドを同時に更新し、**where** 句を満たす行のみを更新します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-567">This example updates multiple fields at the same time, and it updates only those rows that satisfy the **where** clause.</span></span>
...
### <a name="example-updating-joined-tables"></a><span data-ttu-id="1c93f-568">例: 結合されたテーブルの更新プログラム</span><span class="sxs-lookup"><span data-stu-id="1c93f-568">Example: Updating joined tables</span></span>

<span data-ttu-id="1c93f-569">次の例は、**update\_recordset** ステートメントが複数のテーブルの結合をサポートしていることを示しています。</span><span class="sxs-lookup"><span data-stu-id="1c93f-569">The following example shows that the **update\_recordset** statement supports joins of several tables.</span></span> <span data-ttu-id="1c93f-570">結合されたテーブルのデータを使用して、更新中のテーブル内のフィールドに値を割り当てることができます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-570">Data from the joined tables can be used to assign values to fields in the table that is being updated.</span></span>
...
## <a name="deletefrom"></a><span data-ttu-id="1c93f-571">delete\_from</span><span class="sxs-lookup"><span data-stu-id="1c93f-571">delete\_from</span></span>
<span data-ttu-id="1c93f-572">**delete\_from** ステートメントを使用することにより、データベース テーブルから複数のレコードを削除することができます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-572">You can delete multiple records from a database table by using a **delete\_from** statement.</span></span> <span data-ttu-id="1c93f-573">この方法は、一度に 1 つのレコードを削除するループで **xRecord .delete** メソッドを使用する方法よりも効率的かつ高速になります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-573">This approach can be more efficient and faster than an approach that uses the **xRecord .delete** method in a loop to delete one record at a time.</span></span> <span data-ttu-id="1c93f-574">**delete** メソッドをオーバーライドした場合、システムは削除される各行につき 1 回 **delete\_from** ステートメントを **delete** メソッドを呼び出すコードに解釈します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-574">If you've overridden the **delete** method, the system interprets the **delete\_from** statement into code that calls the **delete** method one time for each row that is deleted.</span></span>

### <a name="example-efficiently-deleting-records-by-using-deletefrom"></a><span data-ttu-id="1c93f-575">例: delete\_from を使用して、効率的にレコードを削除</span><span class="sxs-lookup"><span data-stu-id="1c93f-575">Example: Efficiently deleting records by using delete\_from</span></span>

<span data-ttu-id="1c93f-576">次の例は、複数のレコードを効率的に削除する方法を示しています。</span><span class="sxs-lookup"><span data-stu-id="1c93f-576">The following example shows an efficient way to delete multiple records.</span></span>
...
#### <a name="example-inefficiently-deleting-records-by-using-forupdate"></a><span data-ttu-id="1c93f-577">例: forUpdate を使用して、非効率的にレコードを削除</span><span class="sxs-lookup"><span data-stu-id="1c93f-577">Example: Inefficiently deleting records by using forUpdate</span></span>

<span data-ttu-id="1c93f-578">次の例は非効率的です。</span><span class="sxs-lookup"><span data-stu-id="1c93f-578">The following example is inefficient.</span></span> <span data-ttu-id="1c93f-579">個別の SQL **削除**呼び出しを、各レコードのデータベース サーバーに発行します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-579">It issues a separate SQL **delete** call to the database server for every record.</span></span> <span data-ttu-id="1c93f-580">**xRecord** **.delete** メソッドが、呼び出しごとに複数のレコードを削除することはありません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-580">The **xRecord** **.delete** method never deletes more than one record per call.</span></span>
...
### <a name="example-a-delete-operation-that-has-an-inner-join"></a><span data-ttu-id="1c93f-581">例: 内部結合を持つ削除操作</span><span class="sxs-lookup"><span data-stu-id="1c93f-581">Example: A delete operation that has an inner join</span></span>

<span data-ttu-id="1c93f-582">内部結合は **delete\_from** ステートメントではサポートされません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-582">Inner joins aren't supported on the **delete\_from** statement.</span></span> <span data-ttu-id="1c93f-583">したがって、修正していない **join** キーワードを **delete\_from** ステートメント上で使用することができません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-583">Therefore, you can't use the unmodified **join** keyword on the **delete\_from** statement.</span></span> <span data-ttu-id="1c93f-584">ただし、他の方法を使用して内部結合を論理的に実行できます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-584">However, you can logically accomplish an inner join by using other techniques.</span></span> <span data-ttu-id="1c93f-585">次の例は、一連のステートメントを通して内部結合ロジックを達成するための新旧の手法を示しています。</span><span class="sxs-lookup"><span data-stu-id="1c93f-585">The following example shows the new and old techniques for achieving inner join logic through a sequence of statements.</span></span>
...
### <a name="example-a-delete-operation-that-uses-the-notexists-join-keyword"></a><span data-ttu-id="1c93f-586">例: notexists 結合キーワードを使用する削除操作</span><span class="sxs-lookup"><span data-stu-id="1c93f-586">Example: A delete operation that uses the notexists join keyword</span></span>

<span data-ttu-id="1c93f-587">**notexists join** キーワード ペアは **delete\_from** ステートメント内で使用することができます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-587">You can use the **notexists join** keyword pair in a **delete\_from** statement.</span></span> <span data-ttu-id="1c93f-588">次の例の **delete\_from** ステートメントが効率的です。</span><span class="sxs-lookup"><span data-stu-id="1c93f-588">The **delete\_from** statements in the following example are efficient.</span></span> <span data-ttu-id="1c93f-589">**notexists join** 句を使用すると、**delete\_from** ステートメントが特定の行セットを削除できるようになります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-589">The **notexists join** clause enables the **delete\_from** statement to delete a specific set of rows.</span></span> <span data-ttu-id="1c93f-590">この例では、**delete\_from** ステートメントが子の注文明細行の行がない親の注文ヘッダー行をすべて削除します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-590">In this example, the **delete\_from** statement removes all parent-order header rows that there are no child-order line rows for.</span></span> <span data-ttu-id="1c93f-591">また、**exists join** 句を **delete\_from** ステートメント上で使用することができます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-591">You can also use the **exists join** clause on the **delete\_from** statement.</span></span>
...
## <a name="maintain-fast-sql-operations"></a><span data-ttu-id="1c93f-592">高速な SQL 操作の管理</span><span class="sxs-lookup"><span data-stu-id="1c93f-592">Maintain fast SQL operations</span></span>
<span data-ttu-id="1c93f-593">レコード セット ベースの操作をより低速のレコードごとの操作に変換できる状況があります。</span><span class="sxs-lookup"><span data-stu-id="1c93f-593">There are situations where record set–based operations can be converted to slower record-by-record operations.</span></span> <span data-ttu-id="1c93f-594">次の情報は、これらの状況を識別します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-594">The following information identifies these situations.</span></span>


### <a name="non-sql-tables"></a><span data-ttu-id="1c93f-595">非 SQL テーブル</span><span class="sxs-lookup"><span data-stu-id="1c93f-595">Non-SQL tables</span></span>

| <span data-ttu-id="1c93f-596">工程</span><span class="sxs-lookup"><span data-stu-id="1c93f-596">Operation</span></span> | <span data-ttu-id="1c93f-597">変換可能</span><span class="sxs-lookup"><span data-stu-id="1c93f-597">Can be converted</span></span> |
|---|---|
|<span data-ttu-id="1c93f-598">DELETE_FROM</span><span class="sxs-lookup"><span data-stu-id="1c93f-598">DELETE_FROM</span></span>|<span data-ttu-id="1c93f-599">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-599">Yes</span></span>|
|<span data-ttu-id="1c93f-600">UPDATE_RECORDSET</span><span class="sxs-lookup"><span data-stu-id="1c93f-600">UPDATE_RECORDSET</span></span>|<span data-ttu-id="1c93f-601">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-601">Yes</span></span>|
|<span data-ttu-id="1c93f-602">INSERT_RECORDSET</span><span class="sxs-lookup"><span data-stu-id="1c93f-602">INSERT_RECORDSET</span></span>|<span data-ttu-id="1c93f-603">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-603">Yes</span></span>|
|<span data-ttu-id="1c93f-604">ARRAY_INSERT</span><span class="sxs-lookup"><span data-stu-id="1c93f-604">ARRAY_INSERT</span></span>|<span data-ttu-id="1c93f-605">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-605">Yes</span></span>|
|<span data-ttu-id="1c93f-606">オーバーライドにこの設定を使用する</span><span class="sxs-lookup"><span data-stu-id="1c93f-606">Use this setting for overrides</span></span>|<span data-ttu-id="1c93f-607">該当なし</span><span class="sxs-lookup"><span data-stu-id="1c93f-607">Not applicable</span></span>|

### <a name="delete-actions"></a><span data-ttu-id="1c93f-608">アクションの削除</span><span class="sxs-lookup"><span data-stu-id="1c93f-608">Delete actions</span></span>

| <span data-ttu-id="1c93f-609">工程</span><span class="sxs-lookup"><span data-stu-id="1c93f-609">Operation</span></span> | <span data-ttu-id="1c93f-610">変換可能</span><span class="sxs-lookup"><span data-stu-id="1c93f-610">Can be converted</span></span> |
|---|---|
|<span data-ttu-id="1c93f-611">DELETE_FROM</span><span class="sxs-lookup"><span data-stu-id="1c93f-611">DELETE_FROM</span></span>|<span data-ttu-id="1c93f-612">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-612">Yes</span></span>|
|<span data-ttu-id="1c93f-613">UPDATE_RECORDSET</span><span class="sxs-lookup"><span data-stu-id="1c93f-613">UPDATE_RECORDSET</span></span>|<span data-ttu-id="1c93f-614">無</span><span class="sxs-lookup"><span data-stu-id="1c93f-614">No</span></span>|
|<span data-ttu-id="1c93f-615">INSERT_RECORDSET</span><span class="sxs-lookup"><span data-stu-id="1c93f-615">INSERT_RECORDSET</span></span>|<span data-ttu-id="1c93f-616">無</span><span class="sxs-lookup"><span data-stu-id="1c93f-616">No</span></span>|
|<span data-ttu-id="1c93f-617">ARRAY_INSERT</span><span class="sxs-lookup"><span data-stu-id="1c93f-617">ARRAY_INSERT</span></span>|<span data-ttu-id="1c93f-618">無</span><span class="sxs-lookup"><span data-stu-id="1c93f-618">No</span></span>|
|<span data-ttu-id="1c93f-619">オーバーライドにこの設定を使用する</span><span class="sxs-lookup"><span data-stu-id="1c93f-619">Use this setting for overrides</span></span>|<span data-ttu-id="1c93f-620">**skipDeleteActions**</span><span class="sxs-lookup"><span data-stu-id="1c93f-620">**skipDeleteActions**</span></span>|

### <a name="the-database-log-is-enabled"></a><span data-ttu-id="1c93f-621">データベース ログが有効になっています。</span><span class="sxs-lookup"><span data-stu-id="1c93f-621">The database log is enabled.</span></span>

| <span data-ttu-id="1c93f-622">工程</span><span class="sxs-lookup"><span data-stu-id="1c93f-622">Operation</span></span> | <span data-ttu-id="1c93f-623">変換可能</span><span class="sxs-lookup"><span data-stu-id="1c93f-623">Can be converted</span></span> |
|---|---|
|<span data-ttu-id="1c93f-624">DELETE_FROM</span><span class="sxs-lookup"><span data-stu-id="1c93f-624">DELETE_FROM</span></span>|<span data-ttu-id="1c93f-625">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-625">Yes</span></span>|
|<span data-ttu-id="1c93f-626">UPDATE_RECORDSET</span><span class="sxs-lookup"><span data-stu-id="1c93f-626">UPDATE_RECORDSET</span></span>|<span data-ttu-id="1c93f-627">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-627">Yes</span></span>|
|<span data-ttu-id="1c93f-628">INSERT_RECORDSET</span><span class="sxs-lookup"><span data-stu-id="1c93f-628">INSERT_RECORDSET</span></span>|<span data-ttu-id="1c93f-629">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-629">Yes</span></span>|
|<span data-ttu-id="1c93f-630">ARRAY_INSERT</span><span class="sxs-lookup"><span data-stu-id="1c93f-630">ARRAY_INSERT</span></span>|<span data-ttu-id="1c93f-631">無</span><span class="sxs-lookup"><span data-stu-id="1c93f-631">No</span></span>|
|<span data-ttu-id="1c93f-632">オーバーライドにこの設定を使用する</span><span class="sxs-lookup"><span data-stu-id="1c93f-632">Use this setting for overrides</span></span>|<span data-ttu-id="1c93f-633">**skipDatabaseLog**</span><span class="sxs-lookup"><span data-stu-id="1c93f-633">**skipDatabaseLog**</span></span>|

### <a name="overridden-method"></a><span data-ttu-id="1c93f-634">オーバーライドされたメソッド</span><span class="sxs-lookup"><span data-stu-id="1c93f-634">Overridden method</span></span>

| <span data-ttu-id="1c93f-635">工程</span><span class="sxs-lookup"><span data-stu-id="1c93f-635">Operation</span></span> | <span data-ttu-id="1c93f-636">変換可能</span><span class="sxs-lookup"><span data-stu-id="1c93f-636">Can be converted</span></span> |
|---|---|
|<span data-ttu-id="1c93f-637">DELETE_FROM</span><span class="sxs-lookup"><span data-stu-id="1c93f-637">DELETE_FROM</span></span>|<span data-ttu-id="1c93f-638">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-638">Yes</span></span>|
|<span data-ttu-id="1c93f-639">UPDATE_RECORDSET</span><span class="sxs-lookup"><span data-stu-id="1c93f-639">UPDATE_RECORDSET</span></span>|<span data-ttu-id="1c93f-640">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-640">Yes</span></span>|
|<span data-ttu-id="1c93f-641">INSERT_RECORDSET</span><span class="sxs-lookup"><span data-stu-id="1c93f-641">INSERT_RECORDSET</span></span>|<span data-ttu-id="1c93f-642">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-642">Yes</span></span>|
|<span data-ttu-id="1c93f-643">ARRAY_INSERT</span><span class="sxs-lookup"><span data-stu-id="1c93f-643">ARRAY_INSERT</span></span>|<span data-ttu-id="1c93f-644">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-644">Yes</span></span>|
|<span data-ttu-id="1c93f-645">オーバーライドにこの設定を使用する</span><span class="sxs-lookup"><span data-stu-id="1c93f-645">Use this setting for overrides</span></span>|<span data-ttu-id="1c93f-646">**skipDataMethods**</span><span class="sxs-lookup"><span data-stu-id="1c93f-646">**skipDataMethods**</span></span>|

### <a name="alerts-are-set-up-for-the-table"></a><span data-ttu-id="1c93f-647">警告はテーブルの設定をします。</span><span class="sxs-lookup"><span data-stu-id="1c93f-647">Alerts are set up for the table.</span></span>

| <span data-ttu-id="1c93f-648">工程</span><span class="sxs-lookup"><span data-stu-id="1c93f-648">Operation</span></span> | <span data-ttu-id="1c93f-649">変換可能</span><span class="sxs-lookup"><span data-stu-id="1c93f-649">Can be converted</span></span> |
|---|---|
|<span data-ttu-id="1c93f-650">DELETE_FROM</span><span class="sxs-lookup"><span data-stu-id="1c93f-650">DELETE_FROM</span></span>|<span data-ttu-id="1c93f-651">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-651">Yes</span></span>|
|<span data-ttu-id="1c93f-652">UPDATE_RECORDSET</span><span class="sxs-lookup"><span data-stu-id="1c93f-652">UPDATE_RECORDSET</span></span>|<span data-ttu-id="1c93f-653">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-653">Yes</span></span>|
|<span data-ttu-id="1c93f-654">INSERT_RECORDSET</span><span class="sxs-lookup"><span data-stu-id="1c93f-654">INSERT_RECORDSET</span></span>|<span data-ttu-id="1c93f-655">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-655">Yes</span></span>|
|<span data-ttu-id="1c93f-656">ARRAY_INSERT</span><span class="sxs-lookup"><span data-stu-id="1c93f-656">ARRAY_INSERT</span></span>|<span data-ttu-id="1c93f-657">無</span><span class="sxs-lookup"><span data-stu-id="1c93f-657">No</span></span>|
|<span data-ttu-id="1c93f-658">オーバーライドにこの設定を使用する</span><span class="sxs-lookup"><span data-stu-id="1c93f-658">Use this setting for overrides</span></span>|<span data-ttu-id="1c93f-659">**skipEvents**</span><span class="sxs-lookup"><span data-stu-id="1c93f-659">**skipEvents**</span></span>|

### <a name="the-validtimestatefieldtype-property-on-a-table-isnt-equal-to-none"></a><span data-ttu-id="1c93f-660">テーブル上の ValidTimeStateFieldType プロパティは、[なし] とは等しくなりません。</span><span class="sxs-lookup"><span data-stu-id="1c93f-660">The ValidTimeStateFieldType property on a table isn't equal to None.</span></span>

| <span data-ttu-id="1c93f-661">工程</span><span class="sxs-lookup"><span data-stu-id="1c93f-661">Operation</span></span> | <span data-ttu-id="1c93f-662">変換可能</span><span class="sxs-lookup"><span data-stu-id="1c93f-662">Can be converted</span></span> |
|---|---|
|<span data-ttu-id="1c93f-663">DELETE_FROM</span><span class="sxs-lookup"><span data-stu-id="1c93f-663">DELETE_FROM</span></span>|<span data-ttu-id="1c93f-664">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-664">Yes</span></span>|
|<span data-ttu-id="1c93f-665">UPDATE_RECORDSET</span><span class="sxs-lookup"><span data-stu-id="1c93f-665">UPDATE_RECORDSET</span></span>|<span data-ttu-id="1c93f-666">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-666">Yes</span></span>|
|<span data-ttu-id="1c93f-667">INSERT_RECORDSET</span><span class="sxs-lookup"><span data-stu-id="1c93f-667">INSERT_RECORDSET</span></span>|<span data-ttu-id="1c93f-668">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-668">Yes</span></span>|
|<span data-ttu-id="1c93f-669">ARRAY_INSERT</span><span class="sxs-lookup"><span data-stu-id="1c93f-669">ARRAY_INSERT</span></span>|<span data-ttu-id="1c93f-670">有</span><span class="sxs-lookup"><span data-stu-id="1c93f-670">Yes</span></span>|
|<span data-ttu-id="1c93f-671">オーバーライドにこの設定を使用する</span><span class="sxs-lookup"><span data-stu-id="1c93f-671">Use this setting for overrides</span></span>|<span data-ttu-id="1c93f-672">該当なし</span><span class="sxs-lookup"><span data-stu-id="1c93f-672">Not applicable</span></span>|


<span data-ttu-id="1c93f-673"><strong>オーバーライドにこの設定を使用</strong>に対して表示される設定を使用して、パフォーマンスに悪影響を与える 1 つまたは複数の要因を明示的にスキップまたは無視します。</span><span class="sxs-lookup"><span data-stu-id="1c93f-673">You can use the settings that are shown for <strong>Use this setting for overrides</strong> to explicitly skip or ignore one or more factors that adversely affect performance.</span></span> <span data-ttu-id="1c93f-674">何らかの理由で前述の SQL 操作の 1 つをレコードごとの操作にダウングレードした場合、<strong>スキップ\</strong>\* 設定もすべて無視されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-674">If, for some reason, one of the previously mentioned SQL operations is downgraded to a record-by-record operation, all the <strong>skip\</strong>\* settings are also ignored.</span></span> <span data-ttu-id="1c93f-675">たとえば、次のコードでは、コンテナーまたはメモ フィールドが myTable で定義されている場合はこの方法をスキップする必要があると明確に示されていても、myTable テーブルで<strong>挿入</strong>メソッドが実行されます。</span><span class="sxs-lookup"><span data-stu-id="1c93f-675">For example, in the following code, the <strong>insert</strong> method on the myTable table is run, even though it's explicitly stated that this method should be skipped if a container or memo field is defined for myTable.</span></span>
