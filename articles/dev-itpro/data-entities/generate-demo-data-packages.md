...
ms.openlocfilehash: 63037f8743f02977fce63ffd5ff81b721e094cf2
...
デモ データがサポートするシナリオの多くにスクリプトが用意されています。 これらのスクリプトは [Dynamics 365 Finance and Operations のデモ データ スクリプト](https://go.microsoft.com/fwlink/?linkid=861599) で見つけることができます。

> [!NOTE]
> さらなるスクリプトを完成したら、それらを追加します。
