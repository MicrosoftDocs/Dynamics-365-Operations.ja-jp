...
ms.openlocfilehash: fb3a9ccc9118e076458d3adf17d7ac168cc022d4
ms.contentlocale: ja-jp
ms.lasthandoff: 04/20/2018

---

# <a name="service-authentication-troubleshooting"></a>サービス認証のトラブルシューティング
...
次の図は、JWT のコンテンツの例を示します。 [![JWT の例](./media/serviceauthenticationtroubleshooting01.png)](./media/serviceauthenticationtroubleshooting01.png)
