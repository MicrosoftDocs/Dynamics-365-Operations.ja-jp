...
| [更新プログラムの入手](../migration-upgrade/download-hotfix-lcs.md)                            | 更新された情報を取得することで、Finance and Operations または Microsoft Dynamics 365 for Retail を運用するユーザーが、使用している環境で利用可能なアップデートにアクセスするために使用できるツールです。                            |
| [環境の監視](monitoring-diagnostics.md)                            | 環境監視は、管理対象となる Finance and Operations 環境の状態の監視、診断および分析に役立つツールです。                                               |
...
| [アップグレード分析](ax-2012/upgrade-analysis-lcs.md)                         | アップグレード分析は、 Microsoft Dynamics AX 4.0、 Microsoft Dynamics AX 2009, AX 2012 のコード アーティファクトを分析することにより、Finance and Operations の最新バージョンへのアップグレードを計画することに役立ちます。                                                                                                                                                                                                                                                                                                    |
