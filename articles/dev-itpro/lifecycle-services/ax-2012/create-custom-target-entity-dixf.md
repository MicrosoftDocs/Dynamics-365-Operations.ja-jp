...
ms.openlocfilehash: d54dc8b00fea82c359a9399e8ae4d8ca971f9e20
ms.contentlocale: ja-jp
ms.lasthandoff: 04/20/2018

---

# <a name="create-a-custom-target-entity-for-the-data-importexport-framework-ax-2012"></a>データのインポート/エクスポート フレームワーク (AX 2012) のカスタム ターゲット エンティティを作成します
