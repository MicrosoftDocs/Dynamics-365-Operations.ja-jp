...
<xliff xmlns:logoport="urn:logoport:xliffeditor:xliff-extras:1.0" xmlns:tilt="urn:logoport:xliffeditor:tilt-non-translatables:1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:oasis:names:tc:xliff:document:1.2" xmlns:xliffext="urn:microsoft:content:schema:xliffextensions" version="1.2" xsi:schemaLocation="urn:oasis:names:tc:xliff:document:1.2 xliff-core-1.2-transitional.xsd">
  <file datatype="xml" source-language="en-US" original="deploy-test-environment-azure.md" target-language="ja-JP">
    <header>
      <tool tool-company="Microsoft" tool-version="1.0-7889195" tool-name="mdxliff" tool-id="mdxliff"/>
      <xliffext:skl_file_name>deploy-test-environment-azure.f1f846.d5a6dbedc8b71aa89162e6c1c52ca5390adf6f3b.skl</xliffext:skl_file_name>
      <xliffext:version>1.2</xliffext:version>
      <xliffext:ms.openlocfilehash>d5a6dbedc8b71aa89162e6c1c52ca5390adf6f3b</xliffext:ms.openlocfilehash>
      <xliffext:ms.sourcegitcommit>9d4c7edd0ae2053c37c7d81cdd180b16bf3a9d3b</xliffext:ms.sourcegitcommit>
      <xliffext:ms.lasthandoff>05/15/2019</xliffext:ms.lasthandoff>
      <xliffext:ms.openlocfilepath>articles\dev-itpro\lifecycle-services\ax-2012\deploy-test-environment-azure.md</xliffext:ms.openlocfilepath>
    </header>
    <body>
      <group extype="content" id="content">
        <trans-unit xml:space="preserve" translate="yes" id="101" restype="x-metadata">
          <source>Deploy test environments on Azure</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Azure でのテスト環境の配置</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="102" restype="x-metadata">
          <source>This topic provides information about how to deploy a test environment on Microsoft Azure.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">このトピックでは、Microsoft Azure でのテスト環境の配置方法について説明します。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="105">
          <source>Before you complete the procedures in this article, make sure that the following prerequisites are in place.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">この記事の手順を実行する前に、次の条件が満たされていることを確認します。</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">プロジェクトは 1 つの Azure サブスクリプションにだけ接続できることに留意してください。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="135">
          <source>(You may have to scroll to the bottom of the navigation pane to see the <bpt id="p1">**</bpt>Settings<ept id="p1">**</ept> link.) The <bpt id="p2">**</bpt>Settings<ept id="p2">**</ept> page is displayed.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">(<bpt id="p1">**</bpt>設定<ept id="p1">**</ept>リンクを表示するには、ナビゲーションペインの一番下までスクロールしなければならない場合があります。) <bpt id="p2">**</bpt>設定<ept id="p2">**</ept>ページが表示されます。</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Lifecycle Services で <bpt id="p1">**</bpt>Microsoft Azure 設定<ept id="p1">**</ept>パネルを表示するブラウザーに戻ります。</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">この Active Directory はシングルサインオンには使用されません。社内ディレクトリを同期するように設定しないでください。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="175">
          <source>Create an Active Directory account in Azure</source>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Active Directory は Azure 仮想ネットワークに配置できます。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="194">
          <source>AX 2012 R3 installation account Note: This account must have permission to join computers to the domain.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">AX 2012 R3 インストール アカウント 注記: このアカウントは、コンピューターをドメインに参加させるためのアクセス許可を持つ必要があります。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="195">
          <source>To give this account permission, complete the following steps:</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">このアカウントにアクセス許可を与えるには、次の手順を実行します。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="199">
          <source>In the <bpt id="p1">&lt;strong&gt;</bpt>Delegation of Control Wizard<ept id="p1">&lt;/strong&gt;</ept>, click <bpt id="p2">&lt;strong&gt;</bpt>Next<ept id="p2">&lt;/strong&gt;</ept>.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;strong&gt;</bpt>コントロールのデリゲート ウィザード<ept id="p1">&lt;/strong&gt;</ept>で、<bpt id="p2">&lt;strong&gt;</bpt>次へ<ept id="p2">&lt;/strong&gt;</ept>をクリックします。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="202">
          <source>Click <bpt id="p1">&lt;strong&gt;</bpt>Only the following objects in the folder<ept id="p1">&lt;/strong&gt;</ept>, and then from the list, click to select the <bpt id="p2">&lt;strong&gt;</bpt>Computer objects<ept id="p2">&lt;/strong&gt;</ept> check box.</source>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">その後、リスト下部で <bpt id="p1">&lt;strong&gt;</bpt>このフォルダーの選択したオブジェクトを作成する<ept id="p1">&lt;/strong&gt;</ept> および <bpt id="p2">&lt;strong&gt;</bpt>このフォルダーの選択したオブジェクトを削除する<ept id="p2">&lt;/strong&gt;</ept> の各チェック ボックスを選択します。</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">信託の作成方法の詳細については、「<bpt id="p1">[</bpt>フォレスト信託の作成<ept id="p1">](https://technet.microsoft.com/en-us/library/cc754626.aspx)</ept>」を参照してください。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="229">
          <source>In the <bpt id="p1">**</bpt>Select Users, Computers, or Groups<ept id="p1">**</ept> dialog box, type <bpt id="p2">**</bpt>Administrators<ept id="p2">**</ept>.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>ユーザー、コンピュータ、またはグループの選択<ept id="p1">**</ept>ダイアログ ボックスで、<bpt id="p2">**</bpt>管理者<ept id="p2">**</ept>と入力します。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="234">
          <source>5. Deploy a test environment on Azure</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">5. Azure でのテスト環境の配置</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="235">
          <source>Complete the following procedure to deploy a test environment on Azure.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Azure にテスト環境を配置するには、以下の手順に従ってください。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="236">
          <source>On the <bpt id="p1">**</bpt>Cloud-hosted environments<ept id="p1">**</ept> page, click the Add (+) icon.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>クラウド ホスト環境<ept id="p1">**</ept>ページで、追加 (+) アイコンをクリックします。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="238">
          <source>Click <bpt id="p1">**</bpt>Test<ept id="p1">**</ept>.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>テスト<ept id="p1">**</ept> をクリックします。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="250">
          <source>Click <bpt id="p1">&lt;strong&gt;</bpt>Existing domain<ept id="p1">&lt;/strong&gt;</ept>.</source>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="274">
          <source>If you have selected to deploy a Remote Desktop Services virtual machine, click <bpt id="p1">**</bpt>Customize remote desktop services<ept id="p1">**</ept> to specify how your users will access AX 2012 R3 via the web.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">リモート デスクトップ サービスの仮想マシンを配置することを選択した場合、<bpt id="p1">**</bpt>リモート デスクトップ サービスをカスタマイズ<ept id="p1">**</ept>をクリックし、ユーザーが web 経由で AX 2012 R3 にアクセスする方法を指定します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="275">
          <source>Select one of the following options:</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">次のオプションのいずれかを選択します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="276">
          <source><bpt id="p1">**</bpt>Remote Desktop:<ept id="p1">**</ept> This option enables users to login to a full remote desktop.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>リモート デスクトップ:<ept id="p1">**</ept> このオプションはユーザーの完全なリモート デスクトップへのログインを有効にします。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="277">
          <source><bpt id="p1">**</bpt>RemoteApp Programs:<ept id="p1">**</ept> This option enables users to login in to AX 2012 R3 directly, without having the experience of a full desktop window.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>RemoteApp プログラム<ept id="p1">**</ept>: このオプションを使用すると、完全なデスクトップウィンドウを使用しなくても、ユーザは直接 AX 2012 R3 にログインできます。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="278">
          <source>RemoteApp is enabled by default.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">RemoteApp は既定で有効になります。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="279">
          <source>After the environment has been deployed, the following links are available to you on the <bpt id="p1">**</bpt>Cloud-hosted environments<ept id="p1">**</ept> page:</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">環境が配置されると、<bpt id="p1">**</bpt>クラウド ホスト環境<ept id="p1">**</ept>ページで次のリンクが使用できます:</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="280">
          <source><bpt id="p1">**</bpt>RDS Web Access certificate<ept id="p1">**</ept>: This is a self-signed certificate that is provided to allow secured access to the RDS Web Access site.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>RDS Web アクセス証明書<ept id="p1">**</ept>: これは、RDS Web アクセス サイトへの安全なアクセスを許可するために提供される自己署名証明書です。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="281">
          <source>Click the link and open this certificate and install it into the <bpt id="p1">**</bpt>Local Machine<ept id="p1">**</ept> <ph id="ph1">&amp;gt;</ph> <bpt id="p2">**</bpt>Trusted Root Certification Authorities<ept id="p2">**</ept> node before attempting to access the RDS Web Access site.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">リンクをクリックしてこの証明書を開き、RDS Web アクセス サイトにアクセスする前に、<bpt id="p1">**</bpt>ローカル コンピューター<ept id="p1">**</ept><ph id="ph1">&amp;gt;</ph><bpt id="p2">**</bpt>信頼済ルート証明機関<ept id="p2">**</ept>にインストールします。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="282">
          <source>It is recommended that before this environment be placed into a production capacity that you install your own certificate to the RDS cluster.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">この環境を生産能力に配置する前に、RDS クラスターに自分の証明書をインストールすることをお勧めします。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="283">
          <source><bpt id="p1">**</bpt>RDS Web Access<ept id="p1">**</ept>: This allows users to gain access to the AX 2012 R3 environment over the web.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>RDS Web アクセス<ept id="p1">**</ept>: これにより、ユーザはウェブ上で AX 2012 R3 環境にアクセスできます。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="284">
          <source>If you chose the <bpt id="p1">**</bpt>Remote Desktop<ept id="p1">**</ept> option, users will be offered the ability to login to a full remote desktop.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>リモート デスクトップ<ept id="p1">**</ept> オプションを選択すると、ユーザーは完全なリモート デスクトップにログインできます。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="285">
          <source>If you chose <bpt id="p1">**</bpt>RemoteApp Programs<ept id="p1">**</ept>, users will be able to log in directly to AX 2012 R3.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>RemoteApp プログラム<ept id="p1">**</ept> を選択すると、ユーザーが AX 2012 R3 に直接ログインできます。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="286">
          <source><bpt id="p1">**</bpt>RDS Farm Access<ept id="p1">**</ept>: This allows users to gain access to the AX 2012 R3 environment over a VPN connected network.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>RDS ファーム アクセス<ept id="p1">**</ept>: これにより、ユーザは VPN 接続されたネットワークで AX 2012 R3 環境にアクセスできます。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="287">
          <source>This feature is only available if you have:</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">この機能は、次の場合にのみ利用できます。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="288">
          <source>Joined this AX deployment to a VPN connected corporate domain.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">この AX の配置を VPN 接続されている会社のドメインに結合しました。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="289">
          <source>Configured the RDS Gateway to accept connections from the VPN connected network.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">VPN 接続されたネットワークからの接続を受け入れるように RDS ゲートウェイをコンフィギュレーションしました。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="290">
          <source><bpt id="p1">**</bpt>Note:<ept id="p1">**</ept> For both <bpt id="p2">**</bpt>RDS Web Access<ept id="p2">**</ept> and <bpt id="p3">**</bpt>RDS Farm Access<ept id="p3">**</ept>, when joining a deployment to an existing Active Directory domain you must add the RDS Farm to your AD/DNS with the IP address of the Internal Load Balancer.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>注記:<ept id="p1">**</ept> <bpt id="p2">**</bpt>RDS Web アクセス<ept id="p2">**</ept>および <bpt id="p3">**</bpt>RDS ファーム アクセス<ept id="p3">**</ept>の両方で、既存の Active Directory ドメインに配置を結合する際には、内部ロード バランサーの IP アドレスを使用して、AD/DNS に RDS ファームを追加する必要があります。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="291">
          <source>See the following steps:</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">次の手順を参照してください。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="292">
          <source>Get the name of your RDS Farm: This can be obtained from the RDS Farm Access link in LCS.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">RDS ファームの名前を取得します。これは、LCS の RDS ファーム アクセス リンクから入手できます。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="293">
          <source>In this case, it should be <bpt id="p1">**</bpt>RdsFarm0c0fa75<ept id="p1">**</ept>.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">この場合、<bpt id="p1">**</bpt>RdsFarm0c0fa75<ept id="p1">**</ept> とする必要があります。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="294">
          <source><bpt id="p1">[</bpt><ph id="ph1">![</ph>MachineName<ept id="p1">](./media/machinename-300x165.png)](./media/machinename.png)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt><ph id="ph1">![</ph>MachineName<ept id="p1">](./media/machinename-300x165.png)](./media/machinename.png)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="295">
          <source>Get the IP of the Internal Load Balancer from the Cloud Service dashboard in Azure Portal.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Azure ポータルでクラウド サービス ダッシュ ボードから内部ロード バランサの IP を取得します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="296">
          <source>Inspect the RDS machine that has an internal IP next to port <bpt id="p1">**</bpt>3389<ept id="p1">**</ept>.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">ポート <bpt id="p1">**</bpt>3389<ept id="p1">**</ept> の横に内部 IP がある RDS マシンを検査します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="297">
          <source>In the below example, the Internal Load Balancer IP is 10.1.3.4.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">以下の例では、内部ロード バランサーの IP は 10.1.3.4 です。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="298">
          <source><bpt id="p1">[</bpt><ph id="ph1">![</ph>IP address<ept id="p1">](./media/ip-address-144x300.png)](./media/ip-address.png)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt><ph id="ph1">![</ph>IP アドレス<ept id="p1">](./media/ip-address-144x300.png)](./media/ip-address.png)</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="299">
          <source>Add the RDS Farm as a Computer in your AD, using the information obtained above.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">上記で取得した情報を使用して、AD のコンピューターとして RDS フォームを追加します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="300">
          <source><bpt id="p1">[</bpt><ph id="ph1">![</ph>AddToAD<ept id="p1">](./media/addtoad-300x113.png)](./media/addtoad.png)</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">[</bpt><ph id="ph1">![</ph>AddToAD<ept id="p1">](./media/addtoad-300x113.png)](./media/addtoad.png)</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">これらの手順を実行しないと、RD Web アクセスを実行する際に次のエラーが発生します。<bpt id="p1">*</bpt>リモート デスクトップには、コンピューター「RdsFarm0c0fa75.contoso.com」が見つかりません。これは、「RdsFarm0c0fa75.contoso.com」が指定されたネットワークに属していないことを意味する可能性があります。接続しようとしているコンピュータ名およびドメインを確認してください。<ept id="p1">*</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="315">
          <source>If you are deploying to an AD that was previously deployed through Lifecycle Services, select the <bpt id="p1">&lt;strong&gt;</bpt><bpt id="p2">&lt;em&gt;</bpt>APPNET<ept id="p2">&lt;/em&gt;</ept><ept id="p1">&lt;/strong&gt;</ept> value.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Lifecycle Services によって以前に展開した広告に配置する場合は、選択した <bpt id="p1">&lt;strong&gt;</bpt><bpt id="p2">&lt;em&gt;</bpt>APPNET<ept id="p2">&lt;/em&gt;</ept><ept id="p1">&lt;/strong&gt;</ept> 値を選択します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="316">
          <source>The Active Directory subnet must be entered and match the Active Directory subnet IP/Range found in the Azure management portal for the AD you desire to target.</source>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="317">
          <source>Log on to the <bpt id="p1">&lt;a href="https://manage.windowsazure.com/"&gt;</bpt><bpt id="p2">&lt;span style="color: #0066cc"&gt;</bpt>Azure management portal<ept id="p2">&lt;/span&gt;</ept><ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://manage.windowsazure.com/"&gt;</bpt><bpt id="p2">&lt;span style="color: #0066cc"&gt;</bpt>Azure 管理ポータル<ept id="p2">&lt;/span&gt;</ept><ept id="p1">&lt;/a&gt;</ept>へのログオン</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="331">
          <source>Click <bpt id="p1">**</bpt>Deploy to confirm<ept id="p1">**</ept> that you’re ready to deploy the environment.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">環境を展開する準備が整った<bpt id="p1">**</bpt>確認するための展開<ept id="p1">**</ept>をクリックします。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="346">
          <source>Initialize AX 2012 R3</source>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="355">
          <source>Go to the following location on the virtual machine: F:TestTransferTool</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">仮想マシンで次の場所に移動します: F:TestTransferTool</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="356">
          <source>Install the Test Data Transfer Tool.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">テスト データ転送ツールをインストールします。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="357">
          <source>For instructions, see <bpt id="p1">[</bpt>Install the Test Data Transfer Tool (beta) for Microsoft Dynamics AX<ept id="p1">](install-test-data-transfer-tool-beta.md)</ept>.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">手順については、<bpt id="p1">[</bpt>Microsoft Dynamics AX 用のテスト データ転送ツール (ベータ版) をインストールする<ept id="p1">](install-test-data-transfer-tool-beta.md)</ept>を参照してください。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="358">
          <source>Open a command prompt and navigate to the following location: C:\Program Files (x86)\Microsoft Dynamics AX 2012 Test Data Transfer Tool (Beta)</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">コマンド プロンプトを開いて、次の場所にアクセスします: C:\Program Files (x86) \Microsoft Dynamics AX 2012 テスト データ確認転送ツール (ベータ)</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="359">
          <source>Run the following command: dp.exe import F:DemoData MicrosoftDynamicsAx</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">次のコマンドを実行します: dp.exe import F:DemoData MicrosoftDynamicsAx</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="360">
          <source>**Note: **The sample data includes trial license keys for AX 2012 R3.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">**注:** サンプル データには、AX 2012 R3 の試用版のライセンス キーが含まれています。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="361">
          <source>If you choose not to install the sample data, you can download trial license keys—for development or testing purposes—from <bpt id="p1">[</bpt>CustomerSource<ept id="p1">](https://mbs.microsoft.com/downloads/customer/AX/AXDemoTools/MicrosoftDynamicsAX2012R2v4DemoLicense.zip)</ept> or <bpt id="p2">[</bpt>MSDN<ept id="p2">](https://msdn.microsoft.com/en-us/subscriptions/securedownloads/hh442898#FileId=57028)</ept>.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">サンプル データをインストールしないように選択する場合は、開発またはテスト用の試用版ライセンス キーを <bpt id="p1">[</bpt>CustomerSource<ept id="p1">](https://mbs.microsoft.com/downloads/customer/AX/AXDemoTools/MicrosoftDynamicsAX2012R2v4DemoLicense.zip)</ept> または <bpt id="p2">[</bpt>MSDN<ept id="p2">](https://msdn.microsoft.com/en-us/subscriptions/securedownloads/hh442898#FileId=57028)</ept> からダウンロードすることができます</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="362">
          <source>Give users access</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">ユーザーのアクセス許可を付与します</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="363">
          <source>To enable your users to access AX 2012 R3, complete the following tasks:</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">ユーザが AX 2012 R3 にアクセスできるようにするには、以下のタスクを実行します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="364">
          <source>Add each user’s domain account to the Remote Desktop Users group on the CLI-<ph id="ph1">&amp;lt;</ph>GUID<ph id="ph2">&amp;gt;</ph> virtual machine.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">CLI- <ph id="ph1">&amp;lt;</ph>GUID<ph id="ph2">&amp;gt;</ph> 仮想マシンのリモート デスクトップ ユーザー グループに各ユーザーのドメイン アカウントを追加します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="365">
          <source>Give users access to AX 2012 R3.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">ユーザーに AX 2012 R3 へのアクセス許可を付与します。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="366">
          <source>For instructions, see <bpt id="p1">[</bpt>Create new users in Microsoft Dynamics AX<ept id="p1">](https://technet.microsoft.com/en-us/library/aa548139.aspx)</ept>.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">手順については、<bpt id="p1">[</bpt>Microsoft Dynamics AX で新しいユーザーを作成する<ept id="p1">](https://technet.microsoft.com/en-us/library/aa548139.aspx)</ept>を参照してください。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="367">
          <source>**Note: **If you don’t want to create a VPN connection and a domain trust, you can still give users access to AX 2012 R3.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">**注:** VPN 接続とドメイン信頼を作成しない場合でも、ユーザーに AX 2012 R3 へのアクセス権を与えることができます。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="368">
          <source>To do so, you’ll need to log on to the virtual machine that serves as the domain controller, and create domain accounts for each user.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">これを行うには、ドメイン コントローラとして機能する仮想マシンにログオンし、各ユーザーのドメイン アカウントを作成する必要があります。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="369">
          <source>Then, you’ll need to complete the two tasks mentioned above.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">その後、上記の 2 つのタスクを完了する必要があります。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="370">
          <source>Set up and configure AX 2012 R3</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">AX 2012 R3 の設定およびコンフィギュレーション</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="371">
          <source>The procedures for setting up and configuring AX 2012 R3 on Azure are the same procedures used for setting up and configuring on-premises deployments.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Azure 上で AX 2012 R3 を設定およびコンフィギュレーションする手順は、オンプレミス展開の設定およびコンフィギュレーションに使用される手順と同じです。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="372">
          <source>See the following resources for more information.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">詳細については、次のリソースを参照してください。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="374">
          <source><bpt id="p1">&lt;strong&gt;</bpt>Resources<ept id="p1">&lt;/strong&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;strong&gt;</bpt>リソース<ept id="p1">&lt;/strong&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="375">
          <source>See the instructions on TechNet</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">TechNet の手順を参照してください。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="376">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg732218.aspx"&gt;</bpt>System setup for Microsoft Dynamics AX<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg732218.aspx"&gt;</bpt>Microsoft Dynamics AX のシステム設定<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="377">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg732158.aspx"&gt;</bpt>The Microsoft Dynamics AX client<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg732158.aspx"&gt;</bpt>Microsoft Dynamics AX クライアント<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="378">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg731868.aspx"&gt;</bpt>Application Object Servers<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg731868.aspx"&gt;</bpt>Application Object Server<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="379">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/ee873263.aspx"&gt;</bpt>Reporting in Microsoft Dynamics AX<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/ee873263.aspx"&gt;</bpt>Microsoft Dynamics AX でのレポート<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="381">
          <source>Be sure to <bpt id="p1">&lt;a href="https://technet.microsoft.com/EN-US/library/dd309703.aspx"&gt;</bpt>deploy the default reports<ept id="p1">&lt;/a&gt;</ept> and <bpt id="p2">&lt;a href="https://technet.microsoft.com/EN-US/library/aa496432.aspx"&gt;</bpt>grant users access<ept id="p2">&lt;/a&gt;</ept> to them.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/EN-US/library/dd309703.aspx"&gt;</bpt>既定のレポートを展開<ept id="p1">&lt;/a&gt;</ept>し、ユーザーに<bpt id="p2">&lt;a href="https://technet.microsoft.com/EN-US/library/aa496432.aspx"&gt;</bpt>アクセス権を付与<ept id="p2">&lt;/a&gt;</ept>してください。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="382">
          <source><bpt id="p1">&lt;a href="https://www.microsoft.com/en-us/download/details.aspx?id=5916"&gt;</bpt>Management Reporter 2012<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://www.microsoft.com/en-us/download/details.aspx?id=5916"&gt;</bpt>Management Reporter 2012<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="383">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/ee873272.aspx"&gt;</bpt>Analytics in Microsoft Dynamics AX<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/ee873272.aspx"&gt;</bpt> Microsoft Dynamics AX での分析<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="384">
          <source><bpt id="p1">&lt;strong&gt;</bpt>Note<ept id="p1">&lt;/strong&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;strong&gt;</bpt>メモ<ept id="p1">&lt;/strong&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="385">
          <source>To process the cubes that are included with AX 2012 R3, we recommend that you increase the ExternalCommandTimeout value to 7200.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">AX 2012 R3 に含まれているキューブを処理するには、ExternalCommandTimeout 値を 7200 に増やすことをお勧めします。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="386">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg866975.aspx"&gt;</bpt>Help server<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg866975.aspx"&gt;</bpt>ヘルプ サーバー<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="387">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg751374.aspx"&gt;</bpt>Enterprise Portal and Role Centers<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg751374.aspx"&gt;</bpt>エンタープライズ ポータルおよびロール センター<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="388">
          <source><bpt id="p1">&lt;strong&gt;</bpt>Note<ept id="p1">&lt;/strong&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;strong&gt;</bpt>メモ<ept id="p1">&lt;/strong&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="389">
          <source>Enterprise Portal is configured to run on port 81, so be sure to exclude that port in your firewall settings.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">エンタープライズ ポータルはポート 81 で実行するように設定されているため、ファイアウォール設定でそのポートを除外してください。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="390">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg731850.aspx"&gt;</bpt>Enterprise Search<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg731850.aspx"&gt;</bpt>エンタープライズ検索<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="391">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg731810.aspx"&gt;</bpt>Services and Application Integration Framework (AIF)<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg731810.aspx"&gt;</bpt>サービス &amp; アプリケーション統合フレームワーク (AIF)<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="392">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/jj710398.aspx"&gt;</bpt>Microsoft Dynamics AX Retail for IT pros and developers<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/jj710398.aspx"&gt;</bpt>Microsoft Dynamics AX Retail IT プロおよび開発者向け<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="393">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/aa834453.aspx"&gt;</bpt>.NET Business Connector<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/aa834453.aspx"&gt;</bpt>.NET Business Connector<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="394">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg731779.aspx"&gt;</bpt>Security<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg731779.aspx"&gt;</bpt>セキュリティ<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="395">
          <source>View printable guides and white papers</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">印刷可能なガイドおよびホワイト ペーパーの表示</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="396">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg732268.aspx"&gt;</bpt>Printable guides<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg732268.aspx"&gt;</bpt>印刷可能なガイド<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="397">
          <source><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg188985.aspx"&gt;</bpt>White papers for system administrators<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="https://technet.microsoft.com/en-us/library/gg188985.aspx"&gt;</bpt>システム管理者向けのホワイト ペーパー<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="398">
          <source>Use the Microsoft Dynamics AX web search tool</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Microsoft Dynamics AX ウェブ検索ツールの使用</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="399">
          <source><bpt id="p1">&lt;a href="http://go.microsoft.com/fwlink/?LinkID=212924"&gt;</bpt>Web search for developers<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="http://go.microsoft.com/fwlink/?LinkID=212924"&gt;</bpt>開発者用の Web 検索<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="400">
          <source><bpt id="p1">&lt;a href="http://go.microsoft.com/fwlink/?LinkID=212925"&gt;</bpt>Web search for system administrators<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="http://go.microsoft.com/fwlink/?LinkID=212925"&gt;</bpt>システム管理者用の Web 検索<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="401">
          <source><bpt id="p1">&lt;a href="http://go.microsoft.com/fwlink/?LinkID=212922"&gt;</bpt>Web search for application users<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="http://go.microsoft.com/fwlink/?LinkID=212922"&gt;</bpt>アプリケーション ユーザー用の Web 検索<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="402">
          <source><bpt id="p1">&lt;a href="http://go.microsoft.com/fwlink/?LinkID=194311"&gt;</bpt>Combined web search<ept id="p1">&lt;/a&gt;</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">&lt;a href="http://go.microsoft.com/fwlink/?LinkID=194311"&gt;</bpt>結合された Web 検索<ept id="p1">&lt;/a&gt;</ept></target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="403">
          <source>7. Learn more about the service accounts for this environment</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">7. この環境のサービス アカウントに関する詳細</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="406">
          <source>The following table lists the default names of the domain accounts that were created when you deployed the environment.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">次のテーブルに、環境を配置したときに作成されたドメイン アカウントの既定の名前を示します。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="409">
          <source><ph id="ph1">&lt;DomainName&gt;</ph>AOSServiceUser</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><ph id="ph1">&lt;DomainName&gt;</ph>AOSServiceUser</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="410">
          <source>The account used to run the following services on AOS-<ph id="ph1">&lt;GUID&gt;</ph> virtual machines: Microsoft Dynamics AX Object Server.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">次のサービスを AOS-<ph id="ph1">&lt;GUID&gt;</ph> 仮想マシンで実行するために使用されたアカウント: Microsoft Dynamics AX Object Server。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="412">
          <source>The account used to run the following services on SQL-<ph id="ph1">&lt;GUID&gt;</ph> virtual machines: SQL Server Analysis Services (MSSQLSERVER)</source>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="414">
          <source>The account used to install AX 2012 R3.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">AX 2012 R3 をインストールするために使用したアカウント。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="415">
          <source><ph id="ph1">&lt;DomainName&gt;</ph>SPServiceUser</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><ph id="ph1">&lt;DomainName&gt;</ph>SPServiceUser</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="416">
          <source>The account used to run the following services on EP-<ph id="ph1">&lt;GUID&gt;</ph> virtual machines: AppFabric, SharePoint Search Host Controller, SharePoint Server Search 15, SharePoint Timer Service, and SharePoint User Code Host</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">次のサービスを EP-<ph id="ph1">&lt;GUID&gt;</ph> 仮想マシンで実行するために使用したアカウント - : AppFabric、SharePoint Search Host Controller、SharePoint Server Search 15、SharePoint Timer Service、および SharePoint User Code Host。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="417">
          <source><ph id="ph1">&lt;DomainName&gt;</ph>BCProxyUser</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><ph id="ph1">&lt;DomainName&gt;</ph>BCProxyUser</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="418">
          <source>The account used as the Business Connector proxy.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">ビジネス コネクタ プロキシとして使用されるアカウント。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="419">
          <source><ph id="ph1">&lt;DomainName&gt;</ph>AXServiceUser</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><ph id="ph1">&lt;DomainName&gt;</ph>AXServiceUser</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="420">
          <source>The account used to run the following services on AOS-<ph id="ph1">&lt;GUID&gt;</ph> virtual machines: Microsoft Dynamics AX Data Import/Export Framework Services and Microsoft Dynamics ERP RapidStart Connector.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">AOS<ph id="ph1">&lt;GUID&gt;</ph> 仮想マシンで次のサービスを実行するためにアカウントが使用されます: Microsoft Dynamics AX Data Import/Export Framework Service および Microsoft Dynamics ERP RapidStart Connector。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="421">
          <source>The account is also used to run the following services on CLI-<ph id="ph1">&lt;GUID&gt;</ph> virtual machines: Microsoft Dynamics AX for Retail Commerce Data Exchange Async Client.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">アカウントは、次のサービスを CLI-<ph id="ph1">&lt;GUID&gt;</ph> 仮想マシンで実行するためにも使用されます: Microsoft Dynamics AX for Retail Commerce Data Exchange Async Client。</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="422">
          <source><bpt id="p1">**</bpt>Note:<ept id="p1">**</ept> The passwords are displayed on the Cloud-hosted environments page in <bpt id="p2">[</bpt>Lifecycle Services<ept id="p2">](https://lifecycleservices.dynamics.com/en/)</ept>.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>注記:<ept id="p1">**</ept> パスワードは、<bpt id="p2">[</bpt>Lifecycle Services<ept id="p2">](https://lifecycleservices.dynamics.com/en/)</ept> のクラウド ホスト 環境ページに表示されます。</target></trans-unit>
        ...
        <trans-unit xml:space="preserve" translate="yes" id="426">
          <source>The passwords for the local administrator accounts are displayed on the Cloud-hosted environments page in <bpt id="p1">[</bpt>Lifecycle Services<ept id="p1">](https://lifecycleservices.dynamics.com/en/)</ept>.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">ローカル管理者アカウントのパスワードは、<bpt id="p1">[</bpt>Lifecycle Services<ept id="p1">](https://lifecycleservices.dynamics.com/en/)</ept> の クラウド ホスト 環境ページに表示されます。</target></trans-unit>
      </group>
    </body>
  </file>
</xliff>