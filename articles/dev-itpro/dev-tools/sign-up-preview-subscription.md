...
ms.openlocfilehash: 597946cbe772bcdcc81a295524735d2be28c46c7
...
6. プロジェクト情報を入力し、**作成**を選択します。
    ...
    Retail を評価する予定がある場合は、**製品名**フィールドで **Microsoft Dynamics 365 for Retail** を必ず選択します。
