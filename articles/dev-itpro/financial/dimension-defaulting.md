...
![財務分析コード リスト](./media/FinancialDimensionList.png "財務分析コード リスト")
...
![既定の勘定コードを既定の勘定と結合に使用されるコード](./media/DefaultDimension5-4CodeToMerge.png "既定の勘定コードを既定の勘定と結合に使用されるコード")
