...
[![新しい項目](./media/fd-basic.png)]

開いているフォームで、データ モデルの**データ エンティティ**要素のタイプを選択します。

[![データ要素](./media/fd-element.png)]
...
[![すべての選択を解除](./media/fd-wizard2.png)]
...
[![VendInvoiceTrans と置き換え](./media/fd-menu2.png)]
...
[![VendorInvoiceTransactionDetailsEntity の追加](./media/fd-menu3.png)]
