...
2.  [**レポート パーツ グループ**] ダイアログ ボックスで、[**新規**] をクリックします。
...
2.  [**会社**] ダイアログ ボックスで、レポート パーツ グループを割り当てる会社を選択します。
3.  [**変更**] をクリックします。
...
1.  Report Designer の [**会社**] メニューで、[**レポート パーツ グループ**] をクリックします。
...
レポート パーツ グループまたはレポート パーツ グループの特定のレポート パーツをエクスポートできます。 バックアップとしてエクスポートされたレポート パーツ グループを使用できます。 構成要素グループまたは Finance および Operations のインストールの間でエクスポートしたデータをコピーすることもできます。 レポート デザイナーには、参照されているフォント スタイルおよび構成要素グループとともに分析コード セットが含まれています。
1.  レポート デザイナーの [**会社**] メニューで、[**構成要素グループ** をクリックします。
