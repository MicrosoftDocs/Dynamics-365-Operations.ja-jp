...
レポートのスケジュールは作成され、保存される際に、[レポートのスケジュール] の下のナビゲーション ウィンドウに表示されます。 レポートを整理するフォルダーを作成できます。 スケジュールの 1 つのレポートが実行されない場合、他のレポートは、すべて継続して実行されます。
...
8.  [更新] をクリックして、対処する例外を更新します。 はい] をクリックして、結果すべての完全な更新を実行するか、または[いいえ] をクリックして、指定された品目の部分的な更新を実行します。
    | ![Note](https://i-technet.sec.s-msft.com/areas/global/content/clear.gif "メモ")**メモ**                    |
    |------------------------------------------------------------------------------------------------------------|
