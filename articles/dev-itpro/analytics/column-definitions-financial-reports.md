...
| UPT                     | これらのトランザクションが使用できる場合は、未転記のトランザクションのみが含まれるように、列の金額を制限します。<blockquote>[!NOTE] すべてのデータ プロバイダーが未転記トランザクションをサポートしているわけではありません。 詳細については、<a href='http://go.microsoft.com/fwlink/?LinkID=162565'>データ統合ガイド</a> Microsoft Dynamics ERP システムを参照してください。</blockquote> |
