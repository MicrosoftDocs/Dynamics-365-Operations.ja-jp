...
## <a name="key-concepts"></a><span data-ttu-id="b67d2-108">重要な概念</span><span class="sxs-lookup"><span data-stu-id="b67d2-108">Key concepts</span></span>
...
6.  <span data-ttu-id="b67d2-125">**要素の上書き** チェック ボックスをオンにし、**現在のソリューション** オプションをオンにします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-125">Select the **Overwrite Elements** check box and the **Current solution** option.</span></span> <span data-ttu-id="b67d2-126">次の図は、完了した **インポート プロジェクト** ダイアログ ボックスを示しています。</span><span class="sxs-lookup"><span data-stu-id="b67d2-126">The following illustration shows the completed **Import Project** dialog box.</span></span> 
    ...
    <span data-ttu-id="b67d2-127">[![プロジェクトのインポート](./media/importproject1.png)](./media/importproject1.png)</span><span class="sxs-lookup"><span data-stu-id="b67d2-127">[![Import project](./media/importproject1.png)](./media/importproject1.png)</span></span>
...
1.  <span data-ttu-id="b67d2-144">ソリューション エクスプローラーで、**FmtClerkWorkspace** フォームをダブルクリックしてデザイナーで開きます。</span><span class="sxs-lookup"><span data-stu-id="b67d2-144">In Solution Explorer, double-click the **FmtClerkWorkspace** form to open it in the designer.</span></span>
...
1.  <span data-ttu-id="b67d2-160">ソリューション エクスプローラーで、**FmtClerkWorkspace** フォームを右クリックしてから、**スタートアップ オブジェクトとして設定**をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-160">In Solution Explorer, right-click the **FmtClerkWorkspace** form, and then click **Set as Startup Object**.</span></span>
...
6.  <span data-ttu-id="b67d2-177">**プロパティ** ウィンドウで、次のプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-177">In the **Properties** window, set the following properties.</span></span>
    ...
    | <span data-ttu-id="b67d2-178">プロパティ</span><span class="sxs-lookup"><span data-stu-id="b67d2-178">Property</span></span>        | <span data-ttu-id="b67d2-179">先頭値</span><span class="sxs-lookup"><span data-stu-id="b67d2-179">Value</span></span>     |
    |-----------------|-----------|
...
### <a name="add-a-tile-button-to-the-workspace-form"></a><span data-ttu-id="b67d2-239">ワークスペースのフォームへのタイル ボタンの追加</span><span class="sxs-lookup"><span data-stu-id="b67d2-239">Add a tile button to the workspace form</span></span>
...
4. <span data-ttu-id="b67d2-294">**AvailableVehiclesContainer** を右クリックし、**新規** をポイントして、**パーツから** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-294">Right-click **AvailableVehiclesContainer**, point to **New**, and then click **Form Part**.</span></span> <span data-ttu-id="b67d2-295">**注記:** **フォーム パート**はオペレーション ワークスペース パターンにより、ここで唯一許可されるコントロール タイプです。</span><span class="sxs-lookup"><span data-stu-id="b67d2-295">**Note:** \*\*Form Part \*\*is the only control type that the Operational Workspace pattern allows here.</span></span> <span data-ttu-id="b67d2-296">このコントロールは、このセクションのコンテンツを保持するためにビルドするフォームにリンクするために使用されます。</span><span class="sxs-lookup"><span data-stu-id="b67d2-296">This control will be used to link to the form that you will build to hold the content for this section.</span></span> 
   ...
   <span data-ttu-id="b67d2-297">[![セクションを追加](./media/addsection1.png)](./media/addsection1.png)</span><span class="sxs-lookup"><span data-stu-id="b67d2-297">[![Add section](./media/addsection1.png)](./media/addsection1.png)</span></span>
...
6.  <span data-ttu-id="b67d2-317">フォームの 2 番目のデータ ソースとして **FmtVehicleModel** テーブルを追加します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-317">Add the **FmtVehicleModel** table as a second data source for the form.</span></span>
    ...
    2.  <span data-ttu-id="b67d2-319">新しいデータ ソース ノードをクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-319">Click the new data source node.</span></span> <span data-ttu-id="b67d2-320">**プロパティ** ウィンドウで、次のプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-320">In the **Properties** window, set the following properties.</span></span>
        ...
        | <span data-ttu-id="b67d2-321">プロパティ</span><span class="sxs-lookup"><span data-stu-id="b67d2-321">Property</span></span>    | <span data-ttu-id="b67d2-322">先頭値</span><span class="sxs-lookup"><span data-stu-id="b67d2-322">Value</span></span>                                                                                                                                                           |
        |-------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
6.  <span data-ttu-id="b67d2-400">**プロパティ** ウィンドウで、次のプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-400">In the **Properties** window, set the following properties.</span></span>
    ...
    | <span data-ttu-id="b67d2-401">プロパティ</span><span class="sxs-lookup"><span data-stu-id="b67d2-401">Property</span></span>        | <span data-ttu-id="b67d2-402">先頭値</span><span class="sxs-lookup"><span data-stu-id="b67d2-402">Value</span></span>       |
    |-----------------|-------------|
...
### <a name="link-the-new-list-to-the-workspace"></a><span data-ttu-id="b67d2-430">新しいリストのワークスペースへのリンク</span><span class="sxs-lookup"><span data-stu-id="b67d2-430">Link the new list to the workspace</span></span>
...
### <a name="add-a-query-that-maps-fields-to-the-data-cache"></a><span data-ttu-id="b67d2-447">フィールドをデータ キャッシュにマップするクエリの追加</span><span class="sxs-lookup"><span data-stu-id="b67d2-447">Add a query that maps fields to the data cache</span></span>
...
4.  <span data-ttu-id="b67d2-454">新しい **FMTPickupAndReturnQuery** クエリがデザイナーで開かれていない場合、ソリューション エクスプローラーでダブルクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-454">If the new **FMTPickupAndReturnQuery** query isn’t already open in the designer, double-click it in Solution Explorer.</span></span>
5.  <span data-ttu-id="b67d2-455">デザイナーで、**データ ソース**を右クリックしてから**新しいデータ ソース**をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-455">In the designer, right-click **Data Sources**, and then click **New Data Source**.</span></span>
6.  <span data-ttu-id="b67d2-456">**プロパティ** ウィンドウで、次のプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-456">In the **Properties** window, set the following properties.</span></span>

    | <span data-ttu-id="b67d2-457">プロパティ</span><span class="sxs-lookup"><span data-stu-id="b67d2-457">Property</span></span>        | <span data-ttu-id="b67d2-458">先頭値</span><span class="sxs-lookup"><span data-stu-id="b67d2-458">Value</span></span>     |
    |-----------------|-----------|
    | <span data-ttu-id="b67d2-459">テーブル</span><span class="sxs-lookup"><span data-stu-id="b67d2-459">Table</span></span>           | <span data-ttu-id="b67d2-460">FMTRental</span><span class="sxs-lookup"><span data-stu-id="b67d2-460">FMTRental</span></span> |
    | <span data-ttu-id="b67d2-461">Dynamics フィールド</span><span class="sxs-lookup"><span data-stu-id="b67d2-461">Dynamics Fields</span></span> | <span data-ttu-id="b67d2-462">無</span><span class="sxs-lookup"><span data-stu-id="b67d2-462">No</span></span>        |

7.  <span data-ttu-id="b67d2-463">FMTRental データ ソースに、次の 5 つのフィールドを追加します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-463">Add the following five fields to the FMTRental data source.</span></span> <span data-ttu-id="b67d2-464">各フィールドについては、**フィールド**を右クリックし、**新規**を指し、次に**フィールド**をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-464">For each field, right-click **Fields**, point to **New**, and then click **Field**.</span></span> <span data-ttu-id="b67d2-465">**プロパティ** ウィンドウで、必要に応じて**フィールド** プロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-465">In the **Properties** window, set the **Field** property as appropriate.</span></span>
    -   <span data-ttu-id="b67d2-466">StartDate</span><span class="sxs-lookup"><span data-stu-id="b67d2-466">StartDate</span></span>
    -   <span data-ttu-id="b67d2-467">EndDate</span><span class="sxs-lookup"><span data-stu-id="b67d2-467">EndDate</span></span>
    -   <span data-ttu-id="b67d2-468">車両</span><span class="sxs-lookup"><span data-stu-id="b67d2-468">Vehicle</span></span>
    -   <span data-ttu-id="b67d2-469">行政単位 (区画)</span><span class="sxs-lookup"><span data-stu-id="b67d2-469">State</span></span>
    -   <span data-ttu-id="b67d2-470">RentalId</span><span class="sxs-lookup"><span data-stu-id="b67d2-470">RentalId</span></span>

8.  <span data-ttu-id="b67d2-471">**範囲** を右クリックし、**新しい範囲** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-471">Right-click **Ranges**, and then click **New Range**.</span></span>
9.  <span data-ttu-id="b67d2-472">**プロパティ** ウィンドウで、次のプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-472">In the **Properties** window, set the following properties.</span></span>

    | <span data-ttu-id="b67d2-473">プロパティ</span><span class="sxs-lookup"><span data-stu-id="b67d2-473">Property</span></span> | <span data-ttu-id="b67d2-474">先頭値</span><span class="sxs-lookup"><span data-stu-id="b67d2-474">Value</span></span>                                                                                  |
    |----------|----------------------------------------------------------------------------------------|
    | <span data-ttu-id="b67d2-475">フィールド</span><span class="sxs-lookup"><span data-stu-id="b67d2-475">Field</span></span>    | <span data-ttu-id="b67d2-476">行政単位 (区画)</span><span class="sxs-lookup"><span data-stu-id="b67d2-476">State</span></span>                                                                                  |
    | <span data-ttu-id="b67d2-477">先頭値</span><span class="sxs-lookup"><span data-stu-id="b67d2-477">Value</span></span>    | <span data-ttu-id="b67d2-478">1..2 **注記:** この値は受取準備完了または処理中のレンタルをキャッシュします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-478">1..2 **Note:** This value will cache rentals that are Ready for Pickup or In Progress.</span></span> |

10. <span data-ttu-id="b67d2-479">**FMTRental** で **データ ソース** を右クリックし、**新しいデータ ソース** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-479">Under **FMTRental**, right-click **Data Sources**, and then click **New Data Source**.</span></span>
11. <span data-ttu-id="b67d2-480">**プロパティ** ウィンドウで、次のプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-480">In the **Properties** window, set the following properties.</span></span>

    | <span data-ttu-id="b67d2-481">プロパティ</span><span class="sxs-lookup"><span data-stu-id="b67d2-481">Property</span></span>        | <span data-ttu-id="b67d2-482">先頭値</span><span class="sxs-lookup"><span data-stu-id="b67d2-482">Value</span></span>       |
    |-----------------|-------------|
    | <span data-ttu-id="b67d2-483">テーブル</span><span class="sxs-lookup"><span data-stu-id="b67d2-483">Table</span></span>           | <span data-ttu-id="b67d2-484">FMTCustomer</span><span class="sxs-lookup"><span data-stu-id="b67d2-484">FMTCustomer</span></span> |
    | <span data-ttu-id="b67d2-485">Dynamics フィールド</span><span class="sxs-lookup"><span data-stu-id="b67d2-485">Dynamics Fields</span></span> | <span data-ttu-id="b67d2-486">無</span><span class="sxs-lookup"><span data-stu-id="b67d2-486">No</span></span>          |

12. <span data-ttu-id="b67d2-487">FMTCustomer データ ソースに、次の 3 つのフィールドを追加します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-487">Add the following three fields to the FMTCustomer data source.</span></span> <span data-ttu-id="b67d2-488">各フィールドについては、**フィールド**を右クリックし、**新規**を指し、次に**フィールド**をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-488">For each field, right-click **Fields**, point to **New**, and then click **Field**.</span></span> <span data-ttu-id="b67d2-489">**プロパティ** ウィンドウで、必要に応じて**フィールド** プロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-489">In the **Properties** window, set the **Field** property as appropriate.</span></span>
    -   <span data-ttu-id="b67d2-490">名</span><span class="sxs-lookup"><span data-stu-id="b67d2-490">FirstName</span></span>
    -   <span data-ttu-id="b67d2-491">姓</span><span class="sxs-lookup"><span data-stu-id="b67d2-491">LastName</span></span>
    -   <span data-ttu-id="b67d2-492">画像</span><span class="sxs-lookup"><span data-stu-id="b67d2-492">Image</span></span>

13. <span data-ttu-id="b67d2-493">**関係** を右クリックし、 **新しい関係** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-493">Right-click **Relations**, and then click **New Relation**.</span></span>
14. <span data-ttu-id="b67d2-494">**プロパティ** ウィンドウで、次のプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-494">In the **Properties** window, set the following properties.</span></span>

    | <span data-ttu-id="b67d2-495">プロパティ</span><span class="sxs-lookup"><span data-stu-id="b67d2-495">Property</span></span>         | <span data-ttu-id="b67d2-496">先頭値</span><span class="sxs-lookup"><span data-stu-id="b67d2-496">Value</span></span>     |
    |------------------|-----------|
    | <span data-ttu-id="b67d2-497">データ ソースの結合</span><span class="sxs-lookup"><span data-stu-id="b67d2-497">Join Data Source</span></span> | <span data-ttu-id="b67d2-498">FMTRental</span><span class="sxs-lookup"><span data-stu-id="b67d2-498">FMTRental</span></span> |
    | <span data-ttu-id="b67d2-499">フィールド</span><span class="sxs-lookup"><span data-stu-id="b67d2-499">Field</span></span>            | <span data-ttu-id="b67d2-500">顧客</span><span class="sxs-lookup"><span data-stu-id="b67d2-500">Customer</span></span>  |
    | <span data-ttu-id="b67d2-501">関連フィールド</span><span class="sxs-lookup"><span data-stu-id="b67d2-501">Related Field</span></span>    | <span data-ttu-id="b67d2-502">RecID</span><span class="sxs-lookup"><span data-stu-id="b67d2-502">RecID</span></span>     |

    <span data-ttu-id="b67d2-503">作成したクエリは、次の図と一致する必要があります。</span><span class="sxs-lookup"><span data-stu-id="b67d2-503">The query that you've constructed should match the following illustration.</span></span> 

    ![キャッシュ クエリ](./media/cachequery.png)

15. <span data-ttu-id="b67d2-505">**Ctrl+S** キーを押して保存します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-505">Press **Ctrl+S** to save.</span></span>

### <a name="add-a-cache-table"></a><span data-ttu-id="b67d2-506">キャッシュ テーブルの追加</span><span class="sxs-lookup"><span data-stu-id="b67d2-506">Add a cache table</span></span>

<span data-ttu-id="b67d2-507">2 番目のステップでは、キャッシュ クエリから返されるフィールドを持つテーブルを定義します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-507">The second step is to define a table that has the fields that are returned from the cache query.</span></span> <span data-ttu-id="b67d2-508">キャッシュ行をベース フレームワーク キャッシュ テーブルにマップするために使用される **SysDataCacheContextId** フィールドを追加することも必要です。</span><span class="sxs-lookup"><span data-stu-id="b67d2-508">You must also add a **SysDataCacheContextId** field that will be used to map the cache row to the base framework cache tables.</span></span> <span data-ttu-id="b67d2-509">また、このテーブルと他のテーブルとの間に必要な関係を定義する必要もあり、関係するキャッシュされたフィールドを必要とするデータ メソッドも必要です。</span><span class="sxs-lookup"><span data-stu-id="b67d2-509">Additionally, you should also define any required relations between this table and other tables, and also any data methods that you require that involve the cached fields.</span></span>

1.  <span data-ttu-id="b67d2-510">ソリューション エクスプローラーの **FMTutorial** プロジェクトで、**テーブル** フォルダーを右クリックし、**追加**をポイントしてから**新しい項目**をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-510">In Solution Explorer, in the **FMTutorial** project, right-click the **Tables** folder, point to **Add**, and then click **New item**.</span></span>
2.  <span data-ttu-id="b67d2-511">**Dynamics AX アーティファクト** &gt; **データ モデル** &gt; **テーブル** の順にクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-511">Click **Dynamics AX Artifacts** &gt; **Data Model** &gt; **Table**.</span></span> <span data-ttu-id="b67d2-512">**Name** プロパティを **FMTPickupAndReturnTableCache** に置き換えます。</span><span class="sxs-lookup"><span data-stu-id="b67d2-512">Set the **Name** property to **FMTPickupAndReturnTableCache**.</span></span>
3.  <span data-ttu-id="b67d2-513">**追加** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-513">Click **Add**.</span></span>
4.  <span data-ttu-id="b67d2-514">新しい **FMTPickupAndReturnTableCache** テーブルがデザイナーで開かれていない場合、ソリューション エクスプローラーでダブルクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-514">If the new **FMTPickupAndReturnTableCache** table isn’t already open in the designer, double-click it in Solution Explorer.</span></span>
5.  <span data-ttu-id="b67d2-515">デザイナーで、**フィールド**を右クリックしてから、次のフィールドを追加します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-515">In the designer, right-click **Fields**, and then add the following fields.</span></span> <span data-ttu-id="b67d2-516">各フィールドについては、次の表は、データ型および拡張データ型 (EDT) または列挙型を表示します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-516">For each field, the following table shows the data type and the extended data type (EDT) or enum type.</span></span>

    | <span data-ttu-id="b67d2-517">フィールド タイプ</span><span class="sxs-lookup"><span data-stu-id="b67d2-517">Field type</span></span>    | <span data-ttu-id="b67d2-518">フィールド名</span><span class="sxs-lookup"><span data-stu-id="b67d2-518">Field name</span></span>            | <span data-ttu-id="b67d2-519">EDT/ 列挙型タイプ</span><span class="sxs-lookup"><span data-stu-id="b67d2-519">EDT/enum type</span></span>               |
    |---------------|-----------------------|-----------------------------|
    | <span data-ttu-id="b67d2-520">文字列</span><span class="sxs-lookup"><span data-stu-id="b67d2-520">String</span></span>        | <span data-ttu-id="b67d2-521">名</span><span class="sxs-lookup"><span data-stu-id="b67d2-521">First Name</span></span>            | <span data-ttu-id="b67d2-522">FirstName (EDT)</span><span class="sxs-lookup"><span data-stu-id="b67d2-522">FirstName (EDT)</span></span>             |
    | <span data-ttu-id="b67d2-523">文字列</span><span class="sxs-lookup"><span data-stu-id="b67d2-523">String</span></span>        | <span data-ttu-id="b67d2-524">姓</span><span class="sxs-lookup"><span data-stu-id="b67d2-524">Last Name</span></span>             | <span data-ttu-id="b67d2-525">LastName (EDT)</span><span class="sxs-lookup"><span data-stu-id="b67d2-525">LastName (EDT)</span></span>              |
    | <span data-ttu-id="b67d2-526">コンテナー</span><span class="sxs-lookup"><span data-stu-id="b67d2-526">Container</span></span>     | <span data-ttu-id="b67d2-527">画像</span><span class="sxs-lookup"><span data-stu-id="b67d2-527">Image</span></span>                 | <span data-ttu-id="b67d2-528">ビットマップ (EDT)</span><span class="sxs-lookup"><span data-stu-id="b67d2-528">Bitmap (EDT)</span></span>                |
    | <span data-ttu-id="b67d2-529">Int64</span><span class="sxs-lookup"><span data-stu-id="b67d2-529">Int64</span></span>         | <span data-ttu-id="b67d2-530">車両</span><span class="sxs-lookup"><span data-stu-id="b67d2-530">Vehicle</span></span>               | <span data-ttu-id="b67d2-531">FMTVehicleRecID (EDT)</span><span class="sxs-lookup"><span data-stu-id="b67d2-531">FMTVehicleRecID (EDT)</span></span>       |
    | <span data-ttu-id="b67d2-532">UTC 日時</span><span class="sxs-lookup"><span data-stu-id="b67d2-532">Utc Date Time</span></span> | <span data-ttu-id="b67d2-533">StartDate</span><span class="sxs-lookup"><span data-stu-id="b67d2-533">StartDate</span></span>             | <span data-ttu-id="b67d2-534">StartDateTime (EDT)</span><span class="sxs-lookup"><span data-stu-id="b67d2-534">StartDateTime (EDT)</span></span>         |
    | <span data-ttu-id="b67d2-535">UTC 日時</span><span class="sxs-lookup"><span data-stu-id="b67d2-535">Utc Date Time</span></span> | <span data-ttu-id="b67d2-536">EndDate</span><span class="sxs-lookup"><span data-stu-id="b67d2-536">EndDate</span></span>               | <span data-ttu-id="b67d2-537">EndDateTime (EDT)</span><span class="sxs-lookup"><span data-stu-id="b67d2-537">EndDateTime (EDT)</span></span>           |
    | <span data-ttu-id="b67d2-538">Int64</span><span class="sxs-lookup"><span data-stu-id="b67d2-538">Int64</span></span>         | <span data-ttu-id="b67d2-539">SysDataCacheContextId</span><span class="sxs-lookup"><span data-stu-id="b67d2-539">SysDataCacheContextId</span></span> | <span data-ttu-id="b67d2-540">SysDataCacheContextId (EDT)</span><span class="sxs-lookup"><span data-stu-id="b67d2-540">SysDataCacheContextId (EDT)</span></span> |
    | <span data-ttu-id="b67d2-541">列挙</span><span class="sxs-lookup"><span data-stu-id="b67d2-541">Enum</span></span>          | <span data-ttu-id="b67d2-542">行政単位 (区画)</span><span class="sxs-lookup"><span data-stu-id="b67d2-542">State</span></span>                 | <span data-ttu-id="b67d2-543">FMTReservationState (Enum)</span><span class="sxs-lookup"><span data-stu-id="b67d2-543">FMTReservationState (Enum)</span></span>  |
    | <span data-ttu-id="b67d2-544">文字列</span><span class="sxs-lookup"><span data-stu-id="b67d2-544">String</span></span>        | <span data-ttu-id="b67d2-545">RentalId</span><span class="sxs-lookup"><span data-stu-id="b67d2-545">RentalId</span></span>              | <span data-ttu-id="b67d2-546">FMTRentalId (EDT)</span><span class="sxs-lookup"><span data-stu-id="b67d2-546">FMTRentalId (EDT)</span></span>           |

6.  <span data-ttu-id="b67d2-547">デザイナーで、**リレーション**を右クリックし、**新規**をポイントしてから**リレーション**をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-547">In the designer, right-click **Relations**, point to **New**, and then click **Relation**.</span></span>
7.  <span data-ttu-id="b67d2-548">**プロパティ** ウィンドウで、次のプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-548">In the **Properties** window, set the following properties.</span></span>

    | <span data-ttu-id="b67d2-549">プロパティ</span><span class="sxs-lookup"><span data-stu-id="b67d2-549">Property</span></span>      | <span data-ttu-id="b67d2-550">先頭値</span><span class="sxs-lookup"><span data-stu-id="b67d2-550">Value</span></span>     |
    |---------------|-----------|
    | <span data-ttu-id="b67d2-551">氏名</span><span class="sxs-lookup"><span data-stu-id="b67d2-551">Name</span></span>          | <span data-ttu-id="b67d2-552">FMTRental</span><span class="sxs-lookup"><span data-stu-id="b67d2-552">FMTRental</span></span> |
    | <span data-ttu-id="b67d2-553">関連テーブル</span><span class="sxs-lookup"><span data-stu-id="b67d2-553">Related Table</span></span> | <span data-ttu-id="b67d2-554">FMTRental</span><span class="sxs-lookup"><span data-stu-id="b67d2-554">FMTRental</span></span> |

8.  <span data-ttu-id="b67d2-555">**FMTRental** 関係を右クリックし、**新規** をポイントして **標準** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-555">Right-click the **FMTRental** relation, point to **New**, and then click **Normal**.</span></span>
9.  <span data-ttu-id="b67d2-556">**プロパティ** ウィンドウで、次のプロパティを設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-556">In the **Properties** window, set the following properties.</span></span>

    | <span data-ttu-id="b67d2-557">プロパティ</span><span class="sxs-lookup"><span data-stu-id="b67d2-557">Property</span></span>      | <span data-ttu-id="b67d2-558">先頭値</span><span class="sxs-lookup"><span data-stu-id="b67d2-558">Value</span></span>    |
    |---------------|----------|
    | <span data-ttu-id="b67d2-559">フィールド</span><span class="sxs-lookup"><span data-stu-id="b67d2-559">Field</span></span>         | <span data-ttu-id="b67d2-560">RentalId</span><span class="sxs-lookup"><span data-stu-id="b67d2-560">RentalId</span></span> |
    | <span data-ttu-id="b67d2-561">関連フィールド</span><span class="sxs-lookup"><span data-stu-id="b67d2-561">Related Field</span></span> | <span data-ttu-id="b67d2-562">RentalId</span><span class="sxs-lookup"><span data-stu-id="b67d2-562">RentalId</span></span> |

10. <span data-ttu-id="b67d2-563">デザイナーで、**マッピング**を右クリックしてから**新規**をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-563">In the designer, right-click **Mappings**, and then click **New**.</span></span>
11. <span data-ttu-id="b67d2-564">**プロパティ** ウィンドウで、**マップ** プロパティを **SysDataSetCacheTableMap** に設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-564">In the **Properties** window, set the **Map** property to **SysDataSetCacheTableMap**.</span></span>
12. <span data-ttu-id="b67d2-565">**ID** をクリックします。 **プロパティ** ウィンドウで、**フィールドのマップ** プロパティを **RecId** に設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-565">Click **Id**. In the **Properties** window, set the **Map Field To** property to **RecId**.</span></span>
13. <span data-ttu-id="b67d2-566">**SysDataCacheContextId** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-566">Click **SysDataCacheContextId**.</span></span> <span data-ttu-id="b67d2-567">**プロパティ** ウィンドウで、**フィールドのマップ** プロパティを **SysDataCacheContextId** に設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-567">In the **Properties** window, set the **Map Field To** property to **SysDataCacheContextId**.</span></span> <span data-ttu-id="b67d2-568">**注記:** フィールドが一覧に表示されない場合は、**Ctrl+S** キーを押してテーブルを保存しなければならない場合があります。</span><span class="sxs-lookup"><span data-stu-id="b67d2-568">**Note:** If the field doesn't appear in the list, you might have to save the table first, by pressing **Ctrl+S**.</span></span>
14. <span data-ttu-id="b67d2-569">**F7** キーを押して、テーブルのコードを表示します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-569">Press **F7** to view the table’s code.</span></span> <span data-ttu-id="b67d2-570">または、**FMTReturnAndPickupTableCache** を右クリックし、その後**コードの表示**をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-570">Alternatively, right-click **FMTReturnAndPickupTableCache**, and then click **View Code**.</span></span>
15. <span data-ttu-id="b67d2-571">テーブルに、次の表示メソッドを追加します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-571">Add the following display methods to the table.</span></span> <span data-ttu-id="b67d2-572">フォームは後でこれらのメソッドを使用します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-572">The form will use these methods later.</span></span>
...
16. <span data-ttu-id="b67d2-573">**Ctrl+S** キーを押して保存します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-573">Press **Ctrl+S** to save.</span></span>

### <a name="adding-a-cache-class-that-links-the-query-and-table"></a><span data-ttu-id="b67d2-574">クエリとテーブルをリンクするキャッシュ クラスの追加</span><span class="sxs-lookup"><span data-stu-id="b67d2-574">Adding a cache class that links the query and table</span></span>

<span data-ttu-id="b67d2-575">3 番目のステップは、キャッシュ クエリとキャッシュ テーブルの間のリレーションシップを定義するクラスを作成することです。</span><span class="sxs-lookup"><span data-stu-id="b67d2-575">The third step is to create a class that defines the relationship between the cache query and the catch table.</span></span>

1.  <span data-ttu-id="b67d2-576">ソリューション エクスプローラーの **FMTutorial** プロジェクトで、**クラス** フォルダーを右クリックし、**追加**をポイントしてから**新しい項目**をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-576">In Solution Explorer, in the **FMTutorial** project, right-click the **Classes** folder, point to **Add**, and then click **New item**.</span></span>
2.  <span data-ttu-id="b67d2-577">**Dynamics AX アーティファクト** &gt; **コード** &gt; **クラス** の順にクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-577">Click **Dynamics AX Artifacts** &gt; **Code** &gt; **Class**.</span></span> <span data-ttu-id="b67d2-578">**Name** プロパティを **FMTPickupAndReturnClass** に置き換えます。</span><span class="sxs-lookup"><span data-stu-id="b67d2-578">Set the **Name** property to **FMTPickupAndReturnClass**.</span></span>
3.  <span data-ttu-id="b67d2-579">**追加** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-579">Click **Add**.</span></span>
4.  <span data-ttu-id="b67d2-580">新しい **FMTPickupAndReturnClass** クラスがデザイナーで開かれていない場合、ソリューション エクスプローラーでダブルクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-580">If the new **FMTPickupAndReturnClass** class isn’t already open in the designer, double-click it in Solution Explorer.</span></span>
5.  <span data-ttu-id="b67d2-581">クラスに次のコードを追加します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-581">Add the following code to the class.</span></span>
...
6.  <span data-ttu-id="b67d2-582">**Ctrl+S** キーを押して保存します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-582">Press **Ctrl+S** to save.</span></span>

### <a name="uptake-the-data-cache-on-a-list-in-the-workspace-and-table"></a><span data-ttu-id="b67d2-583">ワークスペースとテーブルの一覧にあるデータ キャッシュを読み込む</span><span class="sxs-lookup"><span data-stu-id="b67d2-583">Uptake the data cache on a list in the workspace and table</span></span>

<span data-ttu-id="b67d2-584">データ キャッシュを設定した後、フォーム内でキャッシュの使用を開始することができます。</span><span class="sxs-lookup"><span data-stu-id="b67d2-584">After you've set up the data cache, you can start to use the cache in your forms.</span></span> <span data-ttu-id="b67d2-585">このセクションでは、データ キャッシュを使用するようワークスペース リストのいずれかを更新します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-585">In this section, you will update one of the workspace lists so that it uses the data cache.</span></span>

1.  <span data-ttu-id="b67d2-586">ソリューション エクスプローラーで、**FMTReturningTodayPart** フォームをダブルクリックしてデザイナーで開きます。</span><span class="sxs-lookup"><span data-stu-id="b67d2-586">In Solution Explorer, double-click the **FMTReturningTodayPart** form to open it in the designer.</span></span>
2.  <span data-ttu-id="b67d2-587">**データ ソース**ノードを展開します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-587">Expand the **Data Sources** node.</span></span>
3.  <span data-ttu-id="b67d2-588">**FMTCustomer** データソースを削除します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-588">Delete the **FMTCustomer** data source.</span></span>
4.  <span data-ttu-id="b67d2-589">**FMTRental** データ ソースをクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-589">Click the **FMTRental** data source.</span></span> <span data-ttu-id="b67d2-590">**プロパティ** ウィンドウで、**テーブル** プロパティを **FMTPickupAndReturnTableCache** に設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-590">In the **Properties** window, set the **Table** property to **FMTPickupAndReturnTableCache**.</span></span>
5.  <span data-ttu-id="b67d2-591">**デザイン** &gt; **ReturningTodayGrid** とクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-591">Click **Design** &gt; **ReturningTodayGrid**.</span></span> <span data-ttu-id="b67d2-592">**プロパティ** ウィンドウで、**データ ソース** プロパティを **FMTPickupAndReturnTableCache** に設定します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-592">In the **Properties** window, set the **Data Source** property to **FMTPickupAndReturnTableCache**.</span></span>
6.  <span data-ttu-id="b67d2-593">**ReturningTodayGrid** 内で、**CustomerImage** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-593">Inside **ReturningTodayGrid**, click **CustomerImage**.</span></span> <span data-ttu-id="b67d2-594">**データ ソース**プロパティを **FMTPickupAndReturnTableCache** に、**データ メソッド**プロパティを **customerImage** に更新します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-594">Update the **Data Source** property to **FMTPickupAndReturnTableCache** and the **Data Method** property to **customerImage**.</span></span>
7.  <span data-ttu-id="b67d2-595">**ReturningTodayGrid** 内で、**FirstNameCopy1** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-595">Inside **ReturningTodayGrid**, click **FirstNameCopy1**.</span></span> <span data-ttu-id="b67d2-596">**データ ソース**プロパティを **FMTPickupAndReturnTableCache** に、**データ メソッド**プロパティを **fullName** に更新します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-596">Update the **Data Source** property to **FMTPickupAndReturnTableCache** and the **Data Method** property to **fullName**.</span></span>
8.  <span data-ttu-id="b67d2-597">**F7** キーを押して、フォームのコードを表示します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-597">Press **F7** to view code for the form.</span></span>
9.  <span data-ttu-id="b67d2-598">次のコードに示すように、データ キャッシュに対処できることができるようフォームをインストルメント化します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-598">Instrument the form so that it can react to data caching, as shown in the following code.</span></span>
...
10. <span data-ttu-id="b67d2-599">**Ctrl+S** キーを押して保存します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-599">Press **Ctrl+S** to save.</span></span>

### <a name="update-the-action-above-the-list-so-that-it-works-with-the-cache-table"></a><span data-ttu-id="b67d2-600">キャッシュ テーブルで動作するようにリストにあるアクションを更新する</span><span class="sxs-lookup"><span data-stu-id="b67d2-600">Update the action above the list so that it works with the cache table</span></span>

<span data-ttu-id="b67d2-601">ワークスペースから実行されるアクションは、ベース テーブルからのレコードが必要とするかもしれません。</span><span class="sxs-lookup"><span data-stu-id="b67d2-601">Actions that are performed from the workspace might expect records from the base tables.</span></span> <span data-ttu-id="b67d2-602">したがって、これらのアクションを更新してキャッシュ テーブルと連携させる必要があります。</span><span class="sxs-lookup"><span data-stu-id="b67d2-602">Therefore, these actions might have to be updated so that they work with the cache table.</span></span> <span data-ttu-id="b67d2-603">この例では、**FmtCompleteRecord** は **FMTRental** レコードをコンテキストとして期待しています。</span><span class="sxs-lookup"><span data-stu-id="b67d2-603">In this example, the **FmtCompleteRecord** form currently expects a **FMTRental** record as context.</span></span> <span data-ttu-id="b67d2-604">したがって、このフォームを更新して、ベース レンタル レコードまたはキャッシュ テーブル レコードのいずれかで正しく動作するようにする必要があります。</span><span class="sxs-lookup"><span data-stu-id="b67d2-604">Therefore, this form must be updated so that it works correctly with either a base rental record or a cache table record as context.</span></span>

1.  <span data-ttu-id="b67d2-605">ソリューション エクスプローラーで、**FmtCompleteRental** フォームをダブルクリックしてデザイナーで開きます。</span><span class="sxs-lookup"><span data-stu-id="b67d2-605">In Solution Explorer, double-click the **FmtCompleteRental** form to open it in the designer.</span></span>
2.  <span data-ttu-id="b67d2-606">**F7** キーを押して、フォームのコードを表示します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-606">Press **F7** to view the form’s code.</span></span>
...
3.  <span data-ttu-id="b67d2-607">**init()** メソッドを次のコードと一致するように更新します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-607">Update the **init()** method so that it matches the following code.</span></span>
...
4.  <span data-ttu-id="b67d2-608">**Ctrl+S** キーを押して保存します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-608">Press **Ctrl+S** to save.</span></span>

### <a name="update-the-returning-today-query-so-that-it-works-with-the-cache-table"></a><span data-ttu-id="b67d2-609">キャッシュ テーブルで動作するように Returning today クエリ を更新する</span><span class="sxs-lookup"><span data-stu-id="b67d2-609">Update the Returning today query so that it works with the cache table</span></span>

1.  <span data-ttu-id="b67d2-610">ソリューション エクスプローラーで、**FmtRental\_ReturningToday** クエリをダブルクリックしてデザイナーで開きます。</span><span class="sxs-lookup"><span data-stu-id="b67d2-610">In Solution Explorer, double-click the **FmtRental\_ReturningToday** query to open it in the designer.</span></span>
2.  <span data-ttu-id="b67d2-611">**データ ソース**ノードを展開し、**FMTRental** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-611">Expand the **Data Sources** node, and then click **FMTRental**.</span></span>
3.  <span data-ttu-id="b67d2-612">**プロパティ** ウィンドウで、**テーブル** プロパティを **FMTPickupAndReturnTableCache** に更新します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-612">In the **Properties** window, update the **Table** property to **FMTPickupAndReturnTableCache**.</span></span> <span data-ttu-id="b67d2-613">**注記:** **名前**プロパティは、自動的に同じ値に更新されます。</span><span class="sxs-lookup"><span data-stu-id="b67d2-613">**Note:** The **Name** property should be updated automatically to the same value.</span></span>
4.  <span data-ttu-id="b67d2-614">**Ctrl+S** キーを押して保存します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-614">Press **Ctrl+S** to save.</span></span>

### <a name="view-the-updated-form"></a><span data-ttu-id="b67d2-615">更新されたフォームの表示</span><span class="sxs-lookup"><span data-stu-id="b67d2-615">View the updated form</span></span>

<span data-ttu-id="b67d2-616">Visual Studio を使用し、更新した **FmtClerkWorkspace** フォームをビルドして実行します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-616">Use Visual Studio to build and run the updated **FmtClerkWorkspace** form.</span></span>

1.  <span data-ttu-id="b67d2-617">ソリューション エクスプローラーで、**FmtClerkWorkspace** フォームを右クリックしてから、**スタートアップ オブジェクトとして設定**をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-617">In Solution Explorer, right-click the **FmtClerkWorkspace** form, and then click **Set as Startup Object**.</span></span>
2.  <span data-ttu-id="b67d2-618">**Ctrl+F5** キーを押して、フォームをビルドおよび実行します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-618">Press **Ctrl+F5** to build and run the form.</span></span> <span data-ttu-id="b67d2-619">Internet Explorer でフォームが開きます。</span><span class="sxs-lookup"><span data-stu-id="b67d2-619">The form opens in Internet Explorer.</span></span>
3.  <span data-ttu-id="b67d2-620">**今日を返す**垂直タブをクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-620">Click the **Returning today** vertical tab.</span></span>
4.  <span data-ttu-id="b67d2-621">リストの 2 番目のレコードに対する**完全レンタル**をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-621">Click **Complete rental** for the second record in the list.</span></span>
5.  <span data-ttu-id="b67d2-622">**終了マイレージ** を **200** に設定し、**OK** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-622">Set **End Mileage** to **200**, and then click **OK**.</span></span> <span data-ttu-id="b67d2-623">返却されたレンタルがまだ一覧に表示されていることを確認します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-623">Notice that the rental that you just returned still appears in the list.</span></span>

### <a name="make-sure-that-your-workspace-is-responsive"></a><span data-ttu-id="b67d2-624">ワークスペースが応答可能であることを確認します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-624">Make sure that your workspace is responsive</span></span>

<span data-ttu-id="b67d2-625">一覧からレコードを削除する (例えばユーザーがレンタルを完了させる) アクションをユーザーが行った後は、ご自分の一覧を最新に保つようにしてください。</span><span class="sxs-lookup"><span data-stu-id="b67d2-625">You must make sure that your lists remain up to date after a user performs an action that should remove a record from the list (for example, the user completes a rental).</span></span> <span data-ttu-id="b67d2-626">このセクションでは、ワークスペースが適切に反応することを保証するために、そのアクションをインストルメント化します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-626">In this section, we will instrument that action to help guarantee that the workspace reacts appropriately.</span></span>

1.  <span data-ttu-id="b67d2-627">ソリューション エクスプローラーで、**FmtCompleteRental** フォームをダブルクリックしてデザイナーで開きます。</span><span class="sxs-lookup"><span data-stu-id="b67d2-627">In Solution Explorer, double-click the **FmtCompleteRental** form to open it in the designer.</span></span>
2.  <span data-ttu-id="b67d2-628">**F7** キーを押して、フォームのコードを表示します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-628">Press **F7** to view the code for the form.</span></span>
3.  <span data-ttu-id="b67d2-629">**OKButton** の **clicked()** コードを検索します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-629">Locate the **clicked()** code for **OKButton**.</span></span> <span data-ttu-id="b67d2-630">呼び出しフォームでのデータ ソースの調査呼び出しは、このメソッドの最後の方です。</span><span class="sxs-lookup"><span data-stu-id="b67d2-630">Near the end of this method is a research call on the calling form’s data source.</span></span> <span data-ttu-id="b67d2-631">そのコード行の直前に、次の **if** ステートメントを追加してキャッシュ テーブルから処理済のレンタルを削除します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-631">Just before that line of code, add the following **if** statement to delete the processed rental from the cache table.</span></span>
...
4.  <span data-ttu-id="b67d2-632">**Ctrl+S** キーを押して保存します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-632">Press **Ctrl+S** to save.</span></span>

### <a name="view-the-updated-form"></a><span data-ttu-id="b67d2-633">更新されたフォームの表示</span><span class="sxs-lookup"><span data-stu-id="b67d2-633">View the updated form</span></span>

<span data-ttu-id="b67d2-634">Visual Studio を使用し、更新した **FmtClerkWorkspace** フォームをビルドして実行します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-634">Use Visual Studio to build and run the updated **FmtClerkWorkspace** form.</span></span>

1.  <span data-ttu-id="b67d2-635">ソリューション エクスプローラーで、**FmtClerkWorkspace** フォームを右クリックしてから、**スタートアップ オブジェクトとして設定**をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-635">In Solution Explorer, right-click the **FmtClerkWorkspace** form, and then click **Set as Startup Object**.</span></span>
2.  <span data-ttu-id="b67d2-636">**Ctrl+F5** キーを押して、フォームをビルドおよび実行します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-636">Press **Ctrl+F5** to build and run the form.</span></span> <span data-ttu-id="b67d2-637">Internet Explorer でフォームが開きます。</span><span class="sxs-lookup"><span data-stu-id="b67d2-637">The form opens in Internet Explorer.</span></span>
3.  <span data-ttu-id="b67d2-638">**今日を返す**垂直タブをクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-638">Click the **Returning today** vertical tab.</span></span>
4.  <span data-ttu-id="b67d2-639">リストの 2 番目のレコードに対する**完全レンタル**をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-639">Click **Complete rental** for the second record in the list.</span></span>
5.  <span data-ttu-id="b67d2-640">**終了マイレージ** を **100** に設定し、**OK** をクリックします。</span><span class="sxs-lookup"><span data-stu-id="b67d2-640">Set **End Mileage** to **100**, and then click **OK**.</span></span> <span data-ttu-id="b67d2-641">返却されたレンタルが一覧に表示されなくなったことを確認します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-641">Notice that the rental that you just returned no longer appears in the list.</span></span>

## <a name="related-tutorials"></a><span data-ttu-id="b67d2-642">関連するチュートリアル</span><span class="sxs-lookup"><span data-stu-id="b67d2-642">Related tutorials</span></span>
-   <span data-ttu-id="b67d2-643">[顧客フォームの作成](build-customer-form.md) – フォーム パターンを公開する場合は、このチュートリアルを参照してください。</span><span class="sxs-lookup"><span data-stu-id="b67d2-643">[Building the Customer form](build-customer-form.md) – See this tutorial if you want more exposure to form patterns.</span></span> <span data-ttu-id="b67d2-644">このチュートリアルでは、詳細マスター パターンをフォームに適用するプロセスについて説明します。</span><span class="sxs-lookup"><span data-stu-id="b67d2-644">This tutorial will walk through the process of applying the Details Master pattern to a form.</span></span>
-   <span data-ttu-id="b67d2-645">[ナビゲーションの構築](build-navigation.md) – Dynamics AX のメニュー構造にワークスペースを追加する方法については、このチュートリアルを参照してください。</span><span class="sxs-lookup"><span data-stu-id="b67d2-645">[Building navigation](build-navigation.md) – See this tutorial if you want instructions for adding your workspace to the Dynamics AX menu structure.</span></span>
