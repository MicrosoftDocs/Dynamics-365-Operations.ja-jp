...
Dynamics 365 for Operationsでは、情報コード]のグループを作成してRetailします。 情報コード グループは、少ない情報コードを定義してより多目的な方法で情報コードを使用できるようにすることによって、柔軟性を増加させます。 情報コード グループは次の方法で使用できます。
