...
-   [**金額**] クイック タブ:
    ...
    -   割引アプリケーションおよび計算。
-   [**情報コード**] クイック タブ:
    -   POS で情報コードを管理する方法のすべての側面。 詳細については、「[Info codes](info-codes-retail.md)」を参照してください。
-   [**レシート番号**] クイック タブ:
...
カスタム フィールドを作成して POS に標準で組み込まれていないフィールドを追加できます。 カスタム フィールドを使用する方法の詳細については、「[Working with custom fields blog post](https://blogs.msdn.microsoft.com/axsupport/2012/08/06/ax-for-retail-2012-working-with-custom-fields/)」を参照してください。
