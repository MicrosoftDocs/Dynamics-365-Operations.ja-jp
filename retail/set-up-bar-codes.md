---
title: "バーコードの設定"
description: "この記事では、Microsoft Dynamics 365 for Operations - Retail でのバーコードの使用方法について説明します。"
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
