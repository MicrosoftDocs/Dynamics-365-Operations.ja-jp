---
title: "顧客のロイヤルティ プログラムを設定します。"
description: "この記事では、ロイヤルティ プログラムの設定方法について説明します。 ロイヤルティ プログラムを使用すると、小売店舗で製品を購買する顧客に対して報酬を与え、顧客のロイヤルティを高めることができます。 、Microsoft Dynamics 365では、小売チャンネルの法人に適用する簡単または複雑なロイヤルティ プログラムを設定できます。"
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="set-up-a-customer-loyalty-program"></a>顧客のロイヤルティ プログラムを設定します。

この記事では、ロイヤルティ プログラムの設定方法について説明します。 ロイヤルティ プログラムを使用すると、小売店舗で製品を購買する顧客に対して報酬を与え、顧客のロイヤルティを高めることができます。 、Microsoft Dynamics 365では、小売チャンネルの法人に適用する簡単または複雑なロイヤルティ プログラムを設定できます。
...
-   顧客に参加できる一つ以上のロイヤルティ プログラムにロイヤルティ プログラムに参加、およびリンク ロイヤルティ カードの発行、すべての小売チャンネルのロイヤルティ カード。 顧客が複数のカードのロイヤルティ ポイントを分かち合い、償還できるように、ロイヤルティ カードに顧客レコードにリンクできます。
...
工程は、Dynamics 365 for Operationsのロイヤリティー機能を有効にするために複数のコンポーネントを設定する必要があります。 次の図は、ロイヤルティ コンポーネントと、これらが相互にどのように関連しているかを説明しています。 ![ロイヤルティ設定プロセス フロー](./media/loyaltyprocess.gif)
...
| プロセス名                         | 説明                                                                                                                                                                                                                                                                                                                                                                                                    | ページ名                            |
|--------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|
| 1050 (ロイヤルティ情報)           | Dynamics 365 for Operationsの小売店舗によってデータを送信する場合は、このプロセスを実行します。 ロイヤルティーのデータがすべての店舗に送信されるように、このプロセスを頻繁に実行するようにスケジューリングすることをお勧めします。                                                                                                                                                                                               | 配送スケジュール                |
...
| オフライン ロイヤルティ トランザクションのプロセス | オフラインで処理されたトランザクションを含めるためにロイヤルティー カードを更新するには、このプロセスを実行します。 このプロセスは**オフラインで発生させる**チェック ボックスが報酬がオフラインで取得できるように**パラメータを共有します (**ページで選択されている場合にのみ適用されます。                                                                                                                                               | オフライン ロイヤルティ トランザクションのプロセス |
