...
## <a name="features-that-have-been-deprecated-for-all-deployment-types-of-the-july-2017-update-with-platform-update-8"></a>2017 年 7 月のプラットフォーム アップデート 8 によるアップデートのすべてのデプロイメント タイプに対して推奨されなくなった機能
このリストには、クラウドとオンプレミスの両方のデプロイメントで推奨されなくなった機能が含まれています。
...
|----------------------------------|-------------------------------------------------|
| **廃止の理由**       | 機能の重複。                        |
| **別の機能で置き換えられているか?** | はい。 この機能は Finance and Operations - Warehousing で置き換えられました。 設定および前提条件の詳細については、「[Microsoft Dynamics 365 for Finance and Operations - Warehousing のインストールと構成](/dynamics365/unified-operations/supply-chain/warehousing/install-configure-warehousing-app)」を参照してください。 |
...
## <a name="features-that-have-been-deprecated-for-on-premises-deployments-of-the-july-2017-update-with-platform-update-8"></a>2017 年 7 月のプラットフォーム アップデート 8 によるアップデートのオンプレミス デプロイメント タイプに対して推奨されなくなった機能

### <a name="ssrs-report-viewer-control"></a>SSRS レポート ビューアー コントロール

この機能は、Finance and Operations Web クライアントで HTML 形式のレポートと対話するために使用されました。

|                                  |  |
|----------------------------------|--|
| **廃止の理由**       | SQL Reporting Services (SSRS) では、オンプレミス Web クライアントと互換性のあるレポート ビューアー コントロールをサポートしていません。      |
| **別の機能で置き換えられているか?** | レポートは、オンプレミス サービスによって PDF ドキュメントとしてレンダリングされます。 拡張機能を使用して、アプリケーション レポートに埋め込みドリルスルー リンクを有効にします。 |
| **影響を受けるモジュール**             | すべて    |

### <a name="document-routing-agent"></a>ドキュメント回覧エージェント

ドキュメント回覧エージェント クライアントは、クラウドからドメイン認証されたネットワーク プリンターに接続するためのサービス ゲートウェイとして使用されます。

|                                  |  |
|----------------------------------|--|
| **廃止の理由**       | オンプレミスの展開は、ドメインで認証されたサーバーでホストされます。 これにより、ネットワーク プリンター デバイスに安全かつ直接アクセスできます。 |
| **別の機能で置き換えられているか?** | このコンポーネントは、オンプレミスの展開には必要ありません。|
| **影響を受けるモジュール**             | なし               |
...
## <a name="features-deprecated-in-dynamics-ax-70-releases"></a>Dynamics AX 7.0 リリースで廃止される機能
...
| 別の機能での置き換え? | Azure BLOB ストレージをサポートしてデータベース ストレージは推奨されなくなりました。       |
| 影響を受けるモジュール             | すべて                   |
