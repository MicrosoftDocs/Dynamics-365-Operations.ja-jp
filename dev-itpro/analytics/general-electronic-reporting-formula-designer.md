...
| DATETODATETIME (日付)                      | 日時値に指定された日付値を変換します。                                                                                                                                                                                                                                                                                                            | **DATETODATETIME (CompInfo. 'getCurrentDate()')** は、現在の Dynamics 365 for Operations セッションの日付 12/24/2015 を **12/24/2015 12:00:00 AM** として返します。 この例では、**CompInfo** は、CompanyInfo テーブルを参照する **Dynamics 365 for Operations/テーブル** タイプの ER データ ソースです。 |
