...
- [データ エンティティ](https://ax.help.dynamics.com/en/wiki/data-entities/)
...
- [Power BI タイルをワークスペースへ追加する](http://ax.help.dynamics.com/en/wiki/configuring-powerbi-integration/)
