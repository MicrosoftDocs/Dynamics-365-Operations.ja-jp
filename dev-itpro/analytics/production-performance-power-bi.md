...
- [データ エンティティ](/dynamics365/unified-operations/dev-itpro/data-entities/data-entities.md)
...
- [Power BI タイルをワークスペースへ追加する](/dynamics365/unified-operations/dev-itpro/analytics/configure-power-bi-integration)
