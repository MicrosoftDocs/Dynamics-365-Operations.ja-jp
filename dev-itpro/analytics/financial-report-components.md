...
レポート パーツ グループのレポート パーツ グループまたは特定のレポート パーツをエクスポートできます。 バックアップとしてエクスポートされたレポート パーツ グループを使用できます。 工程のインストールのレポート パーツ グループまたは365 for Operationsの間のエクスポートされたデータをコピーできます。 レポート デザイナがレポート パーツ グループとともに参照するフォント スタイルと分析コードセットが含まれます。
1.  レポート デザイナーの [**会社**] メニューで、[**構成要素グループ** をクリックします。
