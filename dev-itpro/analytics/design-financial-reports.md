---
title: "ビューとデザイン財務諸表"
description: "この記事では、表示すると、アクション、Microsoft Dynamics 365の作成の財務諸表歩く演習を提供します。 財務報告は365 for Operations内の表示エクスペリエンスから[財務諸表を作成、編集できるようにするレポート デザイナできます。"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="view-and-design-financial-reports"></a>ビューとデザイン財務諸表

この記事では、表示すると、アクション、Microsoft Dynamics 365の作成の財務諸表歩く演習を提供します。 財務報告は365 for Operations内の表示エクスペリエンスから[財務諸表を作成、編集できるようにするレポート デザイナできます。  
...
6.  [**編集**] を選択します。 注: [レポート デザイナ ダウンロードしてログインするように要求されます。 ログインしている場合でも、資格情報を使用します。
...
16. フィルター処理されたレポートを閉じます。 財務諸表は、Dynamics 365 for Operationsに追加されたすべての通貨で表示できます。
...
4.  [**ファイル**]、[**名前を付けて保存**] を選択し、[属性の詳細な試算表] レポートの名前を付けます。 注: 新しいレポートがレポート デザイナで作成された、財務諸表の一覧は、Dynamics 365 for Operationsで更新されます。
...
## <a name="exercise-3-create-a-multidimensional-report-using-a-reporting-tree"></a>演習3: レポート ツリーを使用して多次元レポートを作成します。
...
4.  ** ** ** &gt; ファイルとして保存**選択し、レポートを指定します。**連結された貸借対照表、損益計算書に並べて**。
5.  基準年を 2012 に変更します。
...
## <a name="exercise-5-create-a-sidebyside-departmental-report"></a>演習5: ステップバイステップの部門レポートを作成します。
...
[財務報告 (\financials\general-ledger\financial-reporting-getting-started.md) ] 
[ビューの財務諸表 (\financials\general-ledger\view-financial-reports.md) ] 
