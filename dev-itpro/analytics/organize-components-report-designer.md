...
2.  **ファイル**メニューで、新しい** ** ** &gt; レポート定義グループを**クリックしてビューア ウィンドウの新しいレポート グループを開きます。 また、レポート グループ** **ボタンをクリックしてください。[レポート グループ] (https://i-technet.sec.s-msft.com/dynimg/IC679515.gif 「レポート グループ」) ツール バーの。
...
4.  **ファイル**メニューで変更されたレポート グループを、代わりに保存する、[**保存**は**保存**ボタンをクリックします。[保存] (https://i-technet.sec.s-msft.com/dynimg/IC679516.gif 「保存」) ツール バーの。
...
3.  **レポートを生成します。**ボタンをクリックしてください。[レポートを生成します。] (https://i-technet.sec.s-msft.com/dynimg/IC679517.gifは、「」レポートが生成されます) レポートを生成します。
...
<li><strong>財務 &amp; 勘定</strong> 高レベルの概要および勘定の詳細を含むが、レポート。</li>
<li><strong>財務、勘定 &amp; トランザクション</strong> 高レベルの概要およびトランザクションの詳細を含むが、レポート。</li>
</ul></td>
</tr>
<tr class="even">
<td>[仮]</td>
