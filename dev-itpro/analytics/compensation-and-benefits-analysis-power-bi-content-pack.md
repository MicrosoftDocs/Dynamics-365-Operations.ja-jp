---
title: "報酬とその利点のPower BIの内容"
description: "このトピックでは、Dynamics 365 for Operations (について、Power BIの内容に寄与します。 コンテンツ パックに含まれる説明し、コンテンツ パックを作成するのに使用されたエンティティとデータ モデルに関する情報を提供するレポートにアクセスする方法。"
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="compensation-and-benefits-power-bi-content"></a>報酬とその利点のPower BIの内容

このトピックでは、Dynamics 365 for Operations (について、Power BIの内容に寄与します。 コンテンツ パックに含まれる説明し、コンテンツ パックを作成するのに使用されたエンティティとデータ モデルに関する情報を提供するレポートにアクセスする方法。

<a name="accessing-the-content-pack"></a>コンテンツPackのアクセス
--------------------------

報酬を見つけることができ、Microsoft Dynamics Lifecycle Services (LCS)の共有資産のライブラリのコンテンツ パック上します。 コンテンツ パックをダウンロードし、データのMicrosoft Dynamics 365に接続する方法の詳細については、" "を参照してください]、[Microsoftパートナー (能力Bi内容Microsoft partners.md) のLCSのPower BIの内容。
...
| レポート                      | コンテンツ                                                                                                                              |
|----------------------------|---------------------------------------------------------------------------------------------------------------------------------------|
| Compとその利点分析 | 会社、平均時間あたりの支払、平均支払サラリー、雇用別の従業員による時間レートとサラリー従業員は、計画の登録を入力します。 |
| 従業員の福利厚生          | 選択した福利厚生の別の従業員の登録                                                                                               |
...
工程365 for Operationsデータが報酬とその利点の内容のレポートの情報もパック使用されます。 次の表に、コンテンツ パックが基づいているエンティティに示します。
...
| 全従業員\_WorkerName             | 名]ボックスに、完全名                                                                       | 従業員の\_CurrentWorkerに、従業員\_TerminatedWorker Workorce\_WorkerTrend                                                                                                                                                                                                                                                       |
