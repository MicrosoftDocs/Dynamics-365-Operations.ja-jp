...
| **\***EUR-00002 トランザクションの荷積みの住所を指定する                                                          | ヨーロッパ                            |
...
| BPM 明細行                                                                       | 国/地域 |
|--------------------------------------------------------------------------------|----------------|
| **\***生産の需要に基づく委託販売在庫の所有権の変更 | グローバル         |
| **\***委託販売補充注文の作成                                 | グローバル         |
| **\***仕入先のコラボレーションを使用した委託販売の在庫の監視                 | グローバル         |
...
|-----------------------------------------------------------------------------|----------------|
| 場所プロファイルの作成                                                   | グローバル         |
| **\***連結するライセンス プレートのモバイル デバイスのメニュー項目を作成する      | グローバル         |
| 運賃の手動調整                                                  | グローバル         |
