...
|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **何ができますか。**                                                | **これは、なぜ重要ですか。**                                                                                                                                                                                                                                                                                         |
| 財務レポートのデータ マートを再構築します。                          | 環境の間でDynamics AXデータベースを移動するか、または環境への他の侵略的な変更を加えると、財務報告のデータベースを再構築する必要があるかもしがあります。 Windows PowerShellのスクリプトは、自分のデータベースを再構築するためのものです。                                                                |
| 有効ではないレポート デザイナー オプションを選択する必要はありません。 | Management reporter の市場バージョンで使用されていたいくつかのレポート デザイナー オプションは、この Dynamics AX バージョンには適用されません。 これらのオプションは、財務諸表の設計、出荷、およびリンクに関連します。 これらのオプションは、財務諸表のデザイナーからユーザー エラーを防ぐために取除かれました。 |
