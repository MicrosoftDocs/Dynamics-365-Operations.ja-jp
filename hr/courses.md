...
# <a name="set-up-training-courses"></a>トレーニング コース設定
...
-   コースの説明の作成 (作成後は従業員セルフ サービスで通知することが可能)
  ...
  >**メモ**従業員が次に登録されていない場合にのみコースを削除できます。 
...
**従業員の自己サービス**ページを使用して、コースに登録する承認の作業によって現在の工順を指定されている従業員や従業員の登録を使用できます。  現在の作業が**コース**ページの概要FastTab ** **のコースに割り当てることができます。
