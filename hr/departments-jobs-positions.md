---
title: "部門、職務、および職位を使用して、従業員を分類します。"
...
# <a name="organize-your-workforce-using-departments-jobs-and-positions"></a>部門、職務、および職位を使用して、従業員を分類します。
...
|**Accounting**|会計監修者|会計マネージャー|
|**Accounting**|会計 A|経理担当|
|**Human resources**|HR の管理者 (東部)|HR の管理者|
|**Human resources**|HR の管理者 (西部)|HR の管理者|
|**Human resources**|HR の管理者 (中央)|HR の管理者|
...
職務権限とは、職務タスクなどのことです。 職務権限は、職務に割り当てられた一つ以上のタスク、義務、または職責を表します。 職務権限は職務に割り当てられ、補償プランの適正なルールを策定および導入するのに使用されます。 ジョブ機能には、次の表に示します。
...
職位は組織階層の下位レベルの重要な要素です。 職位は、職務の個々のインスタンスです。 たとえば、職位、「販売マネージャ (East) 」、がジョブに関連付けられる職位の一つで、販売マネージャ」と。 職位は、部門で、ワーカーに割り当てられます。
